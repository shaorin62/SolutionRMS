...
Public Class ceSC_JOBCUST
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceSC_JOBCUST"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strSEQNO As String, _
            ...
            Optional ByVal strACCCUSTCODE As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "ACCCUSTCODE", strACCCUSTCODE, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("ACCCUSTCODE", strACCCUSTCODE), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "SC_JOBCUST"     'Entity Name 설정
    End Sub
