...
Public Class ceMD_CLOUD_AMT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_CLOUD_AMT"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strYEARMON As String, _
                             ...
                             Optional ByVal dblCGV_AMT As Double = OPTIONAL_NUM, _
        ...
        Try
            ...
            BuildNameValues(",", "CGV_AMT", dblCGV_AMT, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("CGV_AMT", dblCGV_AMT), _
    ...
    Public Function COMMIDeleteUpdateDo(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = strSQL & "  UPDATE MD_CLOUD_AMT "
            strSQL = strSQL & "  SET COMMI_TRANS_NO = '' "
            strSQL = strSQL & "  FROM MD_CLOUD_AMT"
            ...
            strSQL = strSQL & "  ;UPDATE MD_CLOUD_OUT "
            strSQL = strSQL & "  SET COMMI_TRANS_NO = '' "
            strSQL = strSQL & "  FROM MD_CLOUD_OUT"
    ...
    Public Function Update_TruTrans(ByVal strTRUST_YEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_CLOUD_AMT SET COMMI_TRANS_NO = '" & strTRUTRANS & "' , DEMANDDAY = '" & strDEMANDDAY & "'"
            ...
            strSQL = strSQL & " ; UPDATE MD_CLOUD_CGV"
    ...
    Public Function Update_CommiTax(ByVal strTRANSNO As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_CLOUD_AMT SET COMMI_TAX_NO = '" & strTAXNO & "' "
            strSQL = strSQL & "  WHERE COMMI_TRANS_NO = '" & strTRANSNO & "'"

            strSQL = strSQL & "  ;UPDATE MD_CLOUD_OUT SET COMMI_TAX_NO = '" & strTAXNO & "' "
            strSQL = strSQL & "  WHERE COMMI_TRANS_NO = '" & strTRANSNO & "'"
            Return ProcEntity(strSQL)
        Catch err As Exception
    ...
    Public Function CommiTaxDeleteUpdateDo(ByVal strTAXNO As String) As Integer
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_CLOUD_AMT SET COMMI_TAX_NO = '' "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_CLOUD_AMT"     'Entity Name 설정
    End Sub
