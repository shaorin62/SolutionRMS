...
Public Class ceMD_TRUTAX_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_TRUTAX_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strTAXYEARMON As String, _
            ...
            ByVal dblCLIENTACCODE As String, _
            ByVal dblREAL_MED_ACCODE As String, _
        ...
        Try
            ...
            BuildNameValues(",", "CLIENTACCODE", dblCLIENTACCODE, strFields, strValues)
            BuildNameValues(",", "REAL_MED_ACCODE", dblREAL_MED_ACCODE, strFields, strValues)
    ...
    Public Function DeleteDo2(ByVal strATTR05 As String) As Integer
        ...
        Try
            strSQL = "DELETE FROM MD_TRUTAX_HDR WHERE MEDFLAG = 'A' AND ATTR05 = '" & strATTR05 & "'"
    ...
    '*****************************************************************
    Public Function UPDATE_PRINTTRANSATTR02_HDR(ByVal strTAXYEARMON, ByVal dblTAXNO) As Integer
        Dim strSQL As String

        Try
            strSQL = String.Format("UPDATE MD_PRINTTRANS_HDR SET ATTR02 = 'D'  WHERE {0}", _
                     BuildFields("AND", _
    ...
    '기능 : 분할청구일때 거래명세서헤더 테이블에 분할을 표시하기 위한 함수
    '*****************************************************************
    Public Function UPDATE_ELECTRANSATTR02_HDR(ByVal strTAXYEARMON, ByVal dblTAXNO) As Integer
        Dim strSQL As String

        Try
            strSQL = String.Format("UPDATE MD_ELEC_TRANS_HDR SET ATTR02 = 'D'  WHERE {0}", _
                     BuildFields("AND", _
                                   GetFieldNameValue("TRANSYEARMON", strTAXYEARMON), GetFieldNameValue("TRANSNO", dblTAXNO)))
    ...
    '기능 : 분할청구일때 거래명세서헤더 테이블에 분할을 표시하기 위한 함수
    '*****************************************************************
    Public Function UPDATE_INTERNETTRANSATTR02_HDR(ByVal strTAXYEARMON, ByVal dblTAXNO) As Integer
        Dim strSQL As String

        Try
            strSQL = String.Format("UPDATE MD_INTERNETTRANS_HDR SET ATTR02 = 'D'  WHERE {0}", _
                     BuildFields("AND", _
                                   GetFieldNameValue("TRANSYEARMON", strTAXYEARMON), GetFieldNameValue("TRANSNO", dblTAXNO)))
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UPDATE_ELEC_MEDIUM(ByVal strTAXYEARMON, ByVal intTAXNO, ByVal strTRUST_SEQ) As Integer
        Dim strSQL As String 'strTAXYEARMON, intTAXNO, strTRUST_SEQ
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UPDATE_CATV_MEDIUM(ByVal strTAXYEARMON, ByVal intTAXNO, ByVal strTRUST_SEQ) As Integer
        Dim strSQL As String 'strTAXYEARMON, intTAXNO, strTRUST_SEQ
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : 세금계산서 완료건에 대하여 적요, 부가세 합산 수정
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : 해당 자료를 통합전표를 위해 이동 플래그 변경
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UpdateRtn_TRUTAX_HDR_MERGE(ByVal strTAXYEARMON, ByVal intTAXNO, ByVal strMEDFLAG) As Integer
        Dim strSQL As String 'strTAXYEARMON, intTAXNO, strTRUST_SEQ
        ...
        Try
            ...
            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".UpdateRtn_TRUTAX_HDR_MERGE")
        End Try
    End Function
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : 통합전표 처리 이동 플래그 삭제 
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UpdateRtn_TRUTAX_HDR_MERGE_CANCEL(ByVal strTAXYEARMON, ByVal intTAXNO, ByVal strMEDFLAG) As Integer
        Dim strSQL As String 'strTAXYEARMON, intTAXNO, strTRUST_SEQ
        ...
        Try
            ...
            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".UpdateRtn_TRUTAX_HDR_MERGE_CANCEL")
        End Try
    End Function
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_TRUTAX_HDR"     'Entity Name 설정
    End Sub
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_TRUTAX_HDR.UpdateDo( _
'                                       GetElement(vntData,"TAXYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TAXNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"MEDFLAG", intColCnt, intRow), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
...
'                                       XMLGetElement(xmlRoot,"CLIENTNAME"), _
'                                       XMLGetElement(xmlRoot,"CLIENTOWNER"), _
'                                       XMLGetElement(xmlRoot,"CLIENTADDR1"), _
'                                       XMLGetElement(xmlRoot,"CLIENTADDR2"), _
