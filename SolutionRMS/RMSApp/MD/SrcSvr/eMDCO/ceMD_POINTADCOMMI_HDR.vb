...
Public Class ceMD_POINTADCOMMI_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_POINTADCOMMI_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function ConfirmUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_POINTADCOMMI_HDR  "
            strSQL = strSQL & " SET "
    ...
    Public Function ConfirmCancelUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_POINTADCOMMI_HDR  "
            strSQL = strSQL & " SET "
            strSQL = strSQL & " REQUEST_USER = '',"
            strSQL = strSQL & " REQUEST_DATE = '',"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_POINTADCOMMI_HDR"     'Entity Name 설정
    End Sub
