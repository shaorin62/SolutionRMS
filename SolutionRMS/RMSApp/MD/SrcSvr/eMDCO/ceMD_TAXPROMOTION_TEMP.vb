...
'프로그램명 : ceMD_TAX_TEMP.vb ( MD_TAX_TEMP Entity 처리 Class)
'기      능 : MD_TAX_TEMP Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2008-02-26 오후 1:55:14 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_TAXPROMOTION_TEMP
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_TAXPROMOTION_TEMP"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '*****************************************************************
    Public Function InsertDo(Optional ByVal strTAXYEARMON As String = OPTIONAL_STR, _
                             Optional ByVal strTAXNO As String = OPTIONAL_STR, _
                             Optional ByVal strVATFLAG As String = OPTIONAL_STR, _
                             Optional ByVal strFLAG As String = OPTIONAL_STR, _
                             Optional ByVal strNUM As Double = OPTIONAL_NUM)
        ...
        Try
            ...
            BuildNameValues(",", "FLAG", strFLAG, strFields, strValues)
    ...
    Public Function DeleteDo(ByVal USERID As String) As Integer
        ...
        Try
            strSQL = "DELETE FROM MD_TAXINTERNET_TEMP WHERE USERID ='" & USERID & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "cMD_TAXPROMOTION_TEMP"     'Entity Name 설정
    End Sub
...
'                                       GetElement(vntData,"FLAG", intColCnt, intRow), _
'                                       GetElement(vntData,"USERID", intColCnt, intRow) _
'                                       )
'        Return intRtn

'        Dim intRtn As Integer
'        intRtn = mobjceMD_TAXINTERNET_TEMP.UpdateDo( _
'                                       GetElement(vntData,"TAXYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TAXNO", intColCnt, intRow), _
'                                       GetElement(vntData,"VATFLAG", intColCnt, intRow), _
'                                       GetElement(vntData,"FLAG", intColCnt, intRow), _
