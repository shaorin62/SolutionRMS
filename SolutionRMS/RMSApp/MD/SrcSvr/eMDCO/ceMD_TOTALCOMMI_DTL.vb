...
'프로그램명 : ceMD_TOTALCOMMI_DTL.vb ( MD_TOTALCOMMI_DTL Entity 처리 Class)
'기      능 : MD_TOTALCOMMI_DTL Entity에 대해Insert/Update/Delete/Select를 처리
...
Public Class ceMD_TOTALCOMMI_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_TOTALCOMMI_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function UPDATE_COMMI_DO()
        ...
        Try
            strSQL = " UPDATE MD_TOTAL_MEDIUM A"
            strSQL = strSQL & "   SET A.COMMI_TRANS_NO = (SELECT TRANSYEARMON || '-' || TRANSNO  FROM MD_TOTALCOMMI_DTL B WHERE A.YEARMON = B.TRANSYEARMON AND A.SEQ= B.TRUST_SEQ)"
            strSQL = strSQL & "   WHERE EXISTS "
            strSQL = strSQL & "   ("
            strSQL = strSQL & " 	  SELECT B.TRUST_SEQ, B.ATTR01"
            strSQL = strSQL & " 	  FROM MD_TOTALCOMMI_DTL B"
    ...
    Public Function UPDATE_COMMI_TRNASNO(ByVal strCOMMITRANS As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_TOTAL_MEDIUM SET COMMI_TRANS_NO = '" & strCOMMITRANS & "' WHERE CLIENTCODE = '" & strCLIENTCODE & "' "
    ...
    Public Function Update_CommiTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_TOTALCOMMI_DTL SET TAXYEARMON = '" & strTAXYEARMON & "',TAXNO = " & intTAXNO
    ...
    Public Function CommiTaxDeleteUpdateDo(ByVal strTAXYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_TOTALCOMMI_DTL SET TAXYEARMON = '',TAXNO = NULL "
    ...
    Public Function Update_Vat(ByVal strTRANSYEARMON, ByVal strTRANSNO, ByVal intTRANSSEQ, ByVal lngVAT) As Integer
        ...
        Try
            strSQL = " UPDATE MD_TOTALCOMMI_DTL "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_TOTALCOMMI_DTL"     'Entity Name 설정
    End Sub
