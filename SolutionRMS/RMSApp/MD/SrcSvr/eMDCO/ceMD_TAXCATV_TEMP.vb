...
Public Class ceMD_TAXCATV_TEMP
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_TAXCATV_TEMP"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function DeleteDo(ByVal USERID As String) As Integer
        ...
        Try
            strSQL = "DELETE FROM MD_TAXCATV_TEMP WHERE USERID ='" & USERID & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_TAXCATV_TEMP"     'Entity Name 설정
    End Sub
