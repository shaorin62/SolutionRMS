...
Public Class ceMD_OUTDOOR_DEPT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_OUTDOOR_DEPT"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '*****************************************************************
    Public Function InsertDo(ByVal strCLIENTCODE As String, _
                             ...
                             Optional ByVal strUSE_YN As String = OPTIONAL_STR)
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_OUTDOOR_DEPT"     'Entity Name 설정
    End Sub
