...
'프로그램명 : ceMD_ELECTRIC_COMMIT.vb ( MD_ELECTRIC_COMMIT Entity 처리 Class)
'기      능 : MD_ELECTRIC_COMMIT Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2008-02-11 오전 11:34:58 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체    
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_ELECTRIC_COMMIT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_ELECTRIC_COMMIT"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strYEARMON As String, _
            Optional ByVal strCOMMITFLAG As String = OPTIONAL_STR, _
            Optional ByVal dblABSVALUE As Double = OPTIONAL_NUM, _
        ...
        Try
            ...
            BuildNameValues(",", "COMMITFLAG", strCOMMITFLAG, strFields, strValues)
            BuildNameValues(",", "ABSRATE", dblABSVALUE, strFields, strValues)
    ...
    Public Function UpdateDo(Optional ByVal strYEARMON As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        GetFieldNameValue("COMMITFLAG", strCOMMITFLAG), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_ELECTRIC_COMMIT"     'Entity Name 설정
    End Sub
...
'                                       GetElement(vntData,"COMMITFLAG", intColCnt, intRow), _
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_ELECTRIC_COMMIT.UpdateDo( _
'                                       GetElement(vntData,"YEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"COMMITFLAG", intColCnt, intRow), _
'                                       GetElement(vntData,"ATTR01", intColCnt, intRow), _
'                                       GetElement(vntData,"ATTR02", intColCnt, intRow), _
...
'                                       XMLGetElement(xmlRoot,"COMMITFLAG"), _
