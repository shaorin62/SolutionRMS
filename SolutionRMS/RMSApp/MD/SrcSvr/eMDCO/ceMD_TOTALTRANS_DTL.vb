...
'프로그램명 : ceMD_TOTALTRANS_DTL.vb ( MD_TOTALTRANS_DTL Entity 처리 Class)
'기      능 : MD_TOTALTRANS_DTL Entity에 대해Insert/Update/Delete/Select를 처리
...
Public Class ceMD_TOTALTRANS_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_TOTALTRANS_DTL"    '자신의 클래스명
#End Region
...
Optional ByVal dblSEQ As Double = OPTIONAL_NUM, _
    ...
    Public Function Update_TruTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_TOTALTRANS_DTL SET TAXYEARMON = '" & strTAXYEARMON & "',TAXNO = " & intTAXNO
    ...
    Public Function TruTaxDeleteUpdateDo(ByVal strTAXYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_TOTALTRANS_DTL SET TAXYEARMON = '',TAXNO = NULL "
    ...
    Public Function ConfirmUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_TOTALTRANS_DTL "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_TOTALTRANS_DTL"     'Entity Name 설정
    End Sub
