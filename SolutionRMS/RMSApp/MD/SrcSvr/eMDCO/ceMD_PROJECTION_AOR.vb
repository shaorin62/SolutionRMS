...
Public Class ceMD_PROJECTION_AOR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_PROJECTION_AOR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strYEARMON As String, _
                             ...
                             Optional ByVal dblAOR_RATE As Double = OPTIONAL_NUM, _
        ...
        Try
            ...
            BuildNameValues(",", "AOR_RATE", dblAOR_RATE, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("AOR_RATE", dblAOR_RATE), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_PROJECTION_AOR"     'Entity Name 설정
    End Sub
