...
'프로그램명 : ceMD_OUTDOORCOMMI_HDR.vb ( MD_OUTDOORCOMMI_HDR Entity 처리 Class)
'기      능 : MD_OUTDOORCOMMI_HDR Entity에 대해Insert/Update/Delete/Select를 처리
...
Public Class ceMD_OUTDOORCOMMI_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_OUTDOORCOMMI_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function ConfirmUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_OUTDOORCOMMI_HDR  "
            strSQL = strSQL & " SET "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_OUTDOORCOMMI_HDR"     'Entity Name 설정
    End Sub
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_OUTDOORCOMMI_HDR.UpdateDo( _
'                                       GetElement(vntData,"TRANSYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TRANSNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
'                                       GetElement(vntData,"MEDCODE", intColCnt, intRow), _
