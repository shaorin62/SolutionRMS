...
'프로그램명 : ceMD_PAYMENT_TEMP.vb ( MD_PAYMENT_TEMP Entity 처리 Class)
'기      능 : MD_PAYMENT_TEMP Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2008-05-12 오후 3:34:17 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_PAYMENT_TEMP
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_PAYMENT_TEMP"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(Optional ByVal strTAXYEARMON As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "PRINTDATE", strPRINTDATE, strFields, strValues)
    ...
    Public Function DeleteDo(ByVal USERID As String) As Integer
        ...
        Try
            strSQL = "DELETE FROM MD_PAYMENT_TEMP WHERE USERID = '" & USERID & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_PAYMENT_TEMP"     'Entity Name 설정
    End Sub
...
'                                       GetElement(vntData,"PRINTDATE", intColCnt, intRow), _
'                                       GetElement(vntData,"USERID", intColCnt, intRow) _
'                                       )
'        Return intRtn

'        Dim intRtn As Integer
'        intRtn = mobjceMD_PAYMENT_TEMP.UpdateDo( _
'                                       GetElement(vntData,"TAXYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TAXNO", intColCnt, intRow), _
'                                       GetElement(vntData,"PRINTDATE", intColCnt, intRow), _
'                                       GetElement(vntData,"USERID", intColCnt, intRow) _
...
'                                       XMLGetElement(xmlRoot,"PRINTDATE"), _
