...
Public Class ceMD_POINTAD_CAMPAIGN
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_POINTAD_CAMPAIGN"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strCAMPAIGN_CODE As String, _
                             ...
                             Optional ByVal strCAMPAIGN_TYPE As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "CAMPAIGN_TYPE", strCAMPAIGN_TYPE, strFields, strValues)
    ...
    '*****************************************************************
    Public Function UpdateDo(ByVal strCAMPAIGN_CODE As String, _
                             ByVal strGUBUN As String, _
                             ByVal strCLIENTCODE As String, _
                             Optional ByVal strTIMCODE As String = OPTIONAL_STR, _
                             Optional ByVal strEXCLIENTCODE As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("CAMPAIGN_TYPE", strCAMPAIGN_TYPE), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_POINTAD_CAMPAIGN"     'Entity Name 설정
    End Sub
