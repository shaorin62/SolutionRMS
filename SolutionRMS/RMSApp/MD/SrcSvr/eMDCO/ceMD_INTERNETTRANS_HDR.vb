...
'프로그램명 : ceMD_INTERNETTRANS_HDR.vb ( MD_INTERNETTRANS_HDR Entity 처리 Class)
'기      능 : MD_INTERNETTRANS_HDR Entity에 대해Insert/Update/Delete/Select를 처리
...
Public Class ceMD_INTERNETTRANS_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_INTERNETTRANS_HDR"    '자신의 클래스명
#End Region
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_INTERNETTRANS_HDR"     'Entity Name 설정
    End Sub
