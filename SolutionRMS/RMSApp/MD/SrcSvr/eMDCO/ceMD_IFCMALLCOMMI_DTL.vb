...
Public Class ceMD_IFCMALLCOMMI_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_IFCMALLCOMMI_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function Update_CommiTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_IFCMALLCOMMI_DTL SET TAXYEARMON = '" & strTAXYEARMON & "',TAXNO = " & intTAXNO
    ...
    Public Function CommiTaxDeleteUpdateDo(ByVal strTAXYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_IFCMALLCOMMI_DTL SET TAXYEARMON = '',TAXNO = NULL "
    ...
    Public Function ConfirmUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_IFCMALLCOMMI_DTL "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_IFCMALLCOMMI_DTL"     'Entity Name 설정
    End Sub
