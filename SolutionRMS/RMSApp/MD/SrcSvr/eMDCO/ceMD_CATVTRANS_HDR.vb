...
'프로그램명 : ceMD_CATVTRANS_HDR.vb ( MD_CATVTRANS_HDR Entity 처리 Class)
'기      능 : MD_CATVTRANS_HDR Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2007-12-24 오후 1:00:16 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_CATVTRANS_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_CATVTRANS_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function UpdateDo(Optional ByVal strTRANSYEARMON As String = OPTIONAL_STR, _
            ...
            Optional ByVal dblAMT As Double = OPTIONAL_NUM, _
            Optional ByVal dblVAT As Double = OPTIONAL_NUM, _
            Optional ByVal dblBONUS As Double = OPTIONAL_NUM, _
            Optional ByVal strMED_FLAG As String = OPTIONAL_STR, _
            Optional ByVal strMEMO As String = OPTIONAL_STR, _
            Optional ByVal strATTR01 As String = OPTIONAL_STR, _
            Optional ByVal strATTR02 As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("BONUS", dblBONUS), _
...
Optional ByVal dblTRANSNO As Double = OPTIONAL_NUM, _
    ...
    Public Function UserUpdateDo(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE MD_CATVTRANS_HDR  "
            strSQL = strSQL & " SET "
            strSQL = strSQL & " REQUEST_USER = '" & strUSER & "',"
            strSQL = strSQL & " REQUEST_DATE = '" & strNOW & "',"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_CATVTRANS_HDR"     'Entity Name 설정
    End Sub
...
'                                       GetElement(vntData,"BONUS", intColCnt, intRow, NULL_NUM, true ), _
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_CATVTRANS_HDR.UpdateDo( _
'                                       GetElement(vntData,"TRANSYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TRANSNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
'                                       GetElement(vntData,"MEDCODE", intColCnt, intRow), _
...
'                                       XMLGetElement(xmlRoot,"BONUS", NULL_NUM, true ), _
