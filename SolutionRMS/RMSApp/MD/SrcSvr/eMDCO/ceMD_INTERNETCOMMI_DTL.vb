...
'프로그램명 : ceMD_INTERNETCOMMI_DTL.vb ( MD_INTERNETCOMMI_DTL Entity 처리 Class)
'기      능 : MD_INTERNETCOMMI_DTL Entity에 대해Insert/Update/Delete/Select를 처리
...
Public Class ceMD_INTERNETCOMMI_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_INTERNETCOMMI_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '*****************************************************************
    '입력 : strSQL = SQL 문 By Kim Tae Yub
    '반환 : 처리건수
    '기능 : 청약테이블에 수수료거래명세서 번호 업데이트
    '*****************************************************************
    Public Function UPDATE_COMMI_DO()
        Dim strSQL As String

        Try
            strSQL = " UPDATE MD_INTERNET_MEDIUM A"
            strSQL = strSQL & "   SET A.COMMI_TRANS_NO = (SELECT TRANSYEARMON || '-' || TRANSNO  FROM MD_INTERNETCOMMI_DTL B WHERE A.YEARMON = B.TRANSYEARMON AND A.SEQ= B.TRUST_SEQ)"
            strSQL = strSQL & "   WHERE EXISTS "
            strSQL = strSQL & "   ("
            strSQL = strSQL & " 	  SELECT B.TRUST_SEQ, B.ATTR01"
            strSQL = strSQL & " 	  FROM MD_INTERNETCOMMI_DTL B"
    ...
    Public Function Update_CommiTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_INTERNETCOMMI_DTL SET TAXYEARMON = '" & strTAXYEARMON & "',TAXNO = " & intTAXNO
    ...
    Public Function CommiTaxDeleteUpdateDo(ByVal strTAXYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_INTERNETCOMMI_DTL SET TAXYEARMON = '',TAXNO = NULL "
    ...
    Public Function Update_Vat(ByVal strTRANSYEARMON, ByVal strTRANSNO, ByVal intTRANSSEQ, ByVal lngVAT) As Integer
        ...
        Try
            strSQL = " UPDATE MD_INTERNETCOMMI_DTL "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_INTERNETCOMMI_DTL"     'Entity Name 설정
    End Sub
