...
'프로그램명 : ceMD_ELEC_TRANS_HDR.vb ( MD_ELEC_TRANS_HDR Entity 처리 Class)
'기      능 : MD_ELEC_TRANS_HDR Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2007-12-06 오전 2:05:28 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_ELEC_TRANS_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_ELEC_TRANS_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strTRANSYEARMON As String, _
            ...
            Optional ByVal strREAL_TAXNO As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "REAL_TAXNO", strREAL_TAXNO, strFields, strValues)
...
Optional ByVal dblTRANSNO As Double = OPTIONAL_NUM, _
    ...
    Public Function Update_TruTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_ELEC_TRANS_HDR SET REAL_TAXNO = '" & strTAXNO & "'"
    ...
    '*****************************************************************
    Public Function TruTaxDeleteUpdateDo2(ByVal strAREAL_TAXNO As String) As Integer
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_ELEC_TRANS_HDR SET REAL_TAXNO = '' "
            strSQL = strSQL & "  WHERE REAL_TAXNO = '" & strAREAL_TAXNO & "'"
    ...
    '기능 : 거래명세 디테일 의 세금계산서 번호 업데이트
    '*****************************************************************
    Public Function Update_VAT(ByVal strTRANSYEARMON As String, _
                               ByVal lngTRANSNO As Double, _
                               ByVal strVAT As Double) As Integer
        'strTRANSNO, strTAXNO
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_ELEC_TRANS_HDR SET VAT = " & strVAT
            strSQL = strSQL & "  WHERE TRANSYEARMON = '" & strTRANSYEARMON & "' AND TRANSNO =" & lngTRANSNO
            Return ProcEntity(strSQL)
        Catch err As Exception
        ...
        End Try
    End Function
    Public Function ConfirmUpdate(ByVal dblCOMFIRMFLAG As Double, _
        ...
        Try
            strSQL = "UPDATE MD_ELEC_TRANS_HDR SET CONFIRMFLAG = " & dblCOMFIRMFLAG
            strSQL = strSQL & " ,CONFIRM_USER = '" & strUSER & "',CONFIRM_DATE =  '" & strNOW & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_ELEC_TRANS_HDR"     'Entity Name 설정
    End Sub
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_ELEC_TRANS_HDR.UpdateDo( _
'                                       GetElement(vntData,"TRANSYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TRANSNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
'                                       GetElement(vntData,"MEDCODE", intColCnt, intRow), _
