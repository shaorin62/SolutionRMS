...
Public Class ceMD_ELECTRIC_SUSUTEMP
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_ELECTRIC_SUSUTEMP"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strYEARMON As String, _
            ByVal strINPUT_MEDFLAG As String, _
        ...
        Try
            ...
            BuildNameValues(",", "TRANSRANK", strTRANSRANK, strFields, strValues)
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : strSQL 해당문을 그대로 처리 / 위수탁,수수료 확정시 susutemp insert 
    '*****************************************************************
    Public Function SUSUTEMPInsertDo(ByVal strTEMPSQL As String) As Integer
        Dim strSQL As String
        Try
            strSQL = strTEMPSQL
            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".SUSUTEMPInsertDo")
        End Try
    End Function
    '*****************************************************************
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : strSQL 해당문을 그대로 처리 / 위수탁,수수료 확정취소시 susutemp Delete
    '*****************************************************************
    Public Function SUSUTEMPDeleteDo(ByVal strCANCELSQL As String) As Integer
        Dim strSQL As String
        Try
            strSQL = strCANCELSQL
            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".SUSUTEMPDeleteDo")
        End Try
    End Function
    'SUSUTEMPDeleteDo
#End Region
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_ELECTRIC_SUSUTEMP"     'Entity Name 설정
    End Sub
