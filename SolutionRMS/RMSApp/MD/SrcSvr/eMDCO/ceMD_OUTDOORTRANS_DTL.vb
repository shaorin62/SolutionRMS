...
'프로그램명 : ceMD_OUTDOORTRANS_DTL.vb ( MD_OUTDOORTRANS_DTL Entity 처리 Class)
'기      능 : MD_OUTDOORTRANS_DTL Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2008-02-21 오후 4:29:17 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class ceMD_OUTDOORTRANS_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_OUTDOORTRANS_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strTRANSYEARMON As String, _
            ...
            Optional ByVal dblSUMAMTVAT As Double = OPTIONAL_NUM, _
        ...
        Try
            ...
            BuildNameValues(",", "SUMAMTVAT", dblSUMAMTVAT, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("SUMAMTVAT", dblSUMAMTVAT), _
...
Optional ByVal dblSEQ As Double = OPTIONAL_NUM, _
    ...
    Public Function Update_TruTax(ByVal strTRANSYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_OUTDOORTRANS_DTL SET TAXYEARMON = '" & strTAXYEARMON & "',TAXNO = " & intTAXNO
    ...
    Public Function TruTaxDeleteUpdateDo(ByVal strTAXYEARMON As String, _
        ...
        Dim strSQL As String
        Try
            strSQL = "UPDATE MD_OUTDOORTRANS_DTL SET TAXYEARMON = '',TAXNO = NULL "
    ...
    '위수탁 거래명세서 승인 처리
    Public Function ConfirmUpdate(ByVal dblCONFIRMFLAG As Double, _
        ...
        Try
            strSQL = "UPDATE MD_OUTDOORTRANS_DTL SET CONFIRMFLAG = " & dblCONFIRMFLAG
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_OUTDOORTRANS_DTL"     'Entity Name 설정
    End Sub
...
'        intRtn = mobjceMD_OUTDOORTRANS_DTL.InsertDo( _
...
'                                       GetElement(vntData,"SUMAMTVAT", intColCnt, intRow, NULL_NUM, true ), _
...
'        Dim intRtn As Integer
'        intRtn = mobjceMD_OUTDOORTRANS_DTL.UpdateDo( _
'                                       GetElement(vntData,"TRANSYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TRANSNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"SEQ", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
...
'                                       XMLGetElement(xmlRoot,"SUMAMTVAT", NULL_NUM, true ), _
