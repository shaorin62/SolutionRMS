...
Public Class ccMDOTOUTDOORTRUTAX
    Inherits ccControl
...
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    ...
    Private CLASS_NAME = "ccMDOTOUTDOORTRUTAX"                  '자신의 클래스명
    ...
    Private mobjceMD_OUTDOORTRANS_DTL As eMDCO.ceMD_OUTDOORTRANS_DTL
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_OUTDOOR_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  B.COMMI_RATE,"
            strFormat = strFormat & "  B.COMMISSION,"
            strFormat = strFormat & "  A.DEMANDDAY,"
            If strGUBUN = "taxdiv" Then
                strFormat = strFormat & "  DBO.SC_GET_CUSTNAME_FUN(A.MEDCODE) +' 옥외광고 대행광고료' SUMM,"
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & "  REPLACE(dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE), "
                strFormat = strFormat & "  CASE dbo.INSTR(0,dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE),'(주)') "
                strFormat = strFormat & "  WHEN 0 THEN"
                strFormat = strFormat & "      CASE dbo.INSTR(0,dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE),'(사)') "
                strFormat = strFormat & "      WHEN 0 THEN"
                strFormat = strFormat & "         CASE dbo.INSTR(0,dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE),'(재)') "
                strFormat = strFormat & "          WHEN 0 THEN"
                strFormat = strFormat & "              CASE dbo.INSTR(0,dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE),'(학)') "
                strFormat = strFormat & "              WHEN 0 THEN"
                strFormat = strFormat & "  	            CASE dbo.INSTR(0,dbo.MD_GET_REALMEDCODE_FUN(A.REAL_MED_CODE),'(유)') "
                ...
                strFormat = strFormat & "  END	,'') + ' 옥외광고 대행광고료' SUMM,"
            End If
            ...
            strFormat = strFormat & "  DBO.MD_GET_ACCUSTCODE_FUN(A.CLIENTCODE) CLIENTACCODE,"
            strFormat = strFormat & "  DBO.MD_GET_MEDBUSINO_FUN(A.CLIENTCODE) CLIENTBISNO,"
            strFormat = strFormat & "  A.REAL_MED_CODE,"
            strFormat = strFormat & "  DBO.MD_GET_ACCUSTCODE_FUN(A.REAL_MED_CODE) REAL_MED_ACCODE,"
            strFormat = strFormat & "  DBO.MD_GET_MEDBUSINO_FUN(A.REAL_MED_CODE) REAL_MED_BISNO,"
            strFormat = strFormat & "  A.MEDCODE,"
            strFormat = strFormat & "  A.DEPT_CD DEPTCODE,"
            strFormat = strFormat & "  'U' MEDFLAG, '' VOCHNO,SUBSTRING(A.DEMANDDAY,1,6) TAXYEARMON , "
            strFormat = strFormat & "  DENSE_RANK() OVER (ORDER BY DBO.MD_GET_MEDBUSINO_FUN(A.REAL_MED_CODE),DBO.MD_GET_MEDBUSINO_FUN(A.CLIENTCODE), A.TRANSYEARMON, A.TRANSNO ) RANKTRANS, "
            strFormat = strFormat & "  A.PROGRAM, A.SPONSOR, "
            strFormat = strFormat & "  DBO.MD_GET_CUSTOWNER_FUN(A.CLIENTCODE) CLIENTOWNER,"
            strFormat = strFormat & "  DBO.MD_GET_CUSTADDR1_FUN(A.CLIENTCODE) CLIENTADDR1,"
            strFormat = strFormat & "  DBO.MD_GET_CUSTADDR2_FUN(A.CLIENTCODE) CLIENTADDR2,"
            strFormat = strFormat & "  DBO.MD_GET_CUSTOWNER_FUN(A.REAL_MED_CODE) REAL_MEDOWNER,"
            strFormat = strFormat & "  DBO.MD_GET_CUSTADDR1_FUN(A.REAL_MED_CODE) REAL_MEDADDR1,"
            strFormat = strFormat & "  DBO.MD_GET_CUSTADDR2_FUN(A.REAL_MED_CODE) REAL_MEDADDR2"
            strFormat = strFormat & "  FROM MD_OUTDOORTRANS_DTL A, MD_OUTDOOR_MEDIUM B"
            strFormat = strFormat & "  WHERE 1=1 "
            strFormat = strFormat & "  AND A.TRANSYEARMON = B.YEARMON"
            strFormat = strFormat & "  AND A.TRUST_SEQ = B.SEQ"
            strFormat = strFormat & "  AND A.TAXNO IS NULL AND ISNULL(A.CONFIRMFLAG,0) = 1"
    ...
    Public Function Get_OUTDOOR_TAX(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  WHERE 1=1 AND (MEDFLAG = 'U') {0} ORDER BY TAXYEARMON,TAXNO "
            strSQL = String.Format(strFormat, strWhere)
            ...
            Try
                ...
                Return vntData
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_OUTDOOR_TAX")
            Finally
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    Public Function Get_OUTDOOR_TAXALL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  AND A.TRANSYEARMON = B.YEARMON"
            strFormat = strFormat & "  AND A.TRUST_SEQ = B.SEQ"
            strFormat = strFormat & "  AND ISNULL(A.CONFIRMFLAG,0) = 1"
            'strFormat = strFormat & "  AND (A.AMT <> 0 AND A.AMT IS NOT NULL) "
            strFormat = strFormat & "  {0}"
            strFormat = strFormat & "  ORDER BY REAL_MED_BISNO, CLIENTBISNO,DEMANDDAY, AMT, TRANSNO"
            ...
            Try
                ...
                Return vntData
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_PROMOTION_TAXALL")
            Finally
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_OUTDOORTRANS_DTL = New eMDCO.ceMD_OUTDOORTRANS_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    ...
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_OUTDOORTRANS_DTL.Update_TruTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_OUTDOOR_MEDIUM.Update_TruTax(strTRANSNO, strTAXNO)
                    End If
                Next
            ...
            Finally
                ...
                mobjceMD_OUTDOORTRANS_DTL.Dispose()
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    Public Function DeleteRtn_TruTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_OUTDOORTRANS_DTL.TruTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_OUTDOOR_MEDIUM.TruTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
    ...
    Public Function ProcessRtn_MODIFYTEMP(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                intRtn = mobjceMD_MODIFYTRANS_TEMP.INSERTINTO_TEMP(strTAXYEARMON, strTAXNO, strMEDFLAG, "MD_OUTDOORTRANS_DTL")
