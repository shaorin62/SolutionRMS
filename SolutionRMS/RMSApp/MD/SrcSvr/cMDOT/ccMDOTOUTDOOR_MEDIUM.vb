...
Public Class ccMDOTOUTDOOR_MEDIUM
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDOTOUTDOOR_MEDIUM"                  '자신의 클래스명
    ...
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            Try
                ...
                If strTITLE <> "" Then Con5 = String.Format(" AND (TITLE = '{0}')", strTITLE)

                strWhere = BuildFields(" ", Con1, Con2, Con3, Con4, Con5)

                strFormet = " SELECT  "
                strFormet = strFormet & " 0 CHK, "
                strFormet = strFormet & " YEARMON, SEQ, '승인' GUBUN, "
                ...
                strFormet = strFormet & " ORDER BY CONTIDX DESC "
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        If GetElement(vntData, "SEQ", intColCnt, i, NULL_NUM, True) = -999999 Then
                            ...
                            intRtn = InsertRtn_MD_OUTDOOR_MEDIUM(vntData, intColCnt, i, strYEARMON, strSEQ, strDEMANDDAY, strTBRDSTDATE, strTBRDEDDATE)
                        Else
                            '년월 정리
                            If Len(GetElement(vntData, "YEARMON", intColCnt, i, OPTIONAL_STR)) <> 6 Then
                                strYEARMON = GetElement(vntData, "YEARMON", intColCnt, i, OPTIONAL_STR).Substring(0, 4) & GetElement(vntData, "YEARMON", intColCnt, i, OPTIONAL_STR).Substring(5, 2)
                            ...
                            intRtn = UpdateRtn_MD_OUTDOOR_MEDIUM(vntData, intColCnt, i, strYEARMON, strSEQ, strDEMANDDAY, strTBRDSTDATE, strTBRDEDDATE)
...
#Region "GROUP BLOCK : 외부에 비공개 Method"
    ...
    Private Function UpdateRtn_MD_OUTDOOR_MEDIUM(ByVal vntData As Object, _
                                                 ByVal intColCnt As Integer, _
                                                 ByVal intRow As Integer, _
                                                 ByRef strYEARMON As String, _
                                                 ByRef strSEQ As Integer, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_OUTDOOR_MEDIUM.UpdateDo_MEDIUM( _
                                       strYEARMON, _
                                       strSEQ, _
                                       GetElement(vntData, "CLIENTCODE", intColCnt, intRow), _
                                       GetElement(vntData, "TIMCODE", intColCnt, intRow), _
