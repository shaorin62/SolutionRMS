...
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    ...
    Private CLASS_NAME = "ccMDOTOUTDOORTAX"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_OUTDOOR_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  '옥외 광고료' SUMM,"
            ...
            strFormat = strFormat & "  'D' AS MEDFLAG,"
            ...
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_OUTDOOR_TAXBUILD")
            Finally
    ...
    Public Function Get_OUTDOOR_TAX(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "       AND (MEDFLAG = 'D')"
    ...
    Public Function Get_OUTDOOR_TAXALL(ByVal strInfoXML As String, _
                                       ByRef intRowCnt As Integer, _
                                       ByRef intColCnt As Integer, _
                                       ByVal strYEARMON As String, _
                                       ByVal strCLIENTCODE As String, _
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  ON A.TAXYEARMON = B.TAXYEARMON"
            strFormat = strFormat & "  AND A.TAXNO = B.TAXNO"
            strFormat = strFormat & "  LEFT JOIN MD_OUTDOORCOMMI_DTL D"
            ...
            Try
                ...
                For i = 1 To intRows
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        '헤더저장    
                        intRtn = DIVInsertRtn_MD_COMMITAX_HDR(vntData, intColCnt, i, strTAXYEARMON, intTAXNO, strDEMANDDAY, strPRINTDAY, strVOCH_TYPE)
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_OUTDOORCOMMI_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_OUTDOORCOMMI_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
