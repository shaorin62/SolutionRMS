...
Public Class ccMDOTCLOUDTAX
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDOTCLOUDTAX"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_CLOUD_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  ISNULL(CGV_AMT,0) COMMISSION,"
            strFormat = strFormat & "  'CGV클라우드 광고료' SUMM,"
            ...
            strFormat = strFormat & "  'G' AS MEDFLAG,"
    ...
    Public Function Get_CLOUD_TAX(ByVal strInfoXML As String, _
                                     ByRef intRowCnt As Integer, _
                                     ByRef intColCnt As Integer, _
                                     ByVal strYEARMON As String, _
                                     ByVal strCLIENTCODE As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "       AND (MEDFLAG = 'G')"
    ...
    Public Function Get_CLOUD_TAXALL(ByVal strInfoXML As String, _
                                       ByRef intRowCnt As Integer, _
                                       ByRef intColCnt As Integer, _
                                       ByVal strYEARMON As String, _
                                       ByVal strCLIENTCODE As String, _
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  AND A.TAXNO = B.TAXNO"
            strFormat = strFormat & "  LEFT JOIN MD_CLOUDCOMMI_DTL D"
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_CLOUDCOMMI_DTL = New eMDCO.ceMD_CLOUDCOMMI_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_CLOUDCOMMI_DTL.Update_CommiTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_CLOUD_AMT.Update_CommiTax(strTRANSNO, strTAXNO)
                    End If
                Next
    ...
    Public Function DeleteRtn_CommiTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_CLOUDCOMMI_DTL.CommiTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_CLOUD_AMT.CommiTaxDeleteUpdateDo(strTAXNO)
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_CLOUDCOMMI_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_CLOUDCOMMI_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
    ...
    Public Function SelectRtn_TRANSVAT(ByVal strTRANSYEARMON As String, _
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            Try
                ...
                strSQL = strSQL & " FROM MD_CLOUDCOMMI_DTL"
