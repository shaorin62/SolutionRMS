...
Public Class ccMDITINTERNETCOMMITAX
    Inherits ccControl
...
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    ...
    Private CLASS_NAME = "ccMDITINTERNETCOMMITAX"                  '자신의 클래스명
    Private mobjceMD_COMMITAX_HDR As eMDCO.ceMD_COMMITAX_HDR
    Private mobjceMD_COMMITAX_DTL As eMDCO.ceMD_COMMITAX_DTL

    Private mobjceMD_INTERNETCOMMI_HDR As eMDCO.ceMD_INTERNETCOMMI_HDR
    Private mobjceMD_INTERNETCOMMI_DTL As eMDCO.ceMD_INTERNETCOMMI_DTL
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function Get_INTERNET_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  DBO.SC_GET_CUSTNAME_FUN(DBO.MD_GET_TRUSTTEAM_FUN(TRUST_YEARMON,TRUST_SEQ)) TIMNAME,"
            ...
            strFormat = strFormat & " DBO.MD_GET_ACCUSTCODE_FUN(CLIENTCODE) CLIENTACCODE,"
            strFormat = strFormat & " REAL_MED_CODE,"
            strFormat = strFormat & " DBO.MD_GET_ACCUSTCODE_FUN(REAL_MED_CODE) REAL_MED_ACCODE,"
            strFormat = strFormat & " MEDCODE, DEPT_CD, "
            strFormat = strFormat & " 'O' AS MEDFLAG,"
            If strGUBUN = "taxdiv" Then
            ...
            ElseIf strGUBUN = "taxgroup" Then
                ...
                End If
            End If
            strFormat = strFormat & " FROM MD_INTERNETCOMMI_DTL WHERE 1=1 AND (ISNULL(COMMISSION,0) <> 0) AND TAXNO IS NULL {0}"
            strFormat = strFormat & " ORDER BY TRANSNO, SEQ "
            ...
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_INTERNET_TAXBUILD")
            Finally
    ...
    Public Function Get_INTERNET_TAX(ByVal strInfoXML As String, _
                                     ByRef intRowCnt As Integer, _
                                     ByRef intColCnt As Integer, _
                                     ByVal strYEARMON As String, _
                                     ByVal strREAL_MED_CODE As String, _
    ...
    Public Function Get_INTERNET_TAXALL(ByVal strInfoXML As String, _
                                        ByRef intRowCnt As Integer, _
                                        ByRef intColCnt As Integer, _
                                        ByVal strYEARMON As String, _
                                        ByVal strREAL_MED_CODE As String, _
        ...
        With mobjSCGLConfig
            ...
            ElseIf strGUBUN = "taxgroup" Then
                ...
                End If
            End If
            strFormat = strFormat & " FROM MD_INTERNETCOMMI_DTL WHERE 1=1 AND (ISNULL(COMMISSION,0) <> 0)  {0}"
            strFormat = strFormat & " ORDER BY REAL_MED_BISNO,DEMANDDAY,AMT, TRANSNO"
    ...
    Public Function SelectRtn_HDR(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  SUMM"
            strFormat = strFormat & "  FROM MD_COMMITAX_HDR"
            strFormat = strFormat & "  WHERE 1=1 AND MEDFLAG = 'O' "
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  AND A.TAXNO = B.TAXNO"
            strFormat = strFormat & "  WHERE ISNULL(A.ATTR10,0) <> 999999 AND A.MEDFLAG = 'O' "
            strFormat = strFormat & "  {0}"
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_INTERNETCOMMI_DTL = New eMDCO.ceMD_INTERNETCOMMI_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_INTERNETCOMMI_DTL.Update_CommiTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_INTERNET_MEDIUM.Update_CommiTax(strTRANSNO, strTAXNO)
                    End If
                Next
            ...
            Finally
                ...
                mobjceMD_INTERNETCOMMI_DTL.Dispose()
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    End Function
    ...
    Public Function DeleteRtn_CommiTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_INTERNETCOMMI_DTL.CommiTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_INTERNET_MEDIUM.CommiTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
        ...
        With mobjSCGLConfig
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    mobjceMD_COMMITAX_HDR = New ceMD_COMMITAX_HDR(mobjSCGLConfig)
                    mobjceMD_COMMITAX_DTL = New ceMD_COMMITAX_DTL(mobjSCGLConfig)
                    mobjceMD_INTERNETCOMMI_HDR = New ceMD_INTERNETCOMMI_HDR(mobjSCGLConfig)
                    mobjceMD_INTERNETCOMMI_DTL = New ceMD_INTERNETCOMMI_DTL(mobjSCGLConfig)
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_INTERNETCOMMI_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_INTERNETCOMMI_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
            ...
            Finally
                ...
                mobjceMD_COMMITAX_HDR.Dispose()
                mobjceMD_COMMITAX_DTL.Dispose()
                mobjceMD_INTERNETCOMMI_HDR.Dispose()
                mobjceMD_INTERNETCOMMI_DTL.Dispose()
            End Try
        End With
    End Function
