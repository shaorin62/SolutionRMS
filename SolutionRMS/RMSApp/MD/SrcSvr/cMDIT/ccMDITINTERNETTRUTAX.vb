...
Public Class ccMDITINTERNETTRUTAX
    Inherits ccControl
...
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    ...
    Private CLASS_NAME = "ccMDITINTERNETTRUTAX"                  '자신의 클래스명
	...
	Private mobjceMD_INTERNETTRANS_HDR As eMDCO.ceMD_INTERNETTRANS_HDR
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_INTERNET_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  ISNULL(AMT,0) - ISNULL(DBO.MD_GET_INTERNET_MCSUSU_FUN(TRUST_YEARMON,TRUST_SEQ),0) GENERALAMT,"
            strFormat = strFormat & "  ISNULL(DBO.MD_GET_INTERNET_MCSUSU_FUN(TRUST_YEARMON,TRUST_SEQ),0) OUTLISTAMT,"

            If strGUBUN = "taxdiv" Then
                strFormat = strFormat & " '온라인광고비 - (' + dbo.SC_GET_CUSTNAME_FUN(MEDCODE) +')' SUMM,"
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & " '온라인광고비' SUMM,"
            ...
            ElseIf strGUBUN = "taxgroup" Then
                If strGROUPGBN = "MED" Then
                    strFormat = strFormat & " DENSE_RANK() OVER (ORDER BY dbo.SC_GET_BUSINO_FUN(REAL_MED_CODE),dbo.SC_GET_BUSINO_FUN(CLIENTCODE), MEDCODE, VOCH_TYPE) RANKTRANS"
                Else
                    strFormat = strFormat & "  DENSE_RANK() OVER (ORDER BY dbo.SC_GET_BUSINO_FUN(REAL_MED_CODE),dbo.SC_GET_BUSINO_FUN(CLIENTCODE), VOCH_TYPE) RANKTRANS"
                End If
            ElseIf strGUBUN = "taxgeneralgroup" Then
    ...
    Public Function Get_INTERNET_TAX(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  WHERE 1=1 AND MEDFLAG = 'O' AND ISNULL(ATTR10,0) <> 999999 "
            strFormat = strFormat & "  {0} ORDER BY TAXYEARMON,TAXNO "
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  WHERE 1=1 AND A.MEDFLAG = 'O' "
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_INTERNETTRANS_DTL = New eMDCO.ceMD_INTERNETTRANS_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    ...
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_INTERNETTRANS_DTL.Update_TruTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_INTERNET_MEDIUM.Update_TruTax(strTRANSNO, strTAXNO)
                    End If
                Next
    ...
    Public Function DeleteRtn_TruTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_INTERNETTRANS_DTL.TruTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_INTERNET_MEDIUM.TruTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_INTERNETTRANS_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_INTERNETTRANS_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
