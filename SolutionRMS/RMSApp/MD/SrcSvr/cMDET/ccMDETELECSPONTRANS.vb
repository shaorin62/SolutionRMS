...
Public Class ccMDETELECSPONTRANS
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDETELECSPONTRANS"                  '자신의 클래스명
...
#Region "GROUP BLOCK : Event 선언"
    ...
    Public Function Get_ELECTRANS_HDR(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = "SELECT TRANSYEARMON, TRANSNO, DBO.SC_GET_HIGHCUSTNAME_FUN(CLIENTCODE) CLIENTNAME, DBO.SC_DEPT_NAME_FUN(DEPT_CD) DEPT_NAME, DEMANDDAY, PRINTDAY, AMT, VAT ,(AMT+VAT) SUMAMTVAT FROM MD_ELEC_TRANS_HDR WHERE 1=1 and attr03 = 'Y' {0} "
    ...
    Public Function Get_ELECTRANS_LIST(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strWhere = BuildFields(" ", Con1, Con2, Con3)
            strFormat = "SELECT TRANSYEARMON,  TRANSNO, SEQ, CLIENTCODE, DBO.SC_GET_HIGHCUSTNAME_FUN(CLIENTCODE) CLIENTNAME, TRUST_SEQ, MEDCODE, DBO.SC_GET_CUSTNAME_FUN(MEDCODE) MEDNAME,REAL_MED_CODE,DBO.SC_GET_HIGHCUSTNAME_FUN(REAL_MED_CODE) REAL_MED_NAME,DEPT_CD, DEMANDDAY, PRINTDAY, PROGRAM, ADLOCALFLAG, WEEKDAY, CNT, PRICE, AMT, TRU_TAX_FLAG, VAT, AMT+VAT SUMAMTVAT, MEMO, DBO.MD_GET_ELECMEDNAME_FUN(MED_FLAG) MED_FLAG, TAXYEARMON, TAXNO,SUBSEQ,DBO.PD_JOBCUST_NAME_FUN(SUBSEQ) BRANDNAME,CLIENTSUBCODE,DBO.SC_GET_CUSTNAME_FUN(CLIENTSUBCODE) CLIENTSUBNAME FROM MD_ELEC_TRANS_DTL WHERE 1=1 and SPONSOR = 'Y'  {0} ORDER BY MED_FLAG "
            strSQL = String.Format(strFormat, strWhere)
            '데이터 조회
            Try
                .mobjSCGLSql.SQLConnect(.DBConnStr)
                ...
                Return vntData
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_ELECTRANS_LIST")
            Finally
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    '수수료거래명세 헤더조회
    Public Function Get_ELECSPONCOMMI_HDR(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strWhere = BuildFields(" ", Con1, Con2, Con3)
            strFormat = "SELECT TRANSYEARMON, TRANSNO, DBO.SC_GET_HIGHCUSTNAME_FUN(CLIENTCODE) CLIENTNAME, DBO.SC_DEPT_NAME_FUN(DEPT_CD) DEPT_NAME, DEMANDDAY, PRINTDAY, AMT, VAT, (AMT + VAT) SUMAMTVAT  FROM MD_ELECCOMMI_HDR WHERE 1=1 {0} "
            strSQL = String.Format(strFormat, strWhere)
            '데이터 조회
            Try
                .mobjSCGLSql.SQLConnect(.DBConnStr)
    ...
    '수수료거래명세 상세내역 조회
    Public Function Get_ELECSPONCOMMI_LIST(ByVal strInfoXML As String, _
                                           ByRef intRowCnt As Integer, _
                                           ByRef intColCnt As Integer, _
                                           ByVal strYEARMON As String, _
                                           ByVal strTRANSNO As String, _
        ...
        With mobjSCGLConfig
            ...
            strWhere = BuildFields(" ", Con1, Con2, Con3)
            strFormat = "SELECT TRANSYEARMON,  TRANSNO, SEQ, CLIENTCODE, DBO.SC_GET_HIGHCUSTNAME_FUN(CLIENTCODE) CLIENTNAME, MEDCODE, DBO.SC_GET_CUSTNAME_FUN(MEDCODE) MEDNAME,REAL_MED_CODE,DBO.SC_GET_HIGHCUSTNAME_FUN(REAL_MED_CODE) REAL_MED_NAME,DEPT_CD, DEMANDDAY, PRINTDAY, AMT, SUSURATE, SUSU, VAT, DBO.MD_GET_ELECMEDNAME_FUN(MED_FLAG) MED_FLAG, TRUST_SEQ FROM MD_ELECCOMMI_DTL WHERE 1=1 {0} ORDER BY REAL_MED_CODE "
            strSQL = String.Format(strFormat, strWhere)
            '데이터 조회
            Try
                .mobjSCGLSql.SQLConnect(.DBConnStr)
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        strFormat = strFormat & " 'A' AS MED_FLAG, "
        strFormat = strFormat & " INPUT_MEDFLAG, "
        strFormat = strFormat & " '공중파협찬' AS MED_FLAGNAME,"
        ...
        strFormat = strFormat & " AMT, COMMI_RATE, COMMISSION, COMMISSION * 0.1 AS VAT, COMMISSION + (COMMISSION * 0.1) SUMAMTVAT,"
        ...
        strFormat = strFormat & " DENSE_RANK() OVER (ORDER BY real_med_code DESC) TRANSRANK , sponsor attr03"
        strFormat = strFormat & " FROM MD_ELECTRIC_MEDIUM"
        strFormat = strFormat & " WHERE 1=1 AND ISNULL(MEDCODE,'') <> '' AND ISNULL(REAL_MED_CODE,'') <> '' "
        strFormat = strFormat & " AND ISNULL(COMMI_TRANS_NO, '') = '' AND ISNULL(SPONSOR,'N') ='Y'  "
    ...
    Public Function SelectRtn_HDR(ByVal strInfoXML As String, _
        ...
        strFormat = strFormat & " CASE DBO.MD_COMMITAX_YN2_FUN(A.TRANSYEARMON,A.TRANSNO, 'A') "
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        strFormat = strFormat & " SUSURATE COMMI_RATE,"
        strFormat = strFormat & " ISNULL(SUSU,0) COMMISSION,"
        strFormat = strFormat & " ISNULL(VAT,0) VAT,"
        strFormat = strFormat & " ISNULL(SUSU,0) + ISNULL(VAT,0) SUMAMTVAT,"
        strFormat = strFormat & " '공중파협찬' AS  MED_FLAGNAME,"
        strFormat = strFormat & " MEMO,"
        strFormat = strFormat & " DBO.SC_DEPT_NAME_FUN(DEPT_CD) DEPT_NAME,"
        strFormat = strFormat & " DEMANDDAY,"
        strFormat = strFormat & " PRINTDAY,"
        strFormat = strFormat & " ATTR02 REAL_TAXNO,"
                            ...
                            If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                                If GetElement(vntData, "TRANSRANK", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                    ...
                                    Else
                                        ...
                                        '헤더저장
                                        intRtn = ProcessRtn_Hdr(xmlRoot, strTRANSYEARMON, lngTRANSNO, lngSUMAMT, lngSUMVAT, strCUSTCODE, strMEDCODE, strREAL_MED_CODE, strDEPT_CD, strINPUT_MEDFLAG, strDEMANDDAY, strPRINTDAY, strMEMO)

                                        '디테일저장(거래명세서 번호는 위에서 참조)
                                        intRtn = ProcessRtn_Dtl(strInfoXML, vntData, strTRANSYEARMON, lngTRANSNO, intTRANSNOSEQ, intCnt, strINPUT_MEDFLAG, strDEMANDDAY, strPRINTDAY) ', strDETAIL_ONE_IDs 라인의 시퀀스
                                    End If
                                    '무한업데이트.
                                    intCnt2 = intCnt
                                End If
    ...
    Public Function ProcessRtn_Hdr(ByVal xmlRoot As XmlElement, _
                                   ...
                                   ByRef strINPUT_MEDFLAG As String, _
            ...
            Try
                ...
                Select Case GetFlagMode(XMLGetElement(xmlRoot, meDATA_FLAG))
                    Case meINS_TRANS
                        ...
                        intRtn = InsertRtn_COMMI_HDR(xmlRoot, strTRANSYEARMON, intTRANSNO, strDEMANDDAY, strPRINTDAY, lngSUMAMT, lngSUMVAT, strCUSTCODE, strMEDCODE, strREAL_MED_CODE, strDEPT_CD, strINPUT_MEDFLAG, strMEMO)
                End Select
                            ...
                            Case meINS_TRANS
                                If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                                    If GetElement(vntData, "TRANSRANK", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                        ...
                                        intRtn = InsertRtn_COMMI_DTL(vntData, intColCnt, i, strTRANSYEARMON, intTRANSNO, intTRANSNOSEQ, strINPUT_MEDFLAG, strDEMANDDAY, strPRINTDAY, strMEMO)
                                        ...
                                        intRtn = mobjceMD_ELECTRIC_MEDIUM.Update_CommiTrans(lngTrust_YEARMON, lngTrust_seq, strTRUTRANS)
                                    End If
                                End If
                            Case meUPD_TRANS
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                            ...
                            intRtn = mobjceMD_ELECCOMMI_HDR.DeleteDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_ELECTRIC_MEDIUM.COMMIDeleteUpdateDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_ELECCOMMI_DTL.DeleteDo(strTRANSYEARMON, strTRANSNO)
                        End If
                    Next
                End If
    ...
    Public Function DeleteRtn_Check(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            Try
                ...
                strFormat = strFormat & "  FROM MD_ELECCOMMI_DTL"
                strFormat = strFormat & "  WHERE 1=1 {0} "
                strFormat = strFormat & "  AND ISNULL(ATTR02, '') <> ''"
