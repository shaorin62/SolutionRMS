...
Public Class ccMDETELECSPONCOMMITAX
    Inherits ccControl


#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDETELECSPONCOMMITAX"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function Get_ELECSPON_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & " CASE ISNULL(ATTR02,'')  WHEN '' THEN '' ELSE ATTR02 END AS  TAXNO,"
            ...
            If strGUBUN = "taxdiv" Then
                strFormat = strFormat & " DBO.SC_GET_CUSTNAME_FUN(MEDCODE)+' 공중파 협찬광고 대행수수료' SUMM,"
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & "'공중파 협찬광고 대행수수료' SUMM,"
            End If
            ...
            strFormat = strFormat & " 'A' MEDFLAG,'' VOCHNO,SUBSTRING(DEMANDDAY,1,6) TAXYEARMON,DENSE_RANK() OVER (ORDER BY DBO.SC_GET_BUSINO_FUN(REAL_MED_CODE), TRANSYEARMON, TRANSNO) RANKTRANS,"
            strFormat = strFormat & " MEMO,ATTR03 SPONSOR,"
            ...
            strFormat = strFormat & " WHERE 1=1 AND ISNULL(ATTR02,'') = '' and isnull(attr03,'N') ='Y' "
            strFormat = strFormat & " AND (SUSU <> 0 AND SUSU IS NOT NULL) {0} "
    ...
    Public Function Get_ELECSPON_TAX(ByVal strInfoXML As String, _
                                     ByRef intRowCnt As Integer, _
                                     ByRef intColCnt As Integer, _
                                     ByVal strYEARMON As String, _
                                     ByVal strCLIENTCODE As String, _
                                     ByVal strDEMANDDAYFROM As String, _
                                     ByVal strDEMANDDAYTO As String) As Object
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "    TAXYEARMON + '-' + MJFLAG + '-' + DBO.LPAD(TAXNO,4,'0') "
            strFormat = strFormat & "   TAXMANAGE,"
            strFormat = strFormat & "    '' TRANSYEARMON,"
            ...
            strFormat = strFormat & "  WHERE 1=1 AND (MEDFLAG = 'A') AND ATTR01 = 'Y' {0} "
    ...
    Public Function Get_ELECSPON_TAXALL(ByVal strInfoXML As String, _
                                        ByRef intRowCnt As Integer, _
                                        ByRef intColCnt As Integer, _
                                        ByVal strYEARMON As String, _
                                        ByVal strTRANSNO As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = "  SELECT "
            strFormat = strFormat & "  Case ISNULL(ATTR02,'')  WHEN '' THEN '미완료' ELSE '완료' END AS CHK,"
            strFormat = strFormat & "  CASE ISNULL(ATTR02,'')  WHEN '' THEN '' ELSE ATTR02 END AS  TAXNO,"
            strFormat = strFormat & "  '' TAXMANAGE,"
            strFormat = strFormat & "   TRANSYEARMON,"
            strFormat = strFormat & "   TRANSNO,"
            ...
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & "  REPLACE(dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE), "
                strFormat = strFormat & "  CASE dbo.INSTR(0,dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE),'(주)') "
                strFormat = strFormat & "  WHEN 0 THEN"
                strFormat = strFormat & "      CASE dbo.INSTR(0,dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE),'(사)') "
                strFormat = strFormat & "      WHEN 0 THEN"
                strFormat = strFormat & "         CASE dbo.INSTR(0,dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE),'(재)') "
                strFormat = strFormat & "          WHEN 0 THEN"
                strFormat = strFormat & "              CASE dbo.INSTR(0,dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE),'(학)') "
                strFormat = strFormat & "              WHEN 0 THEN"
                strFormat = strFormat & "  	            CASE dbo.INSTR(0,dbo.SC_GET_HIGHCOMPANYNAME_FUN(REAL_MED_CODE),'(유)') "
                ...
                strFormat = strFormat & "  END	,'') + ' 공중파 협찬광고 대행수수료' SUMM,"
            End If
            ...
            strFormat = strFormat & "  DENSE_RANK() OVER (ORDER BY DBO.SC_GET_BUSINO_FUN(REAL_MED_CODE), TRANSYEARMON, TRANSNO) RANKTRANS, "
            strFormat = strFormat & " MEMO,ATTR03 SPONSOR,"
            strFormat = strFormat & " DBO.SC_GET_CUSTOWNER_FUN(REAL_MED_CODE) REAL_MEDOWNER,"
            strFormat = strFormat & " DBO.SC_GET_ADDRESS1_FUN(REAL_MED_CODE) REAL_MEDADDR1,"
            strFormat = strFormat & " DBO.SC_GET_ADDRESS1_FUN(REAL_MED_CODE) REAL_MEDADDR2"
            strFormat = strFormat & "  FROM MD_ELECCOMMI_DTL "
            strFormat = strFormat & "  WHERE(1 = 1)"
            strFormat = strFormat & "  AND ISNULL(ATTR03,'N') = 'Y' AND (SUSU <> 0 AND SUSU IS NOT NULL) "
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_ELECCOMMI_DTL = New eMDCO.ceMD_ELECCOMMI_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    ...
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_ELECCOMMI_DTL.Update_CommiTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_ELECTRIC_MEDIUM.Update_CommiTax(strTRANSNO, strTAXNO)
                    End If
                Next
    ...
    Public Function DeleteRtn_CommiTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_ELECCOMMI_DTL.CommiTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_ELECTRIC_MEDIUM.CommiTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
