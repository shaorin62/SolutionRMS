...
Public Class ccMDETELECCOMMIVOCH
    Inherits ccControl
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDETELECCOMMIVOCH"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에비공개"
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strSelFields = strSelFields & " case isnull(b.summ,'') when '' then rtrim(convert(char(12),RTRIM(LTRIM(replace(DBO.SC_GET_HIGHCUSTNAME_FUN(A.REAL_MED_CODE),'방송광고공사','')))))+'대행수수료' else b.summ end as  SUMM,"
            ...
            strFormat = "SELECT {0} FROM MD_COMMITAX_HDR  A LEFT JOIN MD_COMMIVOCH_MST B ON A.TAXYEARMON = B.TAXYEARMON AND A.TAXNO = B.TAXNO" & _
                                     " WHERE A.MEDFLAG IN ('A')  {1} {2} {3} {4} {5} "
    ...
    Public Function VOCHDELL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            Try
                ...
                mobjceMD_COMMIVOCH_MST.Update_vochno(strTAXYEARMON, strTAXNO, "ELEC")
