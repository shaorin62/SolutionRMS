...
Public Class ccMDPTPRINTTRUTAX
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDPTPRINTTRUTAX"                  '자신의 클래스명
    ...
    Private mobjceMD_PRINTTRANS_HDR As eMDCO.ceMD_PRINTTRANS_HDR
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_PRINT_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            If strMED_FLAG <> "" Then
                If strMED_FLAG = "B" Then
                    Con6 = " AND (MED_FLAG = 'MP01')"
                Else
                    Con6 = " AND (MED_FLAG = 'MP02')"
                End If
            End If


            If strVOCH_TYPE <> "" Then
                Con7 = " AND VOCH_TYPE IN(" & strVOCH_TYPE & ")"
            Else
                Con7 = " AND VOCH_TYPE IN('XX')"
            End If
            ...
            strFormat = strFormat & "  ISNULL(AMT,0) - ISNULL(DBO.MD_GET_COMMISSION_FUN(TRUST_YEARMON,TRUST_SEQ, CASE MED_FLAG WHEN 'MP01' THEN 'B' WHEN 'MP02' THEN 'C' END),0) GENERALAMT,"
            strFormat = strFormat & "  ISNULL(DBO.MD_GET_COMMISSION_FUN(TRUST_YEARMON,TRUST_SEQ, CASE MED_FLAG WHEN 'MP01' THEN 'B' WHEN 'MP02' THEN 'C' END),0) OUTLISTAMT,"
            If strGUBUN = "taxdiv" Then
                strFormat = strFormat & " '인쇄광고비 - (' + dbo.SC_GET_CUSTNAME_FUN(MEDCODE) +')' SUMM,"
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & " '인쇄광고비' SUMM,"
            End If
            ...
            ElseIf strGUBUN = "taxgroup" Then
                If strGROUPGBN = "MED" Then
                    strFormat = strFormat & "  DENSE_RANK() OVER (ORDER BY dbo.SC_GET_BUSINO_FUN(REAL_MED_CODE),dbo.SC_GET_BUSINO_FUN(CLIENTCODE), MEDCODE, TRANSYEARMON, TRANSNO ) RANKTRANS"
                Else
                    strFormat = strFormat & "  DENSE_RANK() OVER (ORDER BY dbo.SC_GET_BUSINO_FUN(REAL_MED_CODE),dbo.SC_GET_BUSINO_FUN(CLIENTCODE), TRANSYEARMON, TRANSNO ) RANKTRANS"
                End If
            End If
    ...
    Public Function Get_PRINT_TAX(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            If strMED_FLAG <> "" Then
                Con4 = String.Format(" AND (MEDFLAG = '{0}')", strMED_FLAG)
            Else
            ...
            Try
                ...
                Return vntData
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_PRINT_TAX")
            Finally
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    Public Function Get_PRINT_TAXALL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            If strMED_FLAG <> "" Then
                If strMED_FLAG = "B" Then
                    Con4 = " AND (MED_FLAG = 'MP01')"
                Else
                    Con4 = " AND (MED_FLAG = 'MP02')"
                End If
            End If
            If strVOCH_TYPE <> "" Then
                Con5 = " AND VOCH_TYPE IN(" & strVOCH_TYPE & ")"
    ...
    Public Function ProcessRtn_Group(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_PRINTTRANS_DTL = New eMDCO.ceMD_PRINTTRANS_DTL(mobjSCGLConfig)
                        ...
                        For i = 1 To intRows
                            If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 And GetElement(vntData, "RANKTRANS", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                ...
                                If IsArray(vntData) Then
                                    ...
                                    intRtn2 = mobjceMD_PRINTTRANS_DTL.Update_TruTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                                    '신탁의 세금계산서번호 저장
                                    intRtn3 = mobjceMD_BOOKING_MEDIUM.Update_TruTax(strTRANSNO, strTAXNO)
                                End If
    ...
    Public Function DeleteRtn_TruTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_PRINTTRANS_DTL.TruTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_BOOKING_MEDIUM.TruTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_PRINTTRANS_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_PRINTTRANS_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
