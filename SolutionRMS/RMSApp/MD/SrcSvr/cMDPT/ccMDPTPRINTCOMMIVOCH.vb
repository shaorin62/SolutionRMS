...
Public Class ccMDPTPRINTCOMMIVOCH
    Inherits ccControl
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDPTPRINTCOMMIVOCH"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에비공개"
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strSelFields = strSelFields & " 'B0' SEMU,"
            ...
            strFormat = "SELECT {0} FROM MD_COMMITAX_HDR  A LEFT JOIN MD_COMMIVOCH_MST B ON A.TAXYEARMON = B.TAXYEARMON AND A.TAXNO = B.TAXNO" & _
                                     " WHERE A.MEDFLAG IN ('B','C')  {1} {2} {3} {4} {5} "
    ...
    Public Function VOCHDELL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            Try
                ...
                mobjceMD_COMMIVOCH_MST.Update_vochno(strTAXYEARMON, strTAXNO, "PRINT")
