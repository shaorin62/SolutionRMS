...
Public Class ccMDPTPRINTCOMMI
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDPTPRINTCOMMI"                  '자신의 클래스명
...
#Region "GROUP BLOCK : Event 선언"
    ...
    Public Function Get_PRINTCOMMI_CNT(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = "SELECT count(*) FROM MD_PRINTCOMMI_DTL WHERE 1=1 {0}  "
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        If strMED_FLAG <> "" Then Con3 = String.Format(" AND (MED_FLAG = '{0}')", strMED_FLAG) '구분
        ...
        strFormat = strFormat & " REAL_MED_CODE, CLIENTCODE, MEDCODE, DEPT_CD, PROJECTION, EXCLIENTCODE, VOCH_TYPE, "
        ...
        strFormat = strFormat & " AND ISNULL(COMMI_TRANS_NO, '') = '' AND GFLAG IN('B','J','S') "
    ...
    Public Function SelectRtn_HDR(ByVal strInfoXML As String, _
        ...
        strFormat = strFormat & " CASE DBO.MD_TAXCOMMI_YN_FUN(A.TRANSYEARMON,A.TRANSNO, 'B') "
                            ...
                            If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                                If GetElement(vntData, "TRANSRANK", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                    ...
                                    Else
                                        ...
                                        '헤더저장
                                        intRtn = ProcessRtn_Hdr(xmlRoot, strTRANSYEARMON, lngTRANSNO, lngSUMAMT, lngSUMVAT, strCUSTCODE, strREAL_MED_CODE, strDEPT_CD, strMED_FLAG, strDEMANDDAY, strPRINTDAY, strMEMO)
            ...
            Try
                ...
                Select Case GetFlagMode(XMLGetElement(xmlRoot, meDATA_FLAG))
                    Case meINS_TRANS
                        ...
                        intRtn = InsertRtn_COMMI_HDR(xmlRoot, strTRANSYEARMON, intTRANSNO, strDEMANDDAY, strPRINTDAY, lngSUMAMT, lngSUMVAT, strCUSTCODE, strREAL_MED_CODE, strDEPT_CD, strMED_FLAG, strMEMO)
                End Select
                            ...
                            Case meINS_TRANS
                                If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                                    If GetElement(vntData, "TRANSRANK", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                        ...
                                        intRtn = mobjceMD_BOOKING_MEDIUM.Update_CommiTrans(lngTrust_YEARMON, lngTrust_seq, strTRUTRANS)
                                    End If
                                End If
                            Case meUPD_TRANS
    ...
    Public Function SelectRtn_TRANSNO(ByVal strTRANSYEARMON As String) As String
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            Try
                ' ------ Array 데이터 조회 (True 일때 헤더정보 포함 조회(Sheet Data Binding 할 경우 사용), False 일때 데이터만 조회)
                strSQL = String.Format("select ISNULL(Max(TRANSNO),0) +1 From MD_PRINTCOMMI_HDR WHERE TRANSYEARMON = '" & strTRANSYEARMON & "'")
    ...
    Public Function SelectRtn_TRANSNOSEQ(ByVal intTRANSNO As Integer, ByVal strTRANSYEARMON As String) As String
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            ...
            Try
                ' ------ Array 데이터 조회 (True 일때 헤더정보 포함 조회(Sheet Data Binding 할 경우 사용), False 일때 데이터만 조회)
                strSQL = String.Format("select ISNULL(Max(SEQ),0) +1 From MD_PRINTCOMMI_DTL WHERE TRANSYEARMON = '" & strTRANSYEARMON & "' AND TRANSNO = '" & intTRANSNO & "'")
                strRtn = .mobjSCGLSql.SQLSelectOneScalar(strSQL)
                Return strRtn
            Catch err As Exception
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                            ...
                            intRtn = mobjceMD_PRINTCOMMI_HDR.DeleteDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_BOOKING_MEDIUM.COMMIDeleteUpdateDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_PRINTCOMMI_DTL.DeleteDo(strTRANSYEARMON, strTRANSNO)
                        End If
                    Next
                End If
...
#Region "GROUP BLOCK : 외부에 비공개 Method"
    Private Function InsertRtn_COMMI_HDR(ByVal xmlRoot As XmlElement, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_PRINTCOMMI_HDR.InsertDo( _
                                       strTRANSYEARMON, _
                                       intTRANSNO, _
                                       strCUSTCODE, _
                                       strREAL_MED_CODE, _
    ...
    Private Function InsertRtn_COMMI_DTL(ByVal vntData As Object, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_PRINTCOMMI_DTL.InsertDo( _
                                       strTRANSYEARMON, _
                                       intTRANSNO, _
                                       intTRANSNOSEQ, _
