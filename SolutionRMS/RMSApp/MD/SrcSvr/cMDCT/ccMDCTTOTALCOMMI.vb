...
Public Class ccMDCTTOTALCOMMI
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDCTTOTALCOMMI"                  '자신의 클래스명
...
#Region "GROUP BLOCK : Event 선언"
    ...
    Public Function Get_PRINTCOMMI_CNT(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = "SELECT count(*) FROM MD_TOTALCOMMI_DTL WHERE 1=1 {0}  "
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function SelectRtn_HDR(ByVal strInfoXML As String, _
        ...
        strFormat = strFormat & " CASE DBO.MD_TAXCOMMI_YN_FUN(A.TRANSYEARMON,A.TRANSNO, 'T') "
                            ...
                            Case meINS_TRANS
                                If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                                    If GetElement(vntData, "TRANSRANK", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                        ...
                                        intRtn = mobjceMD_TOTAL_MEDIUM.Update_CommiTrans(lngTrust_YEARMON, lngTrust_seq, strTRUTRANS)
                                    End If
                                End If
                            Case meUPD_TRANS
    ...
    Public Function SelectRtn_TRANSNO(ByVal strTRANSYEARMON As String) As String
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            Try
                ' ------ Array 데이터 조회 (True 일때 헤더정보 포함 조회(Sheet Data Binding 할 경우 사용), False 일때 데이터만 조회)
                strSQL = String.Format("select ISNULL(Max(TRANSNO),0) +1 From MD_TOTALCOMMI_HDR WHERE TRANSYEARMON = '" & strTRANSYEARMON & "'")
    ...
    Public Function SelectRtn_TRANSNOSEQ(ByVal intTRANSNO As Integer, ByVal strTRANSYEARMON As String) As String
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            ...
            Try
                ' ------ Array 데이터 조회 (True 일때 헤더정보 포함 조회(Sheet Data Binding 할 경우 사용), False 일때 데이터만 조회)
                strSQL = String.Format("select ISNULL(Max(SEQ),0) +1 From MD_TOTALCOMMI_DTL WHERE TRANSYEARMON = '" & strTRANSYEARMON & "' AND TRANSNO = '" & intTRANSNO & "'")
                strRtn = .mobjSCGLSql.SQLSelectOneScalar(strSQL)
                Return strRtn
            Catch err As Exception
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                            ...
                            intRtn = mobjceMD_TOTALCOMMI_HDR.DeleteDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_TOTAL_MEDIUM.COMMIDeleteUpdateDo(strTRANSYEARMON, strTRANSNO)
                            intRtn = mobjceMD_TOTALCOMMI_DTL.DeleteDo(strTRANSYEARMON, strTRANSNO)
                        End If
                    Next
                End If
...
#Region "GROUP BLOCK : 외부에 비공개 Method"
    Private Function InsertRtn_COMMI_HDR(ByVal xmlRoot As XmlElement, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_TOTALCOMMI_HDR.InsertDo( _
                                       strTRANSYEARMON, _
                                       intTRANSNO, _
                                       strCUSTCODE, _
                                       strMEDCODE, _
    ...
    Private Function InsertRtn_COMMI_DTL(ByVal vntData As Object, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_TOTALCOMMI_DTL.InsertDo( _
                                       strTRANSYEARMON, _
                                       intTRANSNO, _
                                       intTRANSNOSEQ, _
