...
Public Class ccMDCTCATVTRUTAX
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDCTCATVTRUTAX"                  '자신의 클래스명
    ...
    Private mobjceMD_CATVTRANS_HDR As eMDCO.ceMD_CATVTRANS_HDR
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    Public Function Get_CATV_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            If strGUBUN = "taxdiv" Then
                strFormat = strFormat & " '케이블광고비 - (' + dbo.SC_GET_CUSTNAME_FUN(MEDCODE) +')' SUMM,"
            ElseIf strGUBUN = "taxgroup" Then
                strFormat = strFormat & " '케이블광고비' SUMM,"
    ...
    Public Function Get_CATV_TAX(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  WHERE 1=1 AND ISNULL(ATTR10,0) <> 999999 AND MEDFLAG = 'A2' "
            strFormat = strFormat & "  {0} "
            ...
            Try
                ...
                Return vntData
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_CATV_TAX")
            Finally
                .mobjSCGLSql.SQLDisconnect()
            End Try
        End With
    ...
    Public Function ProcessRtn_Group(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_CATVTRANS_DTL = New eMDCO.ceMD_CATVTRANS_DTL(mobjSCGLConfig)
                        ...
                        For i = 1 To intRows
                            If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 And GetElement(vntData, "RANKTRANS", intColCnt, i, OPTIONAL_STR) = intCnt Then
                                ...
                                If IsArray(vntData) Then
                                    ...
                                    intRtn2 = mobjceMD_CATVTRANS_DTL.Update_TruTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                                    '신탁의 세금계산서번호 저장
                                    intRtn3 = mobjceMD_CATV_MEDIUM.Update_TruTax(strTRANSNO, strTAXNO)
                                End If
    ...
    Public Function DeleteRtn_TruTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_CATVTRANS_DTL.TruTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_CATV_MEDIUM.TruTaxDeleteUpdateDo(strTAXNO)
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_CATVTRANS_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_CATVTRANS_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
