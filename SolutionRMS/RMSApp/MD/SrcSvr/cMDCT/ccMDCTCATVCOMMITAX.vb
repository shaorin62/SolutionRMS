...
Public Class ccMDCTCATVCOMMITAX
    Inherits ccControl
...
#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    ...
    Private CLASS_NAME = "ccMDCTCATVCOMMITAX"                  '자신의 클래스명
    ...
    Private mobjceMD_TAXCATV_TEMP As eMDCO.ceMD_TAXCATV_TEMP
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function Get_CATV_TAXBUILD(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            ElseIf strGUBUN = "taxgroup" Then
                ...
                End If
            End If
            strFormat = strFormat & " FROM MD_CATVCOMMI_DTL WHERE 1=1 AND (ISNULL(COMMISSION,0) <> 0) AND TAXNO IS NULL {0}"
            ...
            Catch err As Exception
                Throw RaiseSysErr(err, CLASS_NAME & ".Get_CATV_TAXBUILD")
            Finally
    ...
    Public Function Get_CATV_TAX(ByVal strInfoXML As String, _
                                 ByRef intRowCnt As Integer, _
                                 ByRef intColCnt As Integer, _
                                 ByVal strYEARMON As String, _
                                 ByVal strREAL_MED_CODE As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "       AND (MEDFLAG = 'A2') "
    ...
    Public Function Get_CATV_TAXALL(ByVal strInfoXML As String, _
                                    ByRef intRowCnt As Integer, _
                                    ByRef intColCnt As Integer, _
                                    ByVal strYEARMON As String, _
                                    ByVal strREAL_MED_CODE As String, _
        ...
        With mobjSCGLConfig
            ...
            ElseIf strGUBUN = "taxgroup" Then
                ...
                End If
            End If
            strFormat = strFormat & " FROM MD_CATVCOMMI_DTL WHERE 1=1 AND (ISNULL(COMMISSION,0) <> 0)  {0}"
            strFormat = strFormat & " ORDER BY REAL_MED_BISNO,DEMANDDAY,AMT, TRANSNO"
    ...
    Public Function SelectRtn_DTL(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig
            ...
            strFormat = strFormat & "  AND A.TAXNO = B.TAXNO"
            strFormat = strFormat & "  WHERE ISNULL(A.ATTR10,0) <> 999999 AND A.MEDFLAG = 'A2' "
            strFormat = strFormat & "  {0}"
    ...
    Public Function ProcessRtn_Div(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig '기본정보를 가지고 있는 Config 개체
            Try
                ...
                mobjceMD_CATVCOMMI_DTL = New eMDCO.ceMD_CATVCOMMI_DTL(mobjSCGLConfig)
                ...
                For i = 1 To intRows
                    If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = 1 Then
                        ...
                        intRtn2 = mobjceMD_CATVCOMMI_DTL.Update_CommiTax(strTRANSYEARMON, lngTRANSNO, lngSEQ, strTAXYEARMON, intTAXNO)

                        '신탁의 세금계산서번호 저장
                        intRtn3 = mobjceMD_CATV_MEDIUM.Update_CommiTax(strTRANSNO, strTAXNO)
                    End If
                Next
    ...
    Public Function DeleteRtn_CommiTax(ByVal strInfoXML As String, _
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ...
                intRtn = mobjceMD_CATVCOMMI_DTL.CommiTaxDeleteUpdateDo(strTAXYEARMON, intTAXNO)
                '신탁테이블의 세금계산서 번호 삭제
                intRtn = mobjceMD_CATV_MEDIUM.CommiTaxDeleteUpdateDo(strTAXNO)
                '헤더 삭제
    ...
    Public Function DeleteRtn_TEMP(ByVal strInfoXML As String) As Integer   '데이터 DELETE
        ...
        With mobjSCGLConfig    '기본정보 Config 개체
            Try
                ' 사용할Entity 개체생성(Config 정보를 넘겨생성)
                mobjceMD_TAXCATV_TEMP = New ceMD_TAXCATV_TEMP(mobjSCGLConfig)
                ' DB 접속 및 트랜잭션 시작
                .mobjSCGLSql.SQLConnect(.DBConnStr)
                .mobjSCGLSql.SQLBeginTrans()
                ' 엔티티 오브젝트의 Delete 메소드 호출
                intRtn = mobjceMD_TAXCATV_TEMP.DeleteDo(.WRKUSR)
                ' 트랜잭션 Commit
                .mobjSCGLSql.SQLCommitTrans()
                Return intRtn
            Catch err As Exception
            ...
            Try
                ...
                If IsArray(vntData) Then
                    ...
                    For i = 1 To intRows
                        ...
                        '거래명세서 DTL 업데이트
                        intRtnTran = mobjceMD_CATVCOMMI_DTL.Update_Vat(strTRANSYEARMON, strTRANSNO, intTRANSSEQ, lngVAT)
                    ...
                    intRtnTran = mobjceMD_CATVCOMMI_HDR.Update_VatHDR(strTRANSYEARMON, strTRANSNO, lngTRANSVAT)
                End If
...
#Region "GROUP BLOCK : 외부에 비공개 Method"
    ...
    Private Function InsertRtn_TRANS_TEMP(ByVal strTAXYEARMON As String, _
        ...
        Dim intRtn As Integer
        intRtn = mobjceMD_TAXCATV_TEMP.InsertDo( _
                                       strTAXYEARMON, _
                                       strTAXNO, _
                                       VATFLAG, _
                                       FLAG, _
