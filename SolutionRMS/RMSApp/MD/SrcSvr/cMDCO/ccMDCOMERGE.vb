...
Public Class ccMDCOMERGE
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccMDCOMERGE"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function SelectRtn(ByVal strInfoXML As String, _
        ...
        If strMEDFLAG = "B" Then
            Con5 = String.Format(" AND (MEDFLAG IN ('B','C'))")
        Else
            Con5 = String.Format(" AND (MEDFLAG = '{0}')", strMEDFLAG)
        End If

        If strGUBUN = "MERGE" Then
            Con6 = " AND (ISNULL(MERGEFLAG,'') = '1') "
        Else
            Con6 = " AND (ISNULL(MERGEFLAG,'') = '') "
        End If
        ...
        If strMEDFLAG = "D" Or strMEDFLAG = "G" Or strMEDFLAG = "Y" Or strMEDFLAG = "K" Then
            ...
            strFormat = strFormat & " SUMM, VOCHNO"
            strFormat = strFormat & " FROM MD_COMMITAX_HDR  "
            strFormat = strFormat & "  WHERE 1=1 and isnull(dbo.MD_RMSNO_FUN(taxyearmon,taxno,medflag),'') = ''  "
        ...
        ElseIf strMEDFLAG = "O" Then
            ...
            strFormat = strFormat & "  FROM MD_COMMITAX_HDR  "
            strFormat = strFormat & "  WHERE 1=1 and isnull(dbo.MD_RMSNO_FUN(taxyearmon,taxno,medflag),'') = ''  "
            strFormat = strFormat & "  AND DBO.MD_COMMITAX_DTL_COUNT(TAXYEARMON,TAXNO) = 0 "
            strFormat = strFormat & "  {0} "
            strFormat = strFormat & "  AND ISNULL(ATTR10,0) <> 999999"
            strFormat = strFormat & "  ORDER BY TAXYEARMON, TAXNO"
        ElseIf strMEDFLAG = "A2" Or strMEDFLAG = "B" Then
            strFormat = strFormat & "  SELECT "
            strFormat = strFormat & "  0 CHK,"
            strFormat = strFormat & "  TAXYEARMON,"
            strFormat = strFormat & "  TAXNO,"
            ...
            strFormat = strFormat & "  AND ISNULL(DBO.MD_RMSNO_FUN(TAXYEARMON,TAXNO,MEDFLAG),'') = ''  "
            strFormat = strFormat & "  AND ISNULL(ATTR10,0) <> 999999"
            strFormat = strFormat & "  {0} "
            strFormat = strFormat & "  AND VOCH_TYPE IN ('2','3')"
            strFormat = strFormat & "  ORDER BY TAXYEARMON, TAXNO"
        End If
                    ...
                    For i = 1 To intRows
                        If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = "1" Then
                            ...
                            If strMEDFLAG = "D" Or strMEDFLAG = "G" Or strMEDFLAG = "Y" Or strMEDFLAG = "K" Then
                                ...
                                intRtn = mobjceMD_COMMITAX_HDR.UpdateRtn_COMMITAX_HDR_MERGE(strTAXYEARMON, strTAXNO, strMEDFLAG)
                            ElseIf strMEDFLAG = "O" Then
                                strTAXYEARMON = GetElement(vntData, "TAXYEARMON", intColCnt, i, OPTIONAL_STR)
                                strTAXNO = GetElement(vntData, "TAXNO", intColCnt, i, OPTIONAL_STR)
                            ...
                            ElseIf strMEDFLAG = "A2" Or strMEDFLAG = "B" Or strMEDFLAG = "C" Then
                                ...
                                intRtn = mobjceMD_TRUTAX_HDR.UpdateRtn_TRUTAX_HDR_MERGE(strTAXYEARMON, strTAXNO, strMEDFLAG)
                            End If
                        End If
                    Next
                End If
                    ...
                    For i = 1 To intRows
                        If GetElement(vntData, "CHK", intColCnt, i, OPTIONAL_STR) = "1" Then
                            ...
                            If strMEDFLAG = "D" Or strMEDFLAG = "G" Or strMEDFLAG = "Y" Or strMEDFLAG = "K" Then
                                ...
                                intRtn = mobjceMD_COMMITAX_HDR.UpdateRtn_COMMITAX_HDR_MERGE_CANCEL(strTAXYEARMON, strTAXNO, strMEDFLAG)
                            ElseIf strMEDFLAG = "O" Then
                                strTAXYEARMON = GetElement(vntData, "TAXYEARMON", intColCnt, i, OPTIONAL_STR)
                                strTAXNO = GetElement(vntData, "TAXNO", intColCnt, i, OPTIONAL_STR)
                            ...
                            ElseIf strMEDFLAG = "A2" Or strMEDFLAG = "B" Or strMEDFLAG = "C" Then
                                ...
                                intRtn = mobjceMD_TRUTAX_HDR.UpdateRtn_TRUTAX_HDR_MERGE_CANCEL(strTAXYEARMON, strTAXNO, strMEDFLAG)
                            End If
                        End If
                    Next
                End If
    ...
    Public Function DeleteRtn_Check2(ByVal strInfoXML As String, _
                                     ByRef intRowCnt As Integer, _
                                     ByRef intColCnt As Integer, _
                                     ByVal strTAXYEARMON As String, _
                                     ByVal strTAXNO As String, _
                                     ByVal strTAXNOSEQ As String, _
                                     ByVal strMEDFLAG As String) As Object     'XML  데이터 조회시
        ...
        With mobjSCGLConfig
            Try
                ...
                If strTAXYEARMON <> "" Then Con1 = String.Format(" AND (TAXYEARMON = '{0}')", strTAXYEARMON)
                If strTAXNO <> "" Then Con2 = String.Format(" AND (TAXNO = '{0}')", strTAXNO)
                If strTAXNOSEQ <> "" Then Con3 = String.Format(" AND (TAXNOSEQ = '{0}')", strTAXNOSEQ)
