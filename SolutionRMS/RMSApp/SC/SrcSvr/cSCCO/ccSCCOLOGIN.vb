...
Public Class ccSCCOLOGIN
    Inherits ccControl

#Region "GROUP BLOCK : 전역 또는 모듈레벨의 변수/상수 선언"
    Private CLASS_NAME = "ccSCCOLOGIN"                  '자신의 클래스명
...
#Region "GROUP BLOCK : 외부에 공개 Method"
    ...
    Public Function SelectRtn_PASSWORDCHANGEIDX(ByVal strInfoXML As String, _
                                                ByRef intRowCnt As Integer, _
                                                ByRef intColCnt As Integer, _
                                                ByVal strIDX As String, _
                                                ByVal strPASSWORD As String) As Object
        ...
        strCols = "USE_YN,EMPNO,EMP_NAME,PASSWORD,ISNULL(CLIPPINGLEVEL,0) CLIPPINGLEVEL "
        strWhere = "1=1"
        strFormat = "SELECT {0} FROM SC_EMPLOYEE_MST WHERE EMPNO = '" & strIDX & "' AND PASSWORD = '" & strPASSWORD & "'"
        ...
        With mobjSCGLConfig '기본정보 Config 개체
            ...
            Catch err As Exception
                ' 오류 전송
                Throw RaiseSysErr(err, CLASS_NAME & ".SelectRtn_PASSWORDCHANGEIDX")
            Finally
                ' DB 접속 종료
                .mobjSCGLSql.SQLDisconnect()
            End Try
