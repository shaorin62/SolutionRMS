...
'프로그램명 : ceSC_SUBSEQ_HDR.vb ( ceSC_SUBSEQ_HDR Entity 처리 Class)
...
Public Class ceSC_SUBSEQ_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceSC_SUBSEQ_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strSEQNO As String, _
            Optional ByVal strSEQNAME As String = OPTIONAL_STR, _
            Optional ByVal strHIGHSEQNO As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "SEQNAME", strSEQNAME, strFields, strValues)
            BuildNameValues(",", "HIGHSEQNO", strHIGHSEQNO, strFields, strValues)
    ...
    Public Function UpdateDo(Optional ByVal strSEQNO As String = OPTIONAL_STR, _
        Optional ByVal strSEQNAME As String = OPTIONAL_STR, _
        Optional ByVal strHIGHSEQNO As String = OPTIONAL_STR, _
        Optional ByVal strCUSTCODE As String = OPTIONAL_STR, _
        Optional ByVal strCLIENTSUBCODE As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        GetFieldNameValue("SEQNAME", strSEQNAME), _
                        GetFieldNameValue("HIGHSEQNO", strHIGHSEQNO), _
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function Update_Conf(Optional ByVal strSEQNO As String = OPTIONAL_STR) As Integer
        Dim strSQL As String

        Try
            strSQL = String.Format("UPDATE {0} SET ATTR01 = 'S' WHERE {1}", EntityName, _
                     BuildFields("AND", _
                                   GetFieldNameValue("SEQNO", strSEQNO)))
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function Update_ConfOK(Optional ByVal strSEQNO As String = OPTIONAL_STR) As Integer
        Dim strSQL As String

        Try
            strSQL = String.Format("UPDATE {0} SET ATTR01 = 'Y' WHERE {1}", EntityName, _
                     BuildFields("AND", _
                                   GetFieldNameValue("SEQNO", strSEQNO)))
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "SC_SUBSEQ_DTL"     'Entity Name 설정
    End Sub
