...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '기능 : 해당 Entity에 Insert 처리
    '*****************************************************************
    Public Function InsertCLIENT(ByVal strCUSTCODE As String, _
            Optional ByVal strHIGHCUSTCODE As String = OPTIONAL_STR, _
            Optional ByVal strCUSTNAME As String = OPTIONAL_STR, _
            Optional ByVal strGBNFLAG As String = OPTIONAL_STR, _
            Optional ByVal strCLIENTSUBCODE As String = OPTIONAL_STR, _
    ...
    Public Function InsertMED(ByVal strCUSTCODE As String, _
            Optional ByVal strHIGHCUSTCODE As String = OPTIONAL_STR, _
            Optional ByVal strCUSTNAME As String = OPTIONAL_STR, _
            Optional ByVal strMEDFLAG As String = OPTIONAL_STR, _
            Optional ByVal strMED_TV As String = OPTIONAL_STR, _
            ...
            Optional ByVal strMED_DMB As String = OPTIONAL_STR, _
            Optional ByVal strMED_CATV As String = OPTIONAL_STR, _
            Optional ByVal strMED_GEN As String = OPTIONAL_STR, _
            Optional ByVal strMED_PAP As String = OPTIONAL_STR, _
            Optional ByVal strMED_MAG As String = OPTIONAL_STR, _
            Optional ByVal strMED_NET As String = OPTIONAL_STR, _
            Optional ByVal strMED_OUT As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "MED_DMB", strMED_DMB, strFields, strValues)
            BuildNameValues(",", "MED_CATV", strMED_CATV, strFields, strValues)
            BuildNameValues(",", "MED_GEN", strMED_GEN, strFields, strValues)
            BuildNameValues(",", "MED_PAP", strMED_PAP, strFields, strValues)
            BuildNameValues(",", "MED_MAG", strMED_MAG, strFields, strValues)
            BuildNameValues(",", "MED_NET", strMED_NET, strFields, strValues)
            BuildNameValues(",", "MED_OUT", strMED_OUT, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("MED_GEN", strMED_GEN), _
    ...
    Public Function UpdateCLIENT(Optional ByVal strCUSTCODE As String = OPTIONAL_STR, _
                                 Optional ByVal strHIGHCUSTCODE As String = OPTIONAL_STR, _
                                 Optional ByVal strCUSTNAME As String = OPTIONAL_STR, _
                                 Optional ByVal strGBNFLAG As String = OPTIONAL_STR, _
                                 Optional ByVal strCLIENTSUBCODE As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        GetFieldNameValue("HIGHCUSTCODE", strHIGHCUSTCODE), _
                        GetFieldNameValue("CUSTNAME", strCUSTNAME), _
                        GetFieldNameValue("GBNFLAG", strGBNFLAG), _
    ...
    Public Function UpdateMED(Optional ByVal strCUSTCODE As String = OPTIONAL_STR, _
                              Optional ByVal strHIGHCUSTCODE As String = OPTIONAL_STR, _
                              Optional ByVal strCUSTNAME As String = OPTIONAL_STR, _
                              Optional ByVal strMEDFLAG As String = OPTIONAL_STR, _
                              Optional ByVal strMED_TV As String = OPTIONAL_STR, _
    ...
    Public Function UpdateEXE(Optional ByVal strHIGHCUSTCODE As String = OPTIONAL_STR, _
                              Optional ByVal strCUSTNAME As String = OPTIONAL_STR, _
                              Optional ByVal strGBNFLAG As String = OPTIONAL_STR, _
                              Optional ByVal strMEDFLAG As String = OPTIONAL_STR, _
                              Optional ByVal strUSE_FLAG As String = OPTIONAL_STR) As Integer
