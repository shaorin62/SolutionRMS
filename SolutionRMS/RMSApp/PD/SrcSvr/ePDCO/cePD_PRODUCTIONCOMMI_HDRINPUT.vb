...
'실행  환경 : 
'프로그램명 : cePD_PRODUCTIONCOMMI_HDR.vb (PD_PRODUCTIONCOMMI_HDR Entity 처리 Class)
...
Public Class cePD_PRODUCTIONCOMMI_HDRINPUT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_PRODUCTIONCOMMI_HDRINPUT"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strPREESTNO As String, _
        ...
        Try
            ...
            BuildNameValues(",", "COMMIRATE", dblCOMMIRATE, strFields, strValues)
            BuildNameValues(",", "EXEAMT", dblEXEAMT, strFields, strValues)
            BuildNameValues(",", "EXECOMMIRATE", dblEXECOMMIRATE, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("COMMIRATE", dblCOMMIRATE), _
                        GetFieldNameValue("EXEAMT", dblEXEAMT), _
                        GetFieldNameValue("EXECOMMIRATE", dblEXECOMMIRATE), _
    ...
    Public Function DeleteDo(ByVal strPREESTNO As String, _
                             ByVal strCUSER As String) As Integer
        Dim strSQL As String

        Try
            strSQL = " DELETE FROM PD_PRODUCTIONCOMMI_HDRINPUT "
            strSQL = strSQL & " WHERE PREESTNO = '" & strPREESTNO & "' "
            strSQL = strSQL & " AND CUSER = '" & strCUSER & "' "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_PRODUCTIONCOMMI_HDRINPUT"     'Entity Name 설정
    End Sub
