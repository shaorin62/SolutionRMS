...
Public Class cePD_TAX_MST
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_TAX_MST"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strTAXYEARMON As String, _
            ...
            Optional ByVal dblACCODE As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "ACCODE", dblACCODE, strFields, strValues)
            ...
            BuildNameValues(",", "TAXCODE", dblTAXCODE, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("ACCODE", dblACCODE), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_TAX_MST"     'Entity Name 설정
    End Sub
