...
Public Class cePD_PREBUDGET_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_PREBUDGET_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strJOBNO As String, _
        ...
        Try
            ...
            BuildNameValues(",", "OUTSNAME", strOUTSNAME, strFields, strValues)
    ...
    Public Function UpdateDo(Optional ByVal strJOBNO As String = OPTIONAL_STR, _
            ...
            Optional ByVal strOUTSNAME As String = OPTIONAL_STR, _
            Optional ByVal strCUSTCODE As String = OPTIONAL_STR, _
            Optional ByVal dblAMT As Double = OPTIONAL_NUM, _
            Optional ByVal strCREDAY As String = OPTIONAL_STR, _
            Optional ByVal strCONFIRMFLAG As String = OPTIONAL_STR, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        GetFieldNameValue("OUTSNAME", strOUTSNAME), _
                     ...
                     BuildFields("AND", _
                        GetFieldNameValue("JOBNO", strJOBNO), GetFieldNameValue("OUTSCODE", strOUTSCODE), GetFieldNameValue("REVSEQ", dblREVSEQ)))
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UpdateDo_CREDAY(ByVal dblREVSEQ As Double, _
                                    ByVal strCREDAY As Integer) As Integer
        Dim strSQL As String

        Try
            strSQL = "UPDATE PD_PREBUDGET_HDR SET CREDAY = '" & strCREDAY & "' WHERE REVSEQ = '" & dblREVSEQ & "'"
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function UpdateDo_AMT(ByVal dblREVSEQ As Double) As Integer
        Dim strSQL As String

        Try
            strSQL = "UPDATE PD_PREBUDGET_HDR SET AMT = (SELECT SUM(ISNULL(AMT,0)) SUMAMT FROM PD_PREBUDGET_DTL) "
            strSQL = strSQL & " WHERE REVSEQ = " & dblREVSEQ & " "
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_PREBUDGET_HDR"     'Entity Name 설정
    End Sub
