...
Public Class cePD_PRODUCTIONCOMMI_INPUT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_PRODUCTIONCOMMI_INPUT"    '자신의 클래스명
#End Region
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("EXEAMT", dblAMT), _
                        GetFieldNameValue("EXECHK", strCHK), _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_PRODUCTIONCOMMI_INPUT"     'Entity Name 설정
    End Sub
