...
'프로그램명 : cePD_TRANS_HDR.vb ( PD_TRANS_HDR Entity 처리 Class)
'기      능 : PD_TRANS_HDR Entity에 대해Insert/Update/Delete/Select를 처리
'             - 부모엔티티 객체인 SCGLUtil.ceEntity를 상속
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2007-11-16 오후 1:03:07 By Making Entity Bean
'****************************************************************************************
Imports SCGLUtil.cbSCGLUtil     '공통 유틸리티 객체
Imports SCGLUtil.cbSCGLErr      '공통 오류처리 객체
Imports SCGLEntity              '엔티티 객체의 부모 객체

Public Class cePD_TRANS_HDR
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_TRANS_HDR"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strTRANSYEARMON As String, _
            ...
            Optional ByVal strCREFLAG As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "CREFLAG", strCREFLAG, strFields, strValues)
    ...
    Public Function UpdateDo(Optional ByVal strTRANSYEARMON As String = OPTIONAL_STR, _
            ...
            Optional ByVal dblTAXAMT As Double = OPTIONAL_NUM, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("TAXAMT", dblTAXAMT), _
                        ...
                        GetFieldNameValue("SUBSEQ", strMEMO), _
    ...
    Public Function ConfirmUpdate(ByVal strTRANSYEARMON As String, _
        ...
        Try
            strSQL = "UPDATE PD_TRANS_HDR  "
            strSQL = strSQL & " SET "
            strSQL = strSQL & " CONFIRM_USER = '" & strUSER & "',"
            strSQL = strSQL & " CONFIRM_DATE =  '" & strNOW & "'"
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : 해당 거래명세서 비고 및 부가세 업데이트
    '참고 : Key 조건이 선택적이 아님
    '*****************************************************************
    Public Function UpdateRtn_TAXAMT(ByVal strUPDATETRANSYEARMON As String, _
                                     ByVal intUPDATETRANSNO As Integer, _
                                     ByVal strUPDATEMEMO As String, _
                                     ByVal lngUPDATETAXAMTAXNO As Double) As Integer
        'strUPDATETRANSYEARMON, intUPDATETRANSNO, strUPDATEMEMO, lngUPDATETAXAMTAXNO
        Dim strSQL As String

        Try
            strSQL = "UPDATE PD_TRANS_HDR SET MEMO = '" & strUPDATEMEMO & "',TAXAMT = " & lngUPDATETAXAMTAXNO
            strSQL = strSQL & " WHERE TRANSYEARMON = '" & strUPDATETRANSYEARMON & "' AND TRANSNO = " & intUPDATETRANSNO
            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".UpdateRtn_TAXAMT")
        End Try
    End Function
    'UpdateRtn_VochNo
    '*****************************************************************
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : strSQL 해당문을 그대로 처리 거래명세서가 삭제될때 JOBNO 상태를 업데이트 한다. 
    '*****************************************************************
    Public Function UpdateEndflag(ByVal strTEMPSQL As String) As Integer
        Dim strSQL As String
        Try
            strSQL = strTEMPSQL
            Return ProcEntity(strSQL)
    ...
    '입력 : strSQL = SQL 문
    '반환 : 처리건수
    '기능 : 세금계산서 부가세 수정시 함께 UPDATE
    '참고 : Key 조건이 선택적이 아님
    '*****************************************************************strTRANSYEARMON, strTRANSNO, intRtnTranVAT
    Public Function Update_VatHDR(ByVal strTRANSYEARMON As String, _
                                  ByVal strTRANSNO As Integer, _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_TRANS_HDR"     'Entity Name 설정
    End Sub
...
'                                       GetElement(vntData,"TAXAMT", intColCnt, intRow, NULL_NUM, true ), _
...
'        Dim intRtn As Integer
'        intRtn = mobjcePD_TRANS_HDR.UpdateDo( _
'                                       GetElement(vntData,"TRANSYEARMON", intColCnt, intRow), _
'                                       GetElement(vntData,"TRANSNO", intColCnt, intRow, NULL_NUM, true ), _
'                                       GetElement(vntData,"CLIENTCODE", intColCnt, intRow), _
'                                       GetElement(vntData,"REAL_MED_CODE", intColCnt, intRow), _
...
'                                       XMLGetElement(xmlRoot,"TAXAMT", NULL_NUM, true ), _
'                                       XMLGetElement(xmlRoot,"TAXNO"), _
