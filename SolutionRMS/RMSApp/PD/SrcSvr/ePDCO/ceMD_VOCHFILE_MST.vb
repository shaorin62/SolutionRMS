...
Public Class ceMD_VOCHFILE_MST
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "ceMD_VOCHFILE_MST"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function FileInsertDo(Optional ByVal strYEARMON As String = OPTIONAL_STR, _
                                 ...
                                 Optional ByVal strENDFLAG As String = OPTIONAL_STR) As Integer
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "MD_VOCHFILE_MST"     'Entity Name 설정
    End Sub
