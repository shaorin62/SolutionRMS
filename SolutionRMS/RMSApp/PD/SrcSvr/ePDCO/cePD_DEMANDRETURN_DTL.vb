...
Public Class cePD_DEMANDRETURN_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_DEMANDRETURN_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function DeleteDo(ByVal strPREESTNO As String, _
        ...
        Try
            strSQL = "DELETE FROM PD_DEMANDRETURN_DTL WHERE PREESTNO = '" & strPREESTNO & "' AND SEQ =" & dblSEQ & " AND JOBNO = '" & strJOBNO & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_DEMANDRETURN_DTL"     'Entity Name 설정
    End Sub
