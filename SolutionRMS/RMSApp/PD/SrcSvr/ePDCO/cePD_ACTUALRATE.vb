...
Public Class cePD_ACTUALRATE
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_ACTUALRATE"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function InsertDo(ByVal strJOBNO As String, _
                             ...
                             Optional ByVal strACTDEPTCD As String = OPTIONAL_STR, _
                             Optional ByVal strACTRATE As Double = OPTIONAL_NUM, _
                             Optional ByVal strJOBNOSEQ As Integer = OPTIONAL_NUM)
        ...
        Try
            ...
            BuildNameValues(",", "ACTDEPTCD", strACTDEPTCD, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("ACTDEPTCD", strACTDEPTCD), _
                        GetFieldNameValue("ACTRATE", strACTRATE), _
                        GetFieldNameValue("UUSER", mobjSCGLConfig.WRKUSR), _
                        GetFieldNameValue("UDATE", strNOW)), _
                     BuildFields("AND", _
                        GetFieldNameValue("SEQ", strSEQ)), BuildFields("AND", _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_ACTUALRATE"     'Entity Name 설정
    End Sub
