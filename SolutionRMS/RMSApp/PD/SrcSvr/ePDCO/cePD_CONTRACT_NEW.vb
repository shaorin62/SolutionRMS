'Public Class cePD_CONTRACT_NEW
...
#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_CONTRACT_NEW"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '*****************************************************************
    Public Function InsertDo(Optional ByVal strOUTSCODE As String = OPTIONAL_STR, _
    ...
    Public Function DeleteDo(ByVal strSEQ As String) As Integer
        ...
        Try
            strSQL = "DELETE FROM PD_CONTRACT_NEW WHERE SEQ = '" & strSEQ & "'"
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_CONTRACT_NEW"     'Entity Name 설정
    End Sub
