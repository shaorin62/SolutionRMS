...
Public Class cePD_DEMAND_DTL
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_DEMAND_DTL"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    '*****************************************************************
    ''PREESTNO,YEARMON,JOBNO,SUBNO,CLIENTCODE,TIMCODE,SUBSEQ,strCREDAY,DIVAMT,ADJAMT,CHARGE,OLDCHARGE,PRIORITYJOB,DEMANDFLAG,strMEMO,TAXCODE,USENO,CONFIRMFLAG,DATAYEARMON
    Public Function InsertDo(ByVal strPREESTNO As String, _
            ...
            Optional ByVal dblOLDCHARGE As Double = OPTIONAL_NUM, _
            Optional ByVal strPRIORITYJOB As String = OPTIONAL_STR, _
        ...
        Try
            ...
            BuildNameValues(",", "OLDCHARGE", dblOLDCHARGE, strFields, strValues)
            BuildNameValues(",", "PRIORITYJOB", strPRIORITYJOB, strFields, strValues)
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     BuildFields(",", _
                        ...
                        GetFieldNameValue("OLDCHARGE", dblOLDCHARGE), _
                        GetFieldNameValue("PRIORITYJOB", strPRIORITYJOB), _
                     ...
                     BuildFields("AND", _
                        GetFieldNameValue("PREESTNO", strPREESTNO), GetFieldNameValue("JOBNO", strJOBNO), GetFieldNameValue("SUBNO", dblSUBNO), GetFieldNameValue("YEARMON", strYEARMON)))
    ...
    Public Function DeleteDo(ByVal strYEARMON As String, _
                             ...
                             ByVal dblSUBNO As Double) As Integer
        Dim strSQL As String

        Try
            strSQL = "DELETE FROM PD_DEMAND_DTL WHERE PREESTNO = '" & strPREESTNO & "' AND SUBNO =" & dblSUBNO & " AND JOBNO = '" & strJOBNO & "' AND YEARMON = '" & strYEARMON & "'"
    ...
    '*****************************************************************
    'strYEARMON,strPREESTNO,strJOBNO,dblSUBNO
    Public Function DeleteDo2(ByVal strPREESTNO As String, _
                              ByVal strJOBNO As String, _
                              ByVal dblSUBNO As Double) As Integer
        Dim strSQL As String

        Try
            strSQL = "DELETE FROM PD_DEMAND_DTL WHERE PREESTNO = '" & strPREESTNO & "' AND SUBNO =" & dblSUBNO & " AND JOBNO = '" & strJOBNO & "'"

            Return ProcEntity(strSQL)
        Catch err As Exception
            Throw RaiseSysErr(err, CLASS_NAME & ".DeleteDo2")
        End Try
    End Function
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_DEMAND_DTL"     'Entity Name 설정
    End Sub
