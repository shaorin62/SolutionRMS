...
#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_ESTSUBTYPE"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    Public Function DeleteDo(ByVal strPREESTNO As String, _
        ...
        Try
            ...
            strSQL = strSQL & " AND SUBITEMCODESEQ =" & dblSUBITEMCODESEQ & "'"
    ...
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)
    '*****************************************************************
    Public Function DeleteESTTYPE(ByVal dblHDRSEQ As String, _
                                  ByVal strITEMCODE As String, _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_ESTSUBTYPE"     'Entity Name 설정
    End Sub
