...
Public Class cePD_ESTSUBTYPE_INPUT
    Inherits ceEntity

#Region "GROUP BLOCk : 전역 또는 모듈레벨의 변수/상수 선언"
    Private Const CLASS_NAME = "cePD_ESTSUBTYPE_INPUT"    '자신의 클래스명
#End Region
...
#Region "SQL Insert/Update/Delete/Select"
    ...
    'dblHDRSEQ,strPREESTNO,dblSEQ,dblSUBITEMCODESEQ,dblITEMCODESEQ,strITEMCODE,dblIMESEQ,dblSORTSEQ,dblPRICE,dblQTY,dblTERM,dblAMT,strMEMO,dblEXEPRICE,dblEXEQTY,dblEXETERM,dblEXEAMT,strEXEMEMO,strCONFIRMGBN,strNEWFLAG,strSUBITEMNAME
    ...
    Public Function UpdateDo(ByVal dblHDRSEQ As Double, _
        ...
        Try
            strSQL = String.Format("UPDATE {0} SET {1} WHERE {2}", EntityName, _
                     ...
                     BuildFields("AND", _
                        GetFieldNameValue("HDRSEQ", dblHDRSEQ), GetFieldNameValue("PREESTNO", strPREESTNO), GetFieldNameValue("SEQ", dblSEQ), GetFieldNameValue("SUBITEMCODESEQ", dblSUBITEMCODESEQ), GetFieldNameValue("ITEMCODESEQ", dblITEMCODESEQ), GetFieldNameValue("ITEMCODE", strITEMCODE)))
    ...
    '***************************************************************** dblHDRSEQ, strITEMCODE, strITEMCODESEQ)
    Public Function DeleteDo(ByVal dblHDRSEQ As Double, _
        ...
        Try
            strSQL = " DELETE FROM PD_ESTSUBTYPE_INPUT "
    ...
    '반환 : 처리건수
    '기능 : 해당 Entity에 Delete 처리
    '참고 : Key 조건이 선택적임(OPTIONAL_STR/OPTIONAL_NUM/OPTIONAL_DTM)dblIMESEQ
    '*****************************************************************
    'strITEMCODE, dblHDRSEQ, strITEMCODESEQ)
    Public Function DeleteDo_input(ByVal strITEMCODE As String, _
...
#Region "객체 생성/해제"
    ...
    Public Sub New(Optional ByVal objSCGLConfig As SCGLUtil.cbSCGLConfig = Nothing, Optional ByVal strInfoXML As String = "")
        ...
        MyBase.EntityName = "PD_ESTSUBTYPE_INPUT"     'Entity Name 설정
    End Sub
