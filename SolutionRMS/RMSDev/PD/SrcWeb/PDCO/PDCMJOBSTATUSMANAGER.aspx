<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMJOBSTATUSMANAGER.aspx.vb" Inherits="PD.PDCMJOBSTATUSMANAGER" %>
...
Sub Grid_Layout()
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 25, 0, 5
		mobjSCGLSpr.SpreadDataField .sprSht,    "CHK|REQDAY|JOBNO|SEQ|JOBNAME|CLIENTCODE|CLIENTNAME|JOBGUBN|CONFIRM|MEMO|TRANS|TAX|VOCH|EMPNAME|DEPTNAME|MANAGER|EMPNO|DEPTCD|RANKJOB|PREESTNO|PRIJOBNAME|PROJECTNM|JOBGUBNCODE|TIMCODE|SUBSEQ"
		mobjSCGLSpr.SetHeader .sprSht,		    "선택|등록월|JOBNO|SUBNO|JOB명|CLIENTCODE|광고주|제작부문|상태|비고|거래명세서|세금계산서|전표|담당자|담당부서|승인담당|사번|부서코드|GROUP|PREESTNO|PRIJOBNAME|PROJECTNM|JOBGUBNCODE|TIMCODE|SUBSEQ"
		mobjSCGLSpr.SetColWidth .sprSht, "-1",  "4   |10    |7    |6    |25   |0         |20    |8       |4   |6   |10        |10        |10  |8     |18      |8       |0   |0       |0    |0       |0         |0        |0          |0      |0"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"REQDAY|JOBNO|SEQ|JOBNAME|CLIENTCODE|CLIENTNAME|JOBGUBN|CONFIRM|MEMO|TRANS|TAX|VOCH|EMPNAME|DEPTNAME|MANAGER|EMPNO|DEPTCD|RANKJOB|CHK|PREESTNO|PRIJOBNAME|PROJECTNM|JOBGUBNCODE|TIMCODE|SUBSEQ"
		mobjSCGLSpr.ColHidden .sprSht, "CLIENTCODE|EMPNO|DEPTCD|PREESTNO|PRIJOBNAME|PROJECTNM|JOBGUBNCODE|TIMCODE|SUBSEQ", true
...
Sub sprSht_DblClick (ByVal Col, ByVal Row)
	Dim strJOBNO, strSUBNO,strPREESTNO,strPRIJOBNAME,strPROJECTNM
	Dim strRow, strCol
	Dim strWith
	Dim strHeight
	...
	'strCLIENTCODE,strTIMCODE,strSUBSEQ
	With frmThis
		...
		Else
			...
			strJOBGUBNNAME  = mobjSCGLSpr.GetTextBinding( .sprSht,"JOBGUBN",.sprSht.ActiveRow) 
			...
			strJOBGUBN =  mobjSCGLSpr.GetTextBinding( .sprSht,"JOBGUBNCODE",.sprSht.ActiveRow)	
