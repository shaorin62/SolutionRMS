<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMOUTSLIST_bak.aspx.vb" Inherits="PD.PDCMOUTSLIST_bak" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>매입집계 리스트</title> 
		<!--
'****************************************************************************************
...
Sub ImgSUMMApp_onclick
	...
	With frmThis
		...
		For intCnt = 1 To .sprSht.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",intCnt) = "1" AND mobjSCGLSpr.GetTextBinding(.sprSht,"PURCHASENO",intCnt2) = "" Then
...
Sub InitPage()
   ...
   gSetSheetDefaultColor
    with frmThis
		...
		'Sheet Layout 디자인
		mobjSCGLSpr.SpreadLayout .sprSht, 17, 0,7
	    mobjSCGLSpr.SpreadDataField .sprSht, "CHK | SEQ | PROJECTNM | JOBNO | JOBNAME | CLIENTNAME | OUTSNAME | ITEMNAME | ADJAMT | PURCHASENO | VOCHNO | CONFIRMFLAG | REQDAY | DEMANDDAY | ADJDAY | ENDDAY | OUTSRANK"
		mobjSCGLSpr.SetHeader .sprSht,        "선택|순번|PROJECTNM|JOBNO|JOB명|광고주명|외주처명|외주항목|정산금액|정산번호|전표|승인|의뢰일|청구일|정산일|결산일|랭크"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "  4|  0|        10|    7|   20|      15|      15|      12|      10|       8|   5|   4|     8|     8|     8|    8|  0"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK | CONFIRMFLAG"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "ADJDAY | DEMANDDAY | ENDDAY | REQDAY", , , ,3
		...
		mobjSCGLSpr.ColHidden .sprSht, "SEQ | OUTSRANK", true
		
		.txtYEARMON.value = MID(gNowDate,1,4) & MID(gNowDate,6,2)
		.txtADJDAY.value = gNowDate
...
'****************************************************************************************
Sub InitPageData
	frmThis.txtFROM.value = gNowDate
...
Sub ProcessRtn ()
	...
	'On error resume next
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK | SEQ | PURCHASENO | ADJDAY | JOBNO | OUTSRANK")
		if  not IsArray(vntData) then 
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="middle" align="center"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="SEARCHLABEL" width="70"><SELECT id="cmbPOPUPTYPE" title="프로젝트,JOBNO선택" style="WIDTH: 80px" name="cmbPOPUPTYPE">
														<OPTION value="REG" selected>등록월</OPTION>
														<OPTION value="ADJ">정산월</OPTION>
													</SELECT></TD>
												...
												<TD class="SEARCHLABEL" width="70">정산월</TD>
												<TD class="SEARCHDATA" style="WIDTH: 209px"><INPUT class="INPUT" id="txtFROM2" title="청구일자" style="WIDTH: 72px; HEIGHT: 22px" accessKey="DATE"
														type="text" maxLength="8" size="6" name="txtFROM2"><IMG id="imgFrom2" onmouseover="JavaScript:this.src='../../../images/imgCalEndarOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgCalEndar.gIF'" height="20" src="../../../images/imgCalEndar.gIF"
														width="23" align="absMiddle" border="0" name="imgFrom2">&nbsp;~ <INPUT class="INPUT" id="txtTO2" title="청구일자" style="WIDTH: 72px; HEIGHT: 22px" accessKey="DATE"
														type="text" maxLength="8" size="6" name="txtTO2"><IMG id="imgTo2" onmouseover="JavaScript:this.src='../../../images/imgCalEndarOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgCalEndar.gIF'" height="20" src="../../../images/imgCalEndar.gIF"
														width="23" align="absMiddle" border="0" name="imgTo2"></TD>
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTRANSYEARMON, txtTRANSNO)"
													width="70">
												&nbsp;정산구분
												<TD class="SEARCHDATA" style="WIDTH: 72px"><SELECT id="cmbGUBN" style="WIDTH: 70px" name="cmbGUBN">
							...
							<TR>
								...
								<TD style="WIDTH: 640px" vAlign="middle" align="right" height="20">
									...
									<TABLE id="tblButton1" style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
										<TR>
											<!--	<TD><IMG id="imgVoch" onmouseover="JavaScript:this.src='../../../images/imgVochOn.gIF'" style="CURSOR: hand"
													onmouseout="JavaScript:this.src='../../../images/imgVoch.gIF'" height="20" alt="SAP 처리구분 을 확정 합니다."
													src="../../../images/imgVoch.gIF" border="0" name="imgVoch"></TD>
								...
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="middle" align="center"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey1" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA" style="WIDTH: 127px"><INPUT class="INPUT" id="txtYEARMON" title="코드명" style="WIDTH: 120px; HEIGHT: 22px" type="text"
														maxLength="100" align="left" size="14" name="txtYEARMON" accessKey="NUM"></TD>
												<TD class="SEARCHLABEL" style="WIDTH: 93px;CURSOR: hand" onclick="vbscript:Call gCleanField(txtADJDAY, '')">정산일적용</TD>
												<TD class="SEARCHDATA" style="WIDTH: 208px"><INPUT class="INPUT_L" id="txtADJDAY" title="코드명" style="WIDTH: 72px; HEIGHT: 22px" type="text"
														maxLength="100" align="left" size="6" name="txtADJDAY" accessKey="DATE"><IMG id="ImgADJDAY" onmouseover="JavaScript:this.src='../../../images/imgCalEndarOn.gIF'"
