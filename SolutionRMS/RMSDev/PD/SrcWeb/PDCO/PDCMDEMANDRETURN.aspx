<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMDEMANDRETURN.aspx.vb" Inherits="PD.PDCMDEMANDRETURN" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		  "선택|YEARMON|PREESTNO|JOB명|JOBno.|SUBno.|광고주코드|광고주|견적금액|청구금액|차액|이전차액|청구기준|대표JOB|비고|청구방법|동작구분|팀코드|팀명|브랜드|브랜드코드|견적합의일|작성자|저장구분|승인구분|데이터년월"
		...
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "CREDAY"
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "DEMANDFLAG|TAXCODE|MEMO", -1, -1, 255
		mobjSCGLSpr.SetCellAlign2 .sprSht, "JOBNO|JOBNO|SUBNO",-1,-1,2,2,false '가운데
		mobjSCGLSpr.SetCellAlign2 .sprSht, "JOBNAME|CLIENTNAME|PRIORITYJOB",-1,-1,0,2,false '왼쪽
		mobjSCGLSpr.ColHidden .sprSht, "CLIENTCODE|PREESTNO|OLDCHARGE|TIMCODE|TIMNAME|SUBSEQ|SUBSEQNAME|DATAYEARMON", true
		...
		mobjSCGLSpr.SpreadDataField .sprSht1, "PREESTNO|SEQ|SUBNO|JOBNO|YEARMON|CREDAY|SUBSEQ|BTN0|SUBSEQNAME|TIMCODE|BTN|TIMNAME|CLIENTCODE|BTN2|CLIENTNAME|JOBNAME|DIVAMT|ADJAMT|CHARGE|DEMANDFLAG|MEMO|TAXCODE|SAVEFLAG|USENO|CONFIRMFLAG|DATAYEARMON"
		mobjSCGLSpr.SetHeader .sprSht1,         "견적번호|순번|부번|제작번호|청구년월|견적합의일|브랜드|브랜드명|광고팀|광고팀명|광고주|광고주명|JOB명|분할대상금액|청구금액|잔액|청구기준|비고|청구방법|저장구분|작성자|승인구분|데이터년월"
...
Sub SelectRtn
	...
	with frmThis
		...
		vntData = mobjPDCODEMAND.SelectRtn_Return(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,mstrDEPTCD,mstrMANAGER)
...
Sub ProcessRtn_HDR
	...
	with frmThis
		...
		vntData_Hdr = mobjSCGLSpr.GetDataRows(.sprSht,"CHK|YEARMON|PREESTNO|JOBNO|SUBNO|CLIENTCODE|TIMCODE|SUBSEQ|CREDAY|DIVAMT|ADJAMT|CHARGE|OLDCHARGE|PRIORITYJOB|DEMANDFLAG|MEMO|TAXCODE|USENO|SAVEFLAG|CONFIRMFLAG")
		...
		vntInParams = array(Trim(.txtYEARMON.value),gstrEmpNo)
									...
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL" title="세금계산서조회 조건을 삭제합니다" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON, '')"
												width="80">등록월</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtYEARMON" title="등록월" style="WIDTH: 88px; HEIGHT: 22px" accessKey="NUM"
							...
							<TR>
								<TD id="TD1" align="left" width="400" height="20">
									<table cellSpacing="0" cellPadding="0" width="300" border="0">
										...
										<tr>
											<td class="TITLE">
												&nbsp;&nbsp;반려재요청 상세내역&nbsp;<span id="strMsgBox"></span></td>
										</tr>
									</table>
								</TD>
