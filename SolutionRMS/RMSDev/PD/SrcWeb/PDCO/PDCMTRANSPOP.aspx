<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMTRANSPOP.aspx.vb" Inherits="PD.PDCMTRANSPOP" %>
...
sub InitPage()
	...
	'서버업무객체 생성	
	set mobjPDCMTRANSGet = gCreateRemoteObject("cPDCO.ccPDCOGET")
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON|TRANSNO|CUSTNAME|MEMO|CUSTCODE|BUSINO"
		mobjSCGLSpr.SetHeader .sprSht, "년월|번호|청구지명|계산서완료|청구지코드|사업자번호"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "10|6|16|10|0|0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "TRANSYEARMON"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "TRANSNO"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEMO"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CUSTNAME"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CUSTCODE|BUSINO"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "TRANSYEARMON",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "TRANSNO",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEMO",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "BUSINO",-1,-1,2,2,false
		mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
		mobjSCGLSpr.ColHidden .sprSht,"CUSTCODE|BUSINO",true
        End With
	end with	
	'자료조회	
	SelectRtn
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMTRANSGet.GetPDTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value,strCHK)
...
-->
	...
	<body class="base" style="BACKGROUND-IMAGE: url(../../../images/imgBodyBg.gif)" bottomMargin="0"
		...
		<TABLE id="tblForm" cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
				...
				<TD>
					<FORM id="frmThis">
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
							...
							<TR>
								<TD align="right" class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="KEY" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											border="0" align="right">
											<TBODY>
												<TR>
													<TD align="right" style="WIDTH: 98px;CURSOR: hand;HEIGHT: 27px" onclick="vbscript:Call gCleanField(txtTRANSYEARMON,txtTRANSNO)">
														거래명세서번호&nbsp;</TD>
													<TD align="left" style="WIDTH: 157px; HEIGHT: 27px">&nbsp;<INPUT class="INPUT" id="txtTRANSYEARMON" type="text" size="6" name="txtTRANSYEARMON" style="WIDTH: 72px; HEIGHT: 22px">&nbsp;-
														<INPUT class="INPUT" id="txtTRANSNO" style="WIDTH: 64px; HEIGHT: 22px" type="text" size="5"
															name="txtTRANSNO">
													</TD>
													<TD align="right" style="WIDTH: 98px;CURSOR: hand;HEIGHT: 27px" onclick="vbscript:Call gCleanField(txtTRANSYEARMON,txtTRANSNO)">
														계산서완료조회&nbsp;</TD>
													<TD align="left" style="HEIGHT: 27px">&nbsp; <INPUT type="checkbox" id="chkGUBUN" name="chkGUBUN">
													</TD>
												</TR>
												<!--
												<TR>
													<TD align="right" style="WIDTH: 97px;CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,'')">
														광고주코드&nbsp;</TD>
													<TD align="left" style="WIDTH: 99px"><INPUT class="INPUT" id="txtCLIENTCODE" type="text" size="10" name="txtCLIENTCODE" style="WIDTH: 96px; HEIGHT: 22px">
													</TD>
													<TD align="right" style="WIDTH: 97px;CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTCODE,'')">
														청구지코드&nbsp;
													</TD>
													<TD align="left"><INPUT class="INPUT" id="txtCUSTCODE" name="txtCUSTCODE" type="text" size="10" style="WIDTH: 96px; HEIGHT: 22px" >
													</TD>
												</TR>
												-->
											</TBODY>
            ...
            <OBJECT id=sprSht style="WIDTH: 100%; HEIGHT: 95%" 
            classid=clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5 VIEWASTEXT>
	<PARAM NAME="_Version" VALUE="393216">
	<PARAM NAME="_ExtentX" VALUE="30639">
