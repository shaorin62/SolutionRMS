<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMITEMPOP.aspx.vb" Inherits="PD.PDCMITEMPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtITMENAME.value = vntInParam(i)	
				case 1 : .txtCLASSNAME.value = vntInParam(i)
				case 2 : .cmbDIV.selectedIndex = vntInParam(i)					
			end select
		next
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "ITEMCODE|DIVNAME|CLASSNAME|ITEMNAME|COMMIFLAG|DIV|CLASS|DETAIL_YN|PRODUCTIONCOMMISSION"
		mobjSCGLSpr.SetHeader .sprSht, "코드|소분류|중분류|외주항목명|COMMITION|소분류코드|중분류코드|상세항목여부|간접비"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "9|10|10|13|0|0|0|10|0"
		mobjSCGLSpr.SetRowHeight .sprSht,"-1","13"
		mobjSCGLSpr.SetRowHeight .sprSht,"0","15"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht,"ITEMCODE|DIVNAME|CLASSNAME|ITEMNAME|COMMIFLAG|DETAIL_YN"
		mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
		mobjSCGLSpr.ColHidden .sprSht, "COMMIFLAG|DIV|CLASS|PRODUCTIONCOMMISSION", true
		
		mobjSCGLSpr.SetCellAlign2 .sprSht, "ITEMCODE",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "DIVNAME|CLASSNAME|ITEMNAME",-1,-1,0,2,false
	end with	
	'자료조회	
...
Dim vntDIV
with frmThis
vntDIV = mobjPDCMGET.GetDIVITEM(gstrConfigXml, mlngRowCnt, mlngColCnt)
	if not gDoErrorRtn ("COMBO_DIV") then 
			 gLoadComboBox .cmbDIV, vntDIV, False			 
   	end if  
End with
End Sub  
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetITEMCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.cmbDIV.value,.txtCLASSNAME.value,.txtITMENAME.value)
		...
		if not gDoErrorRtn ("SelectRtn") then
			...
			Else
				For intCnt = 1 To .sprSht.MaxRows
					If mobjSCGLSpr.GetTextBinding(.sprSht,"DETAIL_YN",intCnt) = "Y" Then
				...
				<TD>
					<FORM id="frmThis">
									...
									<TABLE id="tblButton" style="WIDTH: 168px; HEIGHT: 20px" cellSpacing="0" cellPadding="0"
										...
										<TR>
											...
											<TD><IMG id="imgCancel" onmouseover="JavaScript:this.src='../../../images/imgCancelOn.gif'"
													...
													name="imgCancel"></TD>
											<TD width="20" style="WIDTH: 20px"><FONT face="굴림"></FONT></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
							...
							<TR>
								<TD vAlign="middle" height="21" style="WIDTH: 100%" align="right"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="0" cellPadding="0" width="392" align="left"
											border="0">
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 80px">소분류</TD>
													<TD class="SEARCHDATA" width="100"><SELECT id="cmbDIV" title="소분류" style="WIDTH: 96px" name="cmbDIV"></SELECT></TD>
													<TD class="SEARCHLABEL" style="WIDTH: 80px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLASSNAME,txtITMENAME)">중분류</TD>
													<TD class="SEARCHDATA"><INPUT type="text" id="txtCLASSNAME" style="WIDTH: 119px; HEIGHT: 22px" name="txtCLASSNAME"
															class="INPUT" size="14"></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtITMENAME,txtCLASSNAME)">외주항목명</TD>
													<TD class="SEARCHDATA" colspan="3"><INPUT type="text" id="txtITMENAME" style="WIDTH: 304px; HEIGHT: 22px" name="txtITMENAME"
															class="INPUT" size="45"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
							...
							<TR>
								<TD class="BODYSPLIT" style="WIDTH: 382px"><FONT face="굴림"></FONT></TD>
							</TR>
							<TR>
								<TD align="center" style="WIDTH: 100%"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 100%; HEIGHT: 95%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											...
											<PARAM NAME="_ExtentY" VALUE="17886">
							...
							<TR>
								<TD class="BOTTOMSPLIT" id="lblStatus" style="WIDTH: 382px"><FONT face="굴림"></FONT></TD>
							</TR>
						</TABLE>
						<FONT face="굴림"></FONT>
				</TD>
