<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMINSJOBNOPOP.aspx.vb" Inherits="PD.PDCMINSJOBNOPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGet.GetINSJOBNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtWOCODE.value,.txtSEQ.value,.txtJOBNAME.value,.txtCUSTCODE.value)

		if not gDoErrorRtn ("GetINSJOBNO") then
				...
				<TD>
					<FORM id="frmThis">
						<TABLE id="tblTitle" height="28" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/PopupBG.gif"
							border="0">
							<TR>
								<td style="WIDTH: 214px" align="left" width="214" height="28">
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 29px" vAlign="middle">
									<TABLE class="KEY" id="tblKey" height="35" cellSpacing="0" cellPadding="0" width="500"
										...
										<TR>
											<TD align="right" style="WIDTH: 98px;CURSOR: hand" onclick="vbscript:Call gCleanField(txtJOBNAME,'')">포함청구 
												JOB명&nbsp;</TD>
											<TD><FONT face="굴림"><INPUT class="INPUT_L" id="txtJOBNAME" style="WIDTH: 387px; HEIGHT: 22px" type="text" maxLength="255"
														size="59" name="txtJOBNAME"><INPUT id="txtCUSTCODE" style="WIDTH: 5px; HEIGHT: 22px" type="hidden" size="1" name="txtCUSTCODE"><INPUT class="NOINPUT" id="txtWOCODE" style="WIDTH: 8px; HEIGHT: 22px" disabled type="text"
														maxLength="255" size="1" name="txtWOCODE"><INPUT class="INPUT" id="txtSEQ" style="WIDTH: 8px; HEIGHT: 22px" type="text" maxLength="255"
