<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMPONOPOP.aspx.vb" Inherits="PD.PDCMPONOPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>PROJECT 조회</title> 
		<!--
'****************************************************************************************
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 10, 0, 0, 0,2
		mobjSCGLSpr.SpreadDataField .sprSht, "PROJECTNO|PROJECTNM|CLIENTNAME|TIMNAME|SUBSEQNAME|GROUPGBN|CREDAY|CPDEPTNAME|CPEMPNAME|MEMO"
		mobjSCGLSpr.SetHeader .sprSht, "프로젝트 코드|프로젝트 명|광고주명|팀명|브랜드명|그룹구분|의뢰일|당담부서|담당자|메모"
		mobjSCGLSpr.SetColWidth .sprSht, "-1",    "12|30         |0       |0   |0       |0       |0    |0        |0     |0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "PROJECTNO"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "PROJECTNM"
		mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
		mobjSCGLSpr.SetCellAlign2 .sprSht, "PROJECTNO",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "PROJECTNM",-1,-1,0,2,false
		
		mobjSCGLSpr.colhidden .sprSht, "TIMNAME|SUBSEQNAME|GROUPGBN|CREDAY|CPDEPTNAME|CPEMPNAME|MEMO",true
		'CLIENTSUBNAME|SUBSEQNAME|GROUPGBN|CREDAY|CPDEPTNAME|CPEMPNAME|CLIENTTEAMNAME
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetPONO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,.txtCUSTNAME.value)
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														코드</TD>
													<TD class="SEARCHDATA" style="WIDTH: 88px"><INPUT class="INPUT" id="txtCUSTNO" type="text" size="9" name="txtCUSTNO" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,txtCUSTNO)">프로젝트 
														명</TD>
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 100%; HEIGHT: 95%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											...
											<PARAM NAME="_ExtentY" VALUE="19209">
