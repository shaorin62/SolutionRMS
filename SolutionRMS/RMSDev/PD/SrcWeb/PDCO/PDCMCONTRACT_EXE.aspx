<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMCONTRACT_EXE.aspx.vb" Inherits="PD.PDCMCONTRACT_EXE" %>
...
'-----------------------------------------------------------------------------------------
' Field_Lock  승인된 상태는 수정불가
'-----------------------------------------------------------------------------------------
Sub Field_Lock ()
	With frmThis
		If .sprSht.MaxRows > 0 Then
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CONFIRMFLAGNAME",.sprSht.ActiveRow) = "승인" Then
				'구분
				.cmbGBN.disabled = True
				
				.txtCONTRACTNAME.className	= "NOINPUT_L" : .txtCONTRACTNAME.readOnly	= True
				.txtCUSTNAME.className		= "NOINPUT_L" : .txtCUSTNAME.readOnly		= True
				.txtCUSTCODE.className		= "NOINPUT_L" : .txtCUSTCODE.readOnly		= True : .ImgCUSTCODE.disabled	= True
				.txtCONTRACTDAY.className	= "NOINPUT"	  : .txtCONTRACTDAY.readOnly	= True
				
				.txtSTDATE.className		= "NOINPUT"   : .txtSTDATE.readOnly			= True : .imgFROM2.disabled		= True 
				.txtEDDATE.className		= "NOINPUT"   : .txtEDDATE.readOnly			= True : .imgTO2.disabled		= True 
				.txtAMT.className			= "NOINPUT_R" : .txtAMT.readOnly			= True
				.txtCONDITION.className		= "NOINPUT_L" : .txtCONDITION.readOnly		= True 
				.txtMEMO.className			= "NOINPUT_L" : .txtMEMO.readOnly			= True
			else 
				'구분
				.cmbGBN.disabled = False
				
				.txtCONTRACTNAME.className	= "INPUT_L" : .txtCONTRACTNAME.readOnly	= False
				.txtCUSTNAME.className		= "INPUT_L" : .txtCUSTNAME.readOnly		= False
				.txtCUSTCODE.className		= "INPUT_L" : .txtCUSTCODE.readOnly		= False : .ImgCUSTCODE.disabled	= False
				.txtCONTRACTDAY.className	= "INPUT"   : .txtCONTRACTDAY.readOnly	= False
				
				.txtSTDATE.className		= "INPUT"   : .txtSTDATE.readOnly		= False : .imgFROM2.disabled	= False 
				.txtEDDATE.className		= "INPUT"   : .txtEDDATE.readOnly		= False : .imgTO2.disabled		= False 
				.txtAMT.className			= "INPUT_R" : .txtAMT.readOnly			= False
				.txtCONDITION.className		= "INPUT_L" : .txtCONDITION.readOnly	= False 
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOCONTRACT.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, strGBN, strFROM, strTO, strCUSTSCODE, strCONTRACTNO, strCONFIRMFLAG)
					...
					<TD>
						...
						<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtCONTRACTNO1" title="계약서번호" style="WIDTH: 216px; HEIGHT: 22px"
										type="text" maxLength="255" align="left" size="30" name="txtCONTRACTNO1">
								</TD>
								<TD class="SEARCHLABEL">계약유형</TD>
								<TD class="SEARCHDATA" vAlign="middle" align="left" colSpan="2">
									<SELECT class="INPUT" id="cmbGBN1" title="계약유형" style="WIDTH: 99px" name="cmbGBN1">
									</SELECT>
								...
								<TD vAlign="middle" align="center">
									<TABLE class="SEARCHDATA" id="tblDATA" style="WIDTH: 100%; HEIGHT: 6px" cellSpacing="1"
										...
										<TR>
											...
											<TD class="SEARCHDATA" style="WIDTH: 200px; HEIGHT: 25px">
												<SELECT dataFld="GBN" class="INPUT" id="cmbGBN" title="계약유형" style="WIDTH: 112px" dataSrc="#xmlBind"
													name="cmbGBN">
												</SELECT><INPUT dataFld="CONTRACTNO" class="NOINPUT_L" id="txtCONTRACTNO" title="계약서번호" style="WIDTH: 80px; HEIGHT: 22px"
													dataSrc="#xmlBind" readOnly type="text" maxLength="6" size="8" name="txtCONTRACTNO">
											...
											<TD class="SEARCHDATA" style="WIDTH: 250px; HEIGHT: 25px"><INPUT dataFld="CONTRACTNAME" class="INPUT_L" id="txtCONTRACTNAME" title="계약명" style="WIDTH: 245px; HEIGHT: 21px"
													accessKey=",M" dataSrc="#xmlBind" type="text" size="4" name="txtCONTRACTNAME"></TD>
											...
											<TD class="SEARCHDATA"><INPUT dataFld="CUSTNAME" class="INPUT_L" id="txtCUSTNAME" title="계약자명" style="WIDTH: 152px; HEIGHT: 22px"
													accessKey=",M" dataSrc="#xmlBind" type="text" maxLength="255" align="left" size="20" name="txtCUSTNAME">
												...
												<INPUT dataFld="CUSTCODE" class="INPUT" id="txtCUSTCODE" title="계약자코드" style="WIDTH: 96px; HEIGHT: 22px"
													accessKey=",M" dataSrc="#xmlBind" type="text" maxLength="20" align="left" size="10"
													name="txtCUSTCODE"></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call gCleanField(txtCONTRACTDAY, '')">계약일</TD>
											<TD class="SEARCHDATA" style="HEIGHT: 24px"><INPUT dataFld="CONTRACTDAY" class="INPUT" id="txtCONTRACTDAY" title="계약일" style="WIDTH: 112px; HEIGHT: 22px"
													accessKey="DATE" dataSrc="#xmlBind" type="text" maxLength="10" size="13" name="txtCONTRACTDAY">
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call gCleanField(txtSTDATE,txtEDDATE)">기간</TD>
											<TD class="SEARCHDATA" style="HEIGHT: 24px"><INPUT dataFld="STDATE" class="INPUT" id="txtSTDATE" title="계약기간 시작일" style="WIDTH: 95px; HEIGHT: 22px"
													accessKey="DATE" dataSrc="#xmlBind" type="text" maxLength="10" size="1" name="txtSTDATE">
												...
												<INPUT dataFld="EDDATE" class="INPUT" id="txtEDDATE" title="계약기간 종료일" style="WIDTH: 95px; HEIGHT: 22px"
													accessKey="DATE" dataSrc="#xmlBind" type="text" maxLength="10" size="1" name="txtEDDATE">
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call gCleanField(txtAMT,'')">계약금액</TD>
											<TD class="SEARCHDATA" style="HEIGHT: 24px"><INPUT dataFld="AMT" class="INPUT_R" id="txtAMT" title="계약금액" style="WIDTH: 152px; HEIGHT: 22px"
													accessKey="NUM" dataSrc="#xmlBind" type="text" maxLength="100" size="20" name="txtAMT"></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCONDITION, '')">지급(수금)조건</TD>
											<TD class="SEARCHDATA" colSpan="8"><TEXTAREA dataFld="CONDITION" id="txtCONDITION" title="지급(수금)조건" style="WIDTH: 824px; HEIGHT: 36px"
													accessKey=",M" dataSrc="#xmlBind" name="txtCONDITION" wrap="hard" cols="100"></TEXTAREA></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtMEMO, '')">특약사항</TD>
											<TD class="SEARCHDATA" colSpan="8"><TEXTAREA dataFld="MEMO" id="txtMEMO" title="특이사항" style="WIDTH: 824px; HEIGHT: 36px" dataSrc="#xmlBind"
													name="txtMEMO" wrap="hard" cols="100"></TEXTAREA></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
