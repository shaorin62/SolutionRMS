<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMPREESTDTLNEW.aspx.vb" Inherits="PD.PDCMPREESTDTLNEW" %>
...
Sub imgSave_onclick ()
	...
	gFlowWait meWAIT_ON
	If frmThis.txtPREESTNO.value <> "" Then
	ProcessRtn_Update
	Else
	ProcessRtn
	End If
...
strPREESTNO = ""
	...
	intRtn = mobjPDCMPREESTDTL.ProcessRtn_HDRLESS(gstrConfigXml,strMasterData,vntData,strPREESTNO,strAGREEYEARMON)
		if not gDoErrorRtn ("ProcessRtn_HDRLESS") then
			...
			.txtPREESTNO.value = strPREESTNO 'intSearchRtn(0,1)
			SelectRtn
			ESTCONFIRM_Search
		End If
	End with
