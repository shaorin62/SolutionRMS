<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMCUSTPOP.aspx.vb" Inherits="PD.PDCMCUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNO | CUSTNAME | BUSINO | COMPANYNAME|ACCUSTCODE"
		mobjSCGLSpr.SetHeader .sprSht, "코드|광고사명|사업자번호|회사 명|회계코드"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 14 |10| 13|0"
		...
		mobjSCGLSpr.ColHidden .sprSht, "ACCUSTCODE",true
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,.txtCUSTNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="KEY" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														코드</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCUSTNO" type="text" size="9" name="txtCUSTNO" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,txtCUSTNO)">광고주 
														명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
