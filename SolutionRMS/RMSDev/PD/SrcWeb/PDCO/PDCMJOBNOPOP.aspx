<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMJOBNOPOP.aspx.vb" Inherits="PD.PDCMJOBNOPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>JOBNO 조회</title> 
		<!--
'****************************************************************************************
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "JOBNO|JOBNAME|TIMCODE|COMMITION|CLIENTCODE|SUBSEQ|REQDAY|CREPART"
		mobjSCGLSpr.SetHeader .sprSht, "JOBNO|JOB명|사업부코드|커미션|광고주|브랜드|의뢰일|매체분류"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "7|27|0|0|0|8"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "JOBNO"
		...
		mobjSCGLSpr.ColHidden .sprSht, "TIMCODE|COMMITION|CLIENTCODE|SUBSEQ|REQDAY", true
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetJOBNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCODE.value,.txtCODENAME.value)
