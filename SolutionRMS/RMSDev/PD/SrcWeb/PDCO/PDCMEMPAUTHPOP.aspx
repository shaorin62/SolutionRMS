<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMEMPAUTHPOP.aspx.vb" Inherits="PD.PDCMEMPAUTHPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMROLE.GetPDEMP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="KEY" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEMPNO,txtEMPNAME)">
														사원 코드</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtEMPNO" type="text" size="9" name="txtEMPNO" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEMPNO,txtEMPNAME)">
														사원&nbsp;명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtEMPNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
