<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMJOBNODETAIL.aspx.vb" Inherits="PD.PDCMJOBNODETAIL" %>
...
Sub ACTUALRATE_POP
	...
	with frmThis
		...
		vntRet = gShowModalWindow("PDCMACTUALRATEPOP.aspx",vntInParams , 1060,600)
...
Sub InitPage()
    ...
    With frmThis
		...
		'신규일 경우 프로젝트 의 내역을 받아온다.
			...
			mobjSCGLSpr.SetCellsLock2 .sprSht,false,"JOBNAME|JOBGUBN|REQDAY|DEPTCD|DEPTNAME|EMPNO|EMPNAME|HOPEENDDAY|BUDGETAMT|CREGUBN|JOBBASE|BIGO|CREPART|CREDEPTNAME|CREEMPNAME|EXCLIENTCODE|EXCLIENTNAME",1,1,false
			.txtJOBNAME.focus()
		ElseIf  mstrSTATUS = "Detail" Then
			for i = 0 to intNo
			select case i
				case 1 : .txtPROJECTNO1.value = vntInParam(i)	
				case 2 : .txtPROJECTNM1.value = vntInParam(i)
			end select
			next
			InitPageData
			SelectRtn
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCOJOBNO.SelectRtn_PROJECTORJOB(gstrConfigXml,mlngRowCnt,mlngColCnt,strFROM,strTO,Trim(.txtSEARCHCLIENTSUBCODE.value),Trim(.txtSEARCHCLIENTSUBNAME.value),Trim(.txtSEARCHCLIENTCODE.value),Trim(.txtSEARCHCLIENTNAME.value),.cmbSEARCHJOBGUBN.value,.cmbSEARCHENDFLAG.value,Trim(.txtPROJECTNO1.value),Trim(.txtPROJECTNM1.value),Trim(.cmbPOPUPTYPE.value))
		If not gDoErrorRtn ("SelectRtn") then
			...
			Else
				...
				for intCnt = 1 to .sprSht.MaxRows
					...
					'vntDataSubCombo = mobjPDCOJOBNO.GetDataType_SubCode(gstrConfigXml, mlngRowCnt2, mlngColCnt2, strCODE)					
...
Sub ProcessRtn ()
	...
	'On error resume next
		...
		if .txtJOBNO.value = "" then
			strSEQFlag = "new"
			intRtn = mobjPDCOJOBNO.ProcessRtn(gstrConfigXml,strMasterData, strSEQFlag,strJOBNO)
		else
			intRtn = mobjPDCOJOBNO.ProcessRtnSheet(gstrConfigXml,vntData)
		end if
...
Sub Get_SUBCOMBO_VALUE(strCODE,strPos)							
	...
	With frmThis   					
		...
		mlngColCnt=clng(0)				
       	...
       	vntData = mobjPDCOJOBNO.GetDataType_SubCode(gstrConfigXml, mlngRowCnt, mlngColCnt, strCODE)					
...
Sub SEARCHCOMBO_TYPE()
    ...
    With frmThis   
		...
		vntJOBGUBN = mobjPDCOJOBNO.GetDataType_search(gstrConfigXml, mlngRowCnt, mlngColCnt,"JOBGUBN")  'JOB종류 호출
		vntENDFLAG = mobjPDCOJOBNO.GetDataType_search(gstrConfigXml, mlngRowCnt, mlngColCnt,"ENDFLAG")  '제작상태 호출
	...
	with frmThis
		...
		for i = intSelCnt-1 to 0 step -1
			IF mobjSCGLSpr.GetFlagMode(.sprSht,vntData(i)) <> meINS_TRANS then
				...
				If strENDFLAG <> "PF01" Then
					gErrorMsgBox "[" & vntData(i) & "행] 의 진행상태가 의뢰가 아닌건은 삭제하실수 없습니다.","삭제안내!"
					Exit Sub
				End If
			End IF
		next
		...
		for i = intSelCnt-1 to 0 step -1
			...
			IF mobjSCGLSpr.GetFlagMode(.sprSht,vntData(i)) <> meINS_TRANS then
				...
				'실적분배율까지 바로삭제
				intSubRtn =mobjPDCOACTUALRATE.DeleteRtn_DTL_JOBNODEPT_JOBNO2(gstrConfigXml,strCODE)
				'intSubRtn =mobjPDCOACTUALRATE.DeleteRtn_DTL_ACTUALRATE_JOBNO(gstrConfigXml,strCODE)
			End IF
		next
...
Function sprShtToFieldBinding (ByVal Col, ByVal Row)
	...
	with frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData_DEPT = mobjPDCOACTUALRATE.SelectRtn_DTL_JOBNODEPT(gstrConfigXml,mlngRowCnt,mlngColCnt,strJOBNO,"")
		IF mlngRowCnt > 0 then
		...
		<FORM id="frmThis" method="post" runat="server">
			...
			<TABLE id="tblForm" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
				...
				<TBODY>
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="57" background="../../../images/back_p.gIF"
														border="0">
														<TR>
										...
										<TABLE class="searchDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
											...
											<TR>
												...
												<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 22px" onclick="vbscript:Call gCleanField(txtSEARCHCLIENTSUBNAME, txtSEARCHCLIENTSUBCODE)"
													width="90">팀</TD>
												<TD class="SEARCHDATA" style="WIDTH: 229px; HEIGHT: 16.72pt" width="229"><INPUT class="INPUT_L" id="txtSEARCHCLIENTSUBNAME" title="사업부명 조회" style="WIDTH: 154px; HEIGHT: 22px"
														...
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" src="../../../images/imgPopup.gIF" align="absMiddle" border="0" name="ImgSEARCHCLIENTSUBCODE">
													<INPUT class="INPUT" id="txtSEARCHCLIENTSUBCODE" title="사업부코드 조회" style="WIDTH: 56px; HEIGHT: 22px"
												...
												<TD class="SEARCHLABEL" style="WIDTH: 88px; CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call gCleanField(txtSEARCHCLIENTCODE, txtSEARCHCLIENTNAME)"
													width="88">광고주</TD>
												<TD class="SEARCHDATA" style="HEIGHT: 18.24pt"><INPUT class="INPUT_L" id="txtSEARCHCLIENTNAME" title="광고주명 조회" style="WIDTH: 192px; HEIGHT: 22px"
														...
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" src="../../../images/imgPopup.gIF" align="absMiddle" border="0" name="ImgSEARCHCLIENTCODE">
													<INPUT class="INPUT" id="txtSEARCHCLIENTCODE" title="광고주코드 조회" style="WIDTH: 56px; HEIGHT: 22px"
											...
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 112px; CURSOR: hand" onclick="vbscript:Call JOBGUBNClean()"
													width="112">매체부문</TD>
												<TD class="SEARCHDATA" style="WIDTH: 230px" width="230"><SELECT id="cmbSEARCHJOBGUBN" title="매체부문조회" style="WIDTH: 220px" name="cmbSEARCHJOBGUBN"></SELECT></TD>
												...
												<TD class="SEARCHDATA" colSpan="2"><INPUT class="INPUT_L" id="txtPROJECTNM1" title="제작건명 조회" style="WIDTH: 192px; HEIGHT: 22px"
														...
														name="ImgPROJECTNO1"> <INPUT class="INPUT" id="txtPROJECTNO1" title="제작번호 조회" style="WIDTH: 56px; HEIGHT: 22px"
					...
					<tr>
						<td>
							<table class="DATA" height="20" cellSpacing="0" cellPadding="0" width="100%">
								<TR>
									<TD style="WIDTH: 100%; HEIGHT: 20px"></TD>
								</TR>
							</table>
							<TABLE style="WIDTH: 100%; HEIGHT: 8px" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/TitleBG.gIF"
										...
										<table style="WIDTH: 640px; HEIGHT: 20px" cellSpacing="0" cellPadding="0" width="640" border="0">
											...
											<tr>
												<td class="TITLE"><span id="spnHIDDEN" style="CURSOR: hand" onclick="vbscript:Call Set_TBL_HIDDEN ()"><IMG id="imgTableUp" style="CURSOR: hand" alt="자료를 검색합니다." src="../../../images/imgTableUp.gif"
															align="absMiddle" border="0" name="imgTableUp"></span> &nbsp;JOB관리&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
													합계 : <INPUT class="NOINPUTB_R" id="txtSUMAMT" title="합계금액" style="WIDTH: 120px; HEIGHT: 18px"
														accessKey="NUM" readOnly type="text" maxLength="100" size="13" name="txtSUMAMT">&nbsp;&nbsp; 
													선택합계 : <INPUT class="NOINPUTB_R" id="txtSELECTAMT" title="선택금액" style="WIDTH: 120px; HEIGHT: 18px"
														readOnly type="text" maxLength="100" size="16" name="txtSELECTAMT">
												</td>
											</tr>
										</table>
									</TD>
									<TD style="WIDTH: 640px" vAlign="middle" align="right">
										<!--Common Button Start-->
					...
					<TR>
						<TD style="WIDTH: 100%" vAlign="top" align="left">
							<TABLE class="SEARCHdata" id="tblBody1" cellSpacing="1" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD class="SEARCHLABEL" width="90">프로젝트명</TD>
									<TD class="SEARCHdata" width="230"><INPUT dataFld="PROJECTNM" class="NOINPUTB_L" id="txtPROJECTNM" title="프로젝트명" style="WIDTH: 160px; HEIGHT: 21px"
									...
									<TD class="SEARCHLABEL" width="90">브랜드</TD>
									<TD class="SEARCHdata" width="230"><INPUT dataFld="SUBSEQNAME" class="NOINPUTB_L" id="txtSUBSEQNAME" title="브랜드" style="WIDTH: 229px; HEIGHT: 21px"
											dataSrc="#xmlBind" readOnly type="text" size="24" name="txtSUBSEQNAME"></TD>
									<TD class="SEARCHLABEL" width="90">담당부서 [CP]</TD>
									<TD class="SEARCHdata"><INPUT dataFld="CPDEPTNAME" class="NOINPUTB_L" id="txtCPDEPTNAME" title="담당부서 CP" style="WIDTH: 266px; HEIGHT: 21px"
											dataSrc="#xmlBind" readOnly type="text" size="37" name="txtCPDEPTNAME"></TD>
								<TR>
									<TD class="SEARCHLABEL">등록일</TD>
									...
									<TD class="SEARCHdata"><INPUT dataFld="CPEMPNAME" class="NOINPUTB_L" id="txtCPEMPNAME" title="담당자CP" style="WIDTH: 266px; HEIGHT: 21px"
											dataSrc="#xmlBind" readOnly type="text" size="37" name="txtCPEMPNAME"></TD>
								</TR>
								<TR>
									<TD class="SEARCHLABEL">그룹구분</TD>
									...
									<TD class="SEARCHdata"><INPUT dataFld="MEMO" class="NOINPUTB_L" id="txtMEMO" title="사업부" style="WIDTH: 266px; HEIGHT: 21px"
					...
					<TR>
						<TD style="WIDTH: 100%" vAlign="top" align="left">
							<TABLE class="SEARCHdata" id="tblBody2" cellSpacing="1" cellPadding="0" width="100%" border="0">
								<TR>
									...
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call CleanField(txtJOBNAME, '')"
										width="90">JOB명</TD>
									<TD class="SEARCHdata" width="230"><INPUT dataFld="JOBNAME" id="txtJOBNAME" title="제작건명" style="WIDTH: 164px; HEIGHT: 21px"
											accessKey=",M" dataSrc="#xmlBind" type="text" size="21" name="txtJOBNAME" class="INPUT_L"><INPUT dataFld="JOBNO" class="NOINPUT" id="txtJOBNO" title="제작관번호코드" style="WIDTH: 65px; HEIGHT: 21px"
											dataSrc="#xmlBind" readOnly type="text" size="8" name="txtJOBNO"></TD>
									<TD class="SEARCHLABEL" width="90">매체부문</TD>
									<TD class="SEARCHdata" width="230"><SELECT dataFld="JOBGUBN" id="cmbJOBGUBN" title="매체구분" style="WIDTH: 224px" dataSrc="#xmlBind"
									...
									<TD class="SEARCHdata"><INPUT dataFld="DEPTNAME" class="INPUT_L" id="txtDEPTNAME" title="담당부서명" style="WIDTH: 173px; HEIGHT: 22px"
											dataSrc="#xmlBind" type="text" maxLength="100" size="23" name="txtDEPTNAME">
								...
								<TR>
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call CleanField(txtREQDAY, '')">의뢰일</TD>
									...
									<TD class="SEARCHdata"><INPUT dataFld="EMPNAME" class="INPUT_L" id="txtEMPNAME" title="담당자명" style="WIDTH: 173px; HEIGHT: 22px"
								...
								<TR>
									<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call CleanField(txtHOPEENDDAY, '')">완료예정일</TD>
									...
									<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 24px" onclick="vbscript:Call CleanField(txtCREDEPTNAME,txtCREDEPTCD)">제작담당팀</TD>
									<TD class="SEARCHdata" style="HEIGHT: 18.24pt"><INPUT dataFld="CREDEPTNAME" class="INPUT_L" id="txtCREDEPTNAME" title="제작담당자부서명" style="WIDTH: 173px; HEIGHT: 22px"
											dataSrc="#xmlBind" type="text" maxLength="100" size="23" name="txtCREDEPTNAME">
										<IMG id="ImgCREDEPTCD" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
											style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'"
											src="../../../images/imgPopup.gIF" align="absMiddle" border="0" name="ImgCREDEPTCD">
										<INPUT dataFld="CREDEPTCD" class="INPUT_L" id="txtCREDEPTCD" title="제작담당자부서코드" style="WIDTH: 70px; HEIGHT: 22px"
											dataSrc="#xmlBind" type="text" maxLength="6" size="4" name="txtCREDEPTCD"></TD>
								</TR>
								<TR>
									<TD class="SEARCHLABEL">완료구분</TD>
									...
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call CleanField(txtCREEMPNAME, txtCREEMPNO)">제작담당자</TD>
									<TD class="SEARCHdata"><INPUT dataFld="CREEMPNAME" class="INPUT_L" id="txtCREEMPNAME" title="제작담당자" style="WIDTH: 173px; HEIGHT: 22px"
											dataSrc="#xmlBind" type="text" maxLength="100" size="23" name="txtCREEMPNAME">
										<IMG id="ImgCREEMPNO" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
											style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'"
											src="../../../images/imgPopup.gIF" align="absMiddle" border="0" name="ImgCREEMPNO">
										<INPUT dataFld="CREEMPNO" class="INPUT_L" id="txtCREEMPNO" title="제작담당사번" style="WIDTH: 70px; HEIGHT: 22px"
								...
								<TR>
									...
									<TD class="SEARCHdata"><INPUT dataFld="BUDGETAMT" class="INPUT_R" id="txtBUDGETAMT" title="예산금액" style="WIDTH: 224px; HEIGHT: 21px"
											accessKey="NUM" dataSrc="#xmlBind" type="text" size="32" name="txtBUDGETAMT"></TD>
									<TD class="SEARCHLABEL" style="CURSOR: hand">실적분배율</TD>
									<TD class="SEARCHdata">
										<TABLE class="NOINPUTB" id="Table1" style="WIDTH: 224px; HEIGHT: 27px" cellSpacing="1"
											cellPadding="0">
											<TR>
												<TD class="SEARCHdata" style="WIDTH: 100px" align="left" width="100">분배율 등록<INPUT id="chkDEPT" disabled tabIndex="0" type="checkbox" name="chkDEPT"></TD>
												<TD class="SEARCHdata"><IMG id="ImgDivamtPop" onmouseover="JavaScript:this.src='../../../images/ImgDivamtPopOn.gIF'"
									...
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call CleanField(txtEXCLIENTNAME,txtEXCLIENTCODE)">크리조직</TD>
									<TD class="SEARCHdata"><INPUT dataFld="EXCLIENTNAME" class="INPUT_L" id="txtEXCLIENTNAME" title="대대행사명" style="WIDTH: 173px; HEIGHT: 22px"
											dataSrc="#xmlBind" type="text" maxLength="100" size="24" name="txtEXCLIENTNAME">
								...
								<TR>
									<TD class="SEARCHLABEL">합의월</TD>
									<TD class="SEARCHdata"><INPUT dataFld="AGREEYEARMON" class="NOINPUTB" id="txtAGREEYEARMON" title="합의월" style="WIDTH: 224px; HEIGHT: 22px"
									...
									<TD class="SEARCHdata"><INPUT dataFld="SETYEARMON" class="NOINPUTB" id="txtSETYEARMON" title="결산월" style="WIDTH: 260px; HEIGHT: 22px"
											dataSrc="#xmlBind" readOnly type="text" maxLength="10" size="38" name="txtSETYEARMON"></TD>
								</TR>
								<TR>
									<TD class="SEARCHLABEL" onclick="vbscript:Call CleanField(txtBIGO, '')">비고</TD>
									<TD class="SEARCHdata" colSpan="5"><INPUT dataFld="BIGO" id="txtBIGO" title="부가정보 비고" style="WIDTH: 965px; HEIGHT: 21px" dataSrc="#xmlBind"
											type="text" size="148" name="txtBIGO" class="INPUT_L"></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
						...
						<TD style="WIDTH: 100%; HEIGHT: 98%" vAlign="top" align="center">
							<DIV id="pnlTab1" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 98%"
								...
								<OBJECT id="sprSht" style="WIDTH: 100%; HEIGHT: 98%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
									...
									<PARAM NAME="_ExtentX" VALUE="30586">
