...
Sub Grid_Layout()
    ...
    with frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		    "구분|정산번호|외주처코드|외주처명|JOBNO|JOB명|외주항목|정산금액|정산일|칼라|전표확정"
	...
	<body class="base">
		...
		<FORM id="frmThis" method="post" runat="server">
			...
			<TABLE id="tblBody" style="WIDTH: 100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
				...
				<TR>
					<TD style="WIDTH: 1040px; HEIGHT: 15px" vAlign="top" align="center" colSpan="2"><FONT face="굴림">
							<TABLE id="tblKey" cellSpacing="1" cellPadding="0" width="1040" border="0">
								<TR>
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call DateClean()" width="90">&nbsp;정산기간
									</TD>
									<TD class="SEARCHDATA" style="WIDTH: 220px"><INPUT class="INPUT" id="txtFROM" title="정산일자시작" style="WIDTH: 72px; HEIGHT: 22px" accessKey="DATE"
											...
											width="23" align="absMiddle" border="0" name="imgFrom">&nbsp;~ <INPUT class="INPUT" id="txtTO" title="정산일자종료" style="WIDTH: 72px; HEIGHT: 22px" accessKey="DATE"
									...
									<TD class="SEARCHDATA" style="WIDTH: 121px"><INPUT class="INPUT" id="txtPURCHASENO" title="정산번호" style="WIDTH: 120px; HEIGHT: 22px"
									...
									<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtOUTSNAME, txtOUTSCODE)"
										width="90">외주처</TD>
									<TD class="SEARCHDATA" style="WIDTH: 398px"><INPUT class="INPUT_L" id="txtOUTSNAME" title="코드명" style="HEIGHT: 22px" type="text" maxLength="255"
											...
											width="23" align="absMiddle" border="0" name="ImgOUTSCODE"><INPUT class="INPUT_L" id="txtOUTSCODE" title="코드조회" style="WIDTH: 64px; HEIGHT: 22px"
				...
				<TR>
					<TD class="BODYSPLIT" style="WIDTH: 1040px; HEIGHT: 5px"><FONT face="굴림"></FONT></TD>
				</TR>
				<!--추가끝-->
