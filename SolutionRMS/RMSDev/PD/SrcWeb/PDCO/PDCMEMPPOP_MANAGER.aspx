<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMEMPPOP_MANAGER.aspx.vb" Inherits="PD.PDCMEMPPOP_MANAGER" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetPDEMP_MANAGER(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value,"A",.txtDEPTCD.value,.txtDEPTNAME.value)
