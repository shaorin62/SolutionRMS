<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMPREPAYMENTSEARCH.aspx.vb" Inherits="PD.PDCMPREPAYMENTSEARCH" %>
...
Sub Grid_Layout()
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht,    "GBN|CLIENTCODE|CLIENTNAME|SUBSEQ|SUBSEQNAME|JOBNO|JOBNAME|ADJDAY|PURCHASENO|OUTSCODE|OUTSNAME|STD|ADJAMT|EMPNAME"
		mobjSCGLSpr.SetHeader .sprSht,		    "구분|광고주코드|광고주명|브랜드코드|브랜드명|JOBNO|JOB명|거래일자|거래번호|외주처코드|외주처명|적요|집행금액|기획담당"
		mobjSCGLSpr.SetColWidth .sprSht, "-1",  "0   |0         |15      |0         |15      |8    |18   |8       |10      |0         |13      |13  |12      |10"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "ADJDAY"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "ADJAMT", -1, -1, 0
		mobjSCGLSpr.SetCellAlign2 .sprSht, "JOBNO|PURCHASENO|EMPNAME",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME|JOBNAME|SUBSEQNAME|OUTSNAME|STD",-1,-1,0,2,false
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"GBN|CLIENTCODE|CLIENTNAME|SUBSEQ|SUBSEQNAME|JOBNO|JOBNAME|ADJDAY|PURCHASENO|OUTSCODE|OUTSNAME|STD|ADJAMT|EMPNAME"
		mobjSCGLSpr.ColHidden .sprSht, "GBN|CLIENTCODE|SUBSEQ|OUTSCODE", true
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMSEARCH.SelectRtn_PREPAYMENT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtOUTSCODE.value,.txtOUTSNAME.value )
								...
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHLABEL" width="80" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtOUTSNAME, txtOUTSCODE)">외주처
											</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtOUTSNAME" title="코드명" style="WIDTH: 207px; HEIGHT: 22px"
													type="text" maxLength="100" align="left" size="29" name="txtOUTSNAME"> <IMG id="ImgOUTSCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
												...
												<INPUT class="INPUT" id="txtOUTSCODE" title="코드조회" style="WIDTH: 53px; HEIGHT: 22px"
