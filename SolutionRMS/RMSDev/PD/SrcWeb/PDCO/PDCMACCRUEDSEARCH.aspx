<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMACCRUEDSEARCH.aspx.vb" Inherits="PD.PDCMACCRUEDSEARCH" %>
...
Sub Grid_Layout()
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht,    "GBN|OUTSCODE|OUTSNAME|CLIENTCODE|CLIENTNAME|JOBNO|JOBNAME|BUSITYPE|ADJAMT|EMPNAME|HOPEENDDAY"
		mobjSCGLSpr.SetHeader .sprSht,		    "구분|외주처코드|외주처명|광고주코드|광고주명|JOBNO|JOB명|업종|집행금액|기획담당|완료예정일"
		mobjSCGLSpr.SetColWidth .sprSht, "-1",  "0   |0         |23      |0         |18      |12   |18   |14  |12      |13      |12"
		...
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME|JOBNAME|OUTSNAME|BUSITYPE",-1,-1,0,2,false
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"GBN|OUTSCODE|OUTSNAME|CLIENTCODE|CLIENTNAME|JOBNO|JOBNAME|BUSITYPE|ADJAMT|EMPNAME|HOPEENDDAY"
		mobjSCGLSpr.ColHidden .sprSht, "GBN|CLIENTCODE|OUTSCODE", true
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMSEARCH.SelectRtn_ACCRUED(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtOUTSCODE.value,.txtOUTSNAME.value )
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												<TABLE cellSpacing="0" cellPadding="0" width="84" background="../../../images/back_p.gIF"
													border="0">
													<TR>
