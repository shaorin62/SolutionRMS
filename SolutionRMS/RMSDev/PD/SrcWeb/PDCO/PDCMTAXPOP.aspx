<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMTAXPOP.aspx.vb" Inherits="PD.PDCMTAXPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME|SUMM",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetTAXGUNNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value)
											...
											<TBODY>
												<TR>
													<TD align="right" WIDTH="97" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTRANSYEARMON,txtTRANSNO)">
														세금계산서번호&nbsp;</TD>
													<TD align="left" colspan="3"><INPUT class="INPUT" id="txtTRANSYEARMON" type="text" size="6" name="txtTRANSYEARMON" style="WIDTH: 73px; HEIGHT: 22px">&nbsp;-
												...
												<TR>
													...
													<TD id="txtLBNAME" WIDTH="80" align="right" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
														광고주명&nbsp;</TD>
													<TD align="left"><INPUT class="INPUT" id="txtCLIENTNAME" type="text" size="18" name="txtCLIENTNAME" style="WIDTH: 144px; HEIGHT: 22px">
													</TD>
												</TR>
											</TBODY>
										</TABLE>
