<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMDEPTPOP.aspx.vb" Inherits="PD.PDCMDEPTPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht,"1|2",,,0,1	'0 좌측 1 우측 2 중앙
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetCC(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCodeName.value)
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
							...
							<TR>
								<TD  style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
									<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 100%; HEIGHT: 42px" height="42" cellSpacing="0"
										cellPadding="0"  align="right" border="0">
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 100px; CURSOR: hand; HEIGHT: 12px" width="581" onclick="vbscript:Call gCleanField(txtCodeName,'')">부서코드명</td>
