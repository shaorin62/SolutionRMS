<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMTIMPOP.aspx.vb" Inherits="PD.PDCMTIMPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTCODE | CUSTNAME | CLIENTSUBCODE | CLIENTSUBNAME | HIGHCUSTCODE | COMPANYNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|팀명|사업부코드|사업부명|광고주코드|광고주명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 5|  12|         0|      10|         0|     15"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCOGET.GetTIMCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtTIMCODE.value,.txtTIMNAME.value)
											...
											<TBODY>
												<TR>
													...
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
														광고주 명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCLIENTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtCLIENTNAME" tabIndex="1"></TD>
												</TR>
												<TR>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMCODE,txtTIMNAME)">
														코드</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtTIMCODE" type="text" size="9" name="txtTIMCODE"
															style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME,txtTIMCODE)">
														팀&nbsp;명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtTIMNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
