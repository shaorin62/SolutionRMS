<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMACCSEARCH.aspx.vb" Inherits="PD.PDCMACCSEARCH" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>진행비 사용내역</title>
...
Sub Grid_Layout()
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht,    "GBN|CLIENTCODE|CLIENTNAME|JOBNO|JOBNAME|DEPTNAME|ACCDAY|OUTSNAME|BREAKDOWN|AMT|JOBGUBN"
		mobjSCGLSpr.SetHeader .sprSht,		    "구분|광고주|광고주명|JOBNO|JOB명|의뢰부서|거래일자|외주처|적요|집행금액|JOBGUBN"
		mobjSCGLSpr.SetColWidth .sprSht, "-1",  "15  |0     |18      |12   |18  |20      |12      | 18   |20  |12      |0"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "ACCDAY"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT", -1, -1, 0
		mobjSCGLSpr.SetCellAlign2 .sprSht, "JOBNO",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "GBN|CLIENTNAME|JOBNAME|DEPTNAME|OUTSNAME|BREAKDOWN|JOBGUBN",-1,-1,0,2,false
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"GBN|CLIENTCODE|JOBNO|JOBNAME|DEPTNAME|ACCDAY|OUTSNAME|BREAKDOWN|AMT|CLIENTNAME"
		mobjSCGLSpr.ColHidden .sprSht, "GBN|JOBGUBN|CLIENTCODE", true
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMSEARCH.SelectRtn_PDCMACCLISTSEARCH(gstrConfigXml,mlngRowCnt,mlngColCnt,strFROM,strTO )
							...
							<TR>
								<TD style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center" colSpan="2"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call DateClean()" width="90">&nbsp;거래기간
												</TD>
								...
								<TD class="DATAFRAME">
									<DIV id="pnlTab1" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
										...
										<OBJECT id="sprSht" style="Z-INDEX: 101; LEFT: 0px; WIDTH: 100%; POSITION: absolute; TOP: 0px; HEIGHT: 100%"
											...
											<PARAM NAME="_ExtentY" VALUE="19685">
