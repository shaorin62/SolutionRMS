	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 2 : .txtCode.value = vntInParam(i)			'조회추가필드
				case 3 : .txtCodeName.value = vntInParam(i)		'현재 사용중인 것만
		...
		'mobjSCGLSpr.SetHeader .sprSht, "코드|코드명|부서코드|부서명|브랜드명"
		mobjSCGLSpr.SetHeader .sprSht, "코드|브랜드코드|브랜드명|광고주코드|광고주명|부서코드|부서명|사업부코드|사업부"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "9|0|13|0|12|0|8|0|0"
		mobjSCGLSpr.SetRowHeight .sprSht,"-1","13"
		mobjSCGLSpr.SetRowHeight .sprSht,"0","15"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht,"CODE"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht,"SEQNO"	'중앙 정렬
				...
				<TD>
					<FORM id="frmThis">
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" HEIGHT="100%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" vAlign="middle" height="21" style="WIDTH: 382px" align="RIGHT"><FONT face="굴림">
										<TABLE class="KEY" id="tblKey" cellSpacing="0" cellPadding="0" width="392" align="right"
											...
											<TBODY>
												<TR>
													...
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCustCodeName,txtCustCode)">광고주명</TD>
												...
												<TR>
													...
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCodeName,txtCode)">브랜드명</TD>
