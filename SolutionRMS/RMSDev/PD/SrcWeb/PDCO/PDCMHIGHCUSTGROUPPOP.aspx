<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMHIGHCUSTGROUPPOP.aspx.vb" Inherits="PD.PDCMHIGHCUSTGROUPPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetCUSTNO_HIGHCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCLIENTSUBCODE.value,.txtCLIENTSUBNAME.value, .txtCLIENTCODE.value, .txtCLIENTNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="KEY" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,txtCLIENTNAME)">
														코드</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCLIENTCODE" type="text" size="9" name="txtCLIENTCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
														광고주&nbsp;명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCLIENTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
															name="txtCLIENTNAME" tabIndex="1"></TD>
												</TR>
												<TR>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTSUBCODE,txtCLIENTSUBNAME)">
														코드</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCLIENTSUBCODE" type="text" size="9" name="txtCLIENTSUBCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="KEY" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTSUBNAME,txtCLIENTSUBCODE)">
														사업부&nbsp;명&nbsp;</TD>
													<TD class="KEY"><INPUT class="INPUT" id="txtCLIENTSUBNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
															name="txtCLIENTSUBNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
