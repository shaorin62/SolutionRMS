<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMCONTRACT_EXE_POP.aspx.vb" Inherits="PD.PDCMCONTRACT_EXE_POP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "BUSINO | CUSTNAME"
			mobjSCGLSpr.SetHeader .sprSht,       "사업자번호|계약자"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "      13|   30"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetCONTRACT_EXE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,.txtCUSTNAME.value)
							...
							<TR>
								<TD style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0"
											width="392" align="left" border="0">
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														사업자번호</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNO" type="text" size="9" name="txtCUSTNO" style="WIDTH: 90px; HEIGHT: 22px"
															maxLength="20">&nbsp;</TD>
