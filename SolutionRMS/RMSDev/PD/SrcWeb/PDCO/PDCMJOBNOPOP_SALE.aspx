	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 5 : mblnUseOnly = vntInParam(i)		'현재 사용중인 것만
				case 6 : mstrUseDate = vntInParam(i)		'코드 사용 시점
				case 7 : mblnLikeCode = vntInParam(i)		'조회시 코드를 Like할지 여부
			end select
		next
		'SpreadSheet 디자인
		...
		mobjSCGLSpr.SetHeader .sprSht, "JOB등록월|JOBNO|JOB명|사업부코드|커미션|광고주|브랜드|매체분류"
