<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMEXECUSTPOP.aspx.vb" Inherits="PD.PDCMEXECUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht, "코드|외주처명|사업자번호|회사 명|회계코드"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetEXECUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,replace(TRIM(.txtCUSTNAME.value),"'","''"))
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNO" type="text" size="9" name="txtCUSTNO" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
