<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMITEMDIVPOP.aspx.vb" Inherits="PD.PDCMITEMDIVPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i   
				...
				case 1 : .txtCLASSNM.value = vntInParam(i)			'조회추가필드
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "DIVCD|DIVNM"
		mobjSCGLSpr.SetHeader .sprSht, "대분류코드|대분류명"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "20|22"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "DIVCD|DIVNM",-1,-1,0
		mobjSCGLSpr.SetCellAlign2 .sprSht, "DIVCD",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "DIVNM",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjPDCMGET.GetDIVCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCLASSCD.value,.txtCLASSNM.value)
	...
	<body class="base"  bottomMargin="0"
		...
		<TABLE id="tblForm" cellSpacing="0" cellPadding="0" width="100%"  height="100%" border="0">
			<TR>
				<TD>
					<FORM id="frmThis">
						<TABLE id="tblTitle" cellSpacing="0" cellPadding="0" width="100%" 
							border="0">
							<TR>
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="100%" border="0">
							...
							<TR>
								<TD style="HEIGHT: 27px" vAlign="middle" height="27"><FONT face="굴림">
