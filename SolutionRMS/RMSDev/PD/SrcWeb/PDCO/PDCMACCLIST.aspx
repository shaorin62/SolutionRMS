<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PDCMACCLIST.aspx.vb" Inherits="PD.PDCMACCLIST" %>
...
sub InitPage()
	...
	End with
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "JOBNO|SEQ|AMT|BREAKDOWN|ACCDAY"
			mobjSCGLSpr.SetHeader .sprSht,         "제작번호|순번|진행비|내역|거래일"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "       0|   0|   15|   33|    10"
			...
			mobjSCGLSpr.SpreadDataField .sprShtSum, "JOBNO|SEQ|AMT|BREAKDOWN|ACCDAY"
