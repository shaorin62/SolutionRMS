<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMAORCONFLIST.aspx.vb" Inherits="MD.MDCMAORCONFLIST" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 거래명세서 승인 화면(MDCMAORCONFLIST.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMAORCONFLIST.aspx
'기      능 : 거래명세서 승인
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
-->
		...
		<!-- Farpoint SpreadSheet Liecense :spr32x60.ocx -->
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | REAL_MED_NAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | CONFIRM_USER | CONFIRM_DATE | MED_FLAGNAME | MEMO | CNT | EMPNO"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|승인|계산서|거래년월|번호|청구지|청구일|발행일|공급가액|부가세|계|승인자|승인일|매체구분|비고|상세행수|EMPNO"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | REAL_MED_NAME | CONFIRM_USER | MED_FLAGNAME | MEMO", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht_HDR, True, "CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | REAL_MED_NAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | CONFIRM_USER | MED_FLAGNAME | MEMO | CNT"
		...
		mobjSCGLSpr.SpreadLayout .sprSht_DTL, 18, 0, 0, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | REAL_MED_NAME | TITLE | MED_FLAGNAME | AMT | VAT | OUT_AMT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON"
		mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|매체사|계약명|매체구분명|금액|부가세|외주비|청구일자|비고|계산서년월|계산서번호|확정구분|신탁년월" 
		mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        8|	         6|	  0|   0|       4|	  12|    10|    14|        12|  10|     8|    10|      10|   9|         8|         6|       5|       8"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | AMT | VAT | OUT_AMT ", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | CLIENTNAME | REAL_MED_NAME | TITLE | MED_FLAGNAME | MEMO | TAXYEARMON | TAXNO | TRUST_YEARMON", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | REAL_MED_NAME | TITLE | MED_FLAGNAME | AMT | VAT | OUT_AMT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
		mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | TRUST_SEQ | CLIENTNAME | REAL_MED_NAME | TITLE | MED_FLAGNAME | AMT | VAT | OUT_AMT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON", False
		mobjSCGLSpr.ColHidden .sprSht_DTL, "PRINT_SEQ", True
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCAORCOMMI.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON,strREAL_MED_CODE)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDSCAORCOMMI.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		intRtn = mobjMDSCAORCOMMI.ProcessRtn_Confirm(gstrConfigXml, vntData)
...
Sub ProcessRtn_CONFIRM_CANCEL ()
	...
	with frmThis
		vntData = mobjMDSCAORCOMMI.SelectRtn_USER(gstrConfigXml,mlngRowCnt,mlngColCnt)
		...
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_HDR,"CHK | TRANSYEARMON | TRANSNO")
		intRtn = mobjMDSCAORCOMMI.ProcessRtn_Confirm_Cancel(gstrConfigXml, vntData)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="162" background="../../../images/back_p.gIF" border="0">
														<TR>
													...
													<TABLE id="tblButtonDTR" style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
														<TR>
															<TD><IMG id="imgExcelDTR" onmouseover="JavaScript:this.src='../../../images/imgExcelOn.gif'"
																	style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgExcel.gif'"
																	height="20" alt="자료를 엑셀로 받습니다." src="../../../images/imgExcel.gIF" border="0" name="imgExcelDTR">
															</TD>
														</TR>
													</TABLE>
												</TD>
