<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCOMMITINCOMELIST.aspx.vb" Inherits="MD.MDCMCOMMITINCOMELIST" %>
...
Sub InitPage()
    ...
    with frmThis
		...
		'Sheet Layout 디자인
		mobjSCGLSpr.SpreadLayout .sprSht, 20, 0,6
		
	    mobjSCGLSpr.SpreadDataField .sprSht, "YEARMON|VOCH_GBNNAME|CLIENTNAME|REAL_MED_NAME|CLIENTSUBNAME|SUBSEQNAME|MEDFLAGNAME|EXCLIENTCODE|AMT|COMMISSION|EXSUSU|MCSUSU|VAT|CLIENTCODE|REAL_MED_CODE|MEDFLAG|CLIENTSUBCODE|SUBSEQ|VOCH_GBN|COMMI_TAX_FLAG"
		mobjSCGLSpr.SetHeader .sprSht,        "년월|전표구분|광고주|매체사명|사업부|브랜드|매체구분|대행사코드|취급액|매출액|외주비|내수액|부가세|광고주코드|매체사코드|매체구분코드|사업부코드|브랜드코드|전표구분코드|부가세유무",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1","   7|      10|    18|      18|    18|    18|      10|         0|    15|    15|    15|    15|    15|         0|         0|           0|         0|         0|           0|         0"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT|COMMISSION|VAT|EXSUSU|MCSUSU", -1, -1, 0
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"YEARMON|VOCH_GBNNAME|CLIENTNAME|REAL_MED_NAME|CLIENTSUBNAME|SUBSEQNAME|MEDFLAGNAME|EXCLIENTCODE|AMT|COMMISSION|VAT|EXSUSU|MCSUSU|CLIENTCODE|REAL_MED_CODE|MEDFLAG|CLIENTSUBCODE|SUBSEQ|VOCH_GBN|COMMI_TAX_FLAG"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "YEARMON|VOCH_GBNNAME|MEDFLAGNAME",-1,-1,2,2,false
		mobjSCGLSpr.ColHidden .sprSht, "CLIENTCODE|REAL_MED_CODE|MEDFLAG|CLIENTSUBCODE|SUBSEQ|VOCH_GBN|COMMI_TAX_FLAG|EXCLIENTCODE", true
	End with
...
Sub SelectRtn()
	...
	'ON ERROR RESUME NEXT
		...
		IF .cmbCOMMITGBN.value = 0 THEN
			vntData = mobjMDSRREPORTLIST.SelectRtn_LOWINCOME(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON,strVOCH_GBN)

			if not gDoErrorRtn ("SelectRtn_LOWINCOME") then
		...
		ELSE
			vntData = mobjMDSRREPORTLIST.SelectRtn_REPORTINCOME(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON,strVOCH_GBN)

			if not gDoErrorRtn ("SelectRtn_REPORTINCOME") then
				mobjSCGLSpr.SetClipBinding .sprSht, vntData, 1, 1, mlngColCnt, mlngRowCnt, True
				mobjSCGLSpr.SetFlag  frmThis.sprSht,meCLS_FLAG
...
Sub SelectRtn_STATECHK()
	...
	'ON ERROR RESUME NEXT
		...
		vntData1 = mobjMDSRREPORTLIST.SelectRtn_STATECHKINCOME(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEAR)
...
Sub DeleteRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDSRREPORTLIST.DeleteRtn_INCOME(gstrConfigXml,strYEARMON)
		IF not gDoErrorRtn ("DeleteRtn_INCOME") then
...
Sub ProcessRtn
	...
	with frmThis
		...
		strYEARMON = mobjSCGLSpr.GetTextBinding(.sprSht,"YEARMON",1)
		vntData1 = mobjMDSRREPORTLIST.SelectRtn_EXISTREPORTINCOME(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON)
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"YEARMON|VOCH_GBNNAME|CLIENTNAME|REAL_MED_NAME|CLIENTSUBNAME|SUBSEQNAME|MEDFLAGNAME|EXCLIENTCODE|AMT|COMMISSION|EXSUSU|MCSUSU|VAT|CLIENTCODE|REAL_MED_CODE|MEDFLAG|CLIENTSUBCODE|SUBSEQ|VOCH_GBN|COMMI_TAX_FLAG")
		
		intRtn = mobjMDSRREPORTLIST.ProcessRtn_INCOME(gstrConfigXml,vntData)
		
		if not gDoErrorRtn ("ProcessRtn_INCOME") then 'EXCUTION_ProcessRtn ProcessRtn_Confirm_OK
			'모든 플래그 클리어
									...
									<TD class="KEYFRAME" style="WIDTH: 1040px; HEIGHT: 20px" vAlign="top" align="center">
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA">&nbsp;&nbsp;<INPUT id="rdT" title="확정내역조회" type="radio" value="rdT" name="rdGBN" CHECKED>&nbsp;전표확정&nbsp;&nbsp;&nbsp;&nbsp;
											...
											<TR>
												<TD align="left" width="400" height="20">
													<table cellSpacing="0" cellPadding="0" width="100%" border="0">
														...
														<tr>
															<td class="TITLE">&nbsp;리포트 매출기초자료 생성 및 조회</td>
														</tr>
													</table>
												</TD>
