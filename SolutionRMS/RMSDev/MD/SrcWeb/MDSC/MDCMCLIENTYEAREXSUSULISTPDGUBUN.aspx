<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEAREXSUSULISTPDGUBUN.aspx.vb" Inherits="MD.MDCMCLIENTYEAREXSUSULISTPDGUBUN" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>실적집계(제작매출)</title>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "JOBGUBUN|CLIENTNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "매체부문|구분(제작매출)|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|1분기|2분기|3분기|4분기|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "     15|            16| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|  11|    11|  11|    11|  12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "JOBGUBUN|CLIENTNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "JOBGUBUN|CLIENTNAME",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "JOBGUBUN"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEAREXSUSULISTPDGUBUN(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">											
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="210" background="../../../images/back_p.gIF"
														border="0">
														<TR>
											...
											<tr>
												<td class="TITLE">실적집계 (제작 매체부분별 외주비)</td>
											</tr>
										</table>
									</TD>
