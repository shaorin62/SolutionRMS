...
Sub CLIENTCODECHK_POP
	...
	'InitPage
	With frmThis
		vntInParams = array("", "MED") '<< 받아오는경우 '<< 받아오는경우
									...
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" width="100"><IMG id="imgCUSTPOP" onmouseover="JavaScript:this.src='../../../images/imgMedMultiChkOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgMedMultiChk.gIF'" height="20" alt="자료를 검색합니다."
