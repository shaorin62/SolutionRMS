<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTSUBCATVLIST.aspx.vb" Inherits="MD.MDCMCLIENTSUBCATVLIST" %>
...
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2009/12/19 By HWANGDUCKSU
'****************************************************************************************
-->
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "TIMNAME | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "구분|조정매체명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 10|        12| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10| 12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "TIMNAME | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "TIMNAME|",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDNAME",-1,-1,0,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "TIMNAME"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		Next
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTSUBCATVLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value, strLIST)

		if not gDoErrorRtn ("SelectRtn_CLIENTSUBCATVLIST") then
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"MEDNAME",intCnt) = "합계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"MEDNAME",intCnt) = "총합계" Then
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL" title="년도을삭제합니다." style="WIDTH: 80px; CURSOR: hand" onclick="vbscript:Call CleanField(txtYEARMON,'')">년&nbsp; 
												도
											</TD>
											...
											<TD class="SEARCHLABEL" width="80" style="CURSOR: hand" onclick="vbscript:Call CleanField(txtCLIENTNAME, txtCLIENTCODE)">광고주
											</TD>
