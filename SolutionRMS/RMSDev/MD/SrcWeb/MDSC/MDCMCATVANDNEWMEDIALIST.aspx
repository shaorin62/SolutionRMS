...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,        "구분|Category|케이블TV|||IPTV|위성DMB|Others|총집행금액"
		mobjSCGLSpr.SetHeader .sprSht,        "|MPP|CU미디어|CJ미디어|온미디어|브로드앤TV|TU||",SPREAD_HEADER + 1,1,true
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">CATV / New Media 집행비</td>
											</tr>
										</table>
									</TD>
									...
									<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtFYEARMON" title="년도을입력하세요" style="WIDTH: 80px; HEIGHT: 22px"
														type="text" maxLength="6" size="8" name="txtFYEARMON" accessKey="NUM"> ~ <INPUT class="INPUT" id="txtTYEARMON" title="년도을입력하세요" style="WIDTH: 88px; HEIGHT: 22px"
