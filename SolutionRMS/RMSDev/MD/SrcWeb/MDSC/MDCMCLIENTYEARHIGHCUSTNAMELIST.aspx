<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARHIGHCUSTNAMELIST.aspx.vb" Inherits="MD.MDCMCLIENTYEARHIGHCUSTNAMELIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>광고주별 실적-광고처</title>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "광고처|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   16| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|  12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CUSTNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME|",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CUSTNAME"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARHIGHCUSTNAMELIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strGBN)
