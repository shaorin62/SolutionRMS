...
Dim mobjMDCOGET, mobjMDSCREPORTLIST'공통코드, 클래스
Dim mClientsubcode
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjMDSCREPORTLIST	= gCreateRemoteObject("cMDSC.ccMDSCREPORTLIST")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CLIENTNAME|TIMNAME|SUBSEQNAME|MATTERNAME|PUB_DATE|MEDNAME|STD_STEP|DAN|STD_CM|COL_DEG|PUB_FACENAME|AMT|EXCLIENTNAME|DEMANDDAY|MEMO"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CLIENTNAME|TIMNAME|SUBSEQNAME|MATTERNAME|PUB_DATE|MEDNAME|STD_STEP|DAN|STD_CM|COL_DEG|PUB_FACENAME|AMT|EXCLIENTNAME|DEMANDDAY|MEMO"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MATTERNAME|MEDNAME|COL_DEG|PUB_FACENAME|DAN",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME|TIMNAME|SUBSEQNAME|MEMO|EXCLIENTNAME",-1,-1,0,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CLIENTNAME|TIMNAME|SUBSEQNAME"
...
Sub EndPage()
	...
	set mobjMDSCREPORTLIST = Nothing
	gEndPage
End Sub
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCREPORTLIST.SelectRtn_PUBYEARMONAMTLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value, .txtCLIENTCODE.value)
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MATTERNAME",intCnt),2) = "합계" Then
		...
		END IF
		If mobjSCGLSpr.GetTextBinding(.sprSht,"TIMNAME",intCnt) = "TOTAL" Then
