...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAGNAME",intCnt),2) = "소계" Then
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">월별 세부 매체별 광고비&nbsp;</td>
										</tr>
									</table>
								</TD>
								...
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" style="WIDTH: 424px" width="424"><INPUT class="INPUT" id="txtYEARMON" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px"
										...
										<tr>
											<TD class="SEARCHLABEL" style="CURSOR: hand">매체구분
											</TD>
											<TD class="SEARCHDATA" colSpan="4"><INPUT id="chkALL" type="checkbox" CHECKED name="chkALL">&nbsp;전체&nbsp;
												<INPUT id="chkMEDFLAG3" type="checkbox" name="chkMEDFLAG3">&nbsp;TV 
												<INPUT id="chkMEDFLAG4" type="checkbox" name="chkMEDFLAG4">&nbsp;Radio
												<INPUT id="chkMEDFLAG5" type="checkbox" name="chkMEDFLAG5">&nbsp;지상파DMB 
												<INPUT id="chkMEDFLAG6" type="checkbox" name="chkMEDFLAG6">&nbsp;CATV
												<INPUT id="chkMEDFLAG9" type="checkbox" name="chkMEDFLAG9">&nbsp;종합편성방송
												<INPUT id="chkMEDFLAG1" type="checkbox" name="chkMEDFLAG1">&nbsp;신문 
												<INPUT id="chkMEDFLAG2" type="checkbox" name="chkMEDFLAG2">&nbsp;잡지
												<INPUT id="chkMEDFLAG7" type="checkbox" name="chkMEDFLAG7">&nbsp;인터넷 
												<INPUT id="chkMEDFLAG8" type="checkbox" name="chkMEDFLAG8">&nbsp;옥외</TD>
										</tr>
									</TABLE>
								</TD>
							</TR>
