<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARCUSTCICLIST.aspx.vb" Inherits="MD.MDCMCLIENTYEARCUSTCICLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>광고주별 실적-광고주</title>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNAME | CICNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "광고주|CIC명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CUSTNAME | CICNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME | CICNAME",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CUSTNAME | CICNAME"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARCUSTCICLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strGBN)

		if not gDoErrorRtn ("SelectRtn_CLIENTYEARCUSTCICLIST") then
