<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARCUSTNAMELIST_POP.aspx.vb" Inherits="MD.MDCMCLIENTYEARCUSTNAMELIST_POP" %>
...
DIm mblnUseOnly,mstrUseDate,mstrGUBUN,mblnLikeCode
...
sub InitPage()
	...
	with frmThis
		...
		'기본값 설정
		mstrGUBUN = "": mblnUseOnly = true: mstrUseDate="" : mblnLikeCode = true
		
		for i = 0 to intNo
			select case i
				case 0 : .txtYEAR.value = vntInParam(i)	
				case 1 : .txtMONTH.value = vntInParam(i)
				case 2 : .txtCUSTNAME.value = vntInParam(i)			'조회추가필드
				case 3 : .txtTIMNAME.value = vntInParam(i)		'현재 사용중인 것만
				case 4 : mstrGUBUN = vntInParam(i)		'코드 사용 시점
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadLayout .sprSht, 2, 0, 0, 0,0
			mobjSCGLSpr.SpreadDataField .sprSht, "MEDFLAGNAME | SUMAMT "
			mobjSCGLSpr.SetHeader .sprSht, "매체구분|금액"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "10 |30"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEDFLAGNAME"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARCUSTNAMELIST_POP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, .txtMONTH.value, _
																		  trim(.txtCUSTNAME.value), trim(.txtTIMNAME.value), mstrGUBUN)
				...
				<TD>
					<FORM id="frmThis">
							...
							<TR>
								...
								<TD vAlign="middle" height="28">
									<TABLE class="" id="tblWaitP" style="Z-INDEX: 200; LEFT: 150px; VISIBILITY: hidden; WIDTH: 65px; POSITION: absolute; TOP: 0px; HEIGHT: 23px"
										cellSpacing="1" cellPadding="1" width="65" border="0">
										<TR>
									...
									<TABLE id="tblButton" style="HEIGHT: 20px" cellSpacing="0" cellPadding="0" border="0" align="right">
										<TR>
											<TD><IMG id="imgQuery" onmouseover="JavaScript:this.src='../../../images/imgQueryOn.gif'"
													style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgQuery.gif'"
													height="20" alt="자료를 조회합니다." src="../../../images/imgQuery.gif" width="54" border="0"
													name="imgQuery"></TD>
											<TD width="54"><IMG id="imgCancel" onmouseover="JavaScript:this.src='../../../images/imgCancelOn.gif'"
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="95%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" width="100%" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" width="392" cellSpacing="0" cellPadding="0" align="left"
											border="0">
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px;">
														년도</TD>
													<TD class="SEARCHDATA" width="100"><INPUT class="NOINPUT" id="txtYEAR" type="text" size="9" name="txtYEAR" style="WIDTH: 90px; HEIGHT: 22px"
															readOnly>&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px;">
														월</TD>
													<TD class="SEARCHDATA"><INPUT class="NOINPUT" id="txtMONTH" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
															name="txtMONTH" tabIndex="1" readOnly></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px;">
														광고주</TD>
													<TD class="SEARCHDATA" width="100"><INPUT class="NOINPUT_L" id="txtCUSTNAME" type="text" size="9" name="txtCUSTNAME" style="WIDTH: 90px; HEIGHT: 22px"
															readOnly>&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px;">
														팀</TD>
													<TD class="SEARCHDATA"><INPUT class="NOINPUT_L" id="txtTIMNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtTIMNAME" tabIndex="1" readOnly></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 100%; HEIGHT: 95%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											...
											<PARAM NAME="_ExtentX" VALUE="21749">
