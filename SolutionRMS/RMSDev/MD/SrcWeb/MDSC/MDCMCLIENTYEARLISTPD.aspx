<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARLISTPD.aspx.vb" Inherits="MD.MDCMCLIENTYEARLISTPD" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 18, 0, 2, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CLIENTNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "구분(제작매출)|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|1분기|2분기|3분기|4분기|총합계"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARLISTPD(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
