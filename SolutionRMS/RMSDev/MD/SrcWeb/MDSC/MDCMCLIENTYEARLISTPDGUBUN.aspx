<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARLISTPDGUBUN.aspx.vb" Inherits="MD.MDCMCLIENTYEARLISTPDGUBUN" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARLISTPDGUBUN(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">실적집계 (제작매체부분별 매출)</td>
											</tr>
										</table>
									</TD>
