<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARLIST.aspx.vb" Inherits="MD.MDCMCLIENTYEARLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strGBN)
										...
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtYEAR" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px" type="text"
													...
													<INPUT id="chkALL" type="radio" CHECKED value="Y" name="chkGBN">&nbsp;총액&nbsp;&nbsp;&nbsp;
													<INPUT id="chkREAL" type="radio" value="N" name="chkGBN">&nbsp;순액
												</TD>
											</TR>
										</TABLE>										
									</TD>
