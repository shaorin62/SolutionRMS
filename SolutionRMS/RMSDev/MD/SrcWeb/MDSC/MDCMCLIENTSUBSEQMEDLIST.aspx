<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTSUBSEQMEDLIST.aspx.vb" Inherits="MD.MDCMCLIENTSUBSEQMEDLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>부문별 실집행 광고비</title>
...
Sub CLIENTCODECHK_POP
	...
	'InitPage
	With frmThis
		vntInParams = array("", "CLIENT") '<< 받아오는경우 '<< 받아오는경우
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 17, 0, 4, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CLIENTNAME | SUBSEQ | MEDFLAG | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "광고주|조정브랜드|구분|조정매체명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   10|        12|  10|        10| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|   12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CLIENTNAME | SUBSEQ | MEDFLAG | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME | SUBSEQ | MEDFLAG | MEDNAME",-1,-1,2,2,false
		'mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDNAME",-1,-1,0,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CLIENTNAME | SUBSEQ | MEDFLAG | MEDNAME"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		Next
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTSUBSEQMEDLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value, strLIST)

		if not gDoErrorRtn ("SelectRtn_CLIENTSUBSEQMEDLIST") then
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAG",intCnt),2) = "요약" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&HCCFFFF, &H000000,False
		end if
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"SUBSEQ",intCnt),2) = "합계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"SUBSEQ",intCnt) = "총합계" Then
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												<TABLE cellSpacing="0" cellPadding="0" width="129" background="../../../images/back_p.gIF"
													border="0">
													<TR>
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL" title="년도을삭제합니다." style="WIDTH: 80px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON,'')">년&nbsp; 
												도
											</TD>
											...
											<TD class="SEARCHDATA" width="110"><IMG id="imgCUSTPOP" onmouseover="JavaScript:this.src='../../../images/imgCustMultiChkOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgCustMultiChk.gIF'" height="20" alt="자료를 검색합니다."
