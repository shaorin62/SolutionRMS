<%@ Page CodeBehind="MDCMAORCOMMITAX.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMAORCOMMITAX" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>AOR 수수료 세금계산서 발행</title> 
		<!--
'****************************************************************************************
...
Dim mobjMDCMAORCOMMITAX , mobjMDCOGET
Dim mstrCheck
Dim mstrGUBUN
CONST meTAB = 9
mstrGUBUN = ""
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			'md_trans_temp삭제 시작
			intRtn = mobjMDCMAORCOMMITAX.DeleteRtn_TEMP(gstrConfigXml)
			'md_trans_temp삭제 끝
			...
			for i=1 to .sprSht.MaxRows
				IF mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = "1" THEN
					...
					END IF
					strUSERID = ""
					vntDataTemp = mobjMDCMAORCOMMITAX.ProcessRtn_TEMP(gstrConfigXml,strTAXYEARMON, strTAXNO, VATFLAG, FLAG, i, strUSERID)
				END IF
			next
...
Sub REAL_MED_CODE1_POP
	...
	Dim vntInParams
	with frmThis
		vntInParams = array(.txtTRANSYEARMON1.value, .txtREAL_MED_CODE1.value, .txtREAL_MED_NAME1.value, "") 
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTAXREAL_MED_NO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON1.value,.txtREAL_MED_CODE1.value,.txtREAL_MED_NAME1.value, "")
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjMDCMAORCOMMITAX	= gCreateRemoteObject("cMDSC.ccMDSCAORCOMMITAX")
...
Sub EndPage()
	set mobjMDCMAORCOMMITAX = Nothing
...
Sub Grid_Setting (strGUBUN)
	With frmThis
		...
		If strGUBUN = "TAX" Then
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CHK | TAXYEARMON | TAXNO | TAXMANAGE | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | REAL_AMT | COMMI_RATE | AMT | VAT | SUMAMT | DEMANDDAY | SUMM | PRINTDAY | DEPT_NAME | REAL_MEDOWNER | REAL_MEDADDR1 | REAL_MEDADDR2 | VOCHNO"
			mobjSCGLSpr.SetHeader .sprSht,		 "선택|세금계산서년월|세금계산서번호|관리번호|매체사|매체사사업자번호|매체명|취급고|수수료율|수수료|부가세|합계금액|청구일|적요|발행일|담당부서|매체사대표자|주소1|주소2|전표번호"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|             0|             0|      10|    15|	           13|    12|    12|	   7|    13|    10|      13|     9|	 20|     9| 	  9|           0|    0|    0|     10"
			...
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TAXYEARMON | TAXNO | TAXMANAGE | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | SUMM | DEPT_NAME | VOCHNO", -1, -1, 100
			...
			mobjSCGLSpr.ColHidden .sprSht, "REAL_MEDOWNER | REAL_MEDADDR1| REAL_MEDADDR2", true
		...
		Else
			...
			mobjSCGLSpr.ColHidden .sprSht, "CLIENTOWNER | CLIENTADDR1| CLIENTADDR2 | REAL_MEDOWNER | REAL_MEDADDR1| REAL_MEDADDR2 | VOCHNO | TAXYEARMON | TAXNO | TRANSYEARMON | TRANSNO | SEQ | TRUST_YEARMON | TRUST_SEQ | CLIENTCODE | CLIENTACCODE | REAL_MED_CODE | REAL_MED_ACCODE | MEDCODE | DEPT_CD | MED_FLAG | RANKTRANS ", true
...
Sub SelectRtn ()
	...
	with frmThis
		...
		'세금계산서 완료조회
		If .rdT.checked = True Then
			vntData = mobjMDCMAORCOMMITAX.Get_AOR_TAX(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strREAL_MED_CODE, strFROM, strTO)
		...
		ElseIf .rdF.checked = True Then
			vntData = mobjMDCMAORCOMMITAX.Get_AOR_TAXBUILD(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strREAL_MED_CODE, strFROM, strTO, strGUBUN, strGROUPGBN)
			If not gDoErrorRtn ("Get_AOR_TAXBUILD") then
				'조회한 데이터를 바인딩
				call mobjSCGLSpr.SetClipBinding (frmThis.sprSht,vntData,1,1,mlngColCnt,mlngRowCnt,True)
				'초기 상태로 설정
				mobjSCGLSpr.SetFlag  frmThis.sprSht,meCLS_FLAG
		...
		ElseIf .rdA.checked = True Then
			vntData = mobjMDCMAORCOMMITAX.Get_AOR_TAXALL(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strREAL_MED_CODE, strFROM, strTO, strGUBUN, strGROUPGBN)
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intTAXNO = 0
		If .cmbGUBUN.value = "taxdiv" Then
			intRtn = mobjMDCMAORCOMMITAX.ProcessRtn_Div(gstrConfigXml,vntData, intTAXNO)
		Else
			...
			Else
				...
				Next
				'맥스값만 추가하여 보내기
				intRtn = mobjMDCMAORCOMMITAX.ProcessRtn_Group(gstrConfigXml,vntData, intTAXNO,intColFlag)
			End IF
		End If
	...
	with frmThis
		...
		for i = .sprSht.MaxRows to 1 step -1
			if mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 THEN
				...
				intRtn = mobjMDCMAORCOMMITAX.DeleteRtn_CommiTax(gstrConfigXml,strTAXYEARMON, strTAXNO)
							...
							<TR>
								<td align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">AOR 수수료 세금계산서 관리</td>
										</tr>
									</table>
								</td>
										...
										<TR>
											<TD align="left" width="400" height="20">
												<table height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
													<tr>
														<td class="TITLE">수수료합계 : <INPUT class="NOINPUTB_R" id="txtSUMAMT" title="합계금액" style="WIDTH: 120px; HEIGHT: 20px"
