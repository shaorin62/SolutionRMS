<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEAREXSUSULIST.aspx.vb" Inherits="MD.MDCMCLIENTYEAREXSUSULIST" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 19, 0, 2, 0,0
		mobjSCGLSpr.AddCellSpan  .sprSht, 1, SPREAD_HEADER, 2, 1
		mobjSCGLSpr.SpreadDataField .sprSht, "MEDFLAG | AMTGBN |A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "구분|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|1분기|2분기|3분기|4분기|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 10|7|10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|  11|    11|  11|    11|  12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "MEDFLAG | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | Q1 | Q2 | Q3 | Q4 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDFLAG",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "MEDFLAG"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEAREXSUSULIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAG",intCnt) = "소계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&HCCFFFF, &H000000,False
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAG",intCnt) = "합계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAG",intCnt) = "총합계" Then
