<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARCUSTTIMNAMELIST.aspx.vb" Inherits="MD.MDCMCLIENTYEARCUSTTIMNAMELIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>광고주 팀별 매체별</title>
...
Sub GetCLIENTSUBLIST (strCLIENTCODE)
	...
	with frmThis
		...
		strHTML = "" 
		mClientsubcode = ""
		vntData = mobjMDSRREPORTLIST.GetCLIENTSUBLIST3(gstrConfigXml,mlngRowCnt,mlngColCnt,strCLIENTCODE, .txtYEAR.value)
		if not gDoErrorRtn ("GetCLIENTSUBLIST3") then
...
Sub InitPage()
    ...
    With frmThis
       gSetSheetColor mobjSCGLSpr, .sprSht
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "MEDDIV | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "매체구분|매체명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "      8|    16| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|  12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "MEDDIV | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDDIV | MEDNAME",-1,-1,2,2,false
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARCUSTTIMNAMELIST(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtYEAR.value, .txtCLIENTCODE.value, strSUBLIST)
									...
									<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
										<TABLE class="searchDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA" width="424" style="WIDTH: 424px"><INPUT class="INPUT" id="txtYEAR" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px" accessKey="NUM"
