<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARMEDEXSUSULIST.aspx.vb" Inherits="MD.MDCMCLIENTYEARMEDEXSUSULIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>실적집계 (제작대행수수료)</title>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARMEDEXSUSULIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">실적집계(제작대행 수수료)</td>
											</tr>
										</table>
									</TD>
