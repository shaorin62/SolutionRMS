<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTYEARINCOMEPROFIT.aspx.vb" Inherits="MD.MDCMCLIENTYEARINCOMEPROFIT" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>실적집계 (매출이익)</title>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "GUBUN | MEDFLAGNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "구 분|매체구분|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   9|      10| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|   12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "MEDFLAGNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDFLAGNAME | GUBUN",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "GUBUN"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTYEARINCOME_PROFIT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)
		
		if not gDoErrorRtn ("SelectRtn_CLIENTYEARBILLING") then
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		elseIf mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAGNAME",intCnt) = "합계" Then
