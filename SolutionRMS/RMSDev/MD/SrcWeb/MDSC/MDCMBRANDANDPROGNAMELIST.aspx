<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMBRANDANDPROGNAMELIST.aspx.vb" Inherits="MD.MDCMBRANDANDPROGNAMELIST" %>
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		ModuleDir = "MD"
		ReportName = "MDCMBRANDAGENCYLIST.rpt"
		
		strYEARMON		= .txtYEAR.value
		strCLIENTCODE	= .txtCLIENTCODE.value
		
		Params = strYEARMON & ":" & strCLIENTCODE
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 18, 0, 5, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CLIENTNAME | MEDFLAGNAME | TIMNAME | SUBSEQNAME | MATTERNAME | A1 | A2 | A3 | A4 | A5 | A6 | A7 | A8 | A9 | A10 | A11 | A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "광고주|매체|사업부|브랜드|소재명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|TOTAL"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   10|  10|    10|    10|    10| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|  11"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CLIENTNAME | MEDFLAGNAME | TIMNAME | SUBSEQNAME | MATTERNAME | A1 | A2 | A3 | A4 | A5 | A6 | A7 | A8 | A9 | A10 | A11 | A12 | SUMAMT"
		'mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME | MEDFLAGNAME",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME | MEDFLAGNAME | TIMNAME | SUBSEQNAME | MATTERNAME",-1,-1,0,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CLIENTNAME | MEDFLAGNAME | TIMNAME|SUBSEQNAME"
...
Sub InitPageData
	...
	'초기 데이터 설정
	with frmThis
		.txtYEAR.value = Mid(gNowDate2,1,4)
		'Sheet초기화
		.sprSht.MaxRows = 0
		.txtYEAR.focus()
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.SelectRtn_BRANDANDPROGNAMELIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, .txtCLIENTCODE.value)
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"SUBSEQNAME",intCnt),2) = "요약" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&HCCFFFF, &H000000,False
		END IF
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"TIMNAME",intCnt),2) = "요약" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		END IF
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAGNAME",intCnt),2) = "요약" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&HA4F9F9, &H000000,False
		End If
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MEDFLAGNAME",intCnt),2) = "합계" Then
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">ATL브랜드별/소재별 광고비</td>
											</tr>
										</table>
									</TD>
									...
									<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA" style="WIDTH: 424px" width="424"><INPUT class="INPUT" id="txtYEAR" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px" accessKey="NUM"
