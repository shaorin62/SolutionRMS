<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTSUBPRINTLIST.aspx.vb" Inherits="MD.MDCMCLIENTSUBPRINTLIST" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CLIENTNAME | TIMNAME | MED_FLAGNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "광고주|구분|매체|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CLIENTNAME | TIMNAME | MED_FLAGNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME | TIMNAME | MED_FLAGNAME",-1,-1,2,2,false
		'mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDNAME",-1,-1,0,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht, "CLIENTNAME | TIMNAME | MED_FLAGNAME"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		Next
		vntData = mobjMDSRREPORTLIST.SelectRtn_CLIENTSUBPRINTLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value, strLIST)
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MED_FLAGNAME",intCnt),2) = "소계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&HCCFFFF, &H000000,False
		end if
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"TIMNAME",intCnt),2) = "합계" Then
