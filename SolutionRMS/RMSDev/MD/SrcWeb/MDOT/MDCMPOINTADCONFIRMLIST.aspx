<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPOINTADCONFIRMLIST.aspx.vb" Inherits="MD.MDCMPOINTADCONFIRMLIST" %>
...
Sub sprSht_Keyup(KeyCode, Shift)
	...
	With frmThis 
		If .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT") or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"EXSUSU") OR _
		   .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"OCB_AMT") OR .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"KAKAO_AMT") Then
			...
			ELSEIF .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"EXSUSU") Then
				strCOLUMN = "EXSUSU"
			ELSEIF .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"OCB_AMT") Then
				strCOLUMN = "OCB_AMT"
			ELSEIF .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"KAKAO_AMT") Then
				strCOLUMN = "KAKAO_AMT"
			End If
			...
			FOR i = 0 TO intSelCnt -1
				If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT")) OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"EXSUSU")) OR _
										    (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"OCB_AMT")) OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"KAKAO_AMT")) Then
...
Sub InitPage()
	'서버업무객체 생성									
	set mobjPOINTADCONFIRM	= gCreateRemoteObject("cMDOT.ccMDOTPOINTADCONFIRM")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | CONFIRMGBN | GBN | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTNAME | DEPT_NAME | AMT | EXCLIENTCODE | EXCLIENTNAME | EXSUSU | OCB_AMT | KAKAO_AMT | CUSTNAME | MEMO"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|승인유무|구분|년월|번호|캠패인코드|캠패인명|광고주|담당부서|월청구액|대행사코드|대행사명|대행수수료|OCB리워드|KAKAO금액|청구지명|비고"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|       5|   4|   5|   4|         8|      15|    15|      15|      10|         8|      12|         8|        8|        8|      12|  10"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "18"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK "
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "SEQ | AMT | EXSUSU | OCB_AMT | KAKAO_AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "CONFIRMGBN | GBN | YEARMON | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTNAME | DEPT_NAME | EXCLIENTCODE | EXCLIENTNAME | CUSTNAME | MEMO", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CONFIRMGBN | GBN | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTNAME | DEPT_NAME | AMT | EXCLIENTCODE | EXCLIENTNAME | EXSUSU | OCB_AMT | KAKAO_AMT | CUSTNAME | MEMO"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CONFIRMGBN | GBN | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTNAME | DEPT_NAME | EXCLIENTCODE | EXCLIENTNAME | CUSTNAME | MEMO",-1,-1,2,2,false
		mobjSCGLSpr.CellGroupingEach .sprSht,"CAMPAIGN_CODE"
...
Sub EndPage()
	set mobjPOINTADCONFIRM = Nothing
...
Sub SelectRtn ()
	...
	with frmThis
		...
		strCAMPAIGN_CODE	= .txtCAMPAIGN_CODE.value
		...
		vntData = mobjPOINTADCONFIRM.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												strYEARMON, strCLIENTCODE, strCLIENTNAME , _
												strCAMPAIGN_CODE, strCAMPAIGN_NAME)
...
Sub ProcessRtn_ConfirmOK
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK | CONFIRMGBN | GBN | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTNAME | DEPT_NAME | AMT | EXCLIENTCODE | EXCLIENTNAME | EXSUSU | OCB_AMT | KAKAO_AMT | CUSTNAME | MEMO")
		
		intRtn = mobjPOINTADCONFIRM.ProcessRtn(gstrConfigXml,vntData,strUSER,"CONFIRM")
...
Sub ProcessRtn_ConfirmCancel
	...
	with frmThis
		...
		intRtn = mobjPOINTADCONFIRM.ProcessRtn(gstrConfigXml,vntData,strUSER,"CANCEL")
							...
							<TR>
								<td style="WIDTH: 400px" height="28" width="400" align="left">
									<table border="0" cellSpacing="0" cellPadding="0" width="100%">
										...
										<tr>
											<td id="tblTitleName" class="TITLE">포인트AD 청약확정</td>
										</tr>
									</table>
								</td>
								...
								<TD class="KEYFRAME" vAlign="middle" align="left">
									<TABLE id="tblKey" class="SEARCHDATA" border="0" cellSpacing="1" cellPadding="0" width="100%">
										<TR>
											...
											<TD style="CURSOR: hand" class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtCAMPAIGN_NAME,'')"
												width="50">캠페인명</TD>
											<TD style="WIDTH: 130px" class="SEARCHDATA"><INPUT style="WIDTH: 160px; HEIGHT: 22px" id="txtCAMPAIGN_NAME" class="INPUT_L" title="캠페인명"
													maxLength="100" size="22" name="txtCAMPAIGN_NAME">
											<TD style="CURSOR: hand" class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtCAMPAIGN_CODE,'')"
												width="100">캠페인 코드</TD>
											<TD style="WIDTH: 86px" class="SEARCHDATA"><INPUT style="WIDTH: 80px; HEIGHT: 22px" id="txtCAMPAIGN_CODE" class="INPUT_L" title="캠페인 코드"
													maxLength="10" size="6" name="txtCAMPAIGN_CODE"></TD>
