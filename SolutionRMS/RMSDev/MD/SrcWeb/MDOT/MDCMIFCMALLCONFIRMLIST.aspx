<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMIFCMALLCONFIRMLIST.aspx.vb" Inherits="MD.MDCMIFCMALLCONFIRMLIST" %>
...
Sub sprSht_Keyup(KeyCode, Shift)
	...
	With frmThis 
		If .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT") or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"MC_AMT") OR _
		   .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"EX_AMT") Then
			...
			FOR i = 0 TO intSelCnt -1
				If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT")) OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"MC_AMT")) OR _
										    (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"EX_AMT")) Then
...
Sub InitPage()
	'서버업무객체 생성									
	set mobjIFCMALLCONFIRM	= gCreateRemoteObject("cMDOT.ccMDOTIFCMALLCONFIRM")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | CONFIRMGBN | GBN | YEARMON | SEQ | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_NAME | ALL_AMT | EXCLIENTCODE | EXCLIENTNAME | AMT | MC_AMT | EX_AMT | CUSTNAME | MEMO"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|확정구분|구분|년월|순번|계약코드|계약명|광고주코드|광고주명|담당부서명|총매출액|대행사코드|대행사명|매출액|MC금액|대행분배금&수수료|청구지명|비고"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|       5|   8|   5|   4|       8|    15|         8|      15|        15|      12|         0|      12|    12|    12|               10|      12|  10"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "18"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK "
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "ALL_AMT | AMT | MC_AMT | EX_AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "CONFIRMGBN | GBN | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_NAME | EXCLIENTCODE | EXCLIENTNAME | CUSTNAME | MEMO", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "CONFIRMGBN | GBN | YEARMON | SEQ | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_NAME | ALL_AMT | EXCLIENTCODE | EXCLIENTNAME | AMT | MC_AMT | EX_AMT | CUSTNAME | MEMO"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CHK | CONFIRMGBN | GBN | YEARMON | SEQ | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_NAME | EXCLIENTCODE | EXCLIENTNAME | CUSTNAME | MEMO",-1,-1,2,2,false
...
Sub EndPage()
	set mobjIFCMALLCONFIRM = Nothing
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjIFCMALLCONFIRM.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_ConfirmOK
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK | CONFIRMGBN | GBN | YEARMON | SEQ | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_NAME | AMT | EXCLIENTCODE | EXCLIENTNAME | AMT | MC_AMT | EX_AMT | CUSTNAME | MEMO")
		
		intRtn = mobjIFCMALLCONFIRM.ProcessRtn(gstrConfigXml,vntData,strUSER,"CONFIRM")
...
Sub ProcessRtn_ConfirmCancel
	...
	with frmThis
		...
		intRtn = mobjIFCMALLCONFIRM.ProcessRtn(gstrConfigXml,vntData,strUSER,"CANCEL")
							...
							<TR>
								<td style="WIDTH: 400px" height="28" width="400" align="left">
									<table border="0" cellSpacing="0" cellPadding="0" width="100%">
										...
										<tr>
											<td id="tblTitleName" class="TITLE">IFC MALL 청약확정</td>
										</tr>
									</table>
								</td>
