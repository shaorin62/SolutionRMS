<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORMONREALLIST.aspx.vb" Inherits="MD.MDCMOUTDOORMONREALLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCEXECUTE.SelectRtn_OUTDOORMONREALLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)

		if not gDoErrorRtn ("SelectRtn_OUTDOORMONREALLIST") then
