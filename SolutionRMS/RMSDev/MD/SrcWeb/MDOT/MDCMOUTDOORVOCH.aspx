...
Sub sprSht_OUT_Change(ByVal Col, ByVal Row)
	...
	with frmThis
		...
		'이지은씨 요청사항 전표일자와 지급일이 90 일 초과 할경우 메세지 박스 띄워주기
		if Col = mobjSCGLSpr.CnvtDataField(.sprSht_OUT,"DEMANDDAY") then
			IF datediff("D",mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"POSTINGDATE", Row),mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"DEMANDDAY", Row)) > 90 THEN
				gErrorMsgBox "전표일자와 지급일의 차이가 90일을 초과 하였습니다.","확인 요함."
			End if
		end if
...
Sub InitPage()
    ...
    with frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht_SUSU,		    "선택|전표일자|거래처코드|거래처|적요|금액|부가세|세무코드|BP|지급기일|광고주지급일|구분|증빙일|선수금구분|선수금(시작일)|선수금(종료일)|본문TEXT|RMS년월|RMS번호|전표번호|에러코드|에러메세지|GFLAG|AMTGBN|MEDFLAG|VOCH_TYPE"
									...
									<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center" colSpan="2">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA" width="190"><INPUT class="INPUT_L" id="txtCLIENTNAME" title="광고주명" style="WIDTH: 112px; HEIGHT: 22px"
												...
												<TD class="SEARCHLABEL" style="WIDTH: 28px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME, txtTIMCODE)"
													width="28">팀</TD>
												<TD class="SEARCHDATA" width="190"><INPUT class="INPUT_L" id="txtTIMNAME" title="팀명" style="WIDTH: 112px; HEIGHT: 22px" type="text"
														...
														border="0" name="ImgTIMCODE1"> <INPUT class="INPUT_L" id="txtTIMCODE" title="팀코드" style="WIDTH: 53px; HEIGHT: 22px" type="text"
												...
												<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtREAL_MED_NAME" title="매체사명" style="WIDTH: 112px; HEIGHT: 22px"
														...
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" src="../../../images/imgPopup.gIF" align="absMiddle" border="0"
														name="ImgREAL_MED_CODE"> <INPUT class="INPUT_L" id="txtREAL_MED_CODE" title="매체사코드" style="WIDTH: 53px; HEIGHT: 22px"
											...
											<TR>
												...
												<TD class="DATA"><INPUT class="INPUT_L" id="txtSUMM" title="적요적용" style="WIDTH: 368px; HEIGHT: 21px" type="text"
													...
													<DIV id="pnlFLAG" style="VISIBILITY: hidden; WIDTH: 250px; POSITION: absolute; HEIGHT: 24px"
														...
														&nbsp; <INPUT id="rdSUM" title="합산" type="radio" value="rdSUM" name="rdDIVGUBUN">&nbsp;합산&nbsp;
													</DIV>
												</TD>
											</TR>
										</TABLE>
