<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLOUDCONFLIST.aspx.vb" Inherits="MD.MDCMCLOUDCONFLIST" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 거래명세서 승인 화면(MDCMCLOUDCONFLIST.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMCLOUDCONFLIST.aspx
'기      능 : 거래명세서 승인
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_DTL, "CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | CGV_AMT | DEMANDDAY | PRINTDAY | MEMO"
		mobjSCGLSpr.SetHeader .sprSht_DTL,		"광고주|공급가액|부가세|계|MC매출|사내수익|CGV비용|청구일|발행일|비고"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | CGV_AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "CLIENTNAME | MEMO", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | CGV_AMT | DEMANDDAY | PRINTDAY | MEMO" 
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDOTCLOUDCOMMI.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDOTCLOUDCOMMI.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		intRtn = mobjMDOTCLOUDCOMMI.ProcessRtn_Confirm(gstrConfigXml, vntData)
...
Sub ProcessRtn_CONFIRM_CANCEL ()
	...
	with frmThis
		...
		vntData = mobjMDOTCLOUDCOMMI.SelectRtn_USER(gstrConfigXml,mlngRowCnt,mlngColCnt)
		...
		intRtn = mobjMDOTCLOUDCOMMI.ProcessRtn_Confirm_Cancel(gstrConfigXml, vntData)
