<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORCOMMIAL.aspx.vb" Inherits="MD.MDCMOUTDOORCOMMIAL" %>
...
Dim mobjMDOTOUTDOORCOMMI, mobjMDCOGET, mobjSCCOGET
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		If .txtYEARMON1.value = "" Then
			gErrorMsgBox "인쇄할 년월을 입력 하십시오.","저장안내!"
			Exit Sub
		End If
		
		ModuleDir = "MD"

		ReportName = "MDCMOUTDOOR_TRANS_CONFIRM.rpt"
		
		Params = .txtYEARMON1.value
		Opt = "A"
...
Sub imgPrint_onclick ()
	...
	With frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDOTOUTDOORCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		
		ModuleDir = "MD"
		ReportName = "MDCMOUTDOORCOMMI_NEW.rpt"
		...
		strUSERID = ""
		vntData = mobjMDOTOUTDOORCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub printSetTimeout(strTRANSYEARMON, strTRANSNO)
	...
	With frmThis
		intRtn = mobjMDOTOUTDOORCOMMI.DeleteRtn_temp(gstrConfigXml)
		'intRtn2 = mobjMDOTOUTDOORCOMMI.DeleteRtnUpdate_PRINTSEQ(gstrConfigXml, strTRANSYEARMON, strTRANSNO)
	End With
End Sub
...
Sub ProcessRtn_Confirm_User ()
	...
	with frmThis
		...
		IF intSaveRtn = vbYes then 
			...
			intRtn = mobjMDOTOUTDOORCOMMI.ProcessRtn_Confirm_User(gstrConfigXml,vntData,.txtEMPNO.value)
...
Sub sprSht_DTL_Keyup(KeyCode, Shift)
	...
	With frmThis
		If mstrGrid Then
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
				...
				ElseIF .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") Then
					strCOLUMN = "VAT"
				ElseIF .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"OUT_AMT") Then
					strCOLUMN = "OUT_AMT"
				End If
		...
		Else
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
			   .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"OUT_AMT") OR .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"COMMISSION") Then
				strSUM = 0
				intSelCnt = 0
				intSelCnt1 = 0
				strCOLUMN = ""
				...
				FOR i = 0 To intSelCnt -1
					If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT")) OR _
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT")) OR _ 
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"OUT_AMT")) OR _
	...
	With frmThis
		If mstrGrid Then
			If Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") Then
				...
				intRtn = mobjMDOTOUTDOORCOMMI.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			End If
		End If
	End With
End Sub
...
Sub InitPage()
	...
	Dim intNo,i
	'서버업무객체 생성	
	set mobjMDOTOUTDOORCOMMI= gCreateRemoteObject("cMDOT.ccMDOTOUTDOORCOMMI")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | CONFIRM_USER | CONFIRM_DATE | MED_FLAGNAME | MEMO | CNT"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|요청|승인|계산서|거래년월|번호|광고주|청구일|발행일|공급가액|부가세|계|승인자|승인일|매체구분|비고|상세행수"
		mobjSCGLSpr.SetColWidth .sprSht_HDR, "-1", "  4|   4|   4|     6|       8|   5|    15|     8|     8|      10|    10|10|    10|     9|       8|  15|      7"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | CLIENTNAME | CONFIRM_USER | MED_FLAGNAME | MEMO", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht_HDR, True, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | CONFIRM_USER | MED_FLAGNAME | MEMO | CNT"
...
Sub EndPage()
	set mobjMDOTOUTDOORCOMMI = Nothing
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 28, 0, 0, 2
			mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_NAME | HIGHSUBSEQNAME | TITLE | MATTERNAME | MED_GBN | AMT | OUT_AMT | COMMISSION | COMMI_RATE | VAT | LOCATION | TBRDSTDATE | TBRDEDDATE | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON | VOCH_TYPE"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|팀|외주처|외주처|브랜드|계약명|소재명|제작종류|월금액|외주비|내수액|내수율|부가세|장소|시작일|종료일|청구일자|비고|계산서년월|계산서번호|확정구분|신탁년월|VOCH_TYPE" 
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        0|	         0|	  4|   0|       4|	   0|12|     0|    13|    10|    15|    15|      10| 	 9|     9|     9|     5|     9|  15|     8|     8|       8|  12|         0|         0|	     0|       0|		0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht_DTL, "TBRDSTDATE | TBRDEDDATE | DEMANDDAY", -1, -1, 10
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "COMMI_RATE", -1, -1, 2
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | AMT | OUT_AMT | COMMISSION | VAT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_NAME | HIGHSUBSEQNAME | TITLE | MATTERNAME | MED_GBN | LOCATION | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON | VOCH_TYPE", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_NAME | HIGHSUBSEQNAME | TITLE | MATTERNAME | MED_GBN | AMT | OUT_AMT | COMMISSION | COMMI_RATE | VAT | LOCATION | TBRDSTDATE | TBRDEDDATE | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_NAME | HIGHSUBSEQNAME | TITLE | MATTERNAME | MED_GBN | AMT | OUT_AMT | COMMISSION | COMMI_RATE | VAT | LOCATION | TBRDSTDATE | TBRDEDDATE | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_NAME | HIGHSUBSEQNAME | TITLE | MATTERNAME | MED_GBN | AMT | OUT_AMT | COMMISSION | COMMI_RATE | VAT | LOCATION | TBRDSTDATE | TBRDEDDATE | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON", False
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | PRINT_SEQ | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON | MEDNAME | HIGHSUBSEQNAME | MATTERNAME | VOCH_TYPE", true
		Else
			'Sheet 기본Color 지정
			gSetSheetDefaultColor() 
			'******************************************************************
			...
			'******************************************************************
			gSetSheetColor mobjSCGLSpr, .sprSht_DTL
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 34, 0, 1, 0,0
			mobjSCGLSpr.SpreadDataField .sprSht_DTL,   "CHK | YEARMON | SEQ | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION | COMMI_RATE | LOCATION | TBRDSTDATE | TBRDEDDATE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | MEMO | TRANSCUSTRANK"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|매체구분코드|광고주코드|광고주명|팀코드|팀명|브랜드코드|브랜드명|외주처코드|외주처|외주처코드|외주처명|계약명|소재명|제작종류|총금액|월금액|부가세|계|외주비|내수액|내수율|장소|시작일|종료일|담당부서코드|일반구분|외주처코드|전표구분|부가세유무|비고|광고주별생성순번"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|           0|         0|     15|      0|  12|         0|      10|         0|     0|         0|      12|    12|    13|       8|     9|     9|     9| 9|    9|      9|     5|  10|     8|     8|           0|       0|         0|       0|         0|  12|               0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht_DTL, "CHK"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht_DTL, "TBRDSTDATE | TBRDEDDATE", -1, -1, 10
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "SEQ | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION", -1, -1, 0
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "COMMI_RATE", -1, -1, 2
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "YEARMON | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | LOCATION | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | MEMO | TRANSCUSTRANK", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "CHK | YEARMON | SEQ | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION | COMMI_RATE | LOCATION | TBRDSTDATE | TBRDEDDATE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | MEMO | TRANSCUSTRANK" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "YEARMON | SEQ | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION | COMMI_RATE | LOCATION | TBRDSTDATE | TBRDEDDATE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | TRANSCUSTRANK" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "CHK | YEARMON | SEQ | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION | COMMI_RATE | LOCATION | TBRDSTDATE | TBRDEDDATE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | MEMO | TRANSCUSTRANK", False
			mobjSCGLSpr.ColHidden .sprSht_DTL, "YEARMON | MED_FLAG | CLIENTCODE | TIMCODE | HIGHSUBSEQ | MEDCODE | MEDNAME | REAL_MED_CODE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | TRANSCUSTRANK", True
...
Sub ProcessRtn_CUST ()
	...
	With frmThis
		...
		'On error resume next
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_DTL,"CHK | YEARMON | SEQ | MED_FLAG | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | HIGHSUBSEQ | HIGHSUBSEQNAME | MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME | TITLE | MATTERNAME | MED_GBN | TOTALAMT | AMT | VAT | SUMAMTVAT | OUT_AMT | COMMISSION | COMMI_RATE | LOCATION | TBRDSTDATE | TBRDEDDATE | DEPT_CD | GBN_FLAG | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | MEMO | TRANSCUSTRANK")
		...
		intRtn = mobjMDOTOUTDOORCOMMI.ProcessRtn_CUST(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjMDOTOUTDOORCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		mlngColCnt=clng(0)
   		...
   		vntData2 = mobjMDOTOUTDOORCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												strYEARMON, strCLIENTCODE, strTIMCODE)
...
Sub SelectRtn_DTL (Col, Row)
	...
	With frmThis
		...
		vntData = mobjMDOTOUTDOORCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
	...
	With frmThis
		...
		For i = 1 To .sprSht_HDR.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDOTOUTDOORCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDOTOUTDOORCOMMI.DeleteRtn(gstrConfigXml,vntData)
