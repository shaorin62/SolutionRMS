<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPOINTADCONFLIST.aspx.vb" Inherits="MD.MDCMPOINTADCONFLIST" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 거래명세서 승인 화면(MDCMPOINTADCONFLIST.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMPOINTADCONFLIST.aspx
'기      능 : 거래명세서 승인
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
sub sprSht_EXCEL_DblClick (ByVal Col, ByVal Row)
	with frmThis
		if Row = 0 and Col >0 then
			mobjSCGLSpr.SetSheetSortUser  .sprSht_EXCEL, ""
		end if
	end with
end sub
...
Sub sprSht_HDR_Keyup(KeyCode, Shift)
	...
	If KeyCode = 17 or KeyCode = 33 or KeyCode = 34 or KeyCode = 35 or KeyCode = 36 or KeyCode = 38 or KeyCode = 40 Then
		...
		SelectRtn_EXCEL frmThis.sprSht_HDR.ActiveCol,frmThis.sprSht_HDR.ActiveRow
	End If
End Sub
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht_HDR, 18, 0, 0, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | CONFIRM_USER | CONFIRM_DATE | MED_FLAGNAME | MEMO | CNT | EMPNO | CAMPAIGN_CODE"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|승인|계산서|거래년월|번호|광고주|청구일|발행일|공급가액|부가세|계|승인자|승인일|매체구분|비고|상세행수|EMPNO|캠페인코드"
		mobjSCGLSpr.SetColWidth .sprSht_HDR, "-1", "  4|   4|     6|       8|   5|    15|     8|     8|      10|    10|10|    10|     9|      12|  15|       7|    0|         0"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | CLIENTNAME | CONFIRM_USER | MED_FLAGNAME | MEMO | CAMPAIGN_CODE", -1, -1, 200
		...
		mobjSCGLSpr.SpreadLayout .sprSht_DTL, 10, 0, 0, 2
		mobjSCGLSpr.SpreadDataField .sprSht_DTL, "CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | DEMANDDAY | PRINTDAY | MEMO"
		mobjSCGLSpr.SetHeader .sprSht_DTL,		"광고주|공급가액|부가세|계|MC매출|사내수익|KAKAO비용|청구일|발행일|비고"
		mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", " 20|	  10|	 10|10|    10|      10|       10|    10|    10|  15"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "CLIENTNAME | MEMO", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | DEMANDDAY | PRINTDAY | MEMO" 
		
		gSetSheetColor mobjSCGLSpr, .sprSht_EXCEL
		mobjSCGLSpr.SpreadLayout .sprSht_EXCEL, 13, 0, 0, 2
		mobjSCGLSpr.SpreadDataField .sprSht_EXCEL, "POINTNO | CHN | CLIENTNAME | EXCLIENTNAME | ADEXCLIENTNAME | CLIENT_TYPE | TITLE | TDATE | EDATE | SAND_STATUS | SAND_DATE | PAY_YN | AMT "
		mobjSCGLSpr.SetHeader .sprSht_EXCEL,	   "순번|채널|광고주명|대행사명|영업사명|광고타입|광고명|이벤트시작일|이벤트종료일|발송상태|발송일자|입금여부|금액"
		mobjSCGLSpr.SetColWidth .sprSht_EXCEL, "-1", " 4|   8|      10|      10|      10|       8|    10|           8|           8|      10|      10|       6|  10"
		mobjSCGLSpr.SetRowHeight .sprSht_EXCEL, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht_EXCEL, "0", "15"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht_EXCEL, "TDATE | EDATE", -1, -1, 10
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_EXCEL, "AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_EXCEL, "POINTNO | CHN | CLIENTNAME | EXCLIENTNAME | ADEXCLIENTNAME | CLIENT_TYPE | TITLE | SAND_STATUS | SAND_DATE | PAY_YN ", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht_EXCEL, true, "POINTNO | CHN | CLIENTNAME | EXCLIENTNAME | ADEXCLIENTNAME | CLIENT_TYPE | TITLE | TDATE | EDATE | SAND_STATUS | SAND_DATE | PAY_YN | AMT" 

		.sprSht_HDR.style.visibility = "visible"
		.sprSht_DTL.style.visibility = "visible"
		.sprSht_EXCEL.style.visibility = "visible"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub SelectRtn_EXCEL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_TransList_EXCEL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
																strTRANSYEARMON, strTRANSNO, strCAMPAIGN_CODE)
													
		If not gDoErrorRtn ("SelectRtn_TransList_EXCEL") Then
			If mlngRowCnt >0 Then
				'조회시 입금여부를 체크박스로 변경한다.
				mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht_EXCEL, "PAY_YN"
				Call mobjSCGLSpr.SetClipBinding (.sprSht_EXCEL,vntData,1,1,mlngColCnt,mlngRowCnt,True)
				
   				gWriteText lblStatusEXCEL, mlngRowCnt & "건의 자료가 검색" & mePROC_DONE
   			else
   				gWriteText lblStatusEXCEL, mlngRowCnt & "건의 자료가 검색" & mePROC_DONE
   				.sprSht_EXCEL.MaxRows = 0
   			End If
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		intRtn = mobjMDOTPOINTADCOMMI.ProcessRtn_Confirm(gstrConfigXml, vntData)
...
Sub ProcessRtn_CONFIRM_CANCEL ()
	...
	with frmThis
		...
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_USER(gstrConfigXml,mlngRowCnt,mlngColCnt)
		...
		intRtn = mobjMDOTPOINTADCOMMI.ProcessRtn_Confirm_Cancel(gstrConfigXml, vntData)
...
-->
									...
									<TD class="LISTFRAME" style="WIDTH: 100%; HEIGHT: 30%" vAlign="top" align="center">
										<DIV id="pnlTab1" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
											...
											<OBJECT id="sprSht_HDR" style="WIDTH: 100%; HEIGHT: 100%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
												...
												<PARAM NAME="_ExtentY" VALUE="4154">
								...
								<TR>
									<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="top" align="center">
										<TABLE height="28" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/TitleBG.gIF"
											border="0"> <!--background="../../../images/TitleBG.gIF"-->
											<tr>
												<td class="TITLE" style="WIDTH: 50%">1) 거래명세서 상세 내역</td>
												<td class="TITLE" style="WIDTH: 50%">2) 애디 EXCLE 데이터</td>
											</tr>
										</TABLE>
									</TD>
								</TR>
									...
									<TD style="WIDTH: 100%; HEIGHT: 100%" vAlign="top" align="left">
										<TABLE border="0" cellSpacing="1" cellPadding="0" width="100%" align="left" height="98%">
											<tr>
												<TD style="WIDTH: 50%; HEIGHT: 100%" vAlign="top" align="left">
													<DIV id="pnlTab2" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
														...
														<OBJECT id="sprSht_DTL" style="WIDTH: 100%; HEIGHT: 100%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
															...
															<PARAM NAME="_ExtentY" VALUE="9684">
															<PARAM NAME="_StockProps" VALUE="64">
															<PARAM NAME="Enabled" VALUE="-1">
															<PARAM NAME="AllowCellOverflow" VALUE="0">
															<PARAM NAME="AllowDragDrop" VALUE="0">
												...
												<TD style="WIDTH: 50%; HEIGHT: 100%" vAlign="top" align="right">
													<DIV id="pnlTab3" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
														ms_positioning="GridLayout">
														<OBJECT id=sprSht_EXCEL height="100%" width="100%" classid=clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5>
	<PARAM NAME="_Version" VALUE="393216">
	<PARAM NAME="_ExtentX" VALUE="31856">
	...
	<PARAM NAME="OLEDropMode" VALUE="0">
											...
											<TR>
												<TD class="BOTTOMSPLIT" id="lblStatusDTL" style="WIDTH: 50%"></TD>
												<TD class="BOTTOMSPLIT" id="lblStatusEXCEL" style="WIDTH: 50%"></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
