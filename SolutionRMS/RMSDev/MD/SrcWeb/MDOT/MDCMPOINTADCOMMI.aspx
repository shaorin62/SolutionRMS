<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPOINTADCOMMI.aspx.vb" Inherits="MD.MDCMPOINTADCOMMI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>포인트 친구 AD  거래명세서</title>
		<meta content="False" name="vs_snapToGrid">
		<META http-equiv="Content-Type" content="text/html; charset=ks_c_5601-1987">
		<!--
'****************************************************************************************
'시스템구분 : 위수탁거래명세서 등록 화면(MDCMPOINTADCOMMI.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMPOINTADCOMMI.aspx
'기      능 : 수수료거래명세서 입력/삭제 처리
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
Dim mobjMDOTPOINTADCOMMI, mobjMDCOGET, mobjSCCOGET
...
Sub imgPrint_onclick ()
	...
	With frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDOTPOINTADCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		
		ModuleDir = "MD"
		ReportName = "MDCMPOINTADCOMMI.rpt"
		...
		strUSERID = ""
		vntData = mobjMDOTPOINTADCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub ProcessRtn_Confirm_User ()
	...
	with frmThis
		...
		IF intSaveRtn = vbYes then 
			...
			intRtn = mobjMDOTPOINTADCOMMI.ProcessRtn_Confirm_User(gstrConfigXml,vntData,.txtEMPNO.value)
...
Sub CLIENTCODE1_POP
	...
	With frmThis
		vntInParams = array(.txtYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "commi", "POINTAD") 
...
Sub txtCLIENTNAME1_onkeydown
	If window.event.keyCode = meEnter Then
		...
		With frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtCLIENTCODE1.value,.txtCLIENTNAME1.value,"","commi", "OUTDOOR")
...
Sub TIMCODE1_POP
	...
	With frmThis
		vntInParams = array(trim(.txtYEARMON1.value), trim(.txtCLIENTCODE1.value), trim(.txtCLIENTNAME1.value), _
							trim(.txtTIMCODE1.value), trim(.txtTIMNAME1.value), "commi", "OUTDOOR") 
...
Sub sprSht_HDR_DblClick (ByVal Col, ByVal Row)
	...
	With frmThis
		...
		if Row > 0 and Col >1 then
			IF mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"REQUEST_USER",Row) = "" AND mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CONFIRMFLAG",Row) = "" THEN
			
				vntInParams = array(mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"TRANSYEARMON", Row),mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"TRANSNO", Row), _ 
									mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CAMPAIGN_CODE", Row)) '<< 받아오는경우
									
				gShowModalWindow "../MDOT/MDCMPOINTADEXCEL.aspx",vntInParams , 898,680
				gFlowWait meWAIT_ON
				SelectRtn
				gFlowWait meWAIT_OFF
				
			ELSE
				gErrorMsgBox "승인 요청 하지 않은 데이터만 상세 내역을 확인 저장 하실 수 있습니다."," 상세 내역 안내!"
				Exit sub
			END IF 
		END IF 
	...
	With frmThis
		If mstrGrid Then
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
				.sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"KAKAO_AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"TIM_AMT") OR _
				.sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"MC_AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"SUMAMTVAT") Then
				...
				FOR i = 0 To intSelCnt -1
					If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT")) OR _
												...
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"KAKAO_AMT"))OR _ 
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"MC_AMT"))OR _ 
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"TIM_AMT"))OR _ 
		...
		Else
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
			   .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"KAKAO_AMT") OR .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"MC_AMT") OR _
			   .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"TIM_AMT") OR .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"SUMAMTVAT") Then
	...
	With frmThis
		If mstrGrid Then
			If Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") Then 
				...
				intRtn = mobjMDOTPOINTADCOMMI.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			End If
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | REQUEST_USER | REQUEST_DATE | CONFIRM_USER | CONFIRM_DATE | MED_FLAGNAME | MEMO | CNT | CAMPAIGN_CODE"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|요청|승인|계산서|거래년월|번호|광고주|청구일|발행일|공급가액|부가세|계|요청자|요청일|승인자|승인일|매체구분|비고|상세행수|캠페인코드"
		mobjSCGLSpr.SetColWidth .sprSht_HDR, "-1", "  4|   4|   4|     6|       8|   5|    15|     8|     8|      10|    10|10|    10|     9|    10|     9|      12|  15|       7|         0"
		...
		mobjSCGLSpr.SetCellTypeDate2 .sprSht_HDR, "DEMANDDAY | PRINTDAY | REQUEST_DATE | CONFIRM_DATE", -1, -1, 10
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_HDR, "TRANSNO | AMT | VAT | SUMAMTVAT | CNT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | CLIENTNAME | CONFIRM_USER | REQUEST_USER | MED_FLAGNAME | MEMO | CAMPAIGN_CODE", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht_HDR, True, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | REQUEST_USER | CONFIRM_USER | MED_FLAGNAME | MEMO | CNT | CAMPAIGN_CODE"
		mobjSCGLSpr.SetCellAlign2 .sprSht_HDR, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | MED_FLAGNAME | REQUEST_USER | CONFIRM_USER" ,-1,-1,2,2,False
		mobjSCGLSpr.ColHidden .sprSht_HDR, "CAMPAIGN_CODE", true
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 18, 0, 0, 2
			mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|월금액|부가세|계|MC금액|사내수익|KAKAO금액|청구일자|비고|계산서년월|계산서번호|확정구분|신탁년월" 
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        9|	         5|	  5|   0|       4|	  15|    10|    10|10|    10|      10|     10|       8|  15| 	      9|         9|       9|      5"
			...
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | AMT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | VAT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | CLIENTNAME | MEMO | TAXYEARMON | CONFIRMFLAG | TRUST_YEARMON", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | KAKAO_AMT | VAT | SUMAMTVAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | KAKAO_AMT | VAT | SUMAMTVAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | KAKAO_AMT | VAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON", False
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRUST_YEARMON | CONFIRMFLAG", true
		Else
			'Sheet 기본Color 지정
			gSetSheetDefaultColor() 
			'******************************************************************
			...
			'******************************************************************
			gSetSheetColor mobjSCGLSpr, .sprSht_DTL
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 19, 0, 1, 0,0
			mobjSCGLSpr.SpreadDataField .sprSht_DTL,   "CHK | YEARMON | SEQ | DEMANDDAY | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|청구일자|캠페인코드|캠페인명|광고주코드|광고주명|부서코드|부서명|월청구액|부가세|계|MC매출|사내수익|KAKAO비용|비고|COMMI_TAX_FLAG|TRANSCUSTRANK"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|       0|         0|      15|         0|      15|       0|    12|      10|    10|10|    10|      10|       10|  15|             0|           0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht_DTL, "CHK"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht_DTL, "DEMANDDAY", -1, -1, 10
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "SEQ | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "YEARMON | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "CHK | YEARMON | SEQ | DEMANDDAY | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "YEARMON | SEQ | DEMANDDAY | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "CHK | YEARMON | SEQ | DEMANDDAY | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK", False
			mobjSCGLSpr.ColHidden .sprSht_DTL, "YEARMON | CLIENTCODE | DEPT_CD | COMMI_TAX_FLAG | TRANSCUSTRANK", True
		End If
...
Sub SelectRtn ()
	...
	With frmThis
		...
		CALL Grid_Setting()
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		If not gDoErrorRtn ("SelectRtn_HDR") Then
			If mlngRowCnt >0 Then
				Call mobjSCGLSpr.SetClipBinding (.sprSht_HDR,vntData,1,1,mlngColCnt,mlngRowCnt,True)
   				...
   				for i =1 to .sprSht_HDR.maxRows 
					if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"REQUESTGBN",i) = "0" and mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CONFIRMGBN",i) = "" then
						mobjSCGLSpr.SetTextBinding .sprSht_HDR,"CONFIRM_USER",i, ""
						mobjSCGLSpr.SetTextBinding .sprSht_HDR,"CONFIRM_DATE",i, ""	
   					end if 
   				next 
   			Else
   				gWriteText lblStatus, mlngRowCnt & "건의 자료가 검색" & mePROC_DONE
   		...
   		'거래명세서 끊기 전 청약 내역 조회
   		mlngRowCnt=clng(0) : mlngColCnt=clng(0)
   		vntData2 = mobjMDOTPOINTADCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
																strYEARMON, strCLIENTCODE)
...
Sub SelectRtn_DTL (Col, Row)
	...
	With frmThis
		...
		vntData = mobjMDOTPOINTADCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CUST ()
	...
	With frmThis
		...
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_DTL,"CHK | YEARMON | SEQ | DEMANDDAY | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | TIM_AMT | KAKAO_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK")
		...
		intRtn = mobjMDOTPOINTADCOMMI.ProcessRtn_CUST(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
	...
	With frmThis
		...
		For i = 1 To .sprSht_HDR.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDOTPOINTADCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDOTPOINTADCOMMI.DeleteRtn(gstrConfigXml,vntData)
...
-->
	...
	<body class="base">
								...
								<TD id="tblSheet2" style="WIDTH: 100%; HEIGHT: 60%" vAlign="top" align="center">
									<DIV id="pnlTab2" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
										...
										DESIGNTIMEDRAGDROP="213" >
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="31856">
											<PARAM NAME="_ExtentY" VALUE="8546">
											<PARAM NAME="_StockProps" VALUE="64">
											<PARAM NAME="Enabled" VALUE="-1">
											<PARAM NAME="AllowCellOverflow" VALUE="0">
											<PARAM NAME="AllowDragDrop" VALUE="0">
		...
		<iframe id="frmSMS" style="WIDTH: 500px;HEIGHT: 500px; DISPLAY: none;" name="frmSMS">
		</iframe>
	</body>
</HTML>
