<%@ Page CodeBehind="MDCMOUTDOORTRANSGUNLIST.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMOUTDOORTRANSGUNLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>옥외 거래명세 조회</title> 
		<!--
'****************************************************************************************
...
Sub txtTRANSNO_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "commi", "OUTDOOR")
...
Sub TRU_POP
	...
	strYEARMON = .txtTRANSYEARMON.value
	End If
		vntInParams = array(strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "commi", "OUTDOOR") '<< 받아오는경우
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 20, 0, 0, 0
		mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON|TRANSNO|SEQ|CLIENTCODE|CLIENTNAME|MEDCODE|MEDNAME| REAL_MED_CODE | REAL_MED_NAME|DEPT_CD|DEMANDDAY|PRINTDAY|AMT|SUSURATE |SUSU|VAT|MED_FLAG|TAXYEARMON|TAXNO|TRUST_SEQ"
		
		mobjSCGLSpr.SetHeader .sprSht,		 "년월|번호|순번|광고주코드|광고주명|매체코드|매체명|매체사코드|매체사|부서코드|청구일|발행일|금액|수수료율|수수료|부가세|매체종류|세금계산서년월|번호|신탁순번"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 0|	  0|   0|	      0|      10|       0|	  10|         0|    10|       0|    10|     0|  10|       8|     8|     8|       8|             0|   0|      0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "PRINTDAY|DEMANDDAY", -1, -1, 10
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, " AMT| VAT |SUSU", -1, -1, 0
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, " SUSURATE", -1, -1, 2
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CLIENTNAME|MEDNAME|REAL_MED_NAME|MED_FLAG", -1, -1, 20
		mobjSCGLSpr.ColHidden .sprSht, "TRANSYEARMON|TRANSNO|SEQ|CLIENTCODE|MEDCODE|REAL_MED_CODE|DEPT_CD|PRINTDAY|TAXYEARMON|TAXNO|TRUST_SEQ ", true
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strCUSTCODE)
	...
	vntData = mobjMDCMOUTDOORCOMMI.Get_OUTDOORCOMMI_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE)
...
Function SelectRtn_DTL (ByVal strYEARMON,ByVal strTRANSNO, ByVal strCUSTCODE, ByVal strCLIENTSUBCODE)
	...
	vntData = mobjMDCMOUTDOORCOMMI.Get_OUTDOORCOMMI_LIST2(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE)
