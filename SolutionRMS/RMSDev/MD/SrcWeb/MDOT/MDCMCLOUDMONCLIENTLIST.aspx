...
'프로그램명 : MDCMCLOUDMONCLIENTLIST.aspx
'기      능 : 월간 광고주별 집행내역
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,        "광고주|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If mobjSCGLSpr.GetTextBinding(.sprSht,"CLIENTNAME",intCnt) = "합계" Then
								...
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" style="WIDTH: 113px"><INPUT class="INPUT" id="txtYEAR" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px" accessKey="NUM"
