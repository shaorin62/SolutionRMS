<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOOR_REPORT.aspx.vb" Inherits="MD.MDCMOUTDOOR_REPORT" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>옥외 데이터 보고서 생성</title>
		<META http-equiv="Content-Type" content="text/html; charset=ks_c_5601-1987">
		<!--
'****************************************************************************************
'시스템구분 : MD/부킹 화면(OUTDOOR)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMOUTDOOR_REPORT.aspx
'기      능 : 옥외 데이터 보고서 를 위한 데이터 생성
'파라  메터 : 
...
Dim mobjOUTDOOR_REPORT, mobjMDCOGET 
Dim mstrCheck
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjOUTDOOR_REPORT	= gCreateRemoteObject("cMDOT.ccMDOTOUTDOOR_REPORT")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 30, 0, 3, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | YEARMON | SEQ | GUBUN | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | REAL_MED_CODE | REAL_MED_NAME | REAL_MED_BISNO | MED_FLAG | DEMANDDAY | TBRDSTDATE | TBRDEDDATE | GBN_FLAG | TITLE | MATTERNAME | TOTALAMT | AMT | OUT_AMT | COMMI_RATE | COMMISSION | MED_GBN | LOCATION | MEMO | VOCH_TYPE | COMMI_TRANS_NO | TRU_VOCH_NO | ATTR01"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|년월|번호|구분|광고주코드|광고주|팀코드|팀|외주처코드|외주처|사업자번호|매체구분코드|청구일자|계약시작일|계약종료일|매출구분|계약명|소재명|총계약금액|월청구금액|월외주비|내수율|내수액|제작종류|장소|비고|청구구분|거래명세서번호|매입전표번호|상세번호"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|   5|   0|   5|         0|    13|     0|10|         0|    13|        13|           0|       8|         8|         8|       9|    15|    15|        10|        10|      10|     6|     9|      10|  10|  10|       0|             0|           0|       0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "18"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK "
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "YEARMON | GUBUN | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | REAL_MED_CODE | REAL_MED_NAME | REAL_MED_BISNO | MED_FLAG | GBN_FLAG | TITLE | MATTERNAME | MED_GBN | LOCATION | MEMO | ATTR01", -1, -1, 100
...
Sub EndPage()
	set mobjOUTDOOR_REPORT = Nothing
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjOUTDOOR_REPORT.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, _
											   strCLIENTCODE, _
											   strREAL_MED_CODE, _
											   strTIMCODE, strTITLE)
		...
		If not gDoErrorRtn ("SelectRtn") Then
			If mlngRowCnt >0 Then
				...
				mobjSCGLSpr.SetCellsLock2 .sprSht,True,strRows,2,32,True
   				...
   				mobjSCGLSpr.SetCellsLock2 .sprSht, False, " DEMANDDAY | TBRDSTDATE | TBRDEDDATE | TOTALAMT | AMT | OUT_AMT | COMMI_RATE | COMMISSION | LOCATION | MEMO"
...
Sub ProcessRtn ()
	...
	With frmThis
		...
		intRtn = mobjOUTDOOR_REPORT.ProcessRtn(gstrConfigXml,vntData)
		...
		for i = .sprSht.MaxRows to 1 step -1
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 Then
				...
				If dblSEQ = "" Then
					...
					intRtn = mobjOUTDOOR_REPORT.DeleteRtn(gstrConfigXml, strYEARMON,dblSEQ)
							...
							<TR>
								<TD align="left" width="400" height="20">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">옥외 보고서 데이터 관리</td>
										</tr>
									</table>
								</TD>
								...
								<TD style="WIDTH: 100%; HEIGHT: 120px" vAlign="top" align="center">
									<TABLE class="DATA" id="tblHidden" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTBRDSTDATE, txtTBRDEDDATE)"
												width="50">계약기간</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtAMT, '')"
												width="50">금액</TD>
											<TD class="DATA">
										...
										<TR>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTITLE, '')">계약명</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTOTALAMT, '')">총금액</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtOUT_AMT, '')">외주비</TD>
											<TD class="DATA">
										...
										<TR>
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call ggCleanField(txtTIMNAME, txtTIMCODE)">팀</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtMATTERNAME, '')">소재명</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtLOCATION, '')">장소</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCOMMI_RATE, '')">내수율</TD>
											<TD class="DATA">
										...
										<TR>
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_NAME, txtREAL_MED_CODE)">매체사</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtMED_GBN, '')">제작종류</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtMEMO, '')">비고</TD>
											...
											<TD class="LABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCOMMISSION, '')">내수액</TD>
											<TD class="DATA">
