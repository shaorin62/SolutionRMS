<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORREALMEDLIST.aspx.vb" Inherits="MD.MDCMOUTDOORREALMEDLIST" %>
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSROUTDOORMULTILIST.SelectRtn_OUTDOORClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
		
		If not gDoErrorRtn ("SelectRtn_OUTDOORClientGroup") then
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSROUTDOORMULTILIST.GetOUTDOORREAL_MED_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
		
		mvntDataCustCNT = mlngRowCnt
		If not gDoErrorRtn ("GetOUTDOORREAL_MED_CNT") then
			If mlngRowCnt > 0 Then 
				'필드 고정값세팅
				Dim strField
