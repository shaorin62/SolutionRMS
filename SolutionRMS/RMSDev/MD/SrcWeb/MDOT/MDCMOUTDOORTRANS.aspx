<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORTRANS.aspx.vb" Inherits="MD.MDCMOUTDOORTRANS" %>
...
Dim mobjMDCMOUTDOORTRANS, mobjMDCMGET
Dim mstrCheck
Dim mALLCHECK
Dim mstrChk
mALLCHECK = TRUE
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCMOUTDOORTRANS.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		vntData = mobjMDCMOUTDOORTRANS.Get_OUTDOORTRANS_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON,strTRANSNO)
		
		strcntsum = 0
		IF not gDoErrorRtn ("Get_OUTDOORTRANS_CNT") then
			...
			for i=1 to 1
				strUSERID = ""
				vntDataTemp = mobjMDCMOUTDOORTRANS.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, datacnt, strUSERID)
			next
		End IF
		Params = strUSERID
		Opt = "A"
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCMOUTDOORTRANS	= gCreateRemoteObject("cMDOT.ccMDOTOUTDOORTRANS")
...
Sub EndPage()
	set mobjMDCMOUTDOORTRANS = Nothing
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCMOUTDOORTRANS.ProcessRtn(gstrConfigXml,strMasterData,vntData,intTRANSNO,strTRANSYEARMON,intColFlag)
...
Sub SelectRtn ()
	...
	with frmThis
		...
		ELSE
			...
			vntData = mobjMDCMOUTDOORTRANS.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON, strCLIENTCODE)
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strCLIENTCODE)
	...
	vntData = mobjMDCMGET.Get_OUTDOORTRANS_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCLIENTCODE)
...
Function SelectRtn_DTL (ByRef strYEARMON,ByRef strTRANSNO, ByRef strCLIENTCODE)
	...
	vntData = mobjMDCMGET.Get_OUTDOORTRANS_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCLIENTCODE)
...
Sub DeleteRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCMOUTDOORTRANS.DeleteRtn(gstrConfigXml,vntData, strTRANSYEARMON, strTRANSNO)
									...
									<TR>
										<TD style="WIDTH: 300px" align="left" width="427" height="28">
											<table cellSpacing="0" cellPadding="0" width="100%" border="0">
												...
												<tr>
													<td class="TITLE">옥외광고&nbsp;위수탁거래명세 생성 및 발행</td>
												</tr>
											</table>
										</TD>
