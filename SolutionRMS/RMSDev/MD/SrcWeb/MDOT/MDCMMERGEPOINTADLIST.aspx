<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMERGEPOINTADLIST.aspx.vb" Inherits="MD.MDCMMERGEPOINTADLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>포인트 친구AD 통합청구 이동</title>
...
Sub InitPage()
	'서버업무객체 생성									
	set mobjMDCOMERGE		= gCreateRemoteObject("cMDCO.ccMDCOMERGE")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 11, 0, 3, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | TAXYEARMON | TAXNO | MEDFLAG | CLIENTNAME | CLIENTBISNO | AMT | VAT | SUMAMT | SUMM | VOCHNO"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|년월|번호|구분|광고주|사업자번호|금액|부가세|합계|적요|전표번호"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|  10|   6|   0|    20|        15|  11|    11|  11|  25|     13"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "18"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "TAXNO | AMT | VAT | SUMAMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TAXYEARMON | MEDFLAG | CLIENTNAME | CLIENTBISNO | SUMM | VOCHNO", -1, -1, 100
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "TAXYEARMON | TAXNO | MEDFLAG | CLIENTNAME | CLIENTBISNO | AMT | VAT | SUMAMT | SUMM | VOCHNO"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "TAXYEARMON | CLIENTBISNO | VOCHNO",-1,-1,2,2,false
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOMERGE.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		if not gDoErrorRtn ("SelectRtn") then
			...
			For i = 1 to .sprSht.maxrows
				IF mobjSCGLSpr.GetTextBinding(.sprSht,"VOCHNO",i) <> "" THEN
					mobjSCGLSpr.SetCellsLock2 frmThis.sprSht,True,"CHK",i,i,false '전표번호가 있으면 체크 잠금
				Else
					mobjSCGLSpr.SetCellsLock2 frmThis.sprSht,false,"CHK",i,i,false '전표번호가 있으면 체크 해제
				End if 
			next
...
Sub ProcessRtn_MergeSave
	...
	with frmThis
		...
		intRtn = mobjMDCOMERGE.ProcessRtn_MERGE(gstrConfigXml,vntData)
...
Sub ProcessRtn_MergeDelete
	...
	with frmThis
		...
		End If
   		...
   		For intCnt = 1 to .sprSht.MaxRows
   			IF mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",intCnt) = "1" THEN
				...
				vntData = mobjMDCOMERGE.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, mobjSCGLSpr.GetTextBinding( .sprSht,"TAXYEARMON",intCnt), mobjSCGLSpr.GetTextBinding( .sprSht,"TAXNO",intCnt), mobjSCGLSpr.GetTextBinding( .sprSht,"MEDFLAG",intCnt)) 
		...
		intRtn = mobjMDCOMERGE.ProcessRtn_MERGE_CANCEL(gstrConfigXml,vntData)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="188" background="../../../images/back_p.gIF"
														border="0">
														<TR>
