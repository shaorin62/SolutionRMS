<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORREALMEDLIST2.aspx.vb" Inherits="MD.MDCMOUTDOORREALMEDLIST2" %>
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjEXECUTE.SelectRtn_OUTDOORClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjEXECUTE.GetOUTDOORCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
