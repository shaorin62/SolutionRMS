<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPOINTADTAXDTL.aspx.vb" Inherits="MD.MDCMPOINTADTAXDTL" %>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDOTPOINTADTAX	= gCreateRemoteObject("cMDOT.ccMDOTPOINTADTAX")
...
Sub EndPage()
	set mobjMDOTPOINTADTAX = Nothing
	gEndPage
End Sub
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDOTPOINTADTAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDOTPOINTADTAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		intRtn = mobjMDOTPOINTADTAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
							...
							<TR>
								<TD style="WIDTH: 427px" align="left" width="427" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">&nbsp;포인트 친구 AD&nbsp;세금계산서</td>
										</tr>
									</table>
								</TD>
