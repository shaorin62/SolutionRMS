<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLOUDLIST.aspx.vb" Inherits="MD.MDCMCLOUDLIST" %>
...
Sub sprSht_Keydown(KeyCode, Shift)
	...
	If KeyCode = meINS_ROW Then
		...
		mobjSCGLSpr.SetTextBinding frmThis.sprSht,"TIM_RATE",frmThis.sprSht.ActiveRow, "30"
...
'-----------------------------------------------------------------------------------------
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|광고유형|계약코드|계약명|광고주코드|광고주|시작일|종료일|총계약금액|사내수익배분율|CGV배분율|비고"
		mobjSCGLSpr.SetColWidth .sprSht, "-1","  4|       8|       7|   20|	         7|2|  18|     9|     9|        10|             8|        8|  15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
		mobjSCGLSpr.SetCellTYpeButton2 .sprSht,"..", "BTN"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "TOTAL_AMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "TIM_RATE | CGV_RATE", -1, -1, 2
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "TBRDSTDATE | TBRDEDDATE", -1, -1, 10
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "CONT_TYPE | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | MEMO", -1, -1, 200
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjMDOTCLOUDCONTRACT.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strCLIENTCODE, strTITLE, strCONT_TYPE)
...
Sub ProcessRtn ()
	...
	With frmThis
		...
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK | CONT_TYPE | CONT_CODE | CONT_NAME | CLIENTCODE | BTN | CLIENTNAME | TBRDSTDATE | TBRDEDDATE | TOTAL_AMT | TIM_RATE | CGV_RATE | MEMO")
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">CGV 클라우드 정산확정</td>
										</tr>
									</table>
								</TD>
								...
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="top" align="left">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
										...
										<TR>
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTITLE1, '')"
												width="70">계약명</TD>
											<TD class="SEARCHDATA" width="220"><INPUT class="INPUT_L" id="txtTITLE1" title="계약명" style="WIDTH: 216px; HEIGHT: 22px" type="text"
													maxLength="100" size="30" name="txtTITLE1"></TD>
