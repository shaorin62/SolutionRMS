<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMIFCMALLCOMMI.aspx.vb" Inherits="MD.MDCMIFCMALLCOMMI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>IFC MALL 거래명세서</title>
		<meta content="False" name="vs_snapToGrid">
		<META http-equiv="Content-Type" content="text/html; charset=ks_c_5601-1987">
		<!--
'****************************************************************************************
'시스템구분 : 위수탁거래명세서 등록 화면(MDCMIFCMALLCOMMI.aspx)
...
Dim mobjMDOTIFCMALLCOMMI, mobjMDCOGET, mobjSCCOGET
...
Sub imgPrint_onclick ()
	...
	With frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDOTIFCMALLCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		
		ModuleDir = "MD"
		ReportName = "MDCMIFCMALLCOMMI.rpt"
		...
		strUSERID = ""
		vntData = mobjMDOTIFCMALLCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub CLIENTCODE1_POP
	...
	With frmThis
		vntInParams = array(.txtYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "commi", "OUTDOOR") 
	...
	With frmThis
		If mstrGrid Then
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
				.sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"EX_AMT") OR _
				...
				ElseIF .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") Then
					strCOLUMN = "VAT"
				ElseIF .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"MC_AMT") Then
					strCOLUMN = "MC_AMT"
				ElseIF .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"EX_AMT") Then
					strCOLUMN = "EX_AMT"
				...
				FOR i = 0 To intSelCnt -1
					If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT")) OR _
												...
												(vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"EX_AMT"))OR _ 
		...
		Else
			If .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"AMT") or .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"VAT") OR _
			   .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"MC_AMT") OR _
			   .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"EX_AMT") OR .sprSht_DTL.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"SUMAMTVAT") Then
	...
	With frmThis
		If mstrGrid Then
			If Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") Then 
				...
				intRtn = mobjMDOTIFCMALLCOMMI.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			End If
		End If
	End With
End Sub
...
Sub InitPage()
	...
	Dim intNo,i
	'서버업무객체 생성	
	set mobjMDOTIFCMALLCOMMI  = gCreateRemoteObject("cMDOT.ccMDOTIFCMALLCOMMI")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | REQUEST_USER | REQUEST_DATE | CONFIRM_USER | CONFIRM_DATE | MED_FLAGNAME | MEMO | CNT | GUBUN"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|요청|승인|계산서|거래년월|번호|광고주|청구일|발행일|공급가액|부가세|계|요청자|요청일|승인자|승인일|매체구분|비고|상세행수|GUBUN"
		mobjSCGLSpr.SetColWidth .sprSht_HDR, "-1", "  4|   4|   4|     6|       8|   5|    15|     8|     8|      10|    10|10|    10|     9|    10|     9|       8|  15|       7|    0"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | CLIENTNAME | CONFIRM_USER | REQUEST_USER | MED_FLAGNAME | MEMO | GUBUN", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht_HDR, True, "REQUESTGBN | CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | TRANSNO | CLIENTNAME | DEMANDDAY | PRINTDAY | AMT | VAT | SUMAMTVAT | REQUEST_USER | CONFIRM_USER | MED_FLAGNAME | MEMO | CNT | GUBUN"
...
Sub EndPage()
	set mobjMDOTIFCMALLCOMMI = Nothing
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 17, 0, 0, 2
			mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|월금액|부가세|계|MC금액|대행분배금|청구일자|비고|계산서년월|계산서번호|확정구분|신탁년월" 
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        9|	         5|	  5|   4|       4|	  15|    10|    10|10|    10|        10|       8|  15| 	      9|         9|       9|      5"
			...
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | AMT | SUMAMTVAT | MC_AMT | EX_AMT | VAT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | CLIENTNAME | MEMO | TAXYEARMON | CONFIRMFLAG | TRUST_YEARMON", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | VAT | SUMAMTVAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | VAT | SUMAMTVAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | AMT | VAT | DEMANDDAY | MEMO | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON", False
		...
		Else
			...
			mobjSCGLSpr.SpreadDataField .sprSht_DTL,   "CHK | YEARMON | SEQ | GUBUN | DEMANDDAY | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|GUBUN|청구일자|계약코드|계약명|광고주코드|광고주명|부서코드|부서명|월청구액|부가세|계|MC매출|대행분배금|비고|COMMI_TAX_FLAG|TRANSCUSTRANK"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|    0|       0|      0|     15|         0|      15|       0|    12|      10|    10|10|    10|        10|  15|             0|           0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht_DTL, "CHK"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht_DTL, "DEMANDDAY", -1, -1, 10
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "SEQ | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "YEARMON | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, False, "CHK | YEARMON | SEQ | DEMANDDAY | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, True, "YEARMON | SEQ | GUBUN | DEMANDDAY | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | SUMAMTVAT | MC_AMT | EX_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "CHK | YEARMON | SEQ | DEMANDDAY | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK", False
			mobjSCGLSpr.ColHidden .sprSht_DTL, "YEARMON | GUBUN | CLIENTCODE | DEPT_CD | COMMI_TAX_FLAG | TRANSCUSTRANK", True
		End If
...
Sub ProcessRtn_CUST ()
	...
	With frmThis
		...
		'On error resume next
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_DTL,"CHK | YEARMON | SEQ | GUBUN | DEMANDDAY | CONT_CODE | CONT_NAME | CLIENTCODE | CLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT | SUMAMTVAT | MC_AMT | EX_AMT | MEMO | COMMI_TAX_FLAG | TRANSCUSTRANK")
		...
		intRtn = mobjMDOTIFCMALLCOMMI.ProcessRtn_CUST(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjMDOTIFCMALLCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		If not gDoErrorRtn ("SelectRtn_HDR") Then
   		...
   		vntData2 = mobjMDOTIFCMALLCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												  strYEARMON, strCLIENTCODE)
...
Sub SelectRtn_DTL (Col, Row)
	...
	With frmThis
		...
		vntData = mobjMDOTIFCMALLCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
	...
	With frmThis
		...
		For i = 1 To .sprSht_HDR.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDOTIFCMALLCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_HDR,"CHK | TRANSYEARMON | TRANSNO | GUBUN")
		
		intRtn = mobjMDOTIFCMALLCOMMI.DeleteRtn(gstrConfigXml,vntData)
...
Sub ProcessRtn_Confirm_User ()
	...
	with frmThis
		...
		IF intSaveRtn = vbYes then 
			...
			intRtn = mobjMDOTIFCMALLCOMMI.ProcessRtn_Confirm_User(gstrConfigXml,vntData,.txtEMPNO.value)
									...
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
										...
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON1,'')"
												width="60">청구년월</TD>
											<TD class="SEARCHDATA" style="WIDTH: 101px"><INPUT class="INPUT" id="txtYEARMON1" title="년월조회" style="WIDTH: 98px; HEIGHT: 22px" accessKey="NUM"
													maxLength="6" size="7" name="txtYEARMON1"></TD>
											<TD class="SEARCHLABEL" style="WIDTH: 49px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME1, txtCLIENTCODE1)">광고주</TD>
											<TD class="SEARCHDATA" style="WIDTH: 281px"><INPUT class="INPUT_L" id="txtCLIENTNAME1" title="코드명" style="WIDTH: 203px; HEIGHT: 22px"
											...
											<TD class="SEARCHDATA" style="WIDTH: 18px"></TD>
											<TD class="SEARCHDATA">
								...
								<TD id="tblSheet1" style="WIDTH: 100%; HEIGHT: 30%" vAlign="top" align="center">
									<DIV id="pnlTab1" style="POSITION: relative; WIDTH: 100%; HEIGHT: 100%; VISIBILITY: hidden"
										...
										<OBJECT style="WIDTH: 100%; HEIGHT: 100%" id="sprSht_HDR" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											...
											<PARAM NAME="_ExtentY" VALUE="4365">
