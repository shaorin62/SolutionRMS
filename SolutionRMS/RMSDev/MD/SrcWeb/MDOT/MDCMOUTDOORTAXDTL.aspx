<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMOUTDOORTAXDTL.aspx.vb" Inherits="MD.MDCMOUTDOORTAXDTL" %>
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			'md_trans_temp삭제 시작
			intRtn = mobjMDOTOUTDOORTAX.DeleteRtn_TEMP(gstrConfigXml)
			'md_trans_temp삭제 끝
			...
			vntDataTemp = mobjMDOTOUTDOORTAX.ProcessRtn_TEMP(gstrConfigXml,strTAXYEARMON, strTAXNO, VATFLAG, FLAG, i, strUSERID)
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDOTOUTDOORTAX	= gCreateRemoteObject("cMDOT.ccMDOTOUTDOORTAX")
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 11, 0, 1, 2
	    mobjSCGLSpr.SpreadDataField .sprSht, "TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | TITLE | AMT | VAT | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,       "년월|번호|상세순번|광고주|광고주사업자번호|외주처|외주처사업자번호|계약명|금액|부가세|계",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "0 |   0|	   0|	  0|               0|    20|              15|    20|  12|    12|12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT | VAT | SUMAMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TAXYEARMON | TAXNO | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | TITLE", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"TAXYEARMON | TAXNO | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | TITLE | AMT | SUMAMT"
...
Sub EndPage()
	set mobjMDOTOUTDOORTAX = Nothing
	gEndPage
End Sub
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDOTOUTDOORTAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDOTOUTDOORTAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | TITLE | AMT | VAT | SUMAMT")
						
		intRtn = mobjMDOTOUTDOORTAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;옥외광고 수수료 세금계산서</td>
											</tr>
										</table>
									</TD>
