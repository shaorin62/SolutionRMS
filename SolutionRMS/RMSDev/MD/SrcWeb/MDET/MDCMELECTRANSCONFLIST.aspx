...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		"선택|승인|계산서번호|년월 | 번호 | CLIENTCODE | 광고주 | MEDCODE | 매체명 | REAL_MED_CODE | 매체사|대행금액 |부가세|계"
	...
	'			case 2 : .txtCLIENTNAME.value = vntInParam(i)		'현재 사용중인 것만
								...
								<TD style="WIDTH: 100%" vAlign="middle" align="center"><FONT face="굴림">
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA" width="400"><INPUT class="INPUT_L" id="txtCLIENTNAME" title="코드명" style="WIDTH: 312px; HEIGHT: 22px"
