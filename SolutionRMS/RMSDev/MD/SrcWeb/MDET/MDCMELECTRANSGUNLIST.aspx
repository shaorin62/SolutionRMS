<%@ Page CodeBehind="MDCMELECTRANSGUNLIST.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMELECTRANSGUNLIST" %>
...
Sub txtTRANSNO_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "trans", "ELEC")
...
Sub TRU_POP
	...
	End If
	'msgbox strYEARMON
		vntInParams = array(strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "trans", "ELEC") '<< 받아오는경우
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 23, 0, 0, 0
		mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|MEDCODE|MEDNAME| REAL_MED_CODE | REAL_MED_NAME|SUBSEQ|BRANDNAME|CLIENTSUBCODE|CLIENTSUBNAME|PROGRAM |ADLOCALFLAG|WEEKDAY|DEPT_CD|DEMANDDAY|PRINTDAY| PRICE| CNT|AMT| VAT| MED_FLAG"
		mobjSCGLSpr.SetHeader .sprSht,		 "TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|MEDCODE|매체명|REAL_MED_CODE|매체사|브랜드코드|브랜드명|사업부코드|사업부명|소재명|지역|방송요일|DEPT_CD|DEMANDDAY|발행일자|공급가액|회수|광고대금|부가세|매체종류"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "        0|	    0|		   0|		  0|      0|    10|	           0|    10 |    0     |10      |0         |10      |10    |   6|       8|      0|        0|       8|       9|   5|       9|     9|      9|"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeDate2 .sprSht, "PRINTDAY", -1, -1, 10
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "PRICE | AMT| VAT|CNT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEDNAME|REAL_MED_NAME|PROGRAM|ADLOCALFLAG|WEEKDAY|MED_FLAG|BRANDNAME|CLIENTSUBNAME", -1, -1, 20
		mobjSCGLSpr.ColHidden .sprSht, "TRANSYEARMON|TRANSNO | CLIENTCODE|CLIENTNAME|MEDCODE|REAL_MED_CODE|DEPT_CD|DEMANDDAY|SUBSEQ|CLIENTSUBCODE ", true
...
Sub SelectRtn ()
	Dim vntData
	Dim strYEARMON, strCUSTCODE, strTRANSNO
   	Dim i, strCols
	...
	with frmThis
		...
		'쉬트 조회
		Call SelectRtn_DTL (strYEARMON, strTRANSNO, strCUSTCODE)
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strCUSTCODE)
	...
	vntData = mobjMDCMELECTRANSLIST.Get_ELECTRANS_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE)
...
Function SelectRtn_DTL (ByVal strYEARMON,ByVal strTRANSNO, ByVal strCUSTCODE)
	dim vntData
	on error resume next
	...
	vntData = mobjMDCMELECTRANSLIST.Get_ELECTRANS_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE)
							...
							<TR>
								<td align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">&nbsp;공중파&nbsp;위수탁&nbsp;거래명세서 조회 및 발행</td>
										</tr>
									</table>
								</td>
										...
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 83px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTRANSYEARMON, txtTRANSNO)">
													거래명세번호</TD>
												<TD class="DATA" style="WIDTH: 173px"><INPUT class="INPUT" id="txtTRANSYEARMON" title="거래명세년월" style="WIDTH: 72px; HEIGHT: 22px"
														...
														onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF" width="23" align="absMiddle" border="0" name="ImgTRU">
													<INPUT class="INPUT" id="txtTRANSNO" title="거래명세번호" style="WIDTH: 69px; HEIGHT: 22px" type="text"
														maxLength="6" size="5" name="txtTRANSNO" accessKey="NUM"></TD>
												<TD class="SEARCHLABEL" style="WIDTH: 85px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE, txtCLIENTNAME1)">광고주
												</TD>
												<TD class="SEARCHDATA" style="WIDTH: 263px"><INPUT class="INPUT_L" id="txtCLIENTCODE" title="코드조회" style="WIDTH: 64px; HEIGHT: 22px"
														...
														border="0" name="ImgCLIENTCODE">&nbsp;<INPUT class="INPUT_L" id="txtCLIENTNAME1" title="코드명" style="WIDTH: 167px; HEIGHT: 22px"
														type="text" maxLength="100" align="left" size="22" name="txtCLIENTNAME1"></TD>
