<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMELECREALMEDLIST.aspx.vb" Inherits="MD.MDCMELECREALMEDLIST" %>
...
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2008/01/09 By HWANG DUCK SU
'****************************************************************************************
-->
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRELECMULTILIST.SelectRtn_ELECClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
		
		If not gDoErrorRtn ("SelectRtn_ELECClientGroup") then
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRELECMULTILIST.GetELECREAL_MED_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
		
		mvntDataCustCNT = mlngRowCnt
		If not gDoErrorRtn ("GetELECREAL_MED_CNT") then
			If mlngRowCnt > 0 Then 
				'필드 고정값세팅
				Dim strField
