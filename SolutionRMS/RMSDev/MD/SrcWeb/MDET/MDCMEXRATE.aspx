...
Sub InitPage()
    ...
    with frmThis
		...
		'***Sum Sheet 디자인
		'**************************************************	
		'GUBN 이 "F" 면 인서트 해야 하고 "T" 이면 업데이트 하
		...
		mobjSCGLSpr.SetHeader .sprSht,		    "년월|제작대행사코드|제작대행사명|수수료율|비고|저장플레그|GUBN"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		If .txtYEARMON.value = "" Then
			gErrorMsgBox "년월은 반드시 기입 하셔야 합니다.","조회안내!"
			.txtYEARMON.focus()
			Exit Sub
		Elseif Len(.txtYEARMON.value) <> 6  Then
			gErrorMsgBox "년월의 입력형식이 다릅니다.","조회안내!"
			.txtYEARMON.value = ""
			.txtYEARMON.focus()
			Exit Sub
		End If
