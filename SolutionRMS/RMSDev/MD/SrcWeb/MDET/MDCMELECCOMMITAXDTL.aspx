<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMELECCOMMITAXDTL.aspx.vb" Inherits="MD.MDCMELECCOMMITAXDTL" %>
...
Dim mobjMDCMCOMMITAX
Dim mstrMEDFLAG
Dim mobjMDCMELECSPONCOMMITAX
'=========================================================================================
' 이벤트 프로시져 
'=========================================================================================
Sub window_onload
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			IF mobjSCGLSpr.GetTextBinding(.sprSht,"VAT",1) = 0 THEN
				VATFLAG = "N"
			ELSE
				VATFLAG = "Y"
			END IF
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCMCOMMITAX	    = gCreateRemoteObject("cMDCO.ccMDCOCOMMITAX")		'세금계산서조회
    ...
    with frmThis
		...
		'Header 디자인
		mobjSCGLSpr.SetHeader .sprSht,       "년월|번호|순번|대행금액|수수료율|매체코드|금액|부가세액",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "0 |0   |0   |28      |17      |0       |30  |17"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT|VAT|TRANSNO", -1, -1, 0
	    ...
	    mobjSCGLSpr.SetCellTypeFloat2 .sprSht_SUM, "AMT|VAT|TRANSNO", -1, -1, 0
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCMCOMMITAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO,mstrMEDFLAG)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCMCOMMITAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO,mstrMEDFLAG)
...
Sub ProcessRtn
	...
	with frmThis
		...
		intRtn = mobjMDCMCOMMITAX.ProcessRtn_SUMM(gstrConfigXml,strTAXYEARMON,strTAXNO,strSUMM, strVAT)
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;공중파 광고&nbsp;수수료&nbsp;세금계산서</td>
											</tr>
										</table>
									</TD>
										...
										<TABLE id="tblButton" style="WIDTH: 203px; HEIGHT: 20px" cellSpacing="0" cellPadding="0"
											...
											<TR>
												...
												<TD><IMG id="imgClose" onmouseover="JavaScript:this.src='../../../images/imgCloseOn.gIF'"
														...
														name="imgClose"></TD> <!--<IMG id="imgExcel" onmouseover="JavaScript:this.src='../../../images/imgExcelOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgExcel.gif'" height="20" alt="자료를 엑셀로 받습니다."
														src="../../../images/imgExcel.gIF" width="54" border="0" name="imgExcel">-->
											</TR>
										</TABLE>
								...
								<TR>
									<TD class="KEYFRAME" style="WIDTH: 791px" vAlign="middle" align="center"><FONT face="굴림">
											<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 77px; CURSOR: hand" width="78" onclick="vbscript:Call gCleanField(txtTAXYEARMON,txtTAXNO)">계산서번호</TD>
													<TD class="SEARCHDATA"><INPUT dataFld="TAXYEARMON" class="INPUT" id="txtTAXYEARMON" title="세금계산서년월" style="WIDTH: 56px; HEIGHT: 22px"
														...
														<INPUT dataFld="TAXNO" class="INPUT" id="txtTAXNO" title="세금계산서번호" style="WIDTH: 48px; HEIGHT: 22px"
															accessKey="NUM" dataSrc="#xmlBind" type="text" maxLength="4" size="2" name="txtTAXNO">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
														&nbsp;<SELECT id="cmbFLAG" title="영수/청구구분" style="WIDTH: 56px" name="cmbFLAG">
								...
								<TR>
									<TD class="KEYFRAME" vAlign="middle" align="center">
										<TABLE class="DATA" id="tblDATA" style="WIDTH: 791px; HEIGHT: 6px" cellSpacing="1" cellPadding="0"
											...
											<TR>
												<TD class="LABEL" width="78" style="WIDTH: 78px"><FONT face="굴림"><FONT face="굴림">매체사</FONT></FONT></TD>
												<TD class="DATA" width="173"></FONT><FONT face="굴림"><INPUT dataFld="REAL_MED_NAME" class="NOINPUTB_L" id="txtREAL_MED_NAME" title="청구지명" style="WIDTH: 172px; HEIGHT: 22px"
															dataSrc="#xmlBind" readOnly type="text" maxLength="20" size="22" name="txtDEPT_NAME"></FONT>
												</TD>
												<TD class="LABEL" width="90"><FONT face="굴림"><FONT face="굴림"><FONT face="굴림">매체사사업자</FONT></FONT></FONT></TD>
												<TD class="DATA" width="173"><INPUT dataFld="REAL_MED_BISNO" class="NOINPUTB" id="txtREAL_MED_BISNO" title="부가세" style="WIDTH: 172px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly type="text" maxLength="100" size="22" name="txtREAL_MED_BISNO">
												</TD>
