<%@ Page CodeBehind="MDCMELECSPONTRUTAX.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMELECSPONTRUTAX" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>공중파 협찬광고 위수탁세금계산서 발행</title> 
		<!--
'****************************************************************************************
...
Dim mobjMDCMELECSPONTRUTAX , mobjMDCMGET
Dim mstrCheck
'=========================================================================================
' 이벤트 프로시져 
'=========================================================================================
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			'md_trans_temp삭제 시작
			intRtn = mobjMDCMELECSPONTRUTAX.DeleteRtn_TEMP(gstrConfigXml)
			'md_trans_temp삭제 끝
			...
			for i=1 to .sprSht.MaxRows
				IF mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = "1" THEN
					...
					vntDataTemp = mobjMDCMELECSPONTRUTAX.ProcessRtn_TEMP(gstrConfigXml,strTAXYEARMON, strTAXNO, VATFLAG, FLAG, i, strUSERID)
				END IF
			next
...
Sub TAXPOP
	...
	Dim strYEARMON
	With frmThis
		vntInParams = array(.txtTRANSYEARMON1.value, .txtTRANSNO1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value, "trans","ELECSPON") '<< 받아오는경우
		If .rdF.checked = True Then
			vntRet = gShowModalWindow("../MDCO/MDCMTRANSPOP.aspx",vntInParams , 413,435)
		ElseIF .rdT.checked = TRUE THEN
...
Sub CLIENTCODE_POP
	...
	Dim vntInParams
	with frmThis
		vntInParams = array(.txtTRANSYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "trans", "ELECSPON") 
...
Sub txtCLIENTNAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTAXCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value,"trans","ELECSPON")
...
Sub txtTRANSNO1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, .txtTRANSNO1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value, "trans", "ELECSPON", "0")
...
Sub TRANSPOP
	...
	strYEARMON = .txtTRANSYEARMON1.value
	End If
		vntInParams = array(strYEARMON, .txtTRANSNO1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value, "trans","ELECSPON") '<< 받아오는경우
		vntRet = gShowModalWindow("../MDCO/MDCMTRANSPOP.aspx",vntInParams , 413,435)
		if isArray(vntRet) then
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjMDCMELECSPONTRUTAX	= gCreateRemoteObject("cMDET.ccMDETELECSPONTRUTAX")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 36, 0, 9, 2
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | TAXYEARMON | TAXNO | TAXMANAGE | TRANSYEARMON | TRANSNO | SEQ | DEMANDDAY | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT| VAT | SUMAMT | SUMM | DEPT_NAME | PRINTDAY | CLIENTCODE | CLIENTACCODE | REAL_MED_CODE | REAL_MED_ACCODE | MEDCODE | DEPTCODE | MEDFLAG | VOCHNO | RANKTRANS | PROGRAM_NAME | SPONSOR| CLIENTOWNER| CLIENTADDR1| CLIENTADDR2| REAL_MEDOWNER| REAL_MEDADDR1| REAL_MEDADDR2"
		...
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   4|	0|   0|	     11|   5|   4|	 4|     8|	    19|                  17|	  19|                  17|     9|       9|       9|	     9|  30|    10| 	8|         0|          0|          0|           0|      0|       0|       0|      10|   0|    30|       0|0|0|0|0|0|0"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht,true, "TAXYEARMON|TAXNO|TRANSYEARMON|TRANSNO|CLIENTNAME|REAL_MED_NAME|MEDNAME|AMT|VAT|SUMAMT|DEPT_NAME|CLIENTCODE|CLIENTACCODE|CLIENTBISNO|REAL_MED_CODE|REAL_MED_ACCODE|REAL_MED_BISNO|MEDCODE|DEPTCODE|MEDFLAG|SEQ|VOCHNO|RANKTRANS|PROGRAM_NAME"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEDNAME|REAL_MED_NAME|PROGRAM_NAME|TAXMANAGE", -1, -1, 20
		mobjSCGLSpr.ColHidden .sprSht, "TAXNO|CLIENTCODE|CLIENTACCODE|REAL_MED_CODE|REAL_MED_ACCODE|MEDCODE|DEPTCODE|MEDFLAG|VOCHNO|RANKTRANS|TAXYEARMON|SPONSOR|CLIENTOWNER| CLIENTADDR1| CLIENTADDR2| REAL_MEDOWNER| REAL_MEDADDR1| REAL_MEDADDR2", true
...
Sub EndPage()
	set mobjMDCMELECSPONTRUTAX = Nothing
...
Sub SelectRtn ()
	...
	with frmThis
		...
		'세금계산서 완료조회
		If .rdT.checked = True Then
			vntData = mobjMDCMELECSPONTRUTAX.Get_ELECSPON_TAX(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strCUSTCODE,strFROM,strTO,strTAXNO)
			If not gDoErrorRtn ("Get_ELECSPON_TAX") then
				...
				mobjSCGLSpr.ColHidden .sprSht, "TRANSYEARMON|TRANSNO|TAXYEARMON|TAXNO|SEQ|MEDNAME|PROGRAM_NAME", True
				gWriteText lblstatus, "선택한 자료에 대해서 " & mlngRowCnt & " 건의 자료가 검색" & mePROC_DONE
			End If
		'미완료 거래명세서 디테일 조회
		ElseIf .rdF.checked = True Then
			vntData = mobjMDCMELECSPONTRUTAX.Get_ELECSPON_TAXBUILD(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE,strGUBUN)
			If not gDoErrorRtn ("Get_ELECSPON_TAXBUILD") then
				...
				mobjSCGLSpr.ColHidden .sprSht, "TRANSYEARMON|TRANSNO|SEQ|MEDNAME|PROGRAM_NAME", False
				'Layout_change
				gWriteText lblstatus, "선택한 자료에 대해서 " & mlngRowCnt & " 건의 자료가 검색" & mePROC_DONE
				mobjSCGLSpr.ActiveCell .sprSht, 2, 1
			END IF
		ElseIf .rdA.checked = True Then			
			vntData = mobjMDCMELECSPONTRUTAX.Get_ELECSPON_TAXALL(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE, strGUBUN)
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intTAXNO = 0
		If .cmbGUBUN.value = "taxdiv" Then
		intRtn = mobjMDCMELECSPONTRUTAX.ProcessRtn_Div(gstrConfigXml,vntData, intTAXNO)
		Else
			...
			Else
				...
				Next
				'맥스값만 추가하여 보내기
				intRtn = mobjMDCMELECSPONTRUTAX.ProcessRtn_Group(gstrConfigXml,vntData, intTAXNO,intColFlag)
			End IF
		End If
	...
	with frmThis
		...
		for i = .sprSht.MaxRows to 1 step -1
			if mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 THEN
				...
				intRtn = mobjMDCMELECSPONTRUTAX.DeleteRtn_TruTax(gstrConfigXml,strTAXYEARMON, strTAXNO)
