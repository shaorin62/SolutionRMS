<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMELECMULTILIST.aspx.vb" Inherits="MD.MDCMELECMULTILIST" %>
...
Sub InitPage()
	...
	'서버업무객체 생성
	set mobjMDSRELECMULTILIST	= gCreateRemoteObject("cMDSC.ccMDSCPRINTMULTILIST")
...
Sub EndPage()
	set mobjMDSRELECMULTILIST = Nothing
	gEndPage	
End Sub
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mvntData2 = mobjMDSRELECMULTILIST.GetELECMEDCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
		mintCnt2 = mlngRowCnt
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRELECMULTILIST.SelectRtn_ELECCUSTAndMED(gstrConfigXml,mlngRowCnt,mlngColCnt, mintCnt2, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRELECMULTILIST.GetELECCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1), strClientAndMed(2))
