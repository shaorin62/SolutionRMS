<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALTRUTAXDTL.aspx.vb" Inherits="MD.MDCMTOTALTRUTAXDTL" %>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCMTRUTAX	= gCreateRemoteObject("cMDCT.ccMDCTTOTALTRUTAX")
    ...
    with frmThis
	    ...
	    mobjSCGLSpr.SpreadDataField .sprSht, "TAXYEARMON | TAXNO | TAXNOSEQ | VOCH_TYPE_OLD | VOCH_TYPE | CLIENTNAME | CLIENTBISNO | TIMNAME | SUBSEQNAME | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | VAT | SUMAMT | DEPT_NAME | MATTERNAME"
		mobjSCGLSpr.SetHeader .sprSht,       "년월|번호|상세번호|구분|발행|광고주|광고주사업자번호|팀|브랜드|매체사|매체사사업자번호|매체|금액|부가세|계|담당부서|소재",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "0 |   0|       0|   5|   5|     0|               0|12|    12|     0|               0|  12|  10|     9|10|      12|  15"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"TAXYEARMON | TAXNO | VOCH_TYPE_OLD | VOCH_TYPE | CLIENTNAME | CLIENTBISNO | TIMNAME | SUBSEQNAME | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | SUMAMT | DEPT_NAME | MATTERNAME"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "VOCH_TYPE_OLD | VOCH_TYPE | CLIENTBISNO | REAL_MED_BISNO",-1,-1,2,2,false
		mobjSCGLSpr.ColHidden .sprSht, "TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO",true
...
Sub ProcessRtn
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"TAXYEARMON | TAXNO | TAXNOSEQ | VOCH_TYPE_OLD | VOCH_TYPE | CLIENTNAME | CLIENTBISNO | TIMNAME | SUBSEQNAME | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | VAT | SUMAMT | DEPT_NAME | MATTERNAME")
						
		intRtn = mobjMDCMTRUTAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;종합편성 광고 위수탁 세금계산서</td>
											</tr>
										</table>
									</TD>
									...
									<TD class="KEYFRAME" style="WIDTH: 880px" vAlign="middle" align="center"><FONT face="굴림">
											<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
												<TR>
													...
													<TD class="SEARCHDATA" style="WIDTH: 645px"><INPUT class="INPUT" id="txtTAXYEARMON" title="세금계산서년월" style="WIDTH: 56px; HEIGHT: 22px"
										...
										<TABLE class="DATA" id="tblDATA" style="WIDTH: 880px; HEIGHT: 6px" cellSpacing="1" cellPadding="0"
											...
											<TR>
												...
												<TD class="DATA" width="173"></FONT><INPUT dataFld="CLIENTNAME" class="NOINPUT_L" id="txtCLIENTNAME" title="광고주명" style="WIDTH: 172px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="255" align="left" size="22" name="txtCLIENTNAME">
												</TD>
												...
												<TD class="DATA" width="173"><FONT face="굴림"><INPUT dataFld="REAL_MED_NAME" class="NOINPUT_L" id="txtREAL_MED_NAME" title="청구지명" style="WIDTH: 172px; HEIGHT: 22px"
															dataSrc="#xmlBind" readOnly maxLength="255" size="22" name="txtDEPT_NAME"></FONT>
												</TD>
												...
												<TD class="DATA" width="173"><FONT face="굴림"><INPUT dataFld="DEMANDDAY" class="NOINPUT" id="txtDEMANDDAY" title="청구일" style="WIDTH: 172px; HEIGHT: 22px"
															dataSrc="#xmlBind" readOnly maxLength="100" size="22" name="txtDEMANDDAY" accessKey="DATE"></FONT></TD>
											</TR>
											<TR>
												...
												<TD class="DATA"><FONT face="굴림"><INPUT dataFld="CLIENTBISNO" class="NOINPUT" id="txtCLIENTBISNO" title="공급가액" style="WIDTH: 172px; HEIGHT: 22px"
															dataSrc="#xmlBind" readOnly maxLength="20" size="22" name="txtCLIENTBISNO"></FONT>
												</TD>
												...
												<TD class="DATA"></FONT></FONT><INPUT dataFld="REAL_MED_BISNO" class="NOINPUT" id="txtREAL_MED_BISNO" title="부가세" style="WIDTH: 172px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="100" size="22" name="txtREAL_MED_BISNO"></TD>
												<TD class="LABEL"><FONT face="굴림">담당부서</FONT></TD>
												<TD class="DATA"></FONT></FONT><INPUT dataFld="DEPTNAME" class="NOINPUT" id="txtDEPTNAME" title="합계" style="WIDTH: 172px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="255" size="22" name="txtDEPTNAME"></TD>
											</TR>
											<TR>
											...
											<TR>
												...
												<TD class="DATA"><INPUT class="NOINPUT" id="txtVOCHNO" title="사업자번호" style="WIDTH: 172px; HEIGHT: 22px"
												...
												<TD class="DATA" colspan="3"><INPUT dataFld="SUMM" class="INPUT_L" id="txtSUMM" title="적요" style="WIDTH: 442px; HEIGHT: 22px"
														dataSrc="#xmlBind" name="txtSUMM" size="67">
												</TD>
											</TR>
										</TABLE>
									</TD>
					...
					<TR>
						<TD class="LISTFRAME" style="WIDTH: 100%; HEIGHT: 400px" vAlign="top" align="center">
							<DIV id="pnlTab1" style="POSITION: relative; WIDTH: 100%; VISIBILITY: hidden" ms_positioning="GridLayout">
								<OBJECT style="WIDTH: 100%; HEIGHT: 399px" id="sprSht" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
									>
									<PARAM NAME="_Version" VALUE="393216">
									<PARAM NAME="_ExtentX" VALUE="23283">
									<PARAM NAME="_ExtentY" VALUE="10556">
