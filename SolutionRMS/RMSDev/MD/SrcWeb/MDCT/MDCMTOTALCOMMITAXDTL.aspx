<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALCOMMITAXDTL.aspx.vb" Inherits="MD.MDCMTOTALCOMMITAXDTL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>수수료 세금계산서 상세내역</title>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCTTOTALCOMMITAX = gCreateRemoteObject("cMDCT.ccMDCTTOTALCOMMITAX")
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 11, 0
	    mobjSCGLSpr.SpreadDataField .sprSht, "TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | VAT | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,       "년월|번호|상세순번|광고주|광고주사업자번호|매체사|매체사사업자번호|매체|금액|부가세|계",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "0 |   0|       0|	 25|              15|     0|               0|  23|  12|    12|12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT | VAT | SUMAMT", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TAXYEARMON | TAXNO | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"TAXYEARMON | TAXNO | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTBISNO | REAL_MED_BISNO",-1,-1,2,2,false
		mobjSCGLSpr.ColHidden .sprSht, "TAXYEARMON | TAXNO | TAXNOSEQ | REAL_MED_NAME | REAL_MED_BISNO",true
...
Sub EndPage()
	set mobjMDCTTOTALCOMMITAX = Nothing
	gEndPage
End Sub
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCTTOTALCOMMITAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCTTOTALCOMMITAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | VAT | SUMAMT")
						
		intRtn = mobjMDCTTOTALCOMMITAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
				...
				<TBODY>
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;종합편성광고 수수료 세금계산서</td>
											</tr>
										</table>
									</TD>
										...
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTAXYEARMON" title="세금계산서년월" style="WIDTH: 56px; HEIGHT: 22px"
														accessKey="NUM" maxLength="6" size="4" name="txtTAXYEARMON">&nbsp;- <INPUT class="INPUT" id="txtTAXNO" title="세금계산서번호" style="WIDTH: 48px; HEIGHT: 22px" accessKey="NUM"
														maxLength="4" size="2" name="txtTAXNO"></TD>
											</TR>
										</TABLE>
									</TD>
								</TR>
										...
										<TABLE class="DATA" id="tblDATA" style="WIDTH: 880px; HEIGHT: 6px" cellSpacing="1" cellPadding="0"
											...
											<TR>
												...
												<TD class="DATA" width="203"><INPUT dataFld="DEPT_NAME" class="NOINPUT" id="txtDEPTNAME" title="담당부서" style="WIDTH: 200px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="255" size="22" name="txtDEPTNAME">
												</TD>
												<TD class="LABEL" width="90">청구일자</TD>
												<TD class="DATA" width="203"><INPUT dataFld="DEMANDDAY" class="NOINPUT" id="txtDEMANDDAY" title="청구일" style="WIDTH: 200px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="100" size="22" name="txtDEMANDDAY" accessKey="DATE"></TD>
											</TR>
											<TR>
												<TD class="LABEL">매체사사업자</TD>
												<TD class="DATA"><INPUT dataFld="REAL_MED_BISNO" class="NOINPUT" id="txtREAL_MED_BISNO" title="매체사사업자번호"
														style="WIDTH: 200px; HEIGHT: 22px" dataSrc="#xmlBind" readOnly maxLength="100" size="22" name="txtREAL_MED_BISNO">
												</TD>
												<TD class="LABEL">전표번호</TD>
												<TD class="DATA"><INPUT class="NOINPUT" id="txtVOCHNO" title="사업자번호" style="WIDTH: 200px; HEIGHT: 22px"
														dataSrc="#xmlBind" readOnly maxLength="50" size="8" name="txtVOCHNO" dataFld="VOCHNO"></TD>
					...
					<TR>
						<TD class="LISTFRAME" style="WIDTH: 100%; HEIGHT: 430px" vAlign="top" align="center">
							<DIV id="pnlTab1" style="POSITION: relative; WIDTH: 100%; VISIBILITY: hidden" ms_positioning="GridLayout">
								<OBJECT style="WIDTH: 100%; HEIGHT: 429px" id="sprSht" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
									>
									<PARAM NAME="_Version" VALUE="393216">
									<PARAM NAME="_ExtentX" VALUE="23283">
									<PARAM NAME="_ExtentY" VALUE="11350">
