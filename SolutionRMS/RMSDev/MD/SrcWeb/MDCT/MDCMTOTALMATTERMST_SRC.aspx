<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALMATTERMST_SRC.aspx.vb" Inherits="MD.MDCMTOTALMATTERMST_SRC" %>
			...
			If isArray(vntRet) Then
				...
				ELSE
					if (.txtUSERDEPT_CD.value = "11002739" and vntRet(10,0) = "11001435") or _
						...
						(.txtUSERDEPT_CD.value = "11001546" and vntRet(10,0) = "11000322")  then 
		...
		If  Col = mobjSCGLSpr.CnvtDataField(.sprSht,"SUBSEQNAME") Then
			...
			If strCode = "" AND strCodeName <> "" Then			
				...
				If not gDoErrorRtn ("Get_BrandInfo_TIMCODE") Then
					If mlngRowCnt = 1 Then
						IF .txtUSERDEPT_CD.value = vntData(10,0) THEN
						...
						ELSE
							if (.txtUSERDEPT_CD.value = "11002739" and vntData(10,1) = "11001435") or _
								...
								(.txtUSERDEPT_CD.value = "11001546" and vntData(10,1) = "11000322")  then
...
'00090062 윤정인
			...
			vntData_info = mobjSCCOGET.Get_SENDINFO2(gstrConfigXml,mlngRowCnt,mlngColCnt, "00010252")
			'보내는사람정보
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												<TABLE cellSpacing="0" cellPadding="0" width="170" background="../../../images/back_p.gIF"
													border="0">
													<TR>
										...
										<tr>
											<td class="TITLE">종합편성채널-소재관리-등록</td>
										</tr>
									</table>
								</TD>
