<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVMATTERMST_SRC.aspx.vb" Inherits="MD.MDCMCATVMATTERMST_SRC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>소재 관리-등록</title>
...
Sub sprSht_Keydown(KeyCode, Shift)
	...
	If KeyCode = meINS_ROW Then
		...
		mobjSCGLSpr.SetCellsLock2 frmThis.sprSht,false,frmThis.sprSht.ActiveRow,4,4,true
		mobjSCGLSpr.SetTextBinding frmThis.sprSht,"ATTR02",frmThis.sprSht.ActiveRow, "등록"
...
Sub sprSht_ButtonClicked (Col,Row,ButtonDown)
	...
	With frmThis
		If Col = mobjSCGLSpr.CnvtDataField(.sprSht,"BTNSUBSEQ") Then '브랜드
			...
			If isArray(vntRet) Then
				IF trim(.txtUSERDEPT_CD.value) = trim(vntRet(10,0)) THEN
				...
				ELSE
					if (.txtUSERDEPT_CD.value = "11002739" and vntRet(10,0) = "11001435") or _
						(.txtUSERDEPT_CD.value = "11002986" and vntRet(10,0) = "10000016") or _ 
						(.txtUSERDEPT_CD.value = "11002284" and vntRet(10,0) = "11001438") or _ 
						(.txtUSERDEPT_CD.value = "11002740" and vntRet(10,0) = "10001210") or _
						(.txtUSERDEPT_CD.value = "11002549" and vntRet(10,0) = "11000533") or _
						(.txtUSERDEPT_CD.value = "11002286" and vntRet(10,0) = "10000017")  or _
						(.txtUSERDEPT_CD.value = "11001546" and vntRet(10,0) = "11000322")  or _  
						(.txtUSERDEPT_CD.value = "11003433" and vntRet(10,0) = "11001312") then
						...
						gErrorMsgBox "로그인 사용자의 부서와 브랜드의 부서가 동일하지 않습니다.","입력안내!"
						mobjSCGLSpr.SetTextBinding .sprSht,"SUBSEQ",Row, ""
						mobjSCGLSpr.SetTextBinding .sprSht,"SUBSEQNAME",Row, ""
		...
		If  Col = mobjSCGLSpr.CnvtDataField(.sprSht,"SUBSEQNAME") Then
			...
			If strCode = "" AND strCodeName <> "" Then			
				...
				If not gDoErrorRtn ("Get_BrandInfo_TIMCODE") Then
					If mlngRowCnt = 1 Then
						IF trim(.txtUSERDEPT_CD.value) = trim(vntData(10,0)) THEN
						...
						ELSE
							if (.txtUSERDEPT_CD.value = "11002739" and vntData(10,1) = "11001435") or _
								(.txtUSERDEPT_CD.value = "11002986" and vntRet(10,1) = "10000016") or _ 
								(.txtUSERDEPT_CD.value = "11002284" and vntData(10,1) = "11001438") or _ 
								(.txtUSERDEPT_CD.value = "11002740" and vntData(10,1) = "10001210") or _
								(.txtUSERDEPT_CD.value = "11002549" and vntData(10,1) = "11000533") or _
								(.txtUSERDEPT_CD.value = "11002286" and vntData(10,1) = "10000017") or _
								(.txtUSERDEPT_CD.value = "11001546" and vntData(10,1) = "11000322") or _  
								(.txtUSERDEPT_CD.value = "11003433" and vntData(10,1) = "11001312") then
...
Sub mobjSCGLSpr_ClickProc(Col, Row)
	...
	With frmThis
		If Col = mobjSCGLSpr.CnvtDataField(.sprSht,"SUBSEQNAME") Then			
			...
			vntRet = gShowModalWindow("../MDCO/MDCMCUSTSEQPOP_TIMCODE.aspx",vntInParams , 640,445)
			If isArray(vntRet) Then
				IF .txtUSERDEPT_CD.value = vntRet(10,0) THEN
					mobjSCGLSpr.SetTextBinding .sprSht,"SUBSEQ",Row, vntRet(0,0)
					mobjSCGLSpr.SetTextBinding .sprSht,"SUBSEQNAME",Row, vntRet(1,0)
					mobjSCGLSpr.SetTextBinding .sprSht,"CUSTCODE",Row, vntRet(2,0)
					mobjSCGLSpr.SetTextBinding .sprSht,"CUSTNAME",Row, vntRet(3,0)
...
Sub InitPage()
	...
	With frmThis
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "ATTR02 | MATTERCODE | DEPT_NAME | TIMNAME | CLIENTSUBNAME | CUSTCODE | CUSTNAME | UUSER | UDATE" 
...
Sub Get_SESSION_DEPT_CD ()
	...
	With frmThis
		...
		strDEPT_CD = mobjMDCOMATTERMST.Get_SESSION_DEPT_CD(gstrConfigXml,mlngRowCnt,mlngColCnt, gstrEmpNo)
	...
	With frmThis
		...
		For intCnt2 = 1 To .sprSht.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",intCnt2) = 1 Then
				if mobjSCGLSpr.GetTextBinding(.sprSht,"ATTR02",intCnt2) <> "등록" then
					gErrorMsgBox "체크한 데이터 중 " +  i + " 번째 줄의 상태는 등록상태가 아닙니다. 등록상태인 데이터만 승인요청 할 수 있습니다.","승인요청안내!"
					Exit Sub
				end if 
				
				if mobjSCGLSpr.GetTextBinding(.sprSht,"MATTERCODE",intCnt2) = "" then
					gErrorMsgBox "체크한 데이터 중 " +  i + " 번째 줄의 상태는 저장되지 않은 데이터 입니다. 저장을 먼저 하신 후에 해당 데이터를 승인요청할 수 있습니다..","승인요청안내!"
					Exit Sub
				end if 
				
				If intCnt3 Then
					strMsg = mobjSCGLSpr.GetTextBinding(.sprSht,"MATTER",intCnt2)
					intCnt3 = false
				End If
		...
		for i = .sprSht.MaxRows to 1 step -1
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 Then
				...
				If strMATTERCODE = "" Then
					...
					intRtn = mobjMDCOMATTERMST.ProcessRtn_CONF(gstrConfigXml,strMATTERCODE)
				End If				
  				intCnt = intCnt + 1
 			End If
		Next
...
'00090062 윤정인
			...
			vntData_info = mobjSCCOGET.Get_SENDINFO2(gstrConfigXml,mlngRowCnt,mlngColCnt, "1001936")
			'보내는사람정보
			...
			call EMAIL_SEND(strMstEmail, "소재", strFromUserName,strFromUserEmail,strToUserEmail)
...
End Sub
		...
		function EMAIL_SEND(strMstEmail, strGBN, strFromUserName,strFromUserEmail,strToUserEmail){
			frmSMS.location.href = "../../../SC/SrcWeb/SCCO/sendemail.asp?NAME="+ strMstEmail + "&GBN=" + strGBN + "&FromUserName=" + strFromUserName + "&FromUserEmail=" + strFromUserEmail + "&ToUserEmail=" + strToUserEmail; 
		}
		</script>
	</HEAD>
	<body class="base">
		...
		<FORM id="frmThis" method="post" runat="server">
												...
												<TABLE id="tblButton" width="100%" cellSpacing="0" cellPadding="2" align="left" border="0">
													<TR>
														<TD class="SEARCHDATA" align="left"><SELECT id="cmbUSE_YNSEARCH" title="사용구분" style="WIDTH: 100px" name="cmbUSE_YNSEARCH">
																...
																type="text" maxLength="20" name="txtUSERDEPT_CD">
														</TD>
			...
			<iframe id="frmSMS" style="DISPLAY: none;WIDTH: 1000px;HEIGHT: 1000px" name="frmSMS"></iframe> <!--DISPLAY: none; -->
		</TR></TABLE>
	</body>
</HTML>
