<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVMONREALLIST.aspx.vb" Inherits="MD.MDCMCATVMONREALLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCEXECUTE.SelectRtn_CATVMONREALLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)

		if not gDoErrorRtn ("SelectRtn_CATVMONREALLIST") then
