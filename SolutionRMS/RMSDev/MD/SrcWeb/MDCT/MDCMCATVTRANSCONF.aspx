<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVTRANSCONF.aspx.vb" Inherits="MD.MDCMCATVTRANSCONF" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CATV 거래명세서 승인</title>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDTRANSCONF	= gCreateRemoteObject("cMDCT.ccMDCTCATVTRANS") '조회
    ...
    with frmThis
		...
		'Header 디자인
		mobjSCGLSpr.SetHeader .sprSht,        "선택|승인여부|계산서여부|거래년월|번호|광고주코드|광고주|청구일|발행일|공급가액|수수료|합계금액|매체구분코드|매체구분|비고",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1","   4|       7|        10|       8|   4|         0|    14|     8|     8|      10|     9|      11|           0|       8|20"
...
sub sprSht_DblClick (ByVal Col, ByVal Row)
	...
	with frmThis
		...
		elseif Row = 0 and Col =1 then
			...
			vntRet = gShowModalWindow("MDCMCATVTRANSGUNLIST.aspx",vntInParams , 813,545)
			if isArray(vntRet) then
     		end if
		end if
	end with
