<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALMULTILIST.aspx.vb" Inherits="MD.MDCMTOTALMULTILIST" %>
...
Sub CLIENTCODE_POP
	...
	With frmThis
		vntInParams = array(trim(.txtYEAR.value), "TOTAL") '<< 받아오는경우
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mvntData2 = mobjMDSRPRINTMULTILIST.GetTOTALMEDCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
		mintCnt2 = mlngRowCnt
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_TOTALCUSTAndMED(gstrConfigXml,mlngRowCnt,mlngColCnt, mintCnt2, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
		
		If not gDoErrorRtn ("SelectRtn_TOTALCUSTAndMED") then
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRPRINTMULTILIST.GetTOTALCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1), strClientAndMed(2))
