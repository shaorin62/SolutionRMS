<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVLIST.aspx.vb" Inherits="MD.MDCMCATVLIST" %>
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjMDCMCATV		= gCreateRemoteObject("cMDCT.ccMDCTCATV_MEDIUM")
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 24, 0, 0, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | GFLAG| GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | DEMANDDAY | MEDNAME | CLIENTNAME | TIMNAME | MATTERNAME | AMT | COMMISSION | COMMI_RATE| TBRDSTDATE | TBRDEDDATE | CNT | VOCH_TYPE | TRU_TAX_FLAG | BIGO | TRU_TRANS_NO | COMMI_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME "
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|승인|승인여부|명세서여부|년월|순번|청구일|매체명|광고주|CIC/팀|소재|금액|수수료|수수료율|시작일|종료일|초수|전표구분|VAT|비고|거래명세서번호|수수료거래명세서번호|대행사코드|대행사명"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|   0|       7|         0|   0|   0|     9|    13|    13|    13|  14|  10|     9|       9|     9|     9|   6|       8|  4|  10|             0|                   0|         0|       8"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "GFLAG| GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | DEMANDDAY | MEDNAME | CLIENTNAME | TIMNAME | MATTERNAME | AMT | COMMISSION | COMMI_RATE| TBRDSTDATE | TBRDEDDATE | CNT | VOCH_TYPE | TRU_TAX_FLAG | BIGO | TRU_TRANS_NO | COMMI_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "GFLAGNAME | DEMANDDAY | CNT | EXCLIENTNAME",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDNAME | CLIENTNAME | MATTERNAME | TIMNAME | BIGO | EXCLIENTNAME ",-1,-1,0,2,false
		mobjSCGLSpr.ColHidden .sprSht, "YEARMON | SEQ |  GFLAG | TRU_TRANS_NO | COMMI_TRANS_NO | EXCLIENTCODE", true
...
Sub Get_COMBO_VALUE ()
	...
	With frmThis
		...
		vntData_VOCH = mobjMDCMCATV.Get_COMBOVOCH_VALUE(gstrConfigXml,mlngRowCnt,mlngColCnt)
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMBOOKLIST.SelectRtn_CATV(gstrConfigXml,mlngRowCnt,mlngColCnt, _
									strYEARMON, _
...
Sub ProcessRtn_ConfirmOK
	...
	with frmThis
		...
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK |GFLAG| GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | DEMANDDAY | MEDNAME | CLIENTNAME | TIMNAME | MATTERNAME | AMT | COMMISSION | COMMI_RATE| TBRDSTDATE | TBRDEDDATE | CNT | VOCH_TYPE | TRU_TAX_FLAG | BIGO | TRU_TRANS_NO | COMMI_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME")
		strFLAG = "CONFIRM"
		intRtn = mobjMDCMBOOKLIST.ProcessRtn_ConfirmCatv_OK(gstrConfigXml,vntData,strFLAG)
...
Sub ProcessRtn_ConfirmCancel
	...
	with frmThis
		...
		if not gDoErrorRtn ("ProcessRtn_ConfirmCatv_OK") then 
			'모든 플래그 클리어
			mobjSCGLSpr.SetFlag  .sprSht,meCLS_FLAG
