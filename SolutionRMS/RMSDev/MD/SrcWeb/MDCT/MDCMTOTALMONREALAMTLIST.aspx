<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALMONREALAMTLIST.aspx.vb" Inherits="MD.MDCMTOTALMONREALAMTLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_TOTAL_MEDAMT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, .txtREAL_MED_CODE1.value, .txtCLIENTCODE.value)

		if not gDoErrorRtn ("SelectRtn_TOTAL_MEDAMT") then
