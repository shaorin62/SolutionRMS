<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVCOMMITAXDTL.aspx.vb" Inherits="MD.MDCMCATVCOMMITAXDTL" %>
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			'md_trans_temp삭제 시작
			intRtn = mobjMDCTCATVCOMMITAX.DeleteRtn_TEMP(gstrConfigXml)
			'md_trans_temp삭제 끝
			...
			vntDataTemp = mobjMDCTCATVCOMMITAX.ProcessRtn_TEMP(gstrConfigXml,strTAXYEARMON, strTAXNO, VATFLAG, FLAG, i, strUSERID)
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCTCATVCOMMITAX = gCreateRemoteObject("cMDCT.ccMDCTCATVCOMMITAX")
...
Sub EndPage()
	set mobjMDCTCATVCOMMITAX = Nothing
	gEndPage
End Sub
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCTCATVCOMMITAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCTCATVCOMMITAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		intRtn = mobjMDCTCATVCOMMITAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;케이블광고 수수료 세금계산서</td>
											</tr>
										</table>
									</TD>
