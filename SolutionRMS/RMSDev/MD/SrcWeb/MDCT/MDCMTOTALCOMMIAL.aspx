<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALCOMMIAL.aspx.vb" Inherits="MD.MDCMTOTALCOMMIAL" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 수수료거래명세서 등록 화면(MDCMPRINTTRANS1.aspx)
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCTTOTALCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		strUSERID = ""
		vntDataTemp = mobjMDCTTOTALCOMMI.ProcessRtn_TEMP_ALL(gstrConfigXml, vntData, strUSERID)
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		strUSERID = ""
		vntData = mobjMDCTTOTALCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub REAL_MED_CODE1_POP
	...
	with frmThis
		vntInParams = array(.txtYEARMON1.value, .txtREAL_MED_CODE1.value, .txtREAL_MED_NAME1.value, "commi", "TOTAL") 
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtREAL_MED_CODE1.value,.txtREAL_MED_NAME1.value,"","commi", "TOTAL")
...
Sub InitPage()
	...
	dim intNo,i
	'서버업무객체 생성	
	set mobjMDCTTOTALCOMMI	= gCreateRemoteObject("cMDCT.ccMDCTTOTALCOMMI")
...
Sub EndPage()
	set mobjMDCTTOTALCOMMI = Nothing
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        0|	         0|	  0|       4|	 15|    13|    15|    10|       4|    10|    10|11|       5|  10|    10|     9|     9|         9|         5|      0"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		mlngColCnt=clng(0)
   		...
   		vntData2 = mobjMDCTTOTALCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												strYEARMON, strREAL_MED_CODE, strMED_FLAG)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCTTOTALCOMMI.ProcessRtn(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
	...
	with frmThis
		...
		For i = 1 to .sprSht_HDR.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDCTTOTALCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDCTTOTALCOMMI.DeleteRtn(gstrConfigXml,vntData)
