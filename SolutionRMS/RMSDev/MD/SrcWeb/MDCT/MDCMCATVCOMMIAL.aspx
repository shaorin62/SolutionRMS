<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVCOMMIAL.aspx.vb" Inherits="MD.MDCMCATVCOMMIAL" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>수수료 거래명세서</title>
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCTCATVCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		strUSERID = ""
		vntDataTemp = mobjMDCTCATVCOMMI.ProcessRtn_TEMP_ALL(gstrConfigXml, vntData, strUSERID)
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		strUSERID = ""
		vntData = mobjMDCTCATVCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub REAL_MED_CODE1_POP
	...
	with frmThis
		vntInParams = array(.txtYEARMON1.value, .txtREAL_MED_CODE1.value, .txtREAL_MED_NAME1.value, "commi", "CATV") 
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtREAL_MED_CODE1.value,.txtREAL_MED_NAME1.value,"","commi", "CATV")
...
Sub InitPage()
	...
	dim intNo,i
	'서버업무객체 생성	
	set mobjMDCTCATVCOMMI	= gCreateRemoteObject("cMDCT.ccMDCTCATVCOMMI")
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 21, 0, 0, 2
			mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_NAME | AMT | COMMI_RATE | COMMISSION | VAT | SUMAMTVAT | MED_FLAGNAME | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | TRUST_YEARMON | VOCH_TYPE"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|신탁순번|광고주|매체명|매체사|취급액|수수료율|수수료|부가세|계|매체구분|비고|부서명|청구일|발행일|계산서년월|계산서번호|신탁년월|전표타입" 
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        0|	         0|	  0|       4|	 15|    13|    15|    10|       4|    10|    10|11|       5|  10|    10|     9|     9|         9|         5|       0|       0"
			...
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | CLIENTNAME | MEDNAME | REAL_MED_NAME | MED_FLAGNAME | MEMO | DEPT_NAME | TAXYEARMON | TAXNO | TRUST_YEARMON | VOCH_TYPE", -1, -1, 100
			...
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "TRANSYEARMON | TRANSNO | SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_NAME | AMT | COMMI_RATE | COMMISSION | VAT | SUMAMTVAT | MED_FLAGNAME | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | TRUST_YEARMON | VOCH_TYPE" 
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht_DTL, "TRUST_SEQ | MED_FLAGNAME | VOCH_TYPE",-1,-1,2,2,false
		Else
			'Sheet 기본Color 지정
			gSetSheetDefaultColor() 
			'******************************************************************
			...
			'******************************************************************
			gSetSheetColor mobjSCGLSpr, .sprSht_DTL
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 27, 0, 1, 0,0
			mobjSCGLSpr.SpreadDataField .sprSht_DTL,   "CHK | YEARMON | SEQ | MED_FLAG | MED_FLAGNAME | REAL_MED_NAME | REAL_MED_BISNO | CLIENTNAME | CLIENTBISNO | MEDNAME | SUBSEQNAME | MATTERNAME | AMT | COMMI_RATE | COMMISSION | VAT | SUMAMTVAT | MEMO | REAL_MED_CODE | CLIENTCODE | MEDCODE | DEPT_CD | PROJECTION | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | TRANSRANK "
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|매체구분코드|구분|매체사|매체사사업자번호|광고주|광고주사업자번호|매체명|브랜드명|소재명|취급액|수수료율|수수료|부가세|계|비고|매체사코드|광고주코드|매체코드|부서코드|돌출|제작대행사코드|전표구분|부가세유무|생성순서"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|           0|   5|    15|              15|    15|              15|    12|      10|    10|    11|       4|    11|    10|12|  13|         0|         0|       0|       0|   0|             0|       0|         0|      0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			...
			mobjSCGLSpr.ColHidden .sprSht_DTL, "CHK | YEARMON | SEQ | MED_FLAG | MED_FLAGNAME | REAL_MED_NAME | REAL_MED_BISNO | CLIENTNAME | CLIENTBISNO | MEDNAME | SUBSEQNAME | MATTERNAME | AMT | COMMI_RATE | COMMISSION | VAT | SUMAMTVAT | MEMO | REAL_MED_CODE | CLIENTCODE | MEDCODE | DEPT_CD | PROJECTION | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | TRANSRANK ", FALSE
			mobjSCGLSpr.ColHidden .sprSht_DTL, "YEARMON | MED_FLAG | REAL_MED_CODE | CLIENTCODE | MEDCODE | DEPT_CD | PROJECTION | EXCLIENTCODE | VOCH_TYPE | COMMI_TAX_FLAG | TRANSRANK", true
			mobjSCGLSpr.SetCellAlign2 .sprSht_DTL, "SEQ | MED_FLAGNAME",-1,-1,2,2,false
		End If
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCTCATVCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		mlngColCnt=clng(0)
   		...
   		vntData2 = mobjMDCTCATVCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												strYEARMON, strREAL_MED_CODE, strMED_FLAG)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCTCATVCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCTCATVCOMMI.ProcessRtn(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
	...
	with frmThis
		...
		For i = 1 to .sprSht_HDR.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDCTCATVCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDCTCATVCOMMI.DeleteRtn(gstrConfigXml,vntData)
									...
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
										...
										<TR>
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_NAME1, txtREAL_MED_CODE1)"
												width="60">매체사</TD>
											<TD class="SEARCHDATA" width="280"><INPUT class="INPUT_L" id="txtREAL_MED_NAME1" title="코드명" style="WIDTH: 203px; HEIGHT: 22px"
