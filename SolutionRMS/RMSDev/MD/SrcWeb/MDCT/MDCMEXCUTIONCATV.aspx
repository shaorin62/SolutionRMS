<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMEXCUTIONCATV.aspx.vb" Inherits="MD.MDCMEXCUTIONCATV" %>
...
Sub InitPage()
	'서버업무객체 생성	
	set mobjMDCMCATVEXCUTION = gCreateRemoteObject("cMDCT.ccMDCTCATV_MEDIUM")
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		"선택|년월|신탁번호|매체|광고주|매체명|소재명|제작대행사 코드|제작대행사명|제작대행  수수료율|제작대행  수수료|M&C수수료|청약금액|수수료율|수수료|시작일자|종료일자|비고"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "EXSUSURATE", -1, -1, 2
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "EXSUSU | AMT | COMMISSION | MCSUSU", -1, -1, 0
...
Sub EndPage()
	set mobjMDCMCATVEXCUTION = Nothing
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMCATVEXCUTION.EXLIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strCUSTCODE,strPROGRAMNAME)
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCMCATVEXCUTION.EXCUTION_ProcessRtn(gstrConfigXml,vntData)
...
Sub DeleteRtn_Dtl
	...
	with frmThis
		...
		intRtn = mobjMDCMCATVEXCUTION.EXCUTION_DeleteRtn(gstrConfigXml,vntData)
