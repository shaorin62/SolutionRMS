<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVMULTILIST.aspx.vb" Inherits="MD.MDCMCATVMULTILIST" %>
...
Sub CLIENTCODE_POP
	...
	With frmThis
		vntInParams = array(trim(.txtYEAR.value), "CATV") '<< 받아오는경우
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mvntData2 = mobjMDSRPRINTMULTILIST.GetCATVMEDCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strClientAndMed(1), strClientAndMed(2),strVOCH_TYPE)
		mintCnt2 = mlngRowCnt
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_CATVCUSTAndMED(gstrConfigXml,mlngRowCnt,mlngColCnt, mintCnt2, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strClientAndMed(1), strClientAndMed(2), strVOCH_TYPE)
		
		If not gDoErrorRtn ("SelectRtn_CATVCUSTAndMED") then
...
Sub SelectRtn_change ()
	...
	With frmThis
		...
		mvntData2 = mobjMDSRPRINTMULTILIST.GetCATVMEDCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
		mintCnt2 = mlngRowCnt
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_CATVCUSTAndMED(gstrConfigXml,mlngRowCnt,mlngColCnt, mintCnt2, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strClientAndMed(1), strClientAndMed(2), strMED_FLAG)
		If not gDoErrorRtn ("SelectRtn_CATVCUSTAndMED") then
			IF mlngRowCnt <> 0 THEN
				mobjSCGLSpr.SetClipBinding .sprSht, vntData, 1, 1, mlngColCnt, mlngRowCnt, True
			else
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRPRINTMULTILIST.GetCATVCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1), strClientAndMed(2), strVOCH_TYPE)
								...
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="middle" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" width="120"><INPUT class="INPUT" id="txtYEAR" title="년을입력하세요" style="WIDTH: 120px; HEIGHT: 22px" maxLength="4"
													size="14" name="txtYEAR" accessKey="NUM">
											</TD>
											<TD class="SEARCHLABEL" width="70" title="구분을 초기화 합니다.." style="CURSOR: hand" onclick="vbscript:Call gCleanField(cmbVOCH_TYPE1,'')">구분
											</TD>
											<td><SELECT style="Z-INDEX: 0; WIDTH: 102px" id="cmbVOCH_TYPE1" title="구분" name="cmbVOCH_TYPE1">
