<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVTRANSCONFLIST.aspx.vb" Inherits="MD.MDCMCATVTRANSCONFLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCTCATVTRANS.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCTCATVTRANS.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		intRtn = mobjMDCTCATVTRANS.ProcessRtn_Confirm(gstrConfigXml, vntData)
