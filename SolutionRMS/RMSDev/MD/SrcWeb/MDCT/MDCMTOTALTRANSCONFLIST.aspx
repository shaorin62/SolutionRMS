<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALTRANSCONFLIST.aspx.vb" Inherits="MD.MDCMTOTALTRANSCONFLIST" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 위수탁거래명세서 등록 화면(MDCMCATVTRANS.aspx)
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_DTL, "CLIENTNAME | TIMNAME | SUBSEQNAME | MATTERNAME | MEDNAME | REAL_MED_NAME | MED_FLAGNAME | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | DEMANDDAY | PRINTDAY | PUB_DATE "
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "CLIENTNAME | TIMNAME | SUBSEQNAME | MATTERNAME | MEDNAME | REAL_MED_NAME | MED_FLAGNAME | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | DEMANDDAY | PRINTDAY | PUB_DATE " 
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALTRANS.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALTRANS.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		if chkcnt = 0 then
			gErrorMsgBox "승인할 거래명세서 데이터를 체크 하십시오","승인안내"
			exit sub
		end if
		...
		intRtn = mobjMDCTTOTALTRANS.ProcessRtn_Confirm(gstrConfigXml, vntData)
