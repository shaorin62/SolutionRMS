<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVTRUTAXDTL.aspx.vb" Inherits="MD.MDCMCATVTRUTAXDTL" %>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCMTRUTAX	= gCreateRemoteObject("cMDCT.ccMDCTCATVTRUTAX")
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;케이블광고 위수탁 세금계산서</td>
											</tr>
										</table>
									</TD>
