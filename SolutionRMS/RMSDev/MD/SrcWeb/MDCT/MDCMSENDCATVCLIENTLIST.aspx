<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMSENDCATVCLIENTLIST.aspx.vb" Inherits="MD.MDCMSENDCATVCLIENTLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>케이블위수탁 세금계산서 대량 업로드용 조회</title>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		if strCLIENTCODE = "A00003" or strCLIENTCODE = "A00212" then
			vntData = mobjMDCOSENDTRUTAX.Get_SEND_CATVCUST_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG,strCLIENTCODE)
		else
			vntData = mobjMDCOSENDTRUTAX.SENDED_CATV_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG ,strCLIENTCODE)
		end if
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">케이블위수탁 세금계산서 대량 업로드용 조회</td>
										</tr>
									</table>
								</TD>
					...
					<TD style="WIDTH: 100%; HEIGHT: 100%" vAlign="top" align="center">
						<DIV id="pnlTab1" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 100%"
							...
							<OBJECT id="sprSht" style="WIDTH: 100%; HEIGHT: 100%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
								...
								<PARAM NAME="_ExtentY" VALUE="11033">
