<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALMATTERMST.aspx.vb" Inherits="MD.MDCMTOTALMATTERMST" %>
	...
	With frmThis
		...
		If not gDoErrorRtn ("SelectRtn") Then
			If mlngRowCnt > 0 Then
				...
				FOR i =1 TO .sprSht.MaxRows
					If mobjSCGLSpr.GetTextBinding(.sprSht,"ATTR02",i) = "사용" Then
						If dblcnt Then
							strRows = i
							dblcnt = false
						Else
				...
				Else
					...
					If mlngRowCnt > 0 Then
						...
						For intCnt = 0 To mlngRowCnt-1
							...
							ElseIf vntData(0,intCnt) = "T" Then
								strMSG = strMSG & " 종합편성채널: " & vntData(1,intCnt) & "건" 
							End If
						Next
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">종합편성채널-소재정보 관리</td>
										</tr>
									</table>
								</TD>
