<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMSENDTOTALCLIENTLIST.aspx.vb" Inherits="MD.MDCMSENDTOTALCLIENTLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>종합편성방송 세금계산서 대량 업로드용 조회</title>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		if strCLIENTCODE = "A00003" or strCLIENTCODE = "A00212" then
			vntData = mobjMDCOSENDTRUTAX.Get_SEND_TOTALCUST_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG,strCLIENTCODE)
		else
			vntData = mobjMDCOSENDTRUTAX.SENDED_TOTAL_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG ,strCLIENTCODE)
		end if
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td align="left">
												<TABLE cellSpacing="0" cellPadding="0" width="268" background="../../../images/back_p.gIF"
													border="0">
													<TR>
										...
										<tr>
											<td class="TITLE">종합편성방송 세금계산서 대량 업로드용 조회</td>
										</tr>
									</table>
								</TD>
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 58px" vAlign="top" align="center" colSpan="2">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL"  style="WIDTH: 41px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCODESEARCH,'')">년월
											</TD>
											<TD class="SEARCHDATA" width="110"><INPUT class="INPUT" id="txtTAXYEARMON" style="WIDTH: 96px; HEIGHT: 22px" maxLength="8"
										...
										<tr>
											<TD class="SEARCHLABEL" style="WIDTH: 41px; HEIGHT: 24px">광고주
											</TD>
											<TD id="tdCLIENTLIST" class="DATA" colspan="3">
											</TD>
										</tr>
									</TABLE>
								</TD>
					...
					<TD style="WIDTH: 100%; HEIGHT: 100%" vAlign="top" align="center">
						<DIV id="pnlTab1" style="POSITION: relative; WIDTH: 100%; HEIGHT: 100%; VISIBILITY: hidden"
							...
							<OBJECT style="WIDTH: 100%; HEIGHT: 100%" id="sprSht" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
								...
								<PARAM NAME="_ExtentY" VALUE="11138">
