<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTOTALTRANS.aspx.vb" Inherits="MD.MDCMTOTALTRANS" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 위수탁거래명세서 등록 화면(MDCMTOTALTRANSAL.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMTOTALTRANSAL.aspx
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCTTOTALTRANS.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		
		ModuleDir = "MD"
     				 
		ReportName = "MDCMTOTALTRANS_NEW.rpt"
		...
		strUSERID = "" 
		vntDataTemp = mobjMDCTTOTALTRANS.ProcessRtn_TEMP_ALL(gstrConfigXml, vntData, strUSERID)
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		strUSERID = ""
		vntData = mobjMDCTTOTALTRANS.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub printSetTimeout(strTRANSYEARMON, strTRANSNO)
	...
	with frmThis
		intRtn = mobjMDCTTOTALTRANS.DeleteRtn_temp(gstrConfigXml)
		intRtn2 = mobjMDCTTOTALTRANS.DeleteRtnUpdate_PRINTSEQ(gstrConfigXml, strTRANSYEARMON, strTRANSNO)
	end with
end sub
...
Sub ProcessRtn_Confirm_User ()
	...
	with frmThis
		...
		IF intSaveRtn = vbYes then 
			...
			intRtn = mobjMDCTTOTALTRANS.ProcessRtn_Confirm_User(gstrConfigXml,vntData,.txtEMPNO.value)
...
Sub CLIENTCODE1_POP
	...
	with frmThis
		vntInParams = array(.txtYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "trans", "TOTAL") 
...
Sub txtCLIENTNAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtCLIENTCODE1.value,.txtCLIENTNAME1.value,"","trans", "TOTAL")
...
Sub TIMCODE1_POP
	...
	with frmThis
		vntInParams = array(trim(.txtYEARMON1.value), trim(.txtCLIENTCODE1.value), trim(.txtCLIENTNAME1.value), _
							trim(.txtTIMCODE1.value), trim(.txtTIMNAME1.value), "trans", "TOTAL") 
	...
	with frmThis
		If mstrGrid Then
			...
			if Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") then
				...
				intRtn = mobjMDCTTOTALTRANS.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			end if
		END IF
	end with	
End Sub
...
Sub InitPage()
	...
	dim intNo,i
	'서버업무객체 생성	
	set mobjMDCTTOTALTRANS	= gCreateRemoteObject("cMDCT.ccMDCTTOTALTRANS")
...
Sub EndPage()
	set mobjMDCTTOTALTRANS = Nothing
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALTRANS.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		vntData2 = mobjMDCTTOTALTRANS.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCTTOTALTRANS.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCTTOTALTRANS.ProcessRtn(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
	...
	with frmThis
		...
		For i = 1 to .sprSht_HDR.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDCTTOTALTRANS.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDCTTOTALTRANS.DeleteRtn(gstrConfigXml,vntData)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="230" background="../../../images/back_p.gIF"
														border="0">
														<TR>
