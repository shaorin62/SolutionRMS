<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCATVREALMEDLIST.aspx.vb" Inherits="MD.MDCMCATVREALMEDLIST" %>
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_CATVClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
		
		If not gDoErrorRtn ("SelectRtn_CATVClientGroup") then
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRPRINTMULTILIST.GetCATVREAL_MED_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
		
		mvntDataCustCNT = mlngRowCnt
		If not gDoErrorRtn ("GetCATVREAL_MED_CNT") then
			If mlngRowCnt > 0 Then 
				'필드 고정값세팅
				Dim strField
