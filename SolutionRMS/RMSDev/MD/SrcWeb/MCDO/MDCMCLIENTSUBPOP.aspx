<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTSUBPOP.aspx.vb" Inherits="MD.MDCMCLIENTSUBPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTCODE | CUSTNAME | BUSINO | HIGHCUSTCODE | COMPANYNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|사업부|사업자번호|광고주코드|광고주명"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetCLIENTSUBCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtCLIENTSUBCODE.value,.txtCLIENTSUBNAME.value)
