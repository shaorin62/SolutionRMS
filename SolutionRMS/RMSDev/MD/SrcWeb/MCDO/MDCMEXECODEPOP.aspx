<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMEXECODEPOP.aspx.vb" Inherits="MD.MDCMEXECODEPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.Get_EXCLIENTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEXCLIENTCODE.value,.txtEXCLIENTNAME.value)
										...
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0"
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEXCLIENTCODE,txtEXCLIENTNAME)">
														대행사명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtEXCLIENTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtEXCLIENTNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
