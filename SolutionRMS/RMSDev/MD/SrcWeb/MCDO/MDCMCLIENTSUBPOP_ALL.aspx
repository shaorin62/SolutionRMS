<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCLIENTSUBPOP_ALL.aspx.vb" Inherits="MD.MDCMCLIENTSUBPOP_ALL" %>
...
sub InitPage()
	...
	'서버업무객체 생성	
	set mobjSCCOGET = gCreateRemoteObject("cMDCO.ccMDCOGET")
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtCLIENTCODE.value = vntInParam(i)			'조회추가필드
				case 1 : .txtCLIENTNAME.value = vntInParam(i)		'현재 사용중인 것만
				case 2 : .txtCLIENTSUBCODE.value = vntInParam(i)	
				case 3 : .txtCLIENTSUBNAME.value = vntInParam(i)
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTCODE | CUSTNAME | BUSINO | HIGHCUSTCODE | COMPANYNAME | GREATCODE | GREATNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|사업부|사업자번호|광고주코드|광고주명|광고처코드|광고처명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 5|    14|        10|         0|     15 |          0|     15"
			...
			mobjSCGLSpr.ColHidden .sprSht, "HIGHCUSTCODE",true
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTCODE|BUSINO|GREATCODE",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME|COMPANYNAME|GREATNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetCLIENTSUBCODE_ALL(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtCLIENTSUBCODE.value,.txtCLIENTSUBNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,txtCLIENTNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTCODE" type="text" size="9" name="txtCLIENTCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
														광고주 명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtCLIENTNAME" tabIndex="1"></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTSUBCODE,txtCLIENTSUBNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTSUBCODE" type="text" size="9" name="txtCLIENTSUBCODE"
															style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTSUBNAME,txtCLIENTSUBCODE)">
														사업부&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTSUBNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtCLIENTSUBNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
