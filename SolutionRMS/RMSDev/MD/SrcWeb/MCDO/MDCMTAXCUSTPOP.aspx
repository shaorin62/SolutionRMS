<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXCUSTPOP.aspx.vb" Inherits="MD.MDCMTAXCUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | CLIENTCODE | CLIENTNAME | BUSINO"
			mobjSCGLSpr.SetHeader .sprSht, "년월|코드|광고주명|사업자번호"
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht, "TRANSYEARMON|CLIENTCODE|BUSINO",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTAXCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTCODE.value,.txtCUSTNAME.value, mtransTblflag)
							...
							<TR>
								<td style="WIDTH: 148px" align="left" width="148" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE" id="objTitle" valign=bottom>광고주&nbsp;조회
											</td>
										</tr>
									</table>
								</td>
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtYEARMON,'')">년월</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtYEARMON" style="WIDTH: 66px; HEIGHT: 22px" type="text" size="5"
															name="txtYEARMON"></TD>
													<TD class="SEARCHDATA" colSpan="2"></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 68px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTCODE,txtCUSTNAME)">코드</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtCUSTCODE" style="WIDTH: 66px; HEIGHT: 22px" type="text" size="5"
															name="txtCUSTCODE"></TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTCODE,txtCUSTNAME)">광고주</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 165px; HEIGHT: 22px" tabIndex="1" type="text"
															size="21" name="txtCUSTNAME"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
