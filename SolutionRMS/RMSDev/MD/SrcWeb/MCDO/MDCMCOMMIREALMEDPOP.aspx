<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCOMMIREALMEDPOP.aspx.vb" Inherits="MD.MDCMCOMMIREALMEDPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 1 : .txtCUSTNO.value = vntInParam(i)
				case 2 : .txtCUSTNAME.value = vntInParam(i)			'조회추가필드
				case 3 : mstrFlag = vntInParam(i)		'현재 사용중인 것만
				case 4 : mstrTBL_Flag = vntInParam(i)		'코드 사용 시점
				case 5 : msponsor = vntInParam(i)		'조회시 코드를 Like할지 여부
			end select
		next
		'SpreadSheet 디자인
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "YEARMON | REAL_MED_CODE | REAL_MED_NAME | GBN"
			mobjSCGLSpr.SetHeader .sprSht, "년월|코드|매체사|명세서생성"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "7 | 8 | 17 | 10"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "YEARMON"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "REAL_MED_CODE"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "REAL_MED_NAME"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "GBN"
			
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "YEARMON|REAL_MED_CODE|GBN",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "REAL_MED_NAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTNO.value,.txtCUSTNAME.value, strCOMMITCHECK, mstrFlag, mstrTBL_Flag)
...
Sub SheetColChange
	with frmThis
		IF .chkGUBUN.checked = TRUE THEN
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | TRANSNO | REAL_MED_NAME | GBN | REAL_MED_CODE"
			mobjSCGLSpr.SetHeader .sprSht, "명세년월|명세번호|매체사|명세서생성|REAL_MED_CODE"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "7 | 8 | 17 | 10|0"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			...
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "REAL_MED_NAME"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "GBN"
			mobjSCGLSpr.ColHidden .sprSht, "REAL_MED_CODE", true
			
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "TRANSYEARMON|TRANSNO|GBN",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "REAL_MED_NAME",-1,-1,0,2,false
		else
			mobjSCGLSpr.SpreadLayout .sprSht, 4, 0, 0, 0,2
			mobjSCGLSpr.SpreadDataField .sprSht, "YEARMON | REAL_MED_CODE | REAL_MED_NAME | GBN"
								...
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												...
												<TR>
													<TD class="SEARCHLABEL" style=" WIDTH: 68px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														코드</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtCUSTNO" type="text" name="txtCUSTNO" style=" WIDTH: 66px; HEIGHT: 22px"
															size="5">&nbsp;</TD>
													<TD class="SEARCHLABEL" style=" WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,txtCUSTNO)">
														매체사명</TD>
