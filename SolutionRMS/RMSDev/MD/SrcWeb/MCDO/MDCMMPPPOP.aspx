<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMPPPOP.aspx.vb" Inherits="MD.MDCMMPPPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | CUSTNAME"
			mobjSCGLSpr.SetHeader .sprSht, "MPP 코드|MPP 명"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetMPP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTCODE.value,.txtCUSTNAME.value)
										...
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTCODE,txtCUSTNAME)">매체 
														명&nbsp;</TD>
