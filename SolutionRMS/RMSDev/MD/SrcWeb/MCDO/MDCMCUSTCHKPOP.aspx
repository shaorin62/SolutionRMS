<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCUSTCHKPOP.aspx.vb" Inherits="MD.MDCMCUSTCHKPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>광고주 선택/조회</title> 
		<!--
'****************************************************************************************
	...
	With frmThis
		...
		for i=1 to .sprSht.MaxRows
			IF mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 THEN
				IF strFLAG THEN
					strReturn = mobjSCGLSpr.GetTextBinding(.sprSht,"CUSTCODE",i)
					strFLAG = FALSE
				ELSE
					strReturn = strReturn & "|" &mobjSCGLSpr.GetTextBinding(.sprSht,"CUSTCODE",i)
				END IF
			END IF
		Next
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : mstrFLAG = vntInParam(i)	
				case 1 : mstrCUSTFLAG = vntInParam(i)			'조회추가필드
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CHK | CUSTCODE | CUSTNAME | BUSINO"
			mobjSCGLSpr.SetHeader .sprSht,        "선택|코드|거래처|사업자번호"
			mobjSCGLSpr.SetColWidth .sprSht, "-1",   "4|   7|    15|       15"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CUSTCODE"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CUSTNAME|BUSINO"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRREPORTLIST.GetCUSTCHKLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNAME.value, mstrCUSTFLAG)

		if not gDoErrorRtn ("GetCUSTCHKLIST") then
				...
				<TD>
					<FORM id="frmThis">
						<TABLE id="tblTitle" height="28" cellSpacing="0" cellPadding="0" width="100%" 
							border="0">
							<TR>
								<td align="left" width="148" height="28">
								...
								<TD vAlign="middle" height="28">
									<TABLE class="" id="tblWaitP" style="Z-INDEX: 2; LEFT: 158px; VISIBILITY: hidden; WIDTH: 65px; POSITION: absolute; TOP: 0px; HEIGHT: 23px"
										cellSpacing="1" cellPadding="1" width="75%" border="0">
										<TR>
											<TD class="" id="tblWait" style="Z-INDEX: 2"><IMG id="imgWaiting" style="CURSOR: wait" height="23" alt="처리중입니다." src="../../../images/Waiting.GIF"
									...
									<TABLE id="tblButton" style="HEIGHT: 20px" cellSpacing="0" cellPadding="0" border="0" align ="right">
										<TR>
											...
											<TD width="54"><IMG id="imgCancel" onmouseover="JavaScript:this.src='../../../images/imgCancelOn.gif'"
													...
													height="20" alt="화면을 닫습니다." src="../../../images/imgCancel.gif"  border="0"
													name="imgCancel"></TD>
										</TR>
									</TABLE>
								</TD>
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="95%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" width="100%" cellSpacing="0" cellPadding="0" align="left" border="0">
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,'')">
														거래처명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
															name="txtCUSTNAME" tabIndex="1" maxLength="50"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
