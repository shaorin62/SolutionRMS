<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXREAL_MEDPOP.aspx.vb" Inherits="MD.MDCMTAXREAL_MEDPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 3 : mtransTblflag = vntInParam(i)		'현재 사용중인 것만
				case 4 : mtranscommiflag = vntInParam(i)		'코드 사용 시점
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | REAL_MED_CODE | REAL_MED_NAME | BUSINO"
			mobjSCGLSpr.SetHeader .sprSht, "년월|코드|매체사명|사업자번호"
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht, "TRANSYEARMON|REAL_MED_CODE|BUSINO",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTAXREAL_MED_NO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTNO.value,.txtCUSTNAME.value, mtransTblflag)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtYEARMON,'')">
														년월</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtYEARMON" type="text" name="txtYEARMON" style=" WIDTH: 66px; HEIGHT: 22px"
															size="5"></TD>
													<TD class="SEARCHDATA" colspan="2"></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style=" WIDTH: 68px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">코드</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtCUSTNO" type="text" name="txtCUSTNO" style=" WIDTH: 66px; HEIGHT: 22px"
															size="5"></TD>
													<TD class="SEARCHLABEL" style=" WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">매체사</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style=" WIDTH: 165px; HEIGHT: 22px" type="text" name="txtCUSTNAME"
