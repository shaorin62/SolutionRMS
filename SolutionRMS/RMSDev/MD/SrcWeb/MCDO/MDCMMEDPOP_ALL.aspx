<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMEDPOP_ALL.aspx.vb" Inherits="MD.MDCMMEDPOP_ALL" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNO|CUSTNAME|BUSINO|HIGHCUSTCODE|HIGHCUSTNAME|MPP|MPPNAME"
			mobjSCGLSpr.SetHeader .sprSht, "코드|매체명|사업자번호|코드|매체사명|MPP|MPPNAME"
			mobjSCGLSpr.SetColWidth .sprSht, "-1","5|14|        10|   6|      14| 14|     14"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetMEDNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,.txtCUSTNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">코드</TD>
												<TD class="SEARCHDATA" align="left"><INPUT class="INPUT" id="txtCUSTNO" style="WIDTH: 93px; HEIGHT: 22px" type="text" size="10"
														name="txtCUSTNO">&nbsp;</TD>
												<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">매체 
													명&nbsp;</TD>
												<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 140px; HEIGHT: 22px" tabIndex="1" type="text"
														size="18" name="txtCUSTNAME"></TD>
											</TR>
										</TABLE>
									</FONT>
								</TD>
