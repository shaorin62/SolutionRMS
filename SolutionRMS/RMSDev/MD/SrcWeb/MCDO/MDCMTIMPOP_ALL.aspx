<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTIMPOP_ALL.aspx.vb" Inherits="MD.MDCMTIMPOP_ALL" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTCODE | CUSTNAME | CLIENTSUBCODE | CLIENTSUBNAME | HIGHCUSTCODE | COMPANYNAME | GREATCODE | GREATNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|팀명|사업부코드|사업부명|광고주코드|광고주명|광고처코드|광고처명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 5|  12|         0|      10|         0|     15|          0|      15"
			...
			mobjSCGLSpr.ColHidden .sprSht, "CLIENTSUBCODE | HIGHCUSTCODE | GREATCODE ",true
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTCODE",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME | CLIENTSUBNAME | COMPANYNAME | GREATCODE",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetTIMCODE_ALL(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtTIMCODE.value,.txtTIMNAME.value)
