<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMDEPTPOP.aspx.vb" Inherits="MD.MDCMDEPTPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetCC(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCodeName.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px; HEIGHT: 42px" height="42" cellSpacing="0"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHDATA" style="WIDTH: 581px; CURSOR: hand; HEIGHT: 12px" width="581" onclick="vbscript:Call gCleanField(txtCodeName,'')">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;부서코드명 
														&nbsp; <INPUT class="INPUT" id="txtCodeName" style="WIDTH: 116px; HEIGHT: 22px" type="text" size="14"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
