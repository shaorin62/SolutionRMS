<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMREAL_MEDPOP.aspx.vb" Inherits="MD.MDCMREAL_MEDPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 2 : mstrMED_DIV = vntInParam(i)	'medflag를 받는다.  
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | CUSTNAME | BUSINO | COMPANYNAME"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetREAL_MED_CODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHCUSTCODE.value,.txtCUSTNAME.value, mstrMED_DIV)
