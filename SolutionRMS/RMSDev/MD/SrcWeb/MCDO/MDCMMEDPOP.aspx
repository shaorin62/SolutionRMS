<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMEDPOP.aspx.vb" Inherits="MD.MDCMMEDPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|매체명|사업자번호|매체사코드|매체사명"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetMEDCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtREAL_MED_CODE.value, .txtREAL_MED_NAME.value,.txtMEDCODE.value,.txtMEDNAME.value)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_CODE,txtREAL_MED_NAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtREAL_MED_CODE" type="text" size="9" name="txtREAL_MED_CODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_NAME,txtREAL_MED_CODE)">
														매체사&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtREAL_MED_NAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtREAL_MED_NAME" tabIndex="1"></TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtMEDCODE,txtMEDNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtMEDCODE" type="text" size="9" name="txtMEDCODE"
															style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtMEDNAME,txtMEDCODE)">
														매체&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtMEDNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtMEDNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
