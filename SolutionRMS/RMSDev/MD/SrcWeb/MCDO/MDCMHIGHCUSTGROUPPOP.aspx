<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMHIGHCUSTGROUPPOP.aspx.vb" Inherits="MD.MDCMHIGHCUSTGROUPPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtCLIENTSUBCODE.value = vntInParam(i)	
				case 1 : .txtCLIENTSUBNAME.value = vntInParam(i)
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNO | CUSTNAME | BUSINO | COMPANYNAME|ACCUSTCODE|HIGHCUSTCODE|HIGHCUSTNAME"
			mobjSCGLSpr.SetHeader .sprSht, "코드|광고사명|사업자번호|회사 명|회계코드|광고주코드|광고주명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 14 |10| 13|0|0|0"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "CUSTNO"
			...
			mobjSCGLSpr.ColHidden .sprSht, "ACCUSTCODE|HIGHCUSTCODE|HIGHCUSTNAME",true
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNO|BUSINO",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetCUSTNO_HIGHCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCLIENTSUBCODE.value,.txtCLIENTSUBNAME.value, .txtCLIENTCODE.value, .txtCLIENTNAME.value)
