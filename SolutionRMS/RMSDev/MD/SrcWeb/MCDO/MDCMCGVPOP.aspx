<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCGVPOP.aspx.vb" Inherits="MD.MDCMCGVPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>CGV 지점조회</title> 
		<!--
'****************************************************************************************
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtCUSTCODE.value = vntInParam(i)			'조회추가필드
				case 1 : .txtCUSTNAME.value = vntInParam(i)		'현재 사용중인 것만
        ...
        With frmThis
			...
			mobjSCGLSpr.SetHeader .sprSht,		 "지점코드|지점명|사업자번호|매체사코드|매체사명"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetCGVCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCUSTCODE.value, .txtCUSTNAME.value)
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTCODE,'')">
														지점코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTCODE" size="9" name="txtCUSTCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,'')">
														지점명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 140px; HEIGHT: 22px" size="18"
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT style="WIDTH: 392px; HEIGHT: 274px" id="sprSht" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="10371">
											<PARAM NAME="_ExtentY" VALUE="7249">
