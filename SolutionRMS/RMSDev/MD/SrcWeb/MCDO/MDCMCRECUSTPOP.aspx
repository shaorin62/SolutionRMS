<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCRECUSTPOP.aspx.vb" Inherits="MD.MDCMCRECUSTPOP" %>
...
'프로그램명 : MDCMEXCUSTPOP.aspx
'기      능 : 대대행사를 조회하기 위한 팝업
'파라  메터 : 
'			  코드 사용시점, 코드Like할지 여부
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2009/07/22 By Kim Tae Yub
'****************************************************************************************
-->
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CUSTNO | CUSTNAME | BUSINO | COMPANYNAME"
		mobjSCGLSpr.SetHeader .sprSht, "코드|광고사명|사업자번호|회사 명"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 18 |10| 14"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetCRECUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTCODE.value,.txtCUSTNAME.value)

		if not gDoErrorRtn ("GetCRECUSTNO") then
