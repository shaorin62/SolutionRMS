<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMEXEALLPOP.aspx.vb" Inherits="MD.MDCMEXEALLPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtEXCLIENTCODE.value = vntInParam(i)	
				case 1 : .txtEXCLIENTNAME.value = vntInParam(i)
				case 2 : mstrFLAG = vntInParam(i)			'조회추가필드
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "MEDFLAGNAME | EXCLIENTCODE | EXCLIENTNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "구분|코드|제작사"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "6 | 8 | 28"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEDFLAGNAME"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "EXCLIENTCODE"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "EXCLIENTNAME"
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "MEDFLAGNAME | EXCLIENTCODE",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.Get_EXCLIENT_ALL(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEXCLIENTCODE.value,.txtEXCLIENTNAME.value, mstrFLAG)
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEXCLIENTCODE,txtEXCLIENTNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtEXCLIENTCODE" type="text" size="9" name="txtEXCLIENTCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEXCLIENTCODE,txtEXCLIENTNAME)">
														제작사&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtEXCLIENTNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text" size="18"
															name="txtEXCLIENTNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
