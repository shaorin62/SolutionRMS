...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,		"선택|년월|신탁번호|매체|광고주|매체명|소재명|대대행사 코드|대대행사명|대대행  수수료율|대대행  수수료|M&C수수료|단가|금액|수수료율|수수료|게재일|색|면|규격_CM|규격_면|비고"
										...
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 95px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON, '')">년 
													월</TD>
												<TD class="SEARCHDATA" style="WIDTH: 277px"><INPUT class="INPUT" id="txtYEARMON" title="년월조회" style="WIDTH: 88px; HEIGHT: 22px" accessKey="MON"
														type="text" maxLength="6" size="9" name="txtYEARMON" onchange="vbscript:Call gYearmonCheck(txtYEARMON)"></TD>
												<TD class="SEARCHLABEL" style="WIDTH: 103px; CURSOR: hand">매체구분</TD>
												<TD class="SEARCHDATA" style="WIDTH: 79px; CURSOR: hand"><SELECT id="cmbGUBUN" title="매체구분" style="WIDTH: 108px" name="cmbGFLAG1">
											...
											<TR>
												...
												<TD class="SEARCHDATA" style="WIDTH: 277px"><INPUT class="INPUT_L" id="txtCLIENTCODE" title="코드조회" style="WIDTH: 64px; HEIGHT: 22px"
														...
														border="0" name="ImgCLIENTCODE"><INPUT class="INPUT_L" id="txtCLIENTNAME" title="코드명" style="WIDTH: 187px; HEIGHT: 22px"
														type="text" maxLength="100" align="left" size="25" name="txtCLIENTNAME">
												</TD>
												<TD class="SEARCHLABEL" style="WIDTH: 103px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtPROGRAMNAME, '')">소재명
												</TD>
												<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtPROGRAMNAME" title="소재명" style="WIDTH: 304px; HEIGHT: 22px"
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 791px" vAlign="middle" align="center"><FONT face="굴림">
										<TABLE class="DATA" id="tblKey1" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="LABEL" style="WIDTH: 92px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtEXCLIENTCODE, txtEXCLIENTNAME)">대대행사</TD>
												<TD class="DATA" style="WIDTH: 276px"><INPUT class="INPUT_L" id="txtEXCLIENTCODE" title="코드조회" style="WIDTH: 64px; HEIGHT: 22px"
														...
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF" width="23" align="absMiddle"
														border="0" name="ImgEXCLIENTCODE"><INPUT class="INPUT_L" id="txtEXCLIENTNAME" title="코드명" style="WIDTH: 187px; HEIGHT: 22px"
														type="text" maxLength="100" align="left" size="25" name="txtEXCLIENTNAME"></TD>
												<TD class="LABEL" style="WIDTH: 103px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtSUSURATE, '')">수수료율</TD>
												<TD class="DATA" style="WIDTH: 304px"><INPUT class="INPUT_R" id="txtSUSURATE" style="WIDTH: 104px; HEIGHT: 22px" accessKey="NUM"
														...
														onmouseout="JavaScript:this.src='../../../images/ImgApp.gIF'" height="20" alt="대대행사 와 수수료를 일괄적용 합니다." src="../../../images/ImgApp.gif"
