<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXCUSTINTERNETPOP.aspx.vb" Inherits="MD.MDCMTAXCUSTINTERNETPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 3 : mstrgubun = vntInParam(i)		'현재 사용중인 것만
		...
		mobjSCGLSpr.SetHeader .sprSht, "년월|코드|청구지명|사업자번호"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETCOMMI.GetTAXCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTNO.value,.txtCUSTNAME.value, mstrgubun)
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtYEARMON" type="text" name="txtYEARMON" style=" WIDTH: 66px; HEIGHT: 22px"
															size="5">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,'')"></TD>
													<TD class="SEARCHDATA" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" id="txtLB" style=" WIDTH: 68px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
													</TD>
													<TD class="SEARCHDATA" style="WIDTH: 52px"><INPUT class="INPUT" id="txtCUSTNO" type="text" name="txtCUSTNO" style=" WIDTH: 66px; HEIGHT: 22px"
															size="5">&nbsp;</TD>
													<TD class="SEARCHLABEL" id="txtLBNAME" style=" WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,'')">
													</TD>
