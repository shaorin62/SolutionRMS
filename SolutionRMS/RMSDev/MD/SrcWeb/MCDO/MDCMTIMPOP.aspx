<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTIMPOP.aspx.vb" Inherits="MD.SCCOTIMPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetTIMCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtTIMCODE.value,.txtTIMNAME.value)
