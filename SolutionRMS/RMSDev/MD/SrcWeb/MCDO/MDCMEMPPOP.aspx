<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMEMPPOP.aspx.vb" Inherits="MD.MDCMEMPPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetMDEMP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value,"A",.txtDEPTCD.value,.txtDEPTNAME.value)
