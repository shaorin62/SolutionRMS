<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMDEPTCGVPOP.aspx.vb" Inherits="MD.MDCMDEPTCGVPOP" %>
...
'프로그램명 : MDCMDEPTPOP.aspx
'기      능 : CC 코드 조회를 위한 팝업
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2009/07/03 By Kim Tae Yub
'****************************************************************************************
-->
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtDEPT_CODE.value = vntInParam(i)	'CC Code or Name
				case 1 : .txtDEPT_NAME.value = vntInParam(i)	'CC Code or Name
				case 2 : mblnUseOnly = vntInParam(i)		'현재 사용중인 것만
				case 3 : mstrUseDate = vntInParam(i)		'코드 사용 시점
				case 4 : mstrFields = vntInParam(i)			'조회추가필드
			end select
		next
		'SpreadSheet 디자인
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetCC_CGV(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtDEPT_CODE.value, .txtDEPT_NAME.value)
							...
							<TR>
								<td style="WIDTH: 148px" align="left" width="148" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE" id="objTitle" valign=bottom>부서코드조회</td>
										</tr>
									</table>
								</td>
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px; HEIGHT: 42px" height="42" cellSpacing="0"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHDATA" style="WIDTH: 581px; CURSOR: hand; HEIGHT: 12px" width="581" onclick="vbscript:Call gCleanField(txtDEPT_CODE,'')">부서코드 
														&nbsp; <INPUT class="INPUT" id="txtDEPT_CODE" style="WIDTH: 116px; HEIGHT: 22px" type="text" size="14"></TD>
													<TD class="SEARCHDATA" style="WIDTH: 581px; CURSOR: hand; HEIGHT: 12px" width="581" onclick="vbscript:Call gCleanField(txtDEPT_NAME,'')">부서명 
														&nbsp; <INPUT class="INPUT" id="txtDEPT_NAME" style="WIDTH: 116px; HEIGHT: 22px" type="text" size="14"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
