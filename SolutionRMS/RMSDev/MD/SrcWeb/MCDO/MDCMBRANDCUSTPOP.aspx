<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMBRANDCUSTPOP.aspx.vb" Inherits="MD.MDCMBRANDCUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtCUSTNO.value = vntInParam(i)	
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | HIGHCUSTNAME | BUSINO "
		mobjSCGLSpr.SetHeader .sprSht, "코드|광고사명|사업자번호"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 20 |15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "HIGHCUSTCODE"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "HIGHCUSTNAME"
		...
		mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHCUSTNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.Get_HIGHCUST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCUSTNO.value,.txtCUSTNAME.value)
...
-->
							...
							<TR>
								...
								<TD vAlign="middle" height="28">
									<TABLE class="" id="tblWaitP" style="Z-INDEX: 200; LEFT: 150px; VISIBILITY: hidden; WIDTH: 65px; POSITION: absolute; TOP: 0px; HEIGHT: 23px"
										cellSpacing="1" cellPadding="1" width="65px" border="0">
										<TR>
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" height="95%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" width="100%" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" width="392px" cellSpacing="0" cellPadding="0" align="left"
											border="0">
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,txtCUSTNAME)">
														코드</TD>
													<TD class="SEARCHDATA" width="100"><INPUT class="INPUT" id="txtCUSTNO" type="text" size="9" name="txtCUSTNO" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,txtCUSTNO)">광고주 
														명&nbsp;</TD>
	...
	<PARAM NAME="_ExtentY" VALUE="20003">
