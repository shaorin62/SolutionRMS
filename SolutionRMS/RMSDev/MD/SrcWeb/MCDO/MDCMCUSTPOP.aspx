<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCUSTPOP.aspx.vb" Inherits="MD.MDCMCUSTPOP" %>
...
'프로그램명 : SCCOCUSTPOP.aspx
'기      능 : 광고주 팝업
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2009/07/10 By Kim Tae Yub
'****************************************************************************************
-->
...
sub sprSht_DblClick (Col,Row)
	...
	With frmThis
		...
		Else
			window.returnvalue = mobjSCGLSpr.GetClip (.sprSht,1,.sprSht.ActiveRow,-1,1,1)
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtHIGHCUSTCODE.value = vntInParam(i)	
				case 1 : .txtCUSTNAME.value = vntInParam(i)
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | CUSTNAME | BUSINO | COMPANYNAME | GREATCODE | GREATNAME"
			mobjSCGLSpr.SetHeader .sprSht, "코드|청구지|사업자번호|상호명|광고처코드|광고처명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 14 |10| 13| 0| 0"
			...
			mobjSCGLSpr.ColHidden .sprSht, "GREATCODE | GREATNAME",true
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHCUSTCODE|BUSINO",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetHIGHCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHCUSTCODE.value,.txtCUSTNAME.value, "A")
							...
							<TR>
								...
								<TD vAlign="middle" align="right" height="28">
									...
									<TABLE id="tblButton" style="WIDTH: 168px; HEIGHT: 20px" cellSpacing="0" cellPadding="0"
										width="168" border="0">
										<TR>
											<TD><IMG id="imgQuery" onmouseover="JavaScript:this.src='../../../images/imgQueryOn.gif'" style="CURSOR: hand"
													onmouseout="JavaScript:this.src='../../../images/imgQuery.gif'" height="20" alt="자료를 조회합니다."
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHCUSTCODE,txtCUSTNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtHIGHCUSTCODE" type="text" size="9" name="txtHIGHCUSTCODE" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHCUSTCODE,txtCUSTNAME)">광고주</TD>
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 392px; HEIGHT: 274px" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5" VIEWASTEXT>
