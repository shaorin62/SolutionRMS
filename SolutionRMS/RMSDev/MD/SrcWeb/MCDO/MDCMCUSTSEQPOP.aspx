<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCUSTSEQPOP.aspx.vb" Inherits="MD.MDCMCUSTSEQPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, " SEQNO | SEQNAME | CUSTCODE | CUSTNAME | TIMCODE | TIMNAME | CLIENTSUBCODE | CLIENTSUBNAME | DEPT_CD | DEPT_NAME"
		mobjSCGLSpr.SetHeader .sprSht,	  "브랜드코드|브랜드명|광고주코드|광고주명|팀코드|팀명|사업부코드|사업부|부서코드|부서명"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "    0|      10|         0|      15|     0|  10|         0|    10|       0|    10"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.Get_BrandInfo(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtSUBSEQ.value,.txtSUBSEQNAME.value,.txtCUSTCODE.value,.txtCUSTNAME.value)
