<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMSEQCODELISTAL.aspx.vb" Inherits="MD.MDCMSEQCODELISTAL" %>
...
Sub SUBSEQCODE_POP
	...
	with frmThis
		vntInParams = array(trim(.txtSEARCHCUSTCODE.value), trim(.txtSEARCHCUSTNAME.value), trim(.txtSEARCHSEQCODE.value), trim(.txtSEARCHSEQNAME.value)) '<< 받아오는경우
...
Sub txtSEARCHSEQNAME_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			mlngRowCnt=clng(0)
			mlngColCnt=clng(0)
			vntData = mobjMDCMGET.GetDEPT_CDBYCUSTSEQList(gstrConfigXml,mlngRowCnt,mlngColCnt,trim(.txtSEARCHSEQCODE.value),trim(.txtSEARCHSEQNAME.value),trim(.txtSEARCHCUSTCODE.value),trim(.txtSEARCHCUSTNAME.value))
	...
	<body class="base">
		...
		<FORM id="frmThis" method="post" runat="server">
			...
			<TABLE id="tblForm" cellSpacing="0" cellPadding="0" width="1040" border="0">
				<!--Top TR Start-->
				<TR>
					<TD style="WIDTH: 1040px; HEIGHT: 54px">
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0"> <!--TopSplit Start->
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 1040px; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TBODY>
											<TR>
												<TD class="SEARCHLABEL" style="WIDTH: 73px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtSEARCHCUSTCODE,txtSEARCHCUSTNAME)">광고주</TD>
												<TD class="SEARCHDATA" style="WIDTH: 329px"><INPUT class="INPUTB_L" id="txtSEARCHCUSTNAME" title="광고주명조회" style="WIDTH: 232px; HEIGHT: 21px"
														type="text" size="33" name="txtSEARCHCUSTNAME"><IMG id="ImgSEARCHCUST" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF"
														width="23" align="absMiddle" border="0" name="ImgSEARCHCUST"><INPUT class="INPUTB_L" id="txtSEARCHCUSTCODE" title="광고주코드조회" style="WIDTH: 72px; HEIGHT: 21px"
														type="text" size="5" name="txtSEARCHCUSTCODE"></TD>
												<TD class="SEARCHLABEL" style="WIDTH: 82px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtSEARCHSEQCODE,txtSEARCHSEQNAME)">브랜드
												</TD>
												<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtSEARCHSEQNAME" style="WIDTH: 216px; HEIGHT: 22px" tabIndex="0"
														type="text" size="30" name="txtSEARCHSEQNAME" title="브랜드명조회"><IMG id="ImgSUBSEQCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
														style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF" align="absMiddle"
														border="0" name="ImgSUBSEQCODE"><INPUT class="INPUT_L" id="txtSEARCHSEQCODE" title="브랜드코드조회" style="WIDTH: 80px; HEIGHT: 22px"
														tabIndex="0" type="text" size="8" name="txtSEARCHSEQCODE"><INPUT dataFld="ATTR01" id="txtATTR01" style="WIDTH: 5px; HEIGHT: 21px" dataSrc="#xmlBind"
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 1040px; HEIGHT: 22px" vAlign="top" align="center">
									<TABLE class="DATA" id="tblKey1" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="LABEL" title="부서를 삭제합니다." style="WIDTH: 93px; CURSOR: hand; HEIGHT: 11px"
												onclick="vbscript:Call gCleanField(txtCUSTCODE,txtCUSTNAME)">광고주</TD>
											<TD class="DATA" style="WIDTH: 437px; HEIGHT: 8.359pt"><INPUT dataFld="CUSTNAME" class="INPUTB_L" id="txtCUSTNAME" title="광고주명" style="WIDTH: 248px; HEIGHT: 21px"
													dataSrc="#xmlBind" type="text" size="36" name="txtCUSTNAME"><IMG id="ImgCLIENTCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													...
													border="0" name="ImgCLIENTCODE"><INPUT dataFld="CUSTCODE" class="NOINPUT" id="txtCUSTCODE" title="광고주코드" style="WIDTH: 72px"
													accessKey=",M" dataSrc="#xmlBind" readOnly type="text" size="6" name="txtCUSTCODE"></TD>
											<TD class="LABEL" style="WIDTH: 103px; CURSOR: hand; HEIGHT: 11px" onclick="vbscript:Call gCleanField(txtSEQNO,txtSEQNAME)">
												브랜드
											</TD>
											<TD class="DATA"><INPUT dataFld="SEQNAME" class="INPUT_L" id="txtSEQNAME" title="브랜드코드명" style="WIDTH: 232px; HEIGHT: 22px"
													accessKey=",M" dataSrc="#xmlBind" tabIndex="0" type="text" size="33" name="txtSEQNAME"><INPUT dataFld="SEQNO" class="NOINPUT" id="txtSEQNO" title="브랜드코드" style="WIDTH: 88px; HEIGHT: 22px"
													dataSrc="#xmlBind" tabIndex="0" type="text" maxLength="4" size="9" name="txtSEQNO" readOnly>
											</TD>
										</TR>
										<TR>
											<TD class="LABEL" title="사업부를 삭제합니다." style="WIDTH: 93px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTSUBCODE,txtCLIENTSUBNAME)">사업부</TD>
											<TD class="DATA" style="WIDTH: 437px"><INPUT dataFld="CLIENTSUBNAME" class="INPUTB_L" id="txtCLIENTSUBNAME" title="사업부서명" style="WIDTH: 248px; HEIGHT: 21px"
													dataSrc="#xmlBind" type="text" size="36" name="txtCLIENTSUBNAME"><IMG id="ImgCLIENTSUBCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF" width="23" align="absMiddle"
													border="0" name="ImgCLIENTSUBCODE"><INPUT dataFld="CLIENTSUBCODE" class="NOINPUT" id="txtCLIENTSUBCODE" title="사업부코드" style="WIDTH: 72px; HEIGHT: 21px"
													dataSrc="#xmlBind" readOnly type="text" size="6" name="txtCLIENTSUBCODE"><IMG id="ImgCLIENTSUBApp" onmouseover="JavaScript:this.src='../../../images/ImgAppOn.gIF'"
											...
											<TD class="LABEL" title="담당부서를 삭제합니다." style="WIDTH: 103px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtDEPTCD,txtDEPTNAME)">담당부서</TD>
											<TD class="DATA"><INPUT dataFld="DEPTNAME" class="INPUTB_L" id="txtDEPTNAME" title="부서명" style="WIDTH: 208px; HEIGHT: 21px"
													dataSrc="#xmlBind" type="text" size="29" name="txtDEPTNAME"><IMG id="Img1" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'" style="CURSOR: hand"
													onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" height="20" src="../../../images/imgPopup.gIF" width="23" align="absMiddle" border="0"
													name="ImgDEPTCODE"><INPUT dataFld="DEPTCD" class="NOINPUT" id="txtDEPTCD" title="부서코드" style="WIDTH: 89px; HEIGHT: 21px"
													accessKey=",M" dataSrc="#xmlBind" readOnly type="text" size="9" name="txtDEPTCD">
												<IMG id="ImgDEPTApp" onmouseover="JavaScript:this.src='../../../images/ImgAppOn.gIF'"
													...
													height="20" alt="담당부서를 일괄 적용합니다" src="../../../images/ImgApp.gif" width="54" align="absMiddle"
													border="0" name="ImgDEPTApp">
											</TD>
										</TR>
										<TR>
											<TD class="LABEL" title="비고를 삭제합니다." style="WIDTH: 93px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtATTR02,'')">비&nbsp;&nbsp; 
												고</TD>
											<TD class="DATA" colSpan="3"><INPUT dataFld="ATTR02" class="INPUT_L" id="txtATTR02" title="비고" style="WIDTH: 867px; HEIGHT: 22px"
													dataSrc="#xmlBind" tabIndex="0" type="text" size="138" name="txtATTR02"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							...
							<!--List Start-->
							<TR>
								<TD class="LISTFRAME" style="WIDTH: 1040px; HEIGHT: 630px" vAlign="top" align="center">
									<DIV id="pnlTab1" style="VISIBILITY: hidden; WIDTH: 100%; POSITION: relative; HEIGHT: 630px"
										ms_positioning="GridLayout">
										<OBJECT id="sprSht" style="Z-INDEX: 101; LEFT: 0px; WIDTH: 100%; POSITION: absolute; TOP: 0px; HEIGHT: 630px"
