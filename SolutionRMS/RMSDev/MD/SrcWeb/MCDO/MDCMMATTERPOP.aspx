<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMATTERPOP.aspx.vb" Inherits="MD.MDCMMATTERPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "   5|    15|         0|      14|     0|  14|         0|      14|         0|      14|       0|    12|         0|       0"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetMATTER(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTNAME.value, .txtTIMNAME.value, .txtSUBSEQNAME.value, .txtEXCLIENTNAME.value, .txtMATTERNAME.value, .txtDEPT_NAME.value, mstrMEDFLAG)
