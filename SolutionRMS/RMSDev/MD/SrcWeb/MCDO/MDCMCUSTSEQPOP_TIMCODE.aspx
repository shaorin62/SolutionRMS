<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMCUSTSEQPOP_TIMCODE.aspx.vb" Inherits="MD.MDCMCUSTSEQPOP_TIMCODE" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.Get_BrandInfo_TIMCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtSUBSEQ.value,.txtSUBSEQNAME.value,.txtCUSTCODE.value,.txtCUSTNAME.value)
