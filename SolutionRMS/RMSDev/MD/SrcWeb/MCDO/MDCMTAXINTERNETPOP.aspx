<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXINTERNETPOP.aspx.vb" Inherits="MD.MDCMTAXINTERNETPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,     "년월|번호|청구지코드|청구지명|적요"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETCOMMI.GetTAXGUNNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME.value, mstrgubun)
								...
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												...
												<TR>
													<TD class="SEARCHLABEL" id="txtLB"  style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,'')">
														&nbsp;</TD>
													<TD class="SEARCHDATA" style="WIDTH: 72px"><INPUT class="INPUT" id="Text1" style="WIDTH: 73px; HEIGHT: 22px" type="text" size="6"
															name="txtCLIENTCODE">
													</TD>
													<TD class="SEARCHLABEL" id="txtLBNAME" WIDTH="80" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,'')">
														&nbsp;</TD>
