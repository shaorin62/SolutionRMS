<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTRUVOCHFILEPOP.aspx.vb" Inherits="MD.MDCMTRUVOCHFILEPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>전표생성파일 조회</title> 
		<!--
'****************************************************************************************
...
sub InitPage()
	...
	'서버업무객체 생성	
	set ccMDCMPRINTTRUEVOCH = gCreateRemoteObject("cMDPT.ccMDPTPRINTTRUEVOCH")
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtYEARMON.value = vntInParam(i)	'년월
				case 1 : .txtCodeName.value = vntInParam(i)	'파일번호
		...
		mobjSCGLSpr.SetHeader .sprSht, "파일번호|작업진행|생성자|생성일|년월"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "10|8|8|16"
		mobjSCGLSpr.SetRowHeight .sprSht,"-1","13"
		mobjSCGLSpr.SetRowHeight .sprSht,"0","15"
		mobjSCGLSpr.ColHidden .sprSht, "YEARMON", true
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht,"RMSNO|CDATE",,,0,1	'0 좌측 1 우측 2 중앙
...
Sub EndPage()
	set ccMDCMPRINTTRUEVOCH = Nothing
	gEndPage
End Sub
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = ccMDCMPRINTTRUEVOCH.GetFILENO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCodeName.value)
							...
							<TR>
								<td style="WIDTH: 148px" align="left" width="148" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE" id="objTitle" valign="bottom">전표파일 조회</td>
										</tr>
									</table>
								</td>
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px; HEIGHT: 42px" height="42" cellSpacing="0"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 12px" onclick="vbscript:Call gCleanField(txtYEARMON,'')" >년월
													</td>
													<td class="SEARCHDATA"><INPUT id="txtYEARMON" style="WIDTH: 72px; HEIGHT: 21px" type="text" size="6" name="txtYEARMON" class="INPUT">
													</td>
													<td class="SEARCHLABEL" style="CURSOR: hand; HEIGHT: 12px" onclick="vbscript:Call gCleanField(txtCodeName,'')" >전표파일번호 </td>
													<td><INPUT class="INPUT" id="txtCodeName" style="WIDTH: 124px; HEIGHT: 22px" type="text" size="15"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
