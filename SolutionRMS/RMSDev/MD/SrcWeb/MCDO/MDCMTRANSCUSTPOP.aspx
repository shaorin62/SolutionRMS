<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTRANSCUSTPOP.aspx.vb" Inherits="MD.MDCMTRANSCUSTPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 3 : mtranscommiflag = vntInParam(i)		'현재 사용중인 것만
				case 4 : mtransTblflag = vntInParam(i)		'코드 사용 시점
			end select
		next
		'SpreadSheet 디자인
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTCODE.value,.txtCUSTNAME.value, strCOMMITCHECK, mtranscommiflag, mtransTblflag)
	...
	with frmThis
		if mtranscommiflag = "trans" then
			IF .chkGUBUN.checked = TRUE THEN
				...
				mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | TRANSNO | CLIENTNAME | GBN | CLIENTCODE"
				mobjSCGLSpr.SetHeader .sprSht, "명세년월|명세번호|광고주명|명세서생성"
				...
				mobjSCGLSpr.SpreadDataField .sprSht, "YEARMON | CLIENTCODE | CLIENTNAME | GBN"
				mobjSCGLSpr.SetHeader .sprSht, "청구년월|코드|광고주명|명세서생성"
				mobjSCGLSpr.SetColWidth .sprSht, "-1", "7 | 8 | 17 | 10"
				mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
				mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
				...
				mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
				mobjSCGLSpr.SetCellAlign2 .sprSht, "YEARMON|CLIENTCODE|GBN",-1,-1,2,2,false
				mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTNAME",-1,-1,0,2,false
			end if
		else
			IF .chkGUBUN.checked = TRUE THEN
				...
				mobjSCGLSpr.SetHeader .sprSht, "년월|코드|광고주명|명세서생성"
				mobjSCGLSpr.SetColWidth .sprSht, "-1", "7 | 8 | 17 | 10"
				mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
				mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
				mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "YEARMON"
