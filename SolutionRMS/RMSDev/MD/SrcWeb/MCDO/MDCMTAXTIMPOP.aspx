<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXTIMPOP.aspx.vb" Inherits="MD.MDCMTAXTIMPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 5 : mtransTblflag = vntInParam(i)		'현재 사용중인 것만
			end select
		next
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | TIMNAME | TIMCODE | CLIENTNAME | CLIENTCODE"
		mobjSCGLSpr.SetHeader .sprSht,        "명세년월|팀명|팀코드|광고주명|광고주코드"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "      7|  15|     0|      15|        0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TRANSYEARMON | TIMNAME | CLIENTNAME | CLIENTCODE | TIMCODE", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "TRANSYEARMON | TIMNAME | CLIENTNAME | CLIENTCODE | TIMCODE"
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTAXTIMNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value,.txtCUSTCODE.value,.txtCUSTNAME.value, .txtTIMCODE.value, .txtTIMNAME.value, mtransTblflag)
