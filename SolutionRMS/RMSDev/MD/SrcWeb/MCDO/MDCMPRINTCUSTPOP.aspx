<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTCUSTPOP.aspx.vb" Inherits="MD.MDCMPRINTCUSTPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>매체사 선택/조회</title> 
		<!--
'****************************************************************************************
'프로그램명 : MDCMPRINTCUSTPOP.aspx
'기      능 : 광고주 선택/조회
'특이  사항 : 
'----------------------------------------------------------------------------------------
	...
	With frmThis
		...
		for i=1 to .sprSht.MaxRows
			IF mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 THEN
				IF strFLAG THEN
					strReturn = mobjSCGLSpr.GetTextBinding(.sprSht,"CUSTNO",i)
					strFLAG = FALSE
				ELSE
					strReturn = strReturn & "|" &mobjSCGLSpr.GetTextBinding(.sprSht,"CUSTNO",i)
				END IF
			END IF
		Next
		...
		IF strReturn = "" THEN
			...
			exit sub
		END IF
		window.returnvalue = .txtYEAR.value & "♥" & strReturn
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 3, 0, 0, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | CUSTNO | CUSTNAME"
		mobjSCGLSpr.SetHeader .sprSht, "선택|코드|거래처"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "4|10 | 28"
		...
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNO",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRPRINTMULTILIST.GetCUSTEXELIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value,.txtCUSTNAME.value, mstrFLAG)
				...
				<TD>
					<FORM id="frmThis">
						<TABLE id="tblTitle" height="28" cellSpacing="0" cellPadding="0" width="100%" 
							border="0">
							<TR>
								<td style="WIDTH: 153px" align="left" width="148" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE" id="objTitle" valign=bottom>거래처선택/조회
											</td>
										</tr>
									</table>
								</td>
								<TD vAlign="middle" align="right" height="28">
									<TABLE class="" id="tblWaitP" style="Z-INDEX: 200; LEFT: 158px; VISIBILITY: hidden; WIDTH: 65px; POSITION: absolute; TOP: 0px; HEIGHT: 23px"
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNO,'')">년도</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtYEAR" style="WIDTH: 90px; HEIGHT: 22px" type="text" maxLength="4"
															size="9" name="txtYEAR">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCUSTNAME,'')">거래처명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCUSTNAME" style="WIDTH: 140px; HEIGHT: 22px" tabIndex="1" type="text"
															maxLength="50" size="18" name="txtCUSTNAME"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
