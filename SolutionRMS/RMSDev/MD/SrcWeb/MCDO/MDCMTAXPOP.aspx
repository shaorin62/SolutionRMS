<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMTAXPOP.aspx.vb" Inherits="MD.MDCMTAXPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 4 : mtranscommiflag  = vntInParam(i)			'조회추가필드
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "TAXYEARMON|TAXNO|CLIENTCODE|CLIENTNAME|SUMM"
		IF mtranscommiflag = "trans" then
			txtLB.innerHTML ="광고주코드&nbsp;"
			txtLBNAME.innerHTML ="광고주명&nbsp;"
			mobjSCGLSpr.SetHeader .sprSht, "년월|번호|광고주코드|광고주명|적요"
		elseif mtranscommiflag = "commi" then
			txtLB.innerHTML ="매체사코드&nbsp;"
			txtLBNAME.innerHTML ="매체사명&nbsp;"
			mobjSCGLSpr.SetHeader .sprSht,     "년월|번호|매체사코드|매체사명|적요"
		end if
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "6  | 4  | 0        |10       | 22"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "TAXYEARMON"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "TAXNO"
		...
		mobjSCGLSpr.SetCellAlign2 .sprSht, "TAXYEARMON|TAXNO",-1,-1,2,2,false
		mobjSCGLSpr.SetCellAlign2 .sprSht, "SUMM",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMGET.GetTAXGUNNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME.value, mtranscommiflag, mtransTblflag)
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" WIDTH="97" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTRANSYEARMON,txtTRANSNO)">
														세금계산서번호&nbsp;</TD>
													<TD class="SEARCHDATA" colspan="3"><INPUT class="INPUT" id="txtTRANSYEARMON" type="text" size="6" name="txtTRANSYEARMON" style="WIDTH: 73px; HEIGHT: 22px">&nbsp;-
														<INPUT class="INPUT" id="txtTRANSNO" style="WIDTH: 48px; HEIGHT: 22px" type="text" size="2"
															name="txtTRANSNO">
													</TD>
												</TR>
												<TR>
													<TD class="SEARCHLABEL" id="txtLB" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,txtCLIENTNAME)">
														&nbsp;</TD>
													<TD class="SEARCHDATA" style="WIDTH: 72px"><INPUT class="INPUT" id="Text1" style="WIDTH: 73px; HEIGHT: 22px" type="text" size="6"
															name="txtCLIENTCODE">
													</TD>
													<TD class="SEARCHLABEL" id="txtLBNAME" WIDTH="80" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTCODE,txtCLIENTNAME)">
														&nbsp;</TD>
													<TD class="SEARCHDATA" ><INPUT class="INPUT" id="txtCLIENTNAME" type="text" size="18" name="txtCLIENTNAME" style="WIDTH: 144px; HEIGHT: 22px">
													</TD>
												</TR>
											</TBODY>
										</TABLE>
