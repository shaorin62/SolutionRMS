<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETCOMMI.aspx.vb" Inherits="MD.MDCMINTERNETCOMMI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인터넷 수수료거래명세표 생성 및 발행</title>
...
Dim mobjMDCMINTERNETCOMMI, mobjMDCMGET
Dim mstrCheck
Dim mALLCHECK
mALLCHECK = TRUE
mstrCheck=True
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCMINTERNETCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		vntData	= mobjMDCMINTERNETCOMMI.Get_INTERNETCOMMI_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON,strTRANSNO)
		
		strcntsum = 0
		IF not gDoErrorRtn ("Get_INTERNETCOMMI_CNT") then
			...
			for i=1 to 2
				...
				vntDataTemp = mobjMDCMINTERNETCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, datacnt, strUSERID)
			next
		End IF
		Params = strUSERID
		Opt = "A"
...
Sub REAL_MED_CODE_POP
	...
	with frmThis
		...
		vntInParams = array(.txtTRANSYEARMON.value, .txtREAL_MED_CODE.value, .txtREAL_MED_NAME1.value, "commi","INTERNET", strSPONSOR)  
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value,.txtREAL_MED_NAME1.value,"ALL","commi", "INTERNET", strSPONSOR)
...
Sub txtTRANSNO_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON, .txtTRANSNO.value,.txtREAL_MED_CODE.value,.txtREAL_MED_NAME1.value, "commi", "INTERNET", "0")
...
Sub TRU_POP
	...
	with frmThis
		...
		vntInParams = array(strTRANSYEARMON, .txtTRANSNO.value,.txtREAL_MED_CODE.value,.txtREAL_MED_NAME1.value, "commi", "INTERNET") '<< 받아오는경우
...
Sub InitPage()
	...
	With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht,   "CHK |YEARMON | SEQ | REAL_MED_NAME |REAL_MED_BISNO| CLIENTNAME | CLIENTBISNO |SUBSEQ | MEDNAME | AMT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR"
		mobjSCGLSpr.SetHeader .sprSht,		   "선택|YEARMON|SEQ|매체사|매체사사업자번호|광고주|광고주사업자번호|시퀀스|매체명|금액|수수료율|수수료|CLIENTCODE|MEDCODE|REAL_MED_CODE|MED_FLAG|DEPT_CD|COMMI_TAX_FLAG|TRANSRANK|ATTR01|SPONSOR"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|        0|  0|    15|              13|    15|              13|     6|    12|  11|       8|    11|         0|      0|            0|       0|      0|             0|        0|     0|      0"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13" 
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, " CLIENTNAME | REAL_MED_NAME |MEDNAME", -1, -1, 0
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT|COMMISSION", -1, -1, 0
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "COMMI_RATE", -1, -1, 2
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "AMT|COMMISSION" 
		...
		mobjSCGLSpr.SpreadLayout .sprSht_SUM, 21, 1, 0,0,1,1,1,false,true,true,1
		mobjSCGLSpr.SpreadDataField .sprSht_SUM, "CHK |YEARMON | SEQ | REAL_MED_NAME |REAL_MED_BISNO| CLIENTNAME | CLIENTBISNO |SUBSEQ | MEDNAME | AMT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR"
		...
		mobjSCGLSpr.SetHeader .sprSht1,		"TRANSYEARMON|TRANSNO|SEQ|CLIENTCODE|CLIENTNAME|MEDCODE|매체명|REAL_MED_CODE|매체사|DEPT_CD|청구일자|발행일자|금액|수수료율|수수료|부가세|매체종류|SPONSOR |TAXYEARMON|TAXNO|TRUST_SEQ"
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK |YEARMON | SEQ | CLIENTNAME | REAL_MED_NAME | AMT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01")
		'마스터 데이터를 가져 온다.
		...
		intRtn = mobjMDCMINTERNETCOMMI.ProcessRtn(gstrConfigXml,strMasterData,vntData, intCOMMINO,strCOMMIYEARMON, intColFlag1)
...
'		END IF
		...
		ELSE
			...
			vntData1 = mobjMDCMINTERNETCOMMI.SelectRtn_SUSU(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON,strREAL_MED_CODE, strSPONSOR)
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strREAL_MED_CODE)
	...
	vntData = mobjMDCMINTERNETCOMMI.Get_INTERNETCOMMI_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strREAL_MED_CODE)
	
	IF not gDoErrorRtn ("Get_INTERNETCOMMI_HDR") then
		IF mlngRowCnt<=0 then
...
Function SelectRtn_DTL (ByVal strYEARMON,ByVal strTRANSNO, ByVal strREAL_MED_CODE)
	...
	vntData = mobjMDCMINTERNETCOMMI.Get_INTERNETCOMMI_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strREAL_MED_CODE)
	
	IF not gDoErrorRtn ("Get_INTERNETCOMMI_LIST") then
		'조회한 데이터를 바인딩
...
Sub DeleteRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDCMINTERNETCOMMI.DeleteRtn(gstrConfigXml,vntData, strTRANSYEARMON, strTRANSNO)
								...
								<TR>
									<TD style="WIDTH: 300px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">인터넷&nbsp;수수료거래명세 생성및 발행</td>
											</tr>
										</table>
									</TD>
								...
								<TR>
									<TD class="KEYFRAME" style="WIDTH: 791px" vAlign="middle" align="center"><FONT face="굴림">
											<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
												...
												<tr>
													<TD class="SEARCHLABEL" title="청구지코드,명 삭제" style="WIDTH: 91px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_CODE, txtREAL_MED_NAME1)">청구지
													</TD>
