<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETCAMPAIGNPOP.aspx.vb" Inherits="MD.MDCMINTERNETCAMPAIGNPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 1 : .txtCAMPAIGN_CODE.value = vntInParam(i)
				case 2 : .txtCAMPAIGN_NAME.value = vntInParam(i)
				case 3 : mstrFields = vntInParam(i)			'조회추가필드
				case 4 : mblnUseOnly = vntInParam(i)		'현재 사용중인 것만
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "YEARMON | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | SUBSEQ | SUBSEQNAME | TIMCODE | TIMNAME | DEPT_CD | DEPT_NAME | TBRDSTDATE | TBRDEDDATE | EXCLIENTCODE | EXCLIENTNAME | MEMO"
			mobjSCGLSpr.SetHeader .sprSht, "년월|캠페인코드|캠페인|광고주코드|광고주|브랜드코드|브랜드|팀코드|팀명|부서코드|부서명|시작일|종료일|대대행사코드|대대행사|비고"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 0|   0|    15|         0|    10|         0|    10|         0|    10|       0|     0|    10|    10|           0|     10|   10"   
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht, "TBRDSTDATE | TBRDEDDATE", -1, -1, 10
			mobjSCGLSpr.SetCellsLock2 .sprSht, true, "YEARMON | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | SUBSEQ | SUBSEQNAME | TIMCODE | TIMNAME | DEPT_CD | DEPT_NAME | TBRDSTDATE | TBRDEDDATE | EXCLIENTCODE | EXCLIENTNAME | MEMO" 
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CAMPAIGN_NAME | CLIENTNAME | SUBSEQNAME | TIMNAME | EXCLIENTNAME | MEMO",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCOGET.GetCAMPAIGN_INFO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON.value, .txtCAMPAIGN_CODE.value,.txtCAMPAIGN_NAME.value)
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20">
									<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 500px" cellSpacing="0" cellPadding="0" width="500"
										align="right" border="0">
										<TR>
											<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON,'')">년월</TD>
											<TD class="SEARCHDATA" colSpan="3"><INPUT class="INPUT" id="txtYEARMON" style="WIDTH: 90px; HEIGHT: 22px" type="text" maxLength="6"
													name="txtYEARMON"></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCAMPAIGN_CODE,txtCAMPAIGN_NAME)">
												캠페인코드</TD>
											<TD class="SEARCHDATA" width="90"><INPUT class="INPUT" id="txtCAMPAIGN_CODE" type="text" name="txtCAMPAIGN_CODE" style="WIDTH: 90px; HEIGHT: 22px"></TD>
											<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCAMPAIGN_CODE,txtCAMPAIGN_NAME)">
												캠페인명</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCAMPAIGN_NAME" type="text" name="txtCAMPAIGN_NAME" style="WIDTH: 258px; HEIGHT: 22px"
													size="37"></TD>
										</TR>
									</TABLE>
								</TD>
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 500px; HEIGHT: 350px" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											VIEWASTEXT>
