<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETLIST.aspx.vb" Inherits="MD.MDCMINTERNETLIST" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | CAMPAIGN_NAME | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | TBRDSTDATE | TBRDEDDATE | MATTERNAME | AMT | COMMI_RATE | COMMISSION | MEMO | TRU_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|승인여부|명세서여부|년월|순번|캠페인명|광고주|CIC/팀|매체|매체사|랩사|시작일|종료일|소재명|금액|수수료율|수수료|비고|거래명세서번호|제작사코드|제작사명"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|       7|         6|   0|   0|      15|    13|    13|  13|    14|  15|     9|     9|    15|  10|       8|    10|  15|            10|         0|       8"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | CAMPAIGN_NAME | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | MATTERNAME | MEMO | TRU_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME", -1, -1, 100
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | CAMPAIGN_NAME | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | TBRDSTDATE | TBRDEDDATE | MATTERNAME | AMT | COMMI_RATE | COMMISSION | MEMO | TRU_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME "
		mobjSCGLSpr.SetCellAlign2 .sprSht, "GFLAGNAME| CONFIRMFLAG | TRU_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME",-1,-1,2,2,false
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjBOOKLIST.SelectRtn_INTERNET(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, strCAMPAIGN_CODE, strCAMPAIGN_NAME, strCLIENTCODE, strCLIENTNAME, _
												strREAL_MED_CODE, strREAL_MED_NAME, strTIMCODE, strTIMNAME, strMEDCODE, strMEDNAME, _
												strSUBSEQ, strSUBSEQNAME)

		if not gDoErrorRtn ("SelectRtn_INTERNET") then
...
Sub ProcessRtn_ConfirmOK
	...
	with frmThis
		...
		On error resume next
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"CHK | GFLAGNAME | CONFIRMFLAG | YEARMON | SEQ | CAMPAIGN_NAME | CLIENTNAME | TIMNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | TBRDSTDATE | TBRDEDDATE | MATTERNAME | AMT | COMMI_RATE | COMMISSION | MEMO | TRU_TRANS_NO | EXCLIENTCODE | EXCLIENTNAME ")
		
		intRtn = mobjBOOKLIST.ProcessRtn_ConfirmINTERNET_OK(gstrConfigXml,vntData,strFLAG)
		
		if not gDoErrorRtn ("ProcessRtn_ConfirmINTERNET_OK") then 'EXCUTION_ProcessRtn ProcessRtn_Confirm_OK
			'모든 플래그 클리어
...
Sub ProcessRtn_ConfirmCancel
	...
	with frmThis
		...
		if not gDoErrorRtn ("ProcessRtn_ConfirmINTERNET_OK") then 
			'모든 플래그 클리어
			mobjSCGLSpr.SetFlag  .sprSht,meCLS_FLAG
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="175" background="../../../images/back_p.gIF"
														border="0">
														<TR>
										...
										<tr>
											<td class="TITLE">인터넷&nbsp;청약내역 조회 및 승인</td>
										</tr>
									</table>
								</TD>
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="middle" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										...
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCAMPAIGN_NAME1, txtCAMPAIGN_CODE1)"
												width="50">캠페인</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtCAMPAIGN_NAME1" title="코드명" style="WIDTH: 123px; HEIGHT: 22px"
													type="text" maxLength="100" size="14" name="txtCAMPAIGN_NAME1"> <IMG id="ImgCAMPAIGN_CODE1" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													style="CURSOR: hand" onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" src="../../../images/imgPopup.gIF" align="absMiddle"
													border="0" name="ImgCAMPAIGN_CODE1"> <INPUT class="INPUT" id="txtCAMPAIGN_CODE1" title="코드입력" style="WIDTH: 53px; HEIGHT: 22px"
													type="text" maxLength="6" size="1" name="txtCAMPAIGN_CODE1"></TD>
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtMEDNAME1, txtMEDCODE1)"
												width="50">매체명</TD>
											<TD class="SEARCHDATA" colSpan="3"><INPUT class="INPUT_L" id="txtMEDNAME1" title="매체명" style="WIDTH: 123px; HEIGHT: 22px"
