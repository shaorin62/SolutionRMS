<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETMONREALAMTLIST.aspx.vb" Inherits="MD.MDCMINTERNETMONREALAMTLIST" %>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_INTERNET_MEDAMT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, .txtREAL_MED_CODE1.value, .txtCLIENTCODE.value)
