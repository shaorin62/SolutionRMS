<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETTRANSAL.aspx.vb" Inherits="MD.MDCMINTERNETTRANSAL" %>
...
<HTML>
	<HEAD>
		...
		<!--
'****************************************************************************************
'시스템구분 : 위수탁거래명세서 등록 화면(MDCMINTERNETTRANSAL.aspx)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMINTERNETTRANSAL.aspx
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDITINTERNETTRANS.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		strUSERID = ""
		vntDataTemp = mobjMDITINTERNETTRANS.ProcessRtn_TEMP_ALL(gstrConfigXml, vntData, strUSERID)
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		strUSERID = ""
		vntData = mobjMDITINTERNETTRANS.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub printSetTimeout(strTRANSYEARMON, strTRANSNO)
	...
	with frmThis
		intRtn = mobjMDITINTERNETTRANS.DeleteRtn_temp(gstrConfigXml)
		'intRtn2 = mobjMDITINTERNETTRANS.DeleteRtnUpdate_PRINTSEQ(gstrConfigXml, strTRANSYEARMON, strTRANSNO)
	end with
end sub
...
Sub CLIENTCODE1_POP
	...
	with frmThis
		vntInParams = array(.txtYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "trans", "INTERNET") 
...
Sub txtCLIENTNAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtCLIENTCODE1.value,.txtCLIENTNAME1.value,"","trans", "INTERNET")
...
Sub TIMCODE1_POP
	...
	with frmThis
		vntInParams = array(trim(.txtYEARMON1.value), trim(.txtCLIENTCODE1.value), trim(.txtCLIENTNAME1.value), _
							trim(.txtTIMCODE1.value), trim(.txtTIMNAME1.value), "trans", "INTERNET") 
		...
		if Row > 0 and Col >1 then
			if mstrGrid then
				...
				ELSE
					...
					gShowModalWindow "MDCMINTERNETTRANSDTL.aspx",vntInParams , 898,680
	...
	with frmThis
		If mstrGrid Then
			if Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") then
				...
				intRtn = mobjMDITINTERNETTRANS.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			end if
		END IF
	end with
End Sub
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht_HDR, "CHK | CONFIRMGBN | CONFIRMFLAG | CLIENTNAME | MED_FLAGNAME | AMT | VAT | SUMAMTVAT | DEMANDDAY | PRINTDAY | TRANSYEARMON | TRANSNO | CONFIRM_USER | CONFIRMUSER | MEMO | CNT | MED_FLAG"
		mobjSCGLSpr.SetHeader .sprSht_HDR,		  "선택|승인|계산서|광고주|매체구분|공급가액|부가세액|합계금액|청구일|발행일|거래년월|번호|요청자|승인자|비고|상세행수|매체구분코드"
		mobjSCGLSpr.SetColWidth .sprSht_HDR, "-1", "  4|   4|     6|    15|       0|      12|      11|      12|     9|     9|       8|   5|    10|    10|  14|      10|           0"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_HDR, "CONFIRMGBN | CONFIRMFLAG | CLIENTNAME | MED_FLAGNAME | TRANSYEARMON | CONFIRM_USER | CONFIRMUSER | MEMO", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht_HDR, true, "CONFIRMGBN | CONFIRMFLAG | CLIENTNAME | MED_FLAGNAME | AMT | VAT | SUMAMTVAT | DEMANDDAY | PRINTDAY | TRANSYEARMON | TRANSNO | CONFIRM_USER | CONFIRMUSER | MEMO | MED_FLAG"
		mobjSCGLSpr.ColHidden .sprSht_HDR, "MED_FLAG | MED_FLAGNAME", TRUE
		mobjSCGLSpr.SetCellAlign2 .sprSht_HDR, "CONFIRMGBN | CONFIRMFLAG | TRANSYEARMON | MED_FLAGNAME | CONFIRM_USER | CONFIRMUSER" ,-1,-1,2,2,false
...
Sub Grid_Setting ()
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 25, 0, 0, 2
			mobjSCGLSpr.SpreadDataField .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | SUBSEQNAME | TIMNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON "
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|매체명|매체사|랩사|브랜드|팀|소재명|시작일|종료일|금액|부가세|계|비고|담당부서|청구일|발행일|계산서년월|계산서번호|확정구분|신탁년월"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "        0|	         0|	  0|   4|       4|	   0|    12|    13|  13|    10|10|    15|     8|     8|  10| 	 9|10|  15|       0|     0|     0|         9|         9|       0|      0"
			...
			mobjSCGLSpr.SetCellTypeFloat2 .sprSht_DTL, "TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | AMT | VAT | SUMAMTVAT", -1, -1, 0
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "TRANSYEARMON | CLIENTNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | SUBSEQNAME | TIMNAME | MATTERNAME | MEMO | DEPT_NAME | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON ", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, false, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | SUBSEQNAME | TIMNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON " 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "TRANSYEARMON | TRANSNO | SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | SUBSEQNAME | TIMNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON " 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "TRANSYEARMON | TRANSNO | SEQ | PRINT_SEQ | TRUST_SEQ | CLIENTNAME | MEDNAME | REAL_MED_LOWNAME | REAL_MED_NAME | SUBSEQNAME | TIMNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | MEMO | DEPT_NAME | DEMANDDAY | PRINTDAY | TAXYEARMON | TAXNO | CONFIRMFLAG | TRUST_YEARMON ", FALSE
		...
		Else
			...
			'******************************************************************
			gSetSheetColor mobjSCGLSpr, .sprSht_DTL
			mobjSCGLSpr.SpreadLayout .sprSht_DTL, 31, 0, 1, 0,0
			mobjSCGLSpr.SpreadDataField .sprSht_DTL,   "CHK | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK"
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|캠페인코드|캠페인명|광고주코드|광고주명|팀코드|팀명|매체코드|매체명|매체사코드|매체사명|랩사코드|랩사명|브랜드코드|브랜드명|소재명|시작일|종료일|금액|부가세|계|수수료율|수수료|비고|부서코드|부가세유무|제작사코드|전표형태구분|광고주별생성순서"
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|         0|      15|         0|      15|      0| 12|       0|    10|         0|      13|       0|    13|         0|      13|    15|     8|     8|  10|     9|10|       0|     0|  10|       0|         0|         0|           0|              0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
			mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht_DTL, "CHK"
			mobjSCGLSpr.SetCellTypeDate2 .sprSht_DTL, "TBRDSTDATE | TBRDEDDATE", -1, -1, 10
			...
			mobjSCGLSpr.SetCellTypeEdit2 .sprSht_DTL, "YEARMON | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK", -1, -1, 100
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, false, "CHK | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK" 
			mobjSCGLSpr.SetCellsLock2 .sprSht_DTL, true, "YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | SUMAMTVAT | COMMI_RATE | COMMISSION | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK" 
			mobjSCGLSpr.ColHidden .sprSht_DTL, "CHK | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK", FALSE
			mobjSCGLSpr.ColHidden .sprSht_DTL, "YEARMON | CAMPAIGN_CODE | CLIENTCODE | TIMCODE | MEDCODE | REAL_MED_LOWCODE | REAL_MED_CODE | SUBSEQ | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK", true
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDITINTERNETTRANS.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		END IF
   		...
   		vntData2 = mobjMDITINTERNETTRANS.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												  strYEARMON, strCAMPAIGN_CODE, strCLIENTCODE, strTIMCODE, strVOCH_TYPE)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDITINTERNETTRANS.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
...
Sub ProcessRtn_CUST ()
	...
	Dim strCAMPAIGN_CODE, strCAMPAIGN_NAME
	chkcnt = 0
	...
	with frmThis
		...
		'On error resume next
		'쉬트의 변경된 데이터만 가져온다.
		vntData = mobjSCGLSpr.GetDataRows(.sprSht_DTL,"CHK | YEARMON | SEQ | CAMPAIGN_CODE | CAMPAIGN_NAME | CLIENTCODE | CLIENTNAME | TIMCODE | TIMNAME | MEDCODE | MEDNAME | REAL_MED_LOWCODE | REAL_MED_LOWNAME | REAL_MED_CODE | REAL_MED_NAME | SUBSEQ | SUBSEQNAME | MATTERNAME | TBRDSTDATE | TBRDEDDATE | AMT | VAT | SUMAMTVAT | COMMI_RATE | COMMISSION | MEMO | DEPT_CD | TRU_TAX_FLAG | EXCLIENTCODE | VOCH_TYPE | TRANSCUSTRANK")
		...
		strCAMPAIGN_CODE= .txtCAMPAIGN_CODE1.value
		strCAMPAIGN_NAME= .txtCAMPAIGN_NAME1.value
		strCLIENTCODE	= .txtCLIENTCODE1.value
		strCLIENTNAME	= .txtCLIENTNAME1.value
		strTIMCODE		= .txtTIMCODE1.value
		strTIMNAME		= .txtTIMNAME1.value
		
		intRtn = mobjMDITINTERNETTRANS.ProcessRtn_CUST(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
	...
	with frmThis
		...
		For i = 1 to .sprSht_HDR.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDITINTERNETTRANS.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDITINTERNETTRANS.DeleteRtn(gstrConfigXml,vntData)
										...
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
											...
											<TR>
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON1,'')"
													width="60">청구년월</TD>
												<TD class="SEARCHDATA" width="350"><INPUT class="INPUT" id="txtYEARMON1" title="년월조회" style="WIDTH: 98px; HEIGHT: 22px" accessKey="NUM"
											...
											<TR>
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEARMON1,'')">캠페인</TD>
												...
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME1,txtTIMCODE1)"
													width="60">팀</TD>
												<TD class="SEARCHDATA" colspan="2"><INPUT class="INPUT_L" id="txtTIMNAME1" title="팀명" style="WIDTH: 203px; HEIGHT: 22px" type="text"
													...
													<TABLE style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
														<TR>
															...
															<TD><IMG id="ImgConfirmRequest" onmouseover="JavaScript:this.src='../../../images/ImgConfirmRequestOn.gIF'"
																	...
																	height="20" alt="선택된 거래명세서를 승인요청합니다." src="../../../images/ImgConfirmRequest.gIF"
										...
										<TABLE height="28" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/TitleBG.gIF"
											...
											<TR>
												<TD class="TITLE" align="left" width="400" height="22" vAlign="absmiddle">&nbsp; 
													...
													일반 <INPUT id="chkVOCH_TYPE2" title="일반" type="checkbox" name="chkVOCH_TYPE2"></TD>
													...
													<TABLE id="tblButtonDTR" style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
														<TR>
															<TD><IMG id="ImgCRE" onmouseover="JavaScript:this.src='../../../images/ImgCREOn.gIF'" style="CURSOR: hand"
																	onmouseout="JavaScript:this.src='../../../images/ImgCRE.gIF'" height="20" alt="광고주별로 거래명세서를 생성합니다.."
