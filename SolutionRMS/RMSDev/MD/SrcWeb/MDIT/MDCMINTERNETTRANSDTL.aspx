<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETTRANSDTL.aspx.vb" Inherits="MD.MDCMINTERNETTRANSDTL" %>
...
Sub InitPage()
    ...
    with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 14, 0
	    mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON | TRANSNO | SEQ | CAMPAIGN_CODE | CLIENTCODE | CLIENTNAME | REAL_MED_CODE | REAL_MED_NAME | EXCLIENTCODE | EXCLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT "
		mobjSCGLSpr.SetHeader .sprSht,       "거래명세서년월|거래명세서번호|순번|캠페인코드|광고주코드|광고주명|매체사코드|매체사명|랩사코드|랩사명|담당부서코드|담당부서명|금액|부가세"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "           8|             4|   4|         8|         0|      15|         0|      15|       0|    15|           0|        12|  10|    10"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT | VAT ", -1, -1, 0
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "TRANSYEARMON | TRANSNO | SEQ | CAMPAIGN_CODE | CLIENTCODE | CLIENTNAME | REAL_MED_CODE | REAL_MED_NAME | EXCLIENTCODE | EXCLIENTNAME | DEPT_CD | DEPT_NAME ", -1, -1, 200
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"TRANSYEARMON | TRANSNO | SEQ | CAMPAIGN_CODE | CLIENTCODE | CLIENTNAME | REAL_MED_CODE | REAL_MED_NAME | EXCLIENTCODE | EXCLIENTNAME | DEPT_CD | DEPT_NAME | AMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, " CAMPAIGN_CODE | CLIENTNAME | REAL_MED_NAME | EXCLIENTNAME | DEPT_NAME ",-1,-1,2,2,false
...
Function SelectRtn_HDR(ByVal strTRANSYEARMON, ByVal strTRANSNO)
	...
	vntData = mobjMDITINTERNETTRANS.SelectRtn_POPHDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON,strTRANSNO)
...
Function SelectRtn_DTL (ByVal strTRANSYEARMON, ByVal strTRANSNO)
	...
	vntData = mobjMDITINTERNETTRANS.SelectRtn_POPDTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON,strTRANSNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		vntData = mobjSCGLSpr.GetDataRows(.sprSht,"TRANSYEARMON | TRANSNO | SEQ | CAMPAIGN_CODE | CLIENTCODE | CLIENTNAME | REAL_MED_CODE | REAL_MED_NAME | EXCLIENTCODE | EXCLIENTNAME | DEPT_CD | DEPT_NAME | AMT | VAT")
						
		intRtn = mobjMDITINTERNETTRANS.ProcessRtn_VAT(gstrConfigXml,vntData,strTRANSYEARMON,strTRANSNO)
							...
							<TR>
								<TD style="WIDTH: 427px" align="left" width="427" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">인터넷광고 위수탁 거래명세서</td>
										</tr>
									</table>
								</TD>
