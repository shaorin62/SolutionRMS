<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETTRANSCONF.aspx.vb" Inherits="MD.MDCMINTERNETTRANSCONF" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인터넷 거래명세서 승인</title>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDTRANSCONF	= gCreateRemoteObject("cMDIT.ccMDITINTERNETTRANS") '조회
...
sub sprSht_DblClick (ByVal Col, ByVal Row)
	...
	with frmThis
		...
		elseif Row = 0 and Col =1 then
			...
			vntRet = gShowModalWindow("MDCMINTERNETTRANSGUNLIST.aspx",vntInParams , 813,545)
			if isArray(vntRet) then
     		end if
		end if
	end with
