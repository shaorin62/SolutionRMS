<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETSENDCLIENTLIST.aspx.vb" Inherits="MD.MDCMINTERNETSENDCLIENTLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>온라인위수탁 세금계산서 대량 업로드용 조회</title>
...
Sub SelectRtn ()
	...
	with frmThis
		...
		if strCLIENTCODE = "A00003" or strCLIENTCODE = "A00212" then
			vntData = mobjMDCOSENDTRUTAX.Get_SENDED_INTERNETCUST_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG,strCLIENTCODE)
		else
			vntData = mobjMDCOSENDTRUTAX.Get_SENDED_INTERNETCLIENT_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strMEDFLAG,strCLIENTCODE)
		end if
				...
				<TR>
					<TD>
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">온라인위수탁 세금계산서 대량 업로드용 조회</td>
										</tr>
									</table>
								</TD>
						...
						<TABLE id="tblBody" height="95%" cellSpacing="0" cellPadding="0" width="100%" border="0"> <!--TopSplit Start->
							...
							<!--Input Start-->
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 58px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL" style="WIDTH: 46px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtCODESEARCH,'')">년월
											</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTAXYEARMON" style="WIDTH: 96px; HEIGHT: 22px" maxLength="8"
										...
										<tr>
											...
											<TD id="tdCLIENTLIST" class="DATA" colspan="2">
											</TD>
										</tr>
									</TABLE>
								</TD>
