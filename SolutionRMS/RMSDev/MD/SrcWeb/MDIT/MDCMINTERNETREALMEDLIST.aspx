<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETREALMEDLIST.aspx.vb" Inherits="MD.MDCMINTERNETREALMEDLIST" %>
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_INTERNETClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRPRINTMULTILIST.GetINTERNETREAL_MED_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
