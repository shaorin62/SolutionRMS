<%@ Page CodeBehind="MDCMSENDINTERNETTRUTAX.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMSENDINTERNETTRUTAX" %>
...
Sub CLIENTCODE1_POP
	...
	Dim vntInParams
	with frmThis
		vntInParams = array(.txtTAXYEARMON1.value, .txtCLIENTCODE1.value, .txtCLIENTNAME1.value, "INTERNET") 
...
Sub txtCLIENTNAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTAXCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTAXYEARMON1.value,.txtCLIENTCODE1.value,.txtCLIENTNAME1.value, "INTERNET")
	...
	with frmThis
		...
		Else
			If .rdT.checked = True Then
				...
				gShowModalWindow "../MDIT/MDCMINTERNETTRUTAXDTL.aspx",vntInParams , 898,680
				'SelectRtn
			End IF
		end if	
	end with
...
Sub sprSht_ButtonClicked (Col,Row,ButtonDown)
	...
	With frmThis
		If Col = mobjSCGLSpr.CnvtDataField(.sprSht,"BTN") Then
			vntInParams = array(.txtTAXYEARMON1.value, mobjSCGLSpr.GetTextBinding( .sprSht,"BUYLDSCR",.sprSht.ActiveRow), "O", "INTERNET")
	...
	with frmThis
		...
		IF .chkMAE.checked THEN
			if .rdT.checked then
				...
				vntData = mobjMDCOSENTTRUTAX.Get_SENDED_TAX_NO(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strCLIENTCODE, strMED_FLAG, "INTERNET")
		...
		ELSE
			...
			'세금계산서 완료조회
			If .rdT.checked = True Then
				vntData = mobjMDCOSENTTRUTAX.Get_SEND_TAX(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strCLIENTCODE, strMED_FLAG, "INTERNET")
			...
			ElseIf .rdF.checked = True Then			
				vntData = mobjMDCOSENTTRUTAX.Get_SENDED_TAX(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strCLIENTCODE, strMED_FLAG, "INTERNET")
