<%@ Page CodeBehind="MDCMINTERNETTRANSGUNLIST.aspx.vb" Language="vb" AutoEventWireup="false" Inherits="MD.MDCMINTERNETTRANSGUNLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인터넷 위수탁 거래명세 조회</title> 
		<!--
'****************************************************************************************
...
Sub txtTRANSNO_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "trans", "INTERNET")
...
Sub TRU_POP
	...
	strYEARMON = .txtTRANSYEARMON.value
	End If
		vntInParams = array(strYEARMON, .txtTRANSNO.value,.txtCLIENTCODE.value, .txtCLIENTNAME1.value, "trans", "INTERNET") '<< 받아오는경우
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|MEDCODE|MEDNAME| REAL_MED_CODE | REAL_MED_NAME|SUBSEQ|BRANDNAME|CLIENTSUBCODE|CLIENTSUBNAME|PROGRAM |TBRDSTDATE|TBRDEDDATE|DEPT_CD|DEMANDDAY|PRINTDAY|AMT| VAT| TAXYEARMON|TAXNO|MED_FLAG"
		mobjSCGLSpr.SetHeader .sprSht,		 "TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|MEDCODE|매체명|REAL_MED_CODE|매체사|브랜드코드|브랜드명|사업부코드|사업부명|소재명|시작일|종료일|DEPT_CD|DEMANDDAY|발행일자|공급가액|광고대금|부가세|세금계산서년월|세금계산서번호|매체종류"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "         0|	     0|		    0|		   0|      0|    10|	        0|    10|         0|      10|         0|      10|    10|     8|     8|      0|        0|       8|       9|       9|     9|             0|             0|      0"
		...
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "MEDNAME|REAL_MED_NAME|PROGRAM|MED_FLAG|BRANDNAME|CLIENTSUBNAME", -1, -1, 20
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strCUSTCODE)
	...
	vntData = mobjMDCMINTERNETTRANS.Get_INTERNETTRANS_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE)
...
Function SelectRtn_DTL (ByVal strYEARMON,ByVal strTRANSNO, ByVal strCUSTCODE, ByVal strCLIENTSUBCODE)
	...
	vntData = mobjMDCMINTERNETTRANS.Get_INTERNETTRANS_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strCUSTCODE, strCLIENTSUBCODE)
