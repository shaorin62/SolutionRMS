<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETMONREALLIST.aspx.vb" Inherits="MD.MDCMINTERNETMONREALLIST" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,        "구분(매체사)|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|1분기|2분기|3분기|4분기|총합계"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCEXECUTE.SelectRtn_INTERNETMONREALLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)

		if not gDoErrorRtn ("SelectRtn_INTERNETMONREALLIST") then
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If mobjSCGLSpr.GetTextBinding(.sprSht,"REAL_MED_NAME",intCnt) = "합계" Then
