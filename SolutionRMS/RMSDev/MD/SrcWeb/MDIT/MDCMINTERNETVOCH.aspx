<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMINTERNETVOCH.aspx.vb" Inherits="MD.MDCMINTERNETVOCH" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인터넷 전표생성</title>
...
Sub REAL_MED_CODE_POP
	...
	With frmThis
		...
		If isArray(vntRet) Then
			...
			.txtREAL_MED_CODE.value = trim(vntRet(0,0))
			.txtREAL_MED_NAME.value = trim(vntRet(1,0))
		End If
	End With
...
Sub txtSUMM_onchange
	...
	If blnByteCHk  > 23 Then
		intRtn = gYesNoMsgbox("데이터 의 크기는 23Byte 를 넘을수 없습니다. 초기화 하시겠습니까?","처리안내!")
...
Sub InitPage()
	...
	'서버업무객체 생성	
	Set mobjMDCMINTERNETVOCH = gCreateRemoteObject("cMDIT.ccMDITINTERNETVOCH")
    ...
    with frmThis
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_AMT, "CUSTOMERCODE | CUSTNAME | BA | COSTCENTER | DEPT_NAME | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | REAL_MED_NAME | GBN | DEBTOR | ACCOUNT | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | GFLAG | MEDFLAG | AMTGBN", -1, -1, 200
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht_AMT,true,"CUSTOMERCODE | CUSTNAME | REAL_MED_NAME | DEPT_NAME | SUMM | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | GBN | DOCUMENTDATE | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		...
		mobjSCGLSpr.SpreadLayout .sprSht_GEN, 29, 0, 4
		mobjSCGLSpr.SpreadDataField .sprSht_GEN,    "CHK | POSTINGDATE | CUSTOMERCODE | CUSTNAME | SUMM | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | REAL_MED_NAME | GBN | DOCUMENTDATE | PAYCODE | PREPAYMENT | FROMDATE | TODATE | SUMMTEXT | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | GFLAG | MEDFLAG | AMTGBN | TAXNOSEQ"
		mobjSCGLSpr.SetHeader .sprSht_GEN,		    "선택|전표일자|거래처코드|거래처|적요|금액|부가세|세무코드|BP|지급기일|광고주지급일|상대VENDOR|매체사명|구분|증빙일|지급방법|선수금구분|선수금(시작일)|선수금(종료일)|본문TEXT|RMS년월|RMS번호|전표번호|에러코드|에러메세지|GFLAG|MEDFLAG | AMTGBN | TAXNOSEQ"
		mobjSCGLSpr.SetColWidth .sprSht_GEN, "-1",  "   4|       8|        10|    15|  17|  10|    10|       6| 5|       8|           8|        10|      15|   0|     8|      20|        10|            13|            13|      20|      7|      7|       9|       0|        10|    0|       0|       0|		6"
		...
		mobjSCGLSpr.SpreadLayout .sprSht_GENDTL, 35, 0, 4
		mobjSCGLSpr.SpreadDataField .sprSht_GENDTL,    "POSTINGDATE | CUSTOMERCODE | CUSTNAME | SUMM | BA | COSTCENTER | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | REAL_MED_NAME | GBN | ACCOUNT | DEBTOR | BMORDER | DOCUMENTDATE | PAYCODE | BANKTYPE | PREPAYMENT | FROMDATE | TODATE | SUMMTEXT | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | GFLAG | MEDFLAG | AMTGBN | TRANSRANK | TAXNOSEQ"
		mobjSCGLSpr.SetHeader .sprSht_GENDTL,		    "전표일자|거래처코드|거래처|적요|사업영역|코스트센터|금액|부가세|세무코드|BP|지급기일|입금기일|상대VENDOR|매체사명|구분|차변계정|계정|BMORDER|증빙일|지급방법|BANKTYPE|선수금구분|선수금(시작일)|선수금(종료일)|본문TEXT|RMS년월|RMS번호|전표번호|에러코드|에러메세지|GFLAG|MEDFLAG | AMTGBN | TRANSRANK | TAXNOSEQ"
		mobjSCGLSpr.SetColWidth .sprSht_GENDTL, "-1",  "        8|        10|    15|  17|       5|         8|  10|    10|       6| 5|       8|       8|        10|      15|   0|       7|   7|      7|     8|      20|      20|        10|            13|            13|      20|      7|      7|       9|       0|        10|    0|       0|       0|          0|        5"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht_GENDTL,true,"CUSTOMERCODE | CUSTNAME | REAL_MED_NAME | AMT | BP | VENDOR | GBN |  TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG| TRANSRANK | TAXNOSEQ"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht_SUSUDTL,true,"CUSTOMERCODE | CUSTNAME | SUMM | AMT | VAT | BP | VENDOR | GBN | DEBTOR | ACCOUNT | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht_OUT, "AMT | VAT | TAXNO | TRANSRANK", -1, -1, 0 '숫자형
...
Sub EndPage()
	set mobjMDCMINTERNETVOCH = Nothing
...
Sub Get_COMBO_VALUE ()		
	...
	With frmThis	
		...
		vntData = mobjMDCMINTERNETVOCH.Get_COMBO_VALUE(gstrConfigXml,mlngRowCnt,mlngColCnt,"PD_PAYCODE")
...
Sub Get_SUBCOMBO_VALUE(strCODE, row, sprsht)
	...
	With frmThis   
		...
		strCODE = replace(strCODE,"-","")
       	...
       	vntData = mobjMDCMINTERNETVOCH.Get_SUBCOMBO_VALUE(gstrConfigXml, mlngRowCnt, mlngColCnt, strCODE)
...
Sub SelectRtn_AMT ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETVOCH.SelectRtn_AMT(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
...
Sub SelectRtn_GEN ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETVOCH.SelectRtn_GEN(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
													strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
													strGBN, strSALEGBN)
			...
			if mlngRowCnt > 0 Then
				...
				For intCnt = 1 To .sprSht_GEN.MaxRows
					...
					elseif .rdF.checked or .rdE.checked then
						...
						if intTAXNO = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TAXNO",intCnt) then
							mobjSCGLSpr.SetCellShadow .sprSht_GEN, -1, -1, intCnt, intCnt,&HCCFFFF, &H000000,False
							mobjSCGLSpr.SetCellShadow .sprSht_GEN, -1, -1, intCnt -1, intCnt -1,&HCCFFFF, &H000000,False
							
						'	gErrorMsgBox intCnt - 1 & "  번째 와" & intCnt & "  번째 행의 경우 둘중 한개의 전표 만 생성 하시면 됩니다. "& vbCrlf & "    매체사가 다른 한개의 계산서 입니다.","전표 생성 안내"
						else
							intTAXNO = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TAXNO",intCnt)
						end if 
					End If
				Next
...
Sub SelectRtn_GENDTL (Col, Row)
	...
	with frmThis
		...
		strTAXYEARMON = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TAXYEARMON",Row)
		strTAXNO = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TAXNO",Row)
		strTAXNOSEQ = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TAXNOSEQ",Row)
		
		
		if .rdSALE.checked then
			vntData = mobjMDCMINTERNETVOCH.SelectRtn_GENDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
		elseif .rdBUY.checked then
			vntData = mobjMDCMINTERNETVOCH.SelectRtn_GENBUYDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO,strTAXNOSEQ)
		else
			vntData = mobjMDCMINTERNETVOCH.SelectRtn_GENMCBUYDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
		end if
		...
		If not gDoErrorRtn ("SelectRtn_GENDTL") Then
			If mlngRowCnt >0 Then
				...
				elseif .rdMCBUY.checked then 
					IF .rdF.checked THEN 
				'이은지씨 요청으로 임시적으로 이렇게 표시함 201103 KTY
						For intCnt2 = strRow To .sprSht_GENDTL.MaxRows
							if intCnt2 mod 2 = 1 then
						'		mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"BA",intCnt2, "E104"
						'		mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"COSTCENTER",intCnt2, "E1004"
								mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"ACCOUNT",intCnt2, "630190"
								mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"DEBTOR",intCnt2, "404103"
							else
						'		mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"BA",intCnt2, "E009"
						'		mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"COSTCENTER",intCnt2, "E0009"
								mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"ACCOUNT",intCnt2, "630190"
								mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"DEBTOR",intCnt2, "404103"
							end if
						Next
...
Sub SelectRtn_SUSU ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETVOCH.SelectRtn_SUSU(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
													  strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
													  strGBN)
...
Sub SelectRtn_SUSUDTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETVOCH.SelectRtn_SUSUDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
...
Sub SelectRtn_OUT ()
	...
	with frmThis
		...
		vntData = mobjMDCMINTERNETVOCH.SelectRtn_OUT(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, strEDYEARMON, _
													  strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
		...
		if .chkSUMMAE.checked = true then
			...
			if mstrPROCESS = "Create" then
				For intCnt = 1 To .sprSht_GENDTL.MaxRows
					...
					'DTL 시트의 같은 로우 묶음은 하나의 전표번호가 채번된다.VENDOR
					If strTAXYEARMON = mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TAXYEARMON",intCnt) and _
							strTAXNO = mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TAXNO",intCnt) and _
							strTAXNOSEQ = mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TAXNOSEQ",intCnt) Then
					ELSE
					...
					strTAXNOSEQ = mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TAXNOSEQ",intCnt)
					...
					if mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"chk",intCnt) = "1" then		
						...
						if strIF_CNT = "1" then
							...
							strITEMLIST = strITEMLIST + cstr(strHSEQ) + "|" + _
										...
										cstr(mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"TAXNO",intCnt)) + "|" + _
										...
										If mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"CHK",j) = 1 Then
											...
											If CDbl(mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"TRANSRANK",j)) = intCnt Then	
												...
												strITEMLIST = strITEMLIST + ":" + cstr(strHSEQ) + "|" + _
															...
															cstr(mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"TAXNO",j)) + "|" + _
...
Sub Set_VochValue (strRETURNLIST)
	...
	With frmThis
		if mstrPROCESS ="Create" then
			IF mstrGUBUN = "T" THEN
				intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "O")
			ELSEIF mstrGUBUN = "D" THEN
				if .rdSALE.checked then
					intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "O")
				ELSEif .rdMCBUY.checked then
					intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "OAA")
				else
					intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "OD")
				end if
			ELSEIF mstrGUBUN = "S" THEN
				intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "O")
			ELSEIF mstrGUBUN = "O" THEN
				intRtn = mobjMDCMINTERNETVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "O2")
			END IF
   		...
   		elseif mstrPROCESS ="Delete" then
   			IF mstrGUBUN = "D" THEN
				if .rdSALE.checked then
					intRtn = mobjMDCMINTERNETVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "INTERNET" )
				ELSEif .rdMCBUY.checked then
					intRtn = mobjMDCMINTERNETVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "INTERNET" )
				else
					intRtn = mobjMDCMINTERNETVOCH.VOCHDELL_BUY(gstrConfigXml, strRETURNLIST, mstrGUBUN, "INTERNET", "OD")
				end if
			elseIF mstrGUBUN = "O" THEN
				intRtn = mobjMDCMINTERNETVOCH.VOCHDELL_BUY(gstrConfigXml, strRETURNLIST, mstrGUBUN, "INTERNET", "O2")
			ELSE
				intRtn = mobjMDCMINTERNETVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "INTERNET" )
			END IF
...
sub ErrVochDeleteRtn
	...
	with frmThis
		...
		intRtn = mobjMDCMINTERNETVOCH.DeleteRtn(gstrConfigXml,vntData)
		...
		If mstrGUBUN = "T"  then  
			for i = .sprSht_AMT.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_AMT,"CHK",i) = 1 Then
					...
					intRtn = mobjMDCMINTERNETVOCH.DeleteRtn_GANG(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "INTERNET" )
			...
			for i = .sprSht_GEN.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"CHK",i) = 1 Then
					...
					ELSEIF .rdMCBUY.checked then
						...
						intRtn = mobjMDCMINTERNETVOCH.DeleteRtn_GANG_BUY(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "INTERNET", "OD")
					end if
		...
		ELSEIf mstrGUBUN = "O"  then
			for i = .sprSht_OUT.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"CHK",i) = 1 Then
					...
					intRtn = mobjMDCMINTERNETVOCH.DeleteRtn_GANG_BUY(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "INTERNET", "O2")
...
-->
	...
	<body class="base">
				...
				<TR>
					<TD>
							...
							<TR>
								<TD id="TD1" height="20" width="400" align="left" runat="server">
									<table border="0" cellSpacing="0" cellPadding="0" width="100%">
										<tr>
											<td align="left">
												<TABLE border="0" cellSpacing="0" cellPadding="0" width="95" background="../../../images/back_p.gIF">
													<TR>
						...
						<TABLE style="WIDTH: 100%" id="tblBody" border="0" cellSpacing="0" cellPadding="0" height="93%"> <!--TopSplit Start->
							...
							<TR>
								<TD style="WIDTH: 100%; HEIGHT: 15px" class="KEYFRAME" vAlign="top" colSpan="2" align="center">
									<TABLE id="tblKey" class="SEARCHDATA" border="0" cellSpacing="1" cellPadding="0" width="100%">
										<TR>
											<TD style="CURSOR: hand" class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtDEPTCODE,'')"
												width="60">&nbsp;년월
											</TD>
											<TD class="SEARCHDATA" width="90"><INPUT accessKey="NUM" style="WIDTH: 88px; HEIGHT: 22px" id="txtYEARMON" class="INPUT"
													maxLength="6" size="9" name="txtYEARMON"></TD>
											<TD class="SEARCHDATA" width="90"><INPUT accessKey="NUM" style="WIDTH: 88px; HEIGHT: 22px" id="txtEDYEARMON" class="INPUT"
											...
											<TD class="SEARCHDATA" width="220"><INPUT style="WIDTH: 142px; HEIGHT: 22px" id="txtCLIENTNAME" class="INPUT_L" title="광고주명"
													maxLength="100" size="16" name="txtCLIENTNAME"> <IMG style="CURSOR: hand" id="ImgCLIENTCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" border="0" name="ImgCLIENTCODE" align="absMiddle" src="../../../images/imgPopup.gIF">
												<INPUT accessKey=",M" style="WIDTH: 53px; HEIGHT: 22px" id="txtCLIENTCODE" class="INPUT_L"
													title="광고주코드" maxLength="6" size="3" name="txtCLIENTCODE"></TD>
											<TD style="CURSOR: hand" class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtREAL_MED_NAME,txtREAL_MED_CODE)"
												width="60">&nbsp;매체사
											</TD>
											<TD class="SEARCHDATA"><INPUT style="WIDTH: 142px; HEIGHT: 22px" id="txtREAL_MED_NAME" class="INPUT_L" title="매체사명"
													maxLength="100" size="16" name="txtREAL_MED_NAME"> <IMG style="CURSOR: hand" id="ImgREAL_MED_CODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" border="0" name="ImgREAL_MED_CODE" align="absMiddle" src="../../../images/imgPopup.gIF">
												<INPUT accessKey=",M" style="WIDTH: 53px; HEIGHT: 22px" id="txtREAL_MED_CODE" class="INPUT_L"
													title="매체사코드" maxLength="6" name="txtREAL_MED_CODE">
											</TD>
										...
										<TR>
											...
											<TD class="SEARCHDATA" colSpan="4"><INPUT id="rdT" title="완료내역조회" onclick="vbscript:Call Set_delete('imgVochDelco')" value="rdT"
													type="radio" name="rdGBN">&nbsp;완료&nbsp; <INPUT id="rdF" title="미완료 내역조회" onclick="vbscript:Call Set_delete('imgVochDelco')" value="rdF"
													CHECKED type="radio" name="rdGBN">&nbsp;미완료&nbsp; <INPUT id="rdE" title="오류전표 내역조회" onclick="vbscript:Call Set_delete('imgVochDelco')" value="rdE"
													type="radio" name="rdGBN">&nbsp;오류&nbsp;
											</TD>
											<TD style="CURSOR: hand" class="SEARCHLABEL" onclick="vbscript:Call gCleanField(txtEXCLIENTNAME,txtEXCLIENTCODE)"
												width="60">대대행사
											</TD>
											<TD class="SEARCHDATA"><INPUT style="WIDTH: 142px; HEIGHT: 22px" id="txtEXCLIENTNAME" class="INPUT_L" title="코드명"
													maxLength="100" align="left" size="18" name="txtEXCLIENTNAME"> <IMG style="CURSOR: hand" id="ImgEXCLIENTCODE" onmouseover="JavaScript:this.src='../../../images/imgPopupOn.gIF'"
													onmouseout="JavaScript:this.src='../../../images/imgPopup.gIF'" border="0" name="ImgEXCLIENTCODE" align="absMiddle" src="../../../images/imgPopup.gIF">
												<INPUT style="WIDTH: 53px; HEIGHT: 22px" id="txtEXCLIENTCODE" class="INPUT" title="코드조회"
							...
							<!--Input Start-->
							<TR>
								<td class="DATA">합계 : <INPUT accessKey="NUM" style="WIDTH: 120px; HEIGHT: 20px" id="txtSUMAMT" class="NOINPUTB_R"
							...
							<TR>
								<TD class="KEYFRAME" vAlign="middle" align="center">
									<TABLE border="0" cellSpacing="0" cellPadding="0" width="100%" background="../../../images/TitleBG.gIF"
										...
										<TR>
											<TD style="HEIGHT: 26px" width="100%" align="left"><INPUT style="BACKGROUND-IMAGE: url(../../../images/imgTabOn.gIF)" id="btnTab1" class="BTNTABON"
													value="취급액" type="button" name="btnTab1"> <INPUT style="BACKGROUND-IMAGE: url(../../../images/imgTab.gIF)" id="btnTab2" class="BTNTAB"
													value="일반" type="button" name="btnTab2"> <INPUT style="BACKGROUND-IMAGE: url(../../../images/imgTab.gIF)" id="btnTab3" class="BTNTAB"
													value="수수료" type="button" name="btnTab3"> <INPUT style="BACKGROUND-IMAGE: url(../../../images/imgTab.gIF)" id="btnTab4" class="BTNTAB"
													value="대대행" type="button" name="btnTab4">
											</TD>
											<TD height="20" vAlign="middle" align="right">
												<!--Common Button Start-->
												<TABLE style="HEIGHT: 20px" id="tblButton" border="0" cellSpacing="0" cellPadding="2" width="50">
													<TR>
														<td><IMG style="CURSOR: hand" id="ImgvochCre" onmouseover="JavaScript:this.src='../../../images/ImgvochCreOn.gIF'"
																onmouseout="JavaScript:this.src='../../../images/ImgvochCre.gIF'" border="0" name="ImgvochCre"
																alt="전표를 저장합니다." src="../../../images/ImgvochCre.gIF" height="20"></td>
														...
														<td><IMG style="CURSOR: hand" id="ImgErrVochDel" onmouseover="JavaScript:this.src='../../../images/ImgErrVochDelOn.gif'"
																onmouseout="JavaScript:this.src='../../../images/ImgErrVochDel.gIF'" border="0" name="ImgErrVochDel"
								...
								<TD>
									<TABLE id="tblKey1" class="SEARCHDATA" border="0" cellSpacing="1" cellPadding="0" width="100%">
										<TR>
											...
											<TD class="DATA"><INPUT style="WIDTH: 368px; HEIGHT: 21px" id="txtSUMM" class="INPUT_L" title="적요적용" size="56"
													name="txtSUMM"><IMG style="CURSOR: hand" id="ImgSUMMApp" onmouseover="JavaScript:this.src='../../../images/ImgAppOn.gIF'"
													title="적요를 일괄 적용합니다" onmouseout="JavaScript:this.src='../../../images/ImgApp.gIF'" border="0" name="ImgSUMMApp"
													alt="적요를 일괄 적용합니다" align="absMiddle" src="../../../images/ImgApp.gif" width="54" height="20">
												<DIV style="POSITION: absolute; WIDTH: 450px; HEIGHT: 24px; VISIBILITY: hidden" id="pnlGUBUN"
													align="center" ms_positioning="GridLayout">&nbsp;&nbsp;&nbsp;&nbsp; <INPUT id="rdSALE" title="매출" value="SALE" CHECKED type="radio" name="rdGROUP">&nbsp;매출&nbsp;&nbsp;&nbsp; 
													&nbsp; <INPUT id="rdBUY" title="매입" value="BUY" type="radio" name="rdGROUP">&nbsp;매입&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT id="chkSUMMAE" title="매입합산체크" type="checkbox" name="chkSUMMAE">&nbsp;합산&nbsp;&nbsp;&nbsp; 
													&nbsp; <INPUT id="rdMCBUY" title="MC일반매출건을 매입으로 생성" value="MCBUY" type="radio" name="rdGROUP">&nbsp;MC일반매출-&gt;매입</DIV>
												<DIV style="POSITION: absolute; WIDTH: 250px; HEIGHT: 24px; VISIBILITY: hidden" id="pnlFLAG"
													align="center" ms_positioning="GridLayout">&nbsp;&nbsp;&nbsp;&nbsp; <INPUT id="rdDIV" title="분할" value="rdDIV" CHECKED type="radio" name="rdDIVGUBUN">&nbsp;분할&nbsp;&nbsp;&nbsp; 
													&nbsp; <INPUT id="rdSUM" title="합산" value="rdSUM" type="radio" name="rdDIVGUBUN">&nbsp;합산</DIV>
											</TD>
										</TR>
									</TABLE>
								</TD>
							...
							<TR>
								<TD style="WIDTH: 100%; HEIGHT: 10px" class="BODYSPLIT"></TD>
							</TR>
							<!--내용 및 그리드-->
							<TR vAlign="top" align="left">
								<!--내용-->
								<TD style="WIDTH: 100%; HEIGHT: 80%" class="LISTFRAME" vAlign="top" align="center">
									<DIV style="POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; VISIBILITY: hidden; LEFT: 7px"
										id="pnlTab_amt" ms_positioning="GridLayout">
										<OBJECT style="WIDTH: 100%; HEIGHT: 100%" id="sprSht_AMT" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
									...
									<DIV style="POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; VISIBILITY: hidden; LEFT: 7px"
										id="pnlTab_susu" ms_positioning="GridLayout">
										...
										<OBJECT style="WIDTH: 100%; HEIGHT: 30%" id="sprSht_SUSUDTL" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="31855">
											<PARAM NAME="_ExtentY" VALUE="3915">
											<PARAM NAME="_StockProps" VALUE="64">
											<PARAM NAME="Enabled" VALUE="-1">
											<PARAM NAME="AllowCellOverflow" VALUE="0">
											<PARAM NAME="AllowDragDrop" VALUE="0">
									...
									<DIV style="POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; VISIBILITY: hidden; LEFT: 7px"
										id="pnlTab_out" ms_positioning="GridLayout">
		...
		</TR></TABLE><iframe style="WIDTH: 100%; DISPLAY: block; HEIGHT: 300px" id="frmSapCon" src="../../../MD/WebService/TRUVOCHWEBSERVICE.aspx"
