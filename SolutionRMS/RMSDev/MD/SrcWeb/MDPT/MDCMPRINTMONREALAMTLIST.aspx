<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTMONREALAMTLIST.aspx.vb" Inherits="MD.MDCMPRINTMONREALAMTLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>매체사별/매체비 집행현황</title>
...
Sub imgPrint_onclick ()
	...
	Dim i
	Dim strYEARMON
	Dim strCLIENTCODE, strREAL_MED_CODE, strTBLNAME
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 12, 0, 1, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "REAL_MED_NAME | MEDCODE | MEDNAME | CLIENTNAME | AMT | VAT | SUMAMT | COMMISSION | COMMIVAT | SUMCOMMISSION | PAYAMT | CUSTOWNERNAME"
		mobjSCGLSpr.SetHeader .sprSht,        "매체사|코드|매체명|광고주|광고비|부가세액|합계|대행수수료|부가세액|합계|지급액|기본담당자 "
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   18|   0|    15|    15|    9|        9|   9|         9|       9|   9|    12|         8"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMT | VAT | SUMAMT | COMMISSION | COMMIVAT | SUMCOMMISSION | PAYAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "REAL_MED_NAME | MEDCODE | MEDNAME | CLIENTNAME | AMT | VAT | SUMAMT | COMMISSION | COMMIVAT | SUMCOMMISSION | PAYAMT | CUSTOWNERNAME"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "REAL_MED_NAME | MEDNAME | CLIENTNAME | CUSTOWNERNAME",-1,-1,0,2,false
		mobjSCGLSpr.ColHidden .sprSht, "MEDCODE", True
		mobjSCGLSpr.CellGroupingEach .sprSht, "REAL_MED_NAME | CUSTOWNERNAME " '| MEDNAME
    End With
...
Sub InitPageData
	...
	'초기 데이터 설정
	with frmThis
		.txtYEAR.value = Mid(gNowDate2,1,4) & Mid(gNowDate2,6,2)
		'Sheet초기화
		.sprSht.MaxRows = 0
		.txtYEAR.focus()
	End with
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_PRINT_MEDAMT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, .txtREAL_MED_CODE1.value, .txtCLIENTCODE.value)
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		End If
		If mobjSCGLSpr.GetTextBinding(.sprSht,"REAL_MED_NAME",intCnt) = "총계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		END IF
	Next 
	End With
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">매체사별/매체비 집행현황</td>
										</tr>
									</table>
								</TD>
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											<TD class="SEARCHLABEL" title="년월을삭제합니다." style="WIDTH: 60px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtYEAR,'')">년 
												월
											</TD>
