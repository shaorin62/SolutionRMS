<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTCOMMI.aspx.vb" Inherits="MD.MDCMPRINTCOMMI" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인쇄광고 거래명세표 발행</title>
		<META http-equiv="Content-Type" content="text/html; charset=ks_c_5601-1987">
		<!--
'****************************************************************************************
'시스템구분 : 인쇄 수수료거래명세서(MD)
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMPRINTCOMMI.aspx
'기      능 : 인쇄 수수료 거래명세서 생성/조회/발행
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
...
Dim mobjMDCMPRINTCOMMI, mobjMDCMGET
Dim mstrCheck
Dim mALLCHECK
mALLCHECK = TRUE
mstrCheck=True
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDCMPRINTCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		
		ModuleDir = "MD"
		ReportName = "MDCMPRINTCOMMI_NEW.rpt"
		...
		vntData	= mobjMDCMPRINTCOMMI.Get_PRINTCOMMI_CNT(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON,strTRANSNO)
		
		strcntsum = 0
		IF not gDoErrorRtn ("Get_PRINTCOMMI_CNT") then
			...
			for i=1 to 2
				strUSERID = ""
				vntDataTemp = mobjMDCMPRINTCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, datacnt, strUSERID)
			next
		End IF
		Params = strUSERID
		Opt = "A"
...
Sub REAL_MED_CODE_POP
	...
	with frmThis
		...
		vntInParams = array(.txtTRANSYEARMON.value, .txtREAL_MED_CODE.value, .txtREAL_MED_NAME1.value, "commi","PRINT", strSPONSOR) 
		vntRet = gShowModalWindow("../MDCO/MDCMCOMMIREALMEDPOP.aspx",vntInParams , 413,435)
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtTRANSYEARMON.value, .txtTRANSNO.value,.txtREAL_MED_NAME1.value,"ALL","commi", "PRINT", strSPONSOR)
...
Sub txtTRANSNO_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCMGET.GetTRANSNO(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON, .txtTRANSNO.value,.txtREAL_MED_CODE.value,.txtREAL_MED_NAME1.value, "commi", "PRINT", "0")
...
Sub TRU_POP
	...
	with frmThis
		...
		vntInParams = array(strTRANSYEARMON, .txtTRANSNO.value,.txtREAL_MED_CODE.value,.txtREAL_MED_NAME1.value, "commi", "PRINT") '<< 받아오는경우
		vntRet = gShowModalWindow("../MDCO/MDCMTRANSPOP.aspx",vntInParams , 413,430)
		if isArray(vntRet) then
...
Sub InitPage()
	...
	dim intNo,i
	'서버업무객체 생성	
	set mobjMDCMPRINTCOMMI	= gCreateRemoteObject("cMDPT.ccMDPTPRINTCOMMI")
	...
	With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht,   "CHK |YEARMON | SEQ | REAL_MED_NAME |REAL_MED_BISNO| CLIENTNAME | CLIENTBISNO | SUBSEQ | MED_FLAG_NAME | MEDNAME | AMOUNT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR"
		mobjSCGLSpr.SetHeader .sprSht,		   "선택|YEARMON|SEQ|매체사|매체사사업자번호|광고주|광고주사업자번호|시퀀스|구분|매체명|금액|수수료율|수수료|CLIENTCODE|MEDCODE|REAL_MED_CODE|MED_FLAG|DEPT_CD|COMMI_TAX_FLAG|TRANSRANK|ATTR01|SPONSOR"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   4|      0|  0|    15|              13|    15|              13|     6|   5|    12|  13|       7|    12|         0|      0|            0|       0|      0|             0|       10 | 0 "
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13" 
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeCheckBox2 .sprSht, "CHK"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "  REAL_MED_NAME|REAL_MED_BISNO|CLIENTBISNO|CLIENTNAME|SUBSEQ|MED_FLAG_NAME | MEDNAME", -1, -1, 0
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "AMOUNT|COMMISSION", -1, -1, 0
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "COMMI_RATE", -1, -1, 2
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "AMOUNT|COMMISSION" 
		mobjSCGLSpr.SetCellAlign2 .sprSht, "REAL_MED_BISNO|CLIENTBISNO|SUBSEQ|MED_FLAG_NAME",-1,-1,2,2,false
		mobjSCGLSpr.ColHidden .sprSht, "YEARMON|SEQ|CLIENTCODE |MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR", true
		
		
		'합계 표시 그리드 기본화면 구성
		gSetSheetColor mobjSCGLSpr, .sprSht_SUM
		mobjSCGLSpr.SpreadLayout .sprSht_SUM, 22, 1, 0,0,1,1,1,false,true,true,1
		mobjSCGLSpr.SpreadDataField .sprSht_SUM, "CHK |YEARMON | SEQ | REAL_MED_NAME |REAL_MED_BISNO| CLIENTNAME | CLIENTBISNO | SUBSEQ | MED_FLAG_NAME | MEDNAME | AMOUNT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR"
	    ...
	    mobjSCGLSpr.SetCellTypeFloat2 .sprSht_SUM, "AMOUNT|COMMISSION", -1, -1, 0
		mobjSCGLSpr.ColHidden .sprSht_SUM, "YEARMON|SEQ|CLIENTCODE |MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR", true
		...
		mobjSCGLSpr.SpreadLayout .sprSht1, 21, 0, 0, 0,5
		mobjSCGLSpr.SpreadDataField .sprSht1, "TRANSYEARMON | TRANSNO | SEQ | CLIENTCODE |CLIENTNAME| MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME| DEPT_CD| DEMANDDAY| PRINTDAY| AMT| SUSURATE| SUSU| VAT| MED_FLAG | SPONSOR|TAXYEARMON|TAXNO|TRUST_SEQ"
		mobjSCGLSpr.SetHeader .sprSht1,		"TRANSYEARMON|TRANSNO|SEQ|CLIENTCODE|CLIENTNAME|MEDCODE|매체명|REAL_MED_CODE|매체사|DEPT_CD|청구일자|발행일자|금액|수수료율|수수료|부가세|매체종류|SPONSOR|TAXYEARMON|TAXNO"
		mobjSCGLSpr.SetColWidth .sprSht1, "-1", "        0|	    0|	0|	       0|	      0|      0|    18|	           0|    18|      0|       0|       8|  10|       7|    10|    10|     7 | 0 |0|0|0"
		...
		mobjSCGLSpr.ColHidden .sprSht1, "TRANSYEARMON|TRANSNO |SEQ| CLIENTCODE|CLIENTNAME|MEDCODE|REAL_MED_CODE|DEPT_CD|DEMANDDAY|SPONSOR|TAXYEARMON|TAXNO|TRUST_SEQ ", true
...
Sub EndPage()
	set mobjMDCMPRINTCOMMI = Nothing
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		vntData1 = mobjSCGLSpr.GetDataRows(.sprSht,"CHK |YEARMON | SEQ | REAL_MED_NAME |REAL_MED_BISNO| CLIENTNAME | CLIENTBISNO | SUBSEQ | MED_FLAG_NAME | MEDNAME | AMOUNT | COMMI_RATE | COMMISSION  | CLIENTCODE | MEDCODE | REAL_MED_CODE | MED_FLAG | DEPT_CD | COMMI_TAX_FLAG | TRANSRANK | ATTR01|SPONSOR")
		...
		intRtn = mobjMDCMPRINTCOMMI.ProcessRtn(gstrConfigXml,strMasterData,vntData1, intCOMMINO,strCOMMIYEARMON, intColFlag1)
...
'		END IF
		...
		ELSE
			...
			vntData1 = mobjMDCMPRINTCOMMI.SelectRtn_SUSU(gstrConfigXml,mlngRowCnt,mlngColCnt,strTRANSYEARMON,strREAL_MED_CODE, strSPONSOR)
...
Function SelectRtn_HDR (ByVal strYEARMON, ByVal strTRANSNO, ByVal strREAL_MED_CODE)
	...
	vntData = mobjMDCMGET.Get_PRINTCOMMI_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strREAL_MED_CODE)
...
Function SelectRtn_DTL (ByVal strYEARMON,ByVal strTRANSNO, ByVal strREAL_MED_CODE)
	...
	vntData = mobjMDCMGET.Get_PRINTCOMMI_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON,strTRANSNO, strREAL_MED_CODE)
	...
	With frmThis
		...
		IF .sprSht.MaxRows > 0 THEN
			For lngCnt = 1 To .sprSht.MaxRows
				...
				IntAMOUNT	 = mobjSCGLSpr.GetTextBinding(.sprSht,"AMOUNT", lngCnt) '금액
		...
		if .sprSht.MaxRows >0 Then
			mobjSCGLSpr.SetTextBinding .sprSht_SUM,"AMOUNT",1, IntAMTSUM
			mobjSCGLSpr.SetTextBinding .sprSht_SUM,"COMMISSION",1, IntCOMMISSIONSUM		
		ELSE
			mobjSCGLSpr.SetTextBinding .sprSht_SUM,"AMOUNT",1, 0
...
Sub DeleteRtn ()
	...
	with frmThis
		...
		'mobjSCGLSpr.CellChanged frmThis.sprSht, Col, Row
		vntData = mobjSCGLSpr.GetDataRows(.sprSht1,"TRANSYEARMON | TRANSNO | SEQ | CLIENTCODE |CLIENTNAME| MEDCODE | MEDNAME | REAL_MED_CODE | REAL_MED_NAME| DEPT_CD| DEMANDDAY| PRINTDAY| AMT| SUSURATE| SUSU| VAT| MED_FLAG | SPONSOR|TAXYEARMON|TAXNO|TRUST_SEQ")
		
		'선택된 자료를 끝에서 부터 삭제
		strTRANSNO = mobjSCGLSpr.GetTextBinding(.sprSht1,"TRANSNO",1)
		strTRANSYEARMON = mobjSCGLSpr.GetTextBinding(.sprSht1,"TRANSYEARMON",1)
	
		intRtn = mobjMDCMPRINTCOMMI.DeleteRtn(gstrConfigXml,vntData, strTRANSYEARMON, strTRANSNO)
								...
								<TR>
									<TD style="WIDTH: 300px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;인쇄광고&nbsp;수수료거래명세 생성및 발행</td>
											</tr>
										</table>
									</TD>
									...
									<TD class="KEYFRAME" style="WIDTH: 791px" vAlign="middle" align="center"><FONT face="굴림">
											<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
												<TR>
													...
													<TD class="SEARCHDATA" width="312"><INPUT dataFld="PRINTDAY" class="INPUT" id="txtPRINTDAY" title="발행일" style="WIDTH: 96px; HEIGHT: 22px"
												...
												<tr>
													<TD class="SEARCHLABEL" style="WIDTH: 91px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtREAL_MED_CODE, txtREAL_MED_NAME1)"
														title="청구지코드,명 삭제">청구지
													</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtREAL_MED_CODE" title="코드조회" style="WIDTH: 72px; HEIGHT: 22px"
													...
													<TD class="SEARCHLABEL" style="WIDTH: 90px; CURSOR: hand">협찬구분
													</TD>
													<TD class="SEARCHDATA">&nbsp;<INPUT id="chkSPONSOR" type="checkbox" name="chkSPONSOR">&nbsp;협찬&nbsp; 
														생성 및 조회</TD>
												</tr>
											</TABLE>
										</FONT>
								...
								<TR>
									<TD class="KEYFRAME" vAlign="middle" align="center">
										<TABLE class="DATA" id="tblDATA" style="WIDTH: 791px; HEIGHT: 6px" cellSpacing="1" cellPadding="0"
											...
											<TR>
												<TD class="LABEL"><FONT face="굴림">수수료총액</FONT></TD>
