<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTTRANSCONF.aspx.vb" Inherits="MD.MDCMPRINTTRANSCONF" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인쇄 거래명세서 승인</title>
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDTRANSCONF	= gCreateRemoteObject("cMDPT.ccMDPTPRINTTRANS") '조회
    ...
    with frmThis
		...
		'Sheet Layout 디자인
		mobjSCGLSpr.SpreadLayout .sprSht, 15, 0,6
		'mobjSCGLSpr.AddCellSpan  .sprSht, 3, SPREAD_HEADER, 2, 1
		'Binding Field 설정
	    mobjSCGLSpr.SpreadDataField .sprSht, "CHK|CONFIRMGBN|CONFIRMFLAG|TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|DEMANDDAY|PRINTDAY|AMT|VAT|SUMAMT|MED_FLAG|MED_FLAG_NAME|MEMO"
		'Header 디자인
		mobjSCGLSpr.SetHeader .sprSht,        "선택|승인여부|계산서여부|거래년월|번호|광고주코드|광고주|청구일|발행일|공급가액|부가세|합계금액|매체구분코드|매체구분|비고",0,1,true
		mobjSCGLSpr.SetColWidth .sprSht, "-1","   4|       7|         9|       8|   4|         0|    14|     8|     8|      10|     9|      11|           0|       8| 20"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"CONFIRMGBN|TRANSYEARMON|TRANSNO|CLIENTCODE|CLIENTNAME|AMT|VAT|SUMAMT|MED_FLAG|MED_FLAG_NAME|MEMO|CONFIRMFLAG"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CONFIRMFLAG",-1,-1,2,2,false
		'mobjSCGLSpr.SetCellAlign2 .sprSht, "SUMM|CLIENTNAME|REAL_MED_NAME",-1,-1,0,2,false
		mobjSCGLSpr.ColHidden .sprSht, "CLIENTCODE|MED_FLAG", true
	End with
...
sub sprSht_DblClick (ByVal Col, ByVal Row)
	...
	with frmThis
		...
		elseif Row = 0 and Col =1 then
			...
			vntRet = gShowModalWindow("MDCMPRINTTRANSGUNLIST.aspx",vntInParams , 813,545)
			if isArray(vntRet) then
     		end if
		end if
	end with
	...
	If window.event.keyCode = meEnter then
		...
		with frmThis
			...
			if not gDoErrorRtn ("GetCC") then
				If mlngRowCnt = 1 Then
					.txtDEPT_CD.value = trim(vntData(0,0))
					.txtDEPT_NAME.value = trim(vntData(1,0))
...
Sub ProcessRtn_ConfirmCancel
	...
	with frmThis
		...
		if not gDoErrorRtn ("ProcessRtn_Confirm_OK") then
			'모든 플래그 클리어
			mobjSCGLSpr.SetFlag  .sprSht,meCLS_FLAG
									...
									<TD class="KEYFRAME" style="WIDTH: 1040px; HEIGHT: 20px" vAlign="top" align="center">
										<TABLE class="DATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call DateClean()" align="right"
													width="80">청구일자
												</TD>
											...
											<TR>
												<TD align="left" width="400" height="20">
													<table cellSpacing="0" cellPadding="0" width="100%" border="0">
														...
														<tr>
															<td class="TITLE">&nbsp;위수탁 거래명세서 승인</td>
														</tr>
													</table>
												</TD>
