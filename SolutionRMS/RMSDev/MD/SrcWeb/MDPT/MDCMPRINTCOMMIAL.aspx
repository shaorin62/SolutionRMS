<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTCOMMIAL.aspx.vb" Inherits="MD.MDCMPRINTCOMMIAL" %>
...
Dim mobjMDPTPRINTCOMMI, mobjMDCOGET
...
Sub imgALLPrint_onclick ()
	...
	with frmThis
		...
		'md_trans_temp삭제 시작
		intRtn = mobjMDPTPRINTCOMMI.DeleteRtn_temp(gstrConfigXml)
		'md_trans_temp삭제 끝
		...
		strUSERID = ""
		vntDataTemp = mobjMDPTPRINTCOMMI.ProcessRtn_TEMP_ALL(gstrConfigXml, vntData, strUSERID)
...
Sub imgPrint_onclick ()
	...
	with frmThis
		...
		strUSERID = ""
		vntData = mobjMDPTPRINTCOMMI.ProcessRtn_TEMP(gstrConfigXml,strTRANSYEARMON, strTRANSNO, strCNT, strUSERID)
...
Sub printSetTimeout(strTRANSYEARMON, strTRANSNO)
	...
	with frmThis
		intRtn = mobjMDPTPRINTCOMMI.DeleteRtn_temp(gstrConfigXml)
		'intRtn2 = mobjMDPTPRINTCOMMI.DeleteRtnUpdate_PRINTSEQ(gstrConfigXml, strTRANSYEARMON, strTRANSNO)
	end with
end sub
...
Sub REAL_MED_CODE1_POP
	...
	with frmThis
		vntInParams = array(.txtYEARMON1.value, .txtREAL_MED_CODE1.value, .txtREAL_MED_NAME1.value, "commi", "PRINT") 
...
Sub txtREAL_MED_NAME1_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			vntData = mobjMDCOGET.GetTRANSCUSTNO(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEARMON1.value, .txtREAL_MED_CODE1.value,.txtREAL_MED_NAME1.value,"","commi", "PRINT")
	...
	with frmThis
		If mstrGrid Then
			if Col = mobjSCGLSpr.CnvtDataField(.sprSht_DTL,"PRINT_SEQ") then
				...
				intRtn = mobjMDPTPRINTCOMMI.UPDATE_PRINTSEQ(gstrConfigXml,strTRANSYEARMON,strTRANSNO, strSEQ, strPRINT_SEQ)
			end if
		END IF
	end with
End Sub
...
Sub InitPage()
	...
	dim intNo,i
	'서버업무객체 생성	
	set mobjMDPTPRINTCOMMI	= gCreateRemoteObject("cMDPT.ccMDPTPRINTCOMMI")
...
Sub EndPage()
	set mobjMDPTPRINTCOMMI = Nothing
...
Sub Grid_Setting ()
	With frmThis
		...
		Else
			...
			mobjSCGLSpr.SetColWidth .sprSht_DTL, "-1", "   4|	0|   4|           0|   4|    15|              15|    15|              15|    12|      10|    10|    11|       4|    11|    10|12|  13|         0|         0|       0|       0|   0|             0|       0|         0|      0"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht_DTL, "0", "15"
...
Sub ProcessRtn ()
	...
	with frmThis
		...
		intRtn = mobjMDPTPRINTCOMMI.ProcessRtn(gstrConfigXml,strMasterData,vntData,strTRANSYEARMON,intColFlag)
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDPTPRINTCOMMI.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt, _
		...
		mlngColCnt=clng(0)
   		...
   		vntData2 = mobjMDPTPRINTCOMMI.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												strYEARMON, strREAL_MED_CODE, strMED_FLAG)
   				...
   				gWriteText lblStatusDTR, mlngRowCnt & "건의 자료가 검색" & mePROC_DONE
   					For i = 1 to .sprSht_DTL.MaxRows
						IF mobjSCGLSpr.GetTextBinding(.sprSht_DTL,"VOCH_TYPE",i) = "3" THEN
							...
							mobjSCGLSpr.SetCellsLock2 .sprSht_DTL,TRUE,i,2,-1,true
						END IF 
					next
   			else
   				gWriteText lblStatusDTR, mlngRowCnt & "건의 자료가 검색" & mePROC_DONE
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDPTPRINTCOMMI.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
	...
	with frmThis
		...
		For i = 1 to .sprSht_HDR.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_HDR,"CHK",i) = 1 Then
				...
				vntData = mobjMDPTPRINTCOMMI.DeleteRtn_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, strTRANSYEARMON, strTRANSNO) 
				If mlngRowCnt > 0 Then
		...
		intRtn = mobjMDPTPRINTCOMMI.DeleteRtn(gstrConfigXml,vntData)
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="160" background="../../../images/back_p.gIF"
														border="0">
														<TR>
											...
											<tr>
												<td class="TITLE">청약관리 수수료거래명세서</td>
											</tr>
										</table>
									</TD>
									...
									<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="top" align="left">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
											...
											<TR>
												...
												<TD class="SEARCHDATA">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<SELECT id="cmbMED_FLAG1" title="제작종류" style="WIDTH: 80px" name="cmbMED_FLAG1">
