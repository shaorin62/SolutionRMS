<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTREALMEDLIST2.aspx.vb" Inherits="MD.MDCMPRINTREALMEDLIST2" %>
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjEXECUTE.SelectRtn_ClientGroup(gstrConfigXml,mlngRowCnt,mlngColCnt, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strREAL_MEDLIST(1))
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjEXECUTE.GetCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1))
