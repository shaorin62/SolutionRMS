<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTMULTILIST.aspx.vb" Inherits="MD.MDCMPRINTMULTILIST" %>
...
'특이  사항 : 
'----------------------------------------------------------------------------------------
'HISTORY    :1) 2009/07/19 By Kim Tae Yub
'			 2) 
'****************************************************************************************
-->
...
Sub CLIENTCODE_POP
	...
	With frmThis
		vntInParams = array(trim(.txtYEAR.value), "PRINT") '<< 받아오는경우
...
Sub SelectRtn ()
	...
	With frmThis
		...
		mvntData2 = mobjMDSRPRINTMULTILIST.GetPRINTMEDCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value, strClientAndMed(1), strClientAndMed(2))
		mintCnt2 = mlngRowCnt
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjMDSRPRINTMULTILIST.SelectRtn_PRINTCUSTAndMED(gstrConfigXml,mlngRowCnt,mlngColCnt, mintCnt2, mvntDataCust, mvntDataCustCNT, .txtYEAR.value, strClientAndMed(1), strClientAndMed(2), strMED_FLAG, strVOCH_TYPE)
		
		If not gDoErrorRtn ("SelectRtn_PRINTCUSTAndMED") then
...
Sub SetChangeLayout () 
	...
	With frmThis
		...
		mvntDataCust = mobjMDSRPRINTMULTILIST.GetPRINTCLIENTCNT(gstrConfigXml,mlngRowCnt,mlngColCnt,strYEAR, strClientAndMed(1), strClientAndMed(2))
		...
		If not gDoErrorRtn ("GetCLIENTCNT") then
			If mlngRowCnt > 0 Then 
				...
				For intAddHeadCnt = 0 To  mvntDataCustCNT
				...
				For intAddWith = 1 To mvntDataCustCNT
					strAddWith = strAddWith & "|14"
				Next
				strEndWith = strWith & strAddWith & "|14"
				
				'총컬럼갯수
				intLayOutCnt = ""
				intLayOutCnt = 3 + mvntDataCustCNT + 1
				'여기까지 괜찮음
				...
				gSetSheetColor mobjSCGLSpr, .sprSht
				'Sheet Layout 디자인
				mobjSCGLSpr.SpreadLayout .sprSht, intLayOutCnt, 0,3
				mobjSCGLSpr.SpreadDataField .sprSht, mstrField 
				mobjSCGLSpr.SetHeader .sprSht,       strStartHead ,0,1,true
				mobjSCGLSpr.AddCellSpan .sprSht, 1, SPREAD_HEADER + 0, 3    , 1      , 0 , true
				...
				mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "YEAR|YEAR1|CUST", , , 50, , ,0
				mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
				mobjSCGLSpr.SetRowHeight .sprSht, "-1", "14"
				mobjSCGLSpr.SetCellsLock2 .sprSht,true,strField
				mobjSCGLSpr.CellGroupingEach .sprSht, "YEAR|YEAR1"
				mobjSCGLSpr.SetCellAlign2 .sprSht, "YEAR|YEAR1|CUST",-1,-1,2,2,false
			ELSE
				'Sheet 기본Color 지정
				gSetSheetDefaultColor() 
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If mobjSCGLSpr.GetTextBinding(.sprSht,"YEAR",intCnt) = "총계" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		End If
		
		If mobjSCGLSpr.GetTextBinding(.sprSht,"YEAR1",intCnt) = "ZZZZ" Then
			mobjSCGLSpr.SetTextBinding .sprSht,"YEAR1",intCnt, " "
		end if 
	Next 
	End With
End Sub
								...
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="middle" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" width="150"><INPUT class="INPUT" id="txtYEAR" title="년을입력하세요" style="WIDTH: 120px; HEIGHT: 22px" type="text"
											...
											<TD class="SEARCHLABEL" width="70">전표타입
											</TD>
											<TD class="SEARCHDATA">
												<SELECT name="cmbVOCH_TYPE" id="cmbVOCH_TYPE" title="전표타입" style="WIDTH: 136px">
													<OPTION value="" selected>전체</OPTION>
