<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTCOMMITAXDTL.aspx.vb" Inherits="MD.MDCMPRINTCOMMITAXDTL" %>
...
Sub imgPrint_onclick ()
	...
	IF frmThis.sprSht.MaxRows = 0 then
		...
		with frmThis
			...
			'md_trans_temp삭제 시작
			intRtn = mobjMDCMCOMMITAX.DeleteRtn_TEMP(gstrConfigXml)
			'md_trans_temp삭제 끝
			...
			vntDataTemp = mobjMDCMCOMMITAX.ProcessRtn_TEMP(gstrConfigXml,strTAXYEARMON, strTAXNO, VATFLAG, FLAG, i, strUSERID)
...
Sub InitPage()
	...
	'서버업무객체 생성	
	set mobjMDCMCOMMITAX	= gCreateRemoteObject("cMDPT.ccMDPTPRINTCOMMITAX")
    ...
    with frmThis
		...
		mobjSCGLSpr.SetHeader .sprSht,       "년월|번호|상세번호|광고주|광고주사업자번호|매체사|매체사사업자번호|매체|금액|부가세|계",0,1,true
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht,true,"TAXYEARMON | TAXNO | TAXNOSEQ | CLIENTNAME | CLIENTBISNO | REAL_MED_NAME | REAL_MED_BISNO | MEDNAME | AMT | SUMAMT"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTBISNO | REAL_MED_BISNO",-1,-1,2,2,false
		mobjSCGLSpr.ColHidden .sprSht, "TAXYEARMON | TAXNO | REAL_MED_NAME | REAL_MED_BISNO",true
...
Function SelectRtn_HDR(ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCMCOMMITAX.SelectRtn_HDR(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Function SelectRtn_DTL (ByVal strTAXYEARMON, ByVal strTAXNO)
	...
	vntData = mobjMDCMCOMMITAX.SelectRtn_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt,strTAXYEARMON,strTAXNO)
...
Sub ProcessRtn
	...
	with frmThis
		...
		intRtn = mobjMDCMCOMMITAX.ProcessRtn_VAT(gstrConfigXml,vntData,strTAXYEARMON,strTAXNO,strSUMM)
								...
								<TR>
									<TD style="WIDTH: 427px" align="left" width="427" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr>
												<td class="TITLE">&nbsp;인쇄광고 수수료 세금계산서</td>
											</tr>
										</table>
									</TD>
