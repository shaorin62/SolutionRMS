<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTEXETIMLISTPOP.aspx.vb" Inherits="MD.MDCMPRINTEXETIMLISTPOP" %>
...
'프로그램명 : MDCMPRINTEXETIMLISTPOP.aspx
'기      능 : 팀조회
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 4 : .txtTIMCODE.value = vntInParam(i)		'현재 사용중인 것만
				case 5 : .txtTIMNAME.value = vntInParam(i)		'코드 사용 시점
			end select
		next
		'SpreadSheet 디자인
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "FPUB_DATE | TPUB_DATE | TIMCODE | TIMNAME | CLIENTCODE | CLIENTNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "시작일|종료일|코드|팀명|코드|광고주명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "   0|    0|   10|  20|   0|     12"
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht, "TIMCODE | CLIENTCODE",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "TIMNAME | CLIENTNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjEXECUTE.GetPRINTTIM_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtFPUB_DATE.value, .txtTPUB_DATE.value, _
												  .txtCLIENTCODE.value, .txtCLIENTNAME.value, _
												  .txtTIMCODE.value, .txtTIMNAME.value)
									...
									<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
										...
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtFPUB_DATE,txtTPUB_DATE)">
												게재일</TD>
											<TD class="SEARCHDATA" colspan="3"><INPUT class="INPUT" id="txtFPUB_DATE" type="text" size="9" name="txtFPUB_DATE" style="WIDTH: 90px; HEIGHT: 22px"
													maxLength="10" accessKey="DATE">~<INPUT class="INPUT" id="txtTPUB_DATE" style="WIDTH: 90px; HEIGHT: 22px" type="text" maxLength="10"
													size="9" name="txtTPUB_DATE" accessKey="DATE"></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" width="50" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
												코드&nbsp;</TD>
											<TD class="SEARCHDATA" width="70"><INPUT class="INPUT" id="txtCLIENTCODE" style="WIDTH: 68px; HEIGHT: 22px" tabIndex="1"
													type="text" maxLength="6" size="1" name="txtCLIENTCODE"></TD>
											<TD class="SEARCHLABEL" width="60" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)">
												광고주명&nbsp;</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTNAME" style="WIDTH: 200px; HEIGHT: 22px" type="text"
													size="4" name="txtCLIENTNAME" tabIndex="1" maxLength="100"></TD>
										</TR>
										<TR>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME,txtTIMCODE)">
												코드&nbsp;</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTIMCODE" style="WIDTH: 68px; HEIGHT: 22px" tabIndex="1"
													type="text" maxLength="6" size="1" name="txtTIMCODE"></TD>
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME,txtTIMCODE)">
												팀명&nbsp;</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTIMNAME" style="WIDTH: 200px; HEIGHT: 22px" type="text"
													size="4" name="txtTIMNAME" tabIndex="1" maxLength="100"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
