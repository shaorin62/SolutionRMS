<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTEXECUSTLISTPOP.aspx.vb" Inherits="MD.MDCMPRINTEXECUSTLISTPOP" %>
...
'프로그램명 : MDCMPRINTEXECUSTLISTPOP.aspx
'기      능 : 광고주 조회
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "FPUB_DATE | TPUB_DATE | CLIENTCODE | CLIENTNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "시작일|종료일|코드|광고주명"
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CLIENTCODE",-1,-1,2,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		mlngRowCnt=clng(0)
		mlngColCnt=clng(0)
		vntData = mobjEXECUTE.GetPRINTCLIENT_LIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtFPUB_DATE.value, .txtTPUB_DATE.value,.txtCLIENTCODE.value, .txtCLIENTNAME.value)
								...
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20">
									<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
										...
										<TR>
											...
											<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,txtCLIENTCODE)"
												width="60">광고주명&nbsp;</TD>
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtCLIENTNAME" style="WIDTH: 200px; HEIGHT: 22px" tabIndex="1"
													type="text" maxLength="100" size="4" name="txtCLIENTNAME"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
