...
Sub Grid_Setting (strMED_FLAG)
	With frmThis
		...
		If mstrGrid Then
			...
			mobjSCGLSpr.SetHeader .sprSht_DTL,		"거래명세년월|거래명세번호|순번|순서|신탁순번|광고주|매체명|매체사|사업자번호|브랜드|팀|소재명|단|CM|면|규격|P|색도|게재일|금액|부가세|계|매체구분|비고|부서명|청구일|발행일|계산서년월|계산서번호|확정구분|신탁년월|전표구분" 
		...
		Else
			...
			mobjSCGLSpr.SetHeader .sprSht_DTL,		   "선택|년월|순번|매체구분코드|구분|광고주코드|광고주명|팀코드|팀명|매체코드|매체명|매체사코드|매체사명|브랜드코드|브랜드명|소재코드|소재명|단|CM|면|규격|P|색도|게재일|금액|부가세|계|수수료율|수수료|비고|부서코드|부가세유무|돌출|제작사코드|전표형태구분|면세구분|CIC생성순서|광고주별생성순서"
							...
							<TR>
								<TD align="left" width="400" height="20">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE" valign="top">인쇄 거래명세서</td>
										</tr>
									</table>
								</TD>
												...
												<TABLE id="tblButtonDTR" style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
													<TR>
														<TD><IMG id="ImgCICSave" onmouseover="JavaScript:this.src='../../../images/ImgCICSaveOn.gif'"
																...
																alt="CIC별로 거래명세서를 생성합니다." src="../../../images/ImgCICSave.gif" border="0" name="ImgCICSave"></TD>
