<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTMONREALLIST.aspx.vb" Inherits="MD.MDCMPRINTMONREALLIST" %>
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 16, 0, 1, 0,0
		mobjSCGLSpr.SpreadDataField .sprSht, "REAL_MED_NAME | MEDCODE | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
		mobjSCGLSpr.SetHeader .sprSht,        "매체사|코드|매체명|1월|2월|3월|4월|5월|6월|7월|8월|9월|10월|11월|12월|총합계"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "   18|   0| 15| 10| 10| 10| 10| 10| 10| 10| 10| 10|  10|  10|  10|    12"
		mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
		mobjSCGLSpr.SetRowHeight .sprSht, "0", "15"
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT", -1, -1,0
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "REAL_MED_NAME | MEDCODE | MEDNAME | A1 | A2 |  A3 |  A4 |  A5 |  A6 |  A7 |  A8 |  A9 |  A10 |  A11 |  A12 | SUMAMT"
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDSCEXECUTE.SelectRtn_PRINTMONREALLIST(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtYEAR.value)

		if not gDoErrorRtn ("SelectRtn_PRINTMONREALLIST") then
...
Sub Layout_change ()
	...
	For intCnt = 1 To .sprSht.MaxRows 
		...
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"REAL_MED_NAME",intCnt),4) = "(총계)" Then
			mobjSCGLSpr.SetCellShadow .sprSht, -1, -1, intCnt, intCnt,&H99CCFF, &H000000,False
		END IF
		If RIGHT(mobjSCGLSpr.GetTextBinding(.sprSht,"MEDNAME",intCnt),4) = "(소계)" Then
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">광고비 집행 내역&nbsp;- 월간 매체사별 조회</td>
										</tr>
									</table>
								</TD>
								...
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtYEAR" title="년도을입력하세요" style="WIDTH: 100px; HEIGHT: 22px" accessKey="NUM"
