<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTVOCH.aspx.vb" Inherits="MD.MDCMPRINTVOCH" %>
...
Sub btnTab1_onclick
	...
	pnlAMTOUT.style.visibility = "visible" 
	pnlGUBUN.style.visibility = "hidden" 
	pnlFLAG.style.visibility = "hidden" 
	
	if frmThis.rdAMT.checked = true then
...
Sub btnTab2_onclick
	...
	pnlAMTOUT.style.visibility = "hidden" 
	pnlGUBUN.style.visibility = "visible" 
	pnlFLAG.style.visibility = "hidden" 
	
	frmThis.rdSALE.checked = true
...
Sub sprSht_AMTOUTDTL_Change(ByVal Col, ByVal Row)
	...
	with frmThis
		...
		If Col = mobjSCGLSpr.CnvtDataField(.sprSht_AMTOUTDTL,"PAYCODE") Then 
		
			strCODE = mobjSCGLSpr.GetTextBinding( frmThis.sprSht_AMTOUTDTL,"VENDOR",Row)
			Call Get_SUBCOMBO_VALUE(strCODE, Row, .sprSht_AMTOUTDTL)
		end if 
...
Sub sprSht_GEN_Change(ByVal Col, ByVal Row)
	with frmThis
		...
		if .sprSht_GENDTL.MaxRows > 0 then
			...
			strSUMM = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"SUMM",Row)
			strSEMU = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"SEMU",Row)
			strDEMANDDAY = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"DEMANDDAY",Row)
			strDUEDATE = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"DUEDATE",Row)
			strDOCUMENTDATE = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"DOCUMENTDATE",Row)
			strPREPAYMENT = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"PREPAYMENT",Row)
			strFROMDATE = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"FROMDATE",Row)
			strTODATE = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"TODATE",Row)
			strSUMMTEXT = mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"SUMMTEXT",Row)
			...
			For intCnt = 1 To .sprSht_GENDTL.MaxRows
				If mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TAXYEARMON",intCnt) = strTAXYEARMON AND _
					...
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"SUMM",intCnt, strSUMM
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"SEMU",intCnt, strSEMU
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"DEMANDDAY",intCnt, strDEMANDDAY
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"DUEDATE",intCnt, strDUEDATE
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"DOCUMENTDATE",intCnt, strDOCUMENTDATE
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"PREPAYMENT",intCnt, strPREPAYMENT
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"FROMDATE",intCnt, strFROMDATE
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"TODATE",intCnt, strTODATE
					mobjSCGLSpr.SetTextBinding .sprSht_GENDTL,"SUMMTEXT",intCnt, strSUMMTEXT
				End If
			Next
		end if
	End With
...
Sub sprSht_GENDTL_Change(ByVal Col, ByVal Row)
	Dim strCODE
	with frmThis
		If Col = mobjSCGLSpr.CnvtDataField(.sprSht_GENDTL,"PREPAYMENT") Then 
			If mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"PREPAYMENT",Row) = "Y" Then
				mobjSCGLSpr.SetCellsLock2 .sprSht_GENDTL,false,"FROMDATE",Row,Row,false
				mobjSCGLSpr.SetCellsLock2 .sprSht_GENDTL,false,"TODATE",Row,Row,false
			Else
				mobjSCGLSpr.SetCellsLock2 .sprSht_GENDTL,True,"FROMDATE",Row,Row,false
				mobjSCGLSpr.SetCellsLock2 .sprSht_GENDTL,True,"TODATE",Row,Row,false
			End If
		End if
...
Sub InitPage()
	...
	'서버업무객체 생성	
	Set mobjMDCMPRINTVOCH = gCreateRemoteObject("cMDPT.ccMDPTPRINTVOCH")
    ...
    with frmThis
		...
		'mobjSCGLSpr.SetCellsLock2 .sprSht_AMT,true,"CUSTOMERCODE | CUSTNAME | REAL_MED_NAME | DEPT_NAME | SUMM | AMT | VAT | BP | DEMANDDAY | DUEDATE | VENDOR | GBN | DEBTOR | ACCOUNT | DOCUMENTDATE | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		...
		mobjSCGLSpr.SpreadLayout .sprSht_AMTOUTDTL, 34, 0, 4
		...
		mobjSCGLSpr.SetHeader .sprSht_AMTOUTDTL,		    "전표일자|거래처코드|거래처|적요|사업영역|코스트센터|금액|부가세|세무코드|BP|지급기일|입금기일|상대VENDOR|매체사명|구분|차변계정|계정|BMORDER|증빙일|지급방법|BANKTYPE|선수금구분|선수금(시작일)|선수금(종료일)|본문TEXT|RMS년월|RMS번호|전표번호|에러코드|에러메세지|GFLAG|MEDFLAG | AMTGBN | TRANSRANK"
		mobjSCGLSpr.SetColWidth .sprSht_AMTOUTDTL, "-1",  "         8|        10|    15|  17|       5|         8|  10|    10|       6| 5|       8|       8|        10|      15|   0|       7|   7|      7|     8|      20|      20|        10|            13|            13|      20|      7|      7|       9|       0|        10|    0|       0|       0|         0"
		...
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht_AMTOUTDTL, "CUSTOMERCODE | CUSTNAME | SUMM | BA | COSTCENTER | SEMU | BP | VENDOR | REAL_MED_NAME | GBN | ACCOUNT | DEBTOR | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | GFLAG | MEDFLAG | AMTGBN | TRANSRANK", -1, -1, 200
		...
		'mobjSCGLSpr.SetCellsLock2 .sprSht_SUSU,true,"CUSTOMERCODE | CUSTNAME | SUMM | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | GBN | DOCUMENTDATE | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		...
		'mobjSCGLSpr.SetCellsLock2 .sprSht_SUSUDTL,true,"CUSTOMERCODE | CUSTNAME | SUMM | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | GBN | DEBTOR | ACCOUNT | DOCUMENTDATE | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		mobjSCGLSpr.SetCellsLock2 .sprSht_SUSUDTL,true,"CUSTOMERCODE | CUSTNAME | SUMM | AMT | VAT | SEMU | BP | VENDOR | GBN | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG"
		...
		mobjSCGLSpr.SpreadLayout .sprSht_OUT, 41, 0, 4
		mobjSCGLSpr.SpreadDataField .sprSht_OUT,    "CHK | POSTINGDATE | CLIENTNAME | CUSTOMERCODE | CUSTNAME | SUMM | BA | COSTCENTER | AMT | VAT | SEMU | BP | DEMANDDAY | DUEDATE | VENDOR | GBN | ACCOUNT | DEBTOR | BMORDER | DOCUMENTDATE | PAYCODE | BANKTYPE | PREPAYMENT | FROMDATE | TODATE | SUMMTEXT | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | GFLAG | MEDFLAG | AMTGBN | TRANSRANK | MEDFLAGNAME | CLIENTCODE | RMSNO | EXCLIENTCODE | INPUT_MEDFLAG | DEPT_CD "
		mobjSCGLSpr.SetHeader .sprSht_OUT,		    "선택|전표일자|광고주|거래처코드|거래처|적요|사업영역|코스트센터|금액|부가세|세무코드|BP|지급기일|입금기일|상대VENDOR|구분|차변계정|계정|BMORDER|증빙일|지급방법|BANKTYPE|선수금구분|선수금(시작일)|선수금(종료일)|본문TEXT|RMS년월|RMS번호|전표번호|에러코드|에러메세지|GFLAG|MEDFLAG|AMTGBN|TRANSRANK|매체구분|CLIENTCODE|RMSNO|EXCLIENTCODE|INPUT_MEDFLAG|DEPT_CD"
		mobjSCGLSpr.SetColWidth .sprSht_OUT, "-1",  "   4|       8|    15|        10|    15|  17|       5|         8|  10|    10|       6| 5|       8|       8|        10|   0|       7|   7|      7|     8|      20|      20|        10|            13|            13|      20|      7|      7|       9|       0|        10|    0|      0|     0|       10|       6|         0|    0|           0|            0|      0"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht_OUT,true,"CLIENTNAME | CUSTOMERCODE | CUSTNAME | SUMM | AMT | SEMU | BP | VENDOR | GBN | TAXYEARMON | TAXNO | VOCHNO | ERRCODE | ERRMSG | MEDFLAGNAME"
		mobjSCGLSpr.ColHidden .sprSht_OUT, "GBN  | GFLAG | MEDFLAG | DUEDATE | ERRCODE | AMTGBN | CLIENTCODE | RMSNO | EXCLIENTCODE | INPUT_MEDFLAG | DEPT_CD", true
...
Sub Get_COMBO_VALUE ()		
	...
	With frmThis	
		...
		vntData = mobjMDCMPRINTVOCH.Get_COMBO_VALUE(gstrConfigXml,mlngRowCnt,mlngColCnt,"PD_PAYCODE")
...
Sub Get_SUBCOMBO_VALUE(strCODE, row, sprsht)
	...
	With frmThis   
		...
		strCODE = replace(strCODE,"-","")
       	...
       	vntData = mobjMDCMPRINTVOCH.Get_SUBCOMBO_VALUE(gstrConfigXml, mlngRowCnt, mlngColCnt, strCODE)
...
Sub SelectRtn_AMT ()
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_AMT(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
...
Sub SelectRtn_AMTOUT ()
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_AMTOUT(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
													 strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
													 strGBN)
...
Sub SelectRtn_AMTOUTDTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_AMTOUTMCBUYDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
...
Sub SelectRtn_GEN ()
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_GEN(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
													strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
													strGBN, strSALEGBN)
...
Sub SelectRtn_GENDTL (Col, Row)
	...
	with frmThis
		...
		if .rdSALE.checked then
			vntData = mobjMDCMPRINTVOCH.SelectRtn_GENDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
		elseif .rdBUY.checked then
			vntData = mobjMDCMPRINTVOCH.SelectRtn_GENBUYDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
		else
			vntData = mobjMDCMPRINTVOCH.SelectRtn_GENMCBUYDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
		end if
...
Sub SelectRtn_SUSU ()
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_SUSU(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON, _
												   strCLIENTCODE, strCLIENTNAME, strREAL_MED_CODE, strREAL_MED_NAME, _
												   strGBN)
...
Sub SelectRtn_SUSUDTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_SUSUDTL(gstrConfigXml,mlngRowCnt,mlngColCnt, strTAXYEARMON, strTAXNO)
...
Sub SelectRtn_OUT ()
   	Dim vntData
    Dim intCnt
    Dim strYEARMON, strCLIENTCODE, strCLIENTNAME, strGBN, strEDYEARMON
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTVOCH.SelectRtn_OUT(gstrConfigXml, mlngRowCnt, mlngColCnt, strYEARMON,strEDYEARMON, _
		...
		If mstrPROCESS = "Create" Then
			For intCnt = 1 To .sprSht_AMTOUTDTL.MaxRows
				...
				ELSE
					...
					strPOSTINGDATE		= replace(mobjSCGLSpr.GetTextBinding(.sprSht_AMTOUTDTL,"POSTINGDATE",intCnt),"-","")
		...
		if .chkSUMMAE.checked = true then
			...
			elseif mstrPROCESS = "Delete" then
				For intCnt = 1 To intColFlag
					...
					For i = 1 To .sprSht_GENDTL.MaxRows
						If mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"CHK",i) = 1 Then
							'청구합계
							If CDbl(mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"TRANSRANK",i)) = intCnt Then
								lngAMT = CDbl(mobjSCGLSpr.GetTextBinding(.sprSht_GENDTL,"AMT",i))
								lngSUMAMT = lngSUMAMT + lngAMT
...
Function UpdateRtn_OUT_Medium (vntData)
	...
	With frmThis
		...
		intRtn = mobjMDCMPRINTVOCH.UpdateRtn_OUT_Medium(gstrConfigXml,vntData)
...
Sub Set_VochValue (strRETURNLIST)
	...
	With frmThis
		if mstrPROCESS ="Create" then
			IF mstrGUBUN = "T" THEN
				intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "B")
			ElseIf mstrGUBUN = "TO" Then
				intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "BAO")
			ELSEIF mstrGUBUN = "D" THEN
				if .rdSALE.checked then '매출
					intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "B")
				ELSEif .rdMCBUY.checked then ' 매입
					intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "BAA")
				else  'mnc
					intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "BD")
				end if
			ELSEIF mstrGUBUN = "S" THEN
				intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "B")
			ELSEIF mstrGUBUN = "O" THEN
				intRtn = mobjMDCMPRINTVOCH.ProcessRtn(gstrConfigXml,vntData_ProcesssRtn, strRETURNLIST, mstrGUBUN, "B2")
			END IF
   		...
   		elseif mstrPROCESS ="Delete" then
   			IF mstrGUBUN = "D" THEN
				if .rdSALE.checked then
					intRtn = mobjMDCMPRINTVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "PRINT" )
				ELSEif .rdMCBUY.checked then
					intRtn = mobjMDCMPRINTVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "PRINT" )
				else
					intRtn = mobjMDCMPRINTVOCH.VOCHDELL_BUY(gstrConfigXml, strRETURNLIST, mstrGUBUN, "PRINT", "BD")
				end if
			elseIF mstrGUBUN = "O" THEN
				intRtn = mobjMDCMPRINTVOCH.VOCHDELL_BUY(gstrConfigXml, strRETURNLIST, mstrGUBUN, "PRINT", "B2")
			ELSE
				intRtn = mobjMDCMPRINTVOCH.VOCHDELL(gstrConfigXml, strRETURNLIST, mstrGUBUN, "PRINT" )
			END IF
...
sub ErrVochDeleteRtn
	...
	with frmThis
		...
		intRtn = mobjMDCMPRINTVOCH.DeleteRtn(gstrConfigXml,vntData)
		...
		If mstrGUBUN = "T"  then  
			for i = .sprSht_AMT.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_AMT,"CHK",i) = 1 Then
					...
					intRtn = mobjMDCMPRINTVOCH.DeleteRtn_GANG(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "PRINT" )
			...
			for i = .sprSht_GEN.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_GEN,"CHK",i) = 1 Then
					...
					ELSEIF .rdMCBUY.checked then
						...
						intRtn = mobjMDCMPRINTVOCH.DeleteRtn_GANG_BUY(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "PRINT", "BD")
					end if
		...
		ELSEIf mstrGUBUN = "O"  then
			for i = .sprSht_OUT.MaxRows to 1 step -1
				If mobjSCGLSpr.GetTextBinding(.sprSht_OUT,"CHK",i) = 1 Then
					...
					intRtn = mobjMDCMPRINTVOCH.DeleteRtn_GANG_BUY(gstrConfigXml,strTAXYEARMON, strTAXNO, strVOCHNO, mstrGUBUN, "PRINT", "B2")
								...
								<TD class="KEYFRAME" style="WIDTH: 100%; HEIGHT: 15px" vAlign="top" align="center" colSpan="2">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										...
										<TR>
											...
											<TD class="SEARCHDATA" colSpan="2"><INPUT id="rdT" title="완료내역조회" type="radio" value="rdT" name="rdGBN" onclick="vbscript:Call Set_delete('imgVochDelco')">&nbsp;완료&nbsp;
									...
									<TABLE class="SEARCHDATA" id="tblKey1" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="DATA"><INPUT style="WIDTH: 368px; HEIGHT: 21px" id="txtSUMM" class="INPUT_L" title="적요적용" size="56"
												...
												<DIV id="pnlAMTOUT" align="center" style="VISIBILITY: hidden; WIDTH: 450px; POSITION: absolute; HEIGHT: 24px"
													ms_positioning="GridLayout">&nbsp;&nbsp;&nbsp;&nbsp; <INPUT id="rdAMT" title="취급액" type="radio" CHECKED value="SALE" name="rdGROUP">&nbsp;취급액&nbsp;&nbsp;&nbsp;
													<INPUT id="rdMCBUYAMT" title="MC일반매출건을 매입으로 생성" type="radio" value="MCBUY" name="rdGROUP">&nbsp;MC내부비용-매입</DIV>
							...
							<TR vAlign="top" align="left">
								...
								<TD class="LISTFRAME" style="WIDTH: 100%; HEIGHT: 80%" vAlign="top" align="center">
									...
									<DIV id="pnlTab_amtout" style="LEFT: 7px; VISIBILITY: hidden; WIDTH: 100%; POSITION: absolute; HEIGHT: 100%"
										ms_positioning="GridLayout">
										<OBJECT id="sprSht_AMTOUT" style="WIDTH: 100%; HEIGHT: 70%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="32464">
										...
										<OBJECT id="sprSht_AMTOUTDTL" style="WIDTH: 100%; HEIGHT: 30%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="32464">
									...
									<DIV id="pnlTab_gen" style="LEFT: 7px; VISIBILITY: hidden; WIDTH: 100%; POSITION: absolute; HEIGHT: 100%"
										ms_positioning="GridLayout">
										<OBJECT id="sprSht_GEN" style="WIDTH: 100%; HEIGHT: 70%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="32464">
											<PARAM NAME="_ExtentY" VALUE="9181">
											<PARAM NAME="_StockProps" VALUE="64">
										...
										<OBJECT id="sprSht_GENDTL" style="WIDTH: 100%; HEIGHT: 30%" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5">
											<PARAM NAME="_Version" VALUE="393216">
											<PARAM NAME="_ExtentX" VALUE="32464">
											<PARAM NAME="_ExtentY" VALUE="3942">
											<PARAM NAME="_StockProps" VALUE="64">
