<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTTRANSCONFLIST.aspx.vb" Inherits="MD.MDCMPRINTTRANSCONFLIST" %>
...
Sub ProcessRtn_CONFIRM ()
	...
	with frmThis
		...
		intRtn = mobjMDPTPRINTTRANS.ProcessRtn_Confirm(gstrConfigXml, vntData)
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDPTPRINTTRANS.SelectRtn_TransList(gstrConfigXml,mlngRowCnt,mlngColCnt)
...
Sub SelectRtn_DTL (Col, Row)
	...
	with frmThis
		...
		vntData = mobjMDPTPRINTTRANS.SelectRtn_TransList_DTL(gstrConfigXml,mlngRowCnt,mlngColCnt, _
								...
								<TR>
									<TD align="left" width="400" height="28">
										<table cellSpacing="0" cellPadding="0" width="100%" border="0">
											<tr>
												<td align="left">
													<TABLE cellSpacing="0" cellPadding="0" width="153" background="../../../images/back_p.gIF"
														border="0">
														<TR>
