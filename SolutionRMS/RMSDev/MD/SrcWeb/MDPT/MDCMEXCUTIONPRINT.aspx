<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMEXCUTIONPRINT.aspx.vb" Inherits="MD.MDCMEXCUTIONPRINT" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>제작대행사 수수료 분할</title> 
		<!--
'****************************************************************************************
'시스템구분 : 매체공통 대대행사 관리
...
Sub sprSht_Keyup(KeyCode, Shift)
	...
	With frmThis
		If .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT") or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"COMMISSION") _
			or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"EXSUSU") or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"MCSUSU") _
			or .sprSht.ActiveCol = mobjSCGLSpr.CnvtDataField(.sprSht,"PRICE") Then
			strSUM = 0
			intSelCnt = 0
			intSelCnt1 = 0
			strCOLUMN = ""
			...
			FOR i = 0 TO intSelCnt -1
				If vntData_col(i) <> "" and (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"AMT")) OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"COMMISSION")) _
					OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"EXSUSU")) OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"MCSUSU")) _
					OR (vntData_col(i) = mobjSCGLSpr.CnvtDataField(.sprSht,"PRICE"))  Then
...
Sub InitPage()
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | YEARMON | SEQ | MED_FLAG | CLIENTNAME | MEDNAME | MATTERNAME | EXCLIENTCODE | BTN | EXCLIENTNAME | EXSUSURATE | EXSUSU | MCSUSU | PRICE | AMT | COMMI_RATE | COMMISSION | PUB_DATE | COL_DEG | EXECUTE_FACENAME | STD | MEMO"
		mobjSCGLSpr.SetHeader .sprSht,		"선택|년월|신탁번호|매체|광고주|매체명|소재명|제작대행사 코드|제작대행사명|제작대행  수수료율|제작대행  수수료|M&C수수료|단가|금액|수수료율|수수료|게재일|색|면|규격|비고"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "4|   0|       4|   6|    10|    10|    10|              6|2|        10|                 8|               8|        8|   8|   8|       8|     8|     8| 6| 6|  10|20"
		...
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "EXSUSU | PRICE | AMT | COMMISSION | MCSUSU", -1, -1, 0
		mobjSCGLSpr.SetCellTypeFloat2 .sprSht, "COMMI_RATE", -1, -1, 2
		mobjSCGLSpr.SetCellTypeEdit2 .sprSht, "STD | MEMO", -1, -1, 255
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "PUB_DATE | STD | AMT | COMMI_RATE| COMMISSION | PRICE"
		mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "YEARMON | SEQ | MED_FLAG | CLIENTNAME | MEDNAME | MATTERNAME | COL_DEG | EXECUTE_FACENAME | STD", -1, -1, 40
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjMDCMPRINTEXCUTION.EXLIST(gstrConfigXml,mlngRowCnt,mlngColCnt, strYEARMON, strCUSTCODE,strGUBUN,strPROGRAMNAME)
		...
		'Master 입력 데이터 Validation : 필수 입력항목 검사
  		...
  		for intCnt = 1 to .sprSht.MaxRows
			 ...
			 AND mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",intCnt) = 1)  Then 
					gErrorMsgBox intCnt & " 번째 행의 입력내용 을 확인하십시오" & vbcrlf & "제작대행사가 없을 시 제작대행수수료율/수수료는 0 입니다.","입력오류"
					Exit Function
			 End if
		next
   	End with
									...
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
										<TR>
											...
											<TD class="SEARCHDATA" style="WIDTH: 91px"><INPUT class="INPUT" id="txtYEARMON" title="년월조회" style="WIDTH: 88px; HEIGHT: 22px" accessKey="NUM"
													type="text" maxLength="6" onchange="vbscript:Call gYearmonCheck(txtYEARMON)" name="txtYEARMON"></TD>
											...
											<TD class="SEARCHDATA" width="110"><SELECT id="cmbGUBUN" title="매체구분" style="WIDTH: 105px" name="cmbGFLAG1">
											...
											<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtPROGRAMNAME" title="소재명" style="WIDTH: 208px; HEIGHT: 22px"
													type="text" maxLength="100" align="left" size="29" name="txtPROGRAMNAME"></TD>
