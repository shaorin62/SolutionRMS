<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMPRINTMATTERMST_SRC.aspx.vb" Inherits="MD.MDCMPRINTMATTERMST_SRC" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>소재코드 관리-등록</title>
...
Sub InitPage()
	...
	With frmThis
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, true, "ATTR02 | MATTERCODE | MATTER | DEPT_NAME | TIMNAME | CLIENTSUBNAME | CUSTCODE | CUSTNAME | UUSER | UDATE" 
...
'1001938 윤정인
			...
			vntData_info = mobjSCCOGET.Get_SENDINFO2(gstrConfigXml,mlngRowCnt,mlngColCnt, "1001938")
							...
							<TR>
								<TD align="left" width="400" height="28">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td class="TITLE">인쇄-소재정보 관리-등록</td>
										</tr>
									</table>
								</TD>
