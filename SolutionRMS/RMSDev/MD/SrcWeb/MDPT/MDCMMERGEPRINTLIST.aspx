<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MDCMMERGEPRINTLIST.aspx.vb" Inherits="MD.MDCMMERGEPRINTLIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>인쇄 통합청구 보내기</title>
		<META http-equiv="Content-Type" content="text/html; charset=ks_c_5601-1987">
		<!--
'****************************************************************************************
'시스템구분 : MD/MDCMMERGEPRINTLIST 인쇄 통합청구 이동 화면
'실행  환경 : ASP.NET, VB.NET, COM+ 
'프로그램명 : MDCMMERGEPRINTLIST.aspx
'기      능 : 
'파라  메터 : 
'특이  사항 : 
'----------------------------------------------------------------------------------------
