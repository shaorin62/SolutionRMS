<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOCUSTEXELIST.aspx.vb" Inherits="SC.SCCOCUSTEXELIST" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>거래선 등록(대대행사)</title>
...
Function Busino_Check ()
	...
	With frmThis
		...
		vntData = mobjSCCOCUSTLIST.Busino_Check(gstrConfigXml,mlngRowCnt,mlngColCnt, _
												trim(Replace(mobjSCGLSpr.GetTextBinding( .sprSht_CUST,"BUSINO",.sprSht_CUST.ActiveRow),"-","")), "G")
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjSCCOCUSTLIST.SelectRtn_EXEHDR(gstrConfigXml,mlngRowCnt,mlngColCnt, strCLIENTNAME, strCOMPANYNAME, strBUSINO)

		If not gDoErrorRtn ("SelectRtn_EXEHDR") Then
...
Sub ProcessRtn_EXEHDR ()
	...
	With frmThis
		...
		intRtn = mobjSCCOCUSTLIST.ProcessRtn_EXEHDR(gstrConfigXml,vntData, "G")
	...
	With frmThis
		For i = 1 to .sprSht_CUST.MaxRows
			if mobjSCGLSpr.GetTextBinding(.sprSht_CUST,"CHK",i) = 1 Then
				...
				Else
					vntData = mobjSCCOCUSTLIST.SelectRtn_CountCheck(gstrConfigXml,mlngRowCnt,mlngColCnt, strHIGHCUSTCODE, "G") 
					If mlngRowCnt > 0 Then
						strMSG = ""
