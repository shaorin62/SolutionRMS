<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOMPPPOP.aspx.vb" Inherits="SC.SCCOMPPPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SetHeader .sprSht, "코드|MPP명|사업자번호|상호명"
										...
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHCUSTCODE,txtCUSTNAME)">&nbsp;MPP 
														명&nbsp;</TD>
