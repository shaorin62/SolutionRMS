<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOEMPPOP.aspx.vb" Inherits="SC.SCCOEMPPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetSCEMP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value,"A",.txtDEPTCD.value,.txtDEPTNAME.value)
