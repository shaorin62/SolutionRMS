<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOHIGHDEPTPOP.aspx.vb" Inherits="SC.SCCOHIGHDEPTPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetCC_HIGH(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtCodeName.value)
