<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOEMPAUTHPOP.aspx.vb" Inherits="SC.SCCOEMPAUTHPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOROLEMST.GetSCEMP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value)
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD align="center"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 392px; HEIGHT: 296px" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											VIEWASTEXT>
