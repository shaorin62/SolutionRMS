<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOBRANDDTLLIST.aspx.vb" Inherits="SC.SCCOBRANDDTLLIST" %>
...
'----------------------------------------------------------------------
    ...
    With frmThis
		...
		mobjSCGLSpr.SpreadDataField .sprSht, "CHK | ATTR01 | SEQNO | SEQNAME | HIGHSEQNO | TIMCODE | BTNTIM | TIMNAME | CLIENTSUBCODE | BTNSUB | CLIENTSUBNAME | CUSTCODE | BTN | CUSTNAME | DEPT_CD | BTNDEPT | DEPT_NAME | CUSER | CDATE | MEMO | MAXYEARMON"
		mobjSCGLSpr.SetHeader .sprSht,		 "선택|사용구분|코드|브랜드명|대표브랜드|팀코드|팀명|CIC코드|CIC/사업부|광고주코드|광고주명|부서코드|부서명|등록자|등록일|비고|1년간최근사용년월"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", " 4|      10|   7|      15|        12|     7|2|10|      9|2|       9|         8|2|    15|       8|2|  10|     8|    12|  15|               10"
		...
		mobjSCGLSpr.SetCellsLock2 .sprSht, True, "SEQNO | CUSER | CDATE"
		mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHSEQNO | TIMCODE | CLIENTSUBCODE | CUSTCODE | DEPT_CD | MAXYEARMON" ,-1,-1,2,2,false
...
Sub SelectRtn ()
	...
	With frmThis
		...
		vntData = mobjSCCOBRANDLIST.SelectRtn_SUBSEQ(gstrConfigXml,mlngRowCnt,mlngColCnt, strCLIENTNAME, strSEQNAME, strHIGHSEQNAME, strUSE_YN)
		...
		If not gDoErrorRtn ("SelectRtn_SUBSEQ") Then
			...
			mobjSCGLSpr.SetCellsLock2 .sprSht, false, "TIMCODE | BTNTIM | TIMNAME | CLIENTSUBCODE | BTNSUB | CLIENTSUBNAME | CUSTCODE | BTN | CUSTNAME | DEPT_CD | BTNDEPT | DEPT_NAME"
	...
	With frmThis
		...
		If not gDoErrorRtn ("ProcessRtn_SUBSEQ") Then
			If isArray(returnvalue) Then
				...
				'gOkMsgBox  returnvalue(0) & "건의 자료가 저장" & mePROC_DONE,"저장안내!"
	...
	With frmThis
		...
		For intCnt2 = 1 To .sprSht.MaxRows
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",intCnt2) = 1 Then
				if mobjSCGLSpr.GetTextBinding(.sprSht,"ATTR01",intCnt2) <> "승인요청" then
		...
		for i = .sprSht.MaxRows to 1 step -1
			If mobjSCGLSpr.GetTextBinding(.sprSht,"CHK",i) = 1 Then
				...
				If strSEQNO = "" Then
					...
					intRtn = mobjSCCOBRANDLIST.ProcessRtn_CONFOK(gstrConfigXml,strSEQNO)
				End If				
   				intCnt = intCnt + 1
   			End If
		Next
							...
							<TR>
								<TD class="KEYFRAME" style="WIDTH: 100%" vAlign="top" align="left">
									<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" align="left"
										border="0">
										<TR>
											<TD class="SEARCHLABEL" width="60" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtCLIENTNAME,'')">광고주명</TD>
											...
											<TD class="SEARCHLABEL" width="60" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtSEQNAME,'')">브랜드명</TD>
											...
											<TD class="SEARCHLABEL" width="80" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHSEQNAME,'')">대표브랜드명</TD>
											...
											<TD class="SEARCHLABEL" width="60" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHSEQNAME,'')">사용구분</TD>
												...
												<TABLE style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
													<TR>
														...
														<TD><IMG id="imgConf" onmouseover="JavaScript:this.src='../../../images/imgAgreeOn.gIF'" style="CURSOR: hand"
																onmouseout="JavaScript:this.src='../../../images/imgAgree.gIF'" height="20" alt="자료를 저장합니다."
