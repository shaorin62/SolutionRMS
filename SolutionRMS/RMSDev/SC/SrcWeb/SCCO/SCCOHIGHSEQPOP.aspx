<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOHIGHSEQPOP.aspx.vb" Inherits="SC.SCCOHIGHSEQPOP" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>대표브랜드 조회</title> 
		<!--
'****************************************************************************************
...
sub InitPage()
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				case 0 : .txtHIGHSUBSEQ.value = vntInParam(i)	
				case 1 : .txtHIGHSEQNAME.value = vntInParam(i)
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadLayout .sprSht, 2, 0, 0, 0,2
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHSEQNO | HIGHSEQNAME"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|대표브랜드명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "10 | 30"
			mobjSCGLSpr.SetRowHeight .sprSht, "-1", "13"
			mobjSCGLSpr.SetRowHeight .sprSht, "0", "20"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "HIGHSEQNO"
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "HIGHSEQNAME"
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHSEQNO",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHSEQNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetHIGHSUBSEQ(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHSUBSEQ.value,.txtHIGHSEQNAME.value)

		if not gDoErrorRtn ("GetHIGHSUBSEQ") then
							...
							<TR>
								<TD class="KEYFRAME" style="HEIGHT: 20px" vAlign="middle" height="20"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 40px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHSUBSEQ,txtHIGHSEQNAME)">
														코드</TD>
													<TD class="SEARCHDATA" width="90"><INPUT class="INPUT" id="txtHIGHSUBSEQ" type="text" name="txtHIGHSUBSEQ" style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 90px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHSUBSEQ,txtHIGHSEQNAME)">
														대표브랜드&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtHIGHSEQNAME" style="WIDTH: 148px; HEIGHT: 22px" type="text" size="19"
															name="txtHIGHSEQNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
