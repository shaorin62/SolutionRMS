<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOCUSTPOP.aspx.vb" Inherits="SC.SCCOCUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | CUSTNAME | BUSINO | COMPANYNAME | GROUPGBN"
			mobjSCGLSpr.SetHeader .sprSht, "코드|청구지|사업자번호|상호명"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 14 |10| 13"
			...
			mobjSCGLSpr.ColHidden .sprSht, "GROUPGBN",true
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetHIGHCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHCUSTCODE.value,.txtCUSTNAME.value, "A")
										...
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHCUSTCODE,txtCUSTNAME)">광고주 
														명&nbsp;</TD>
