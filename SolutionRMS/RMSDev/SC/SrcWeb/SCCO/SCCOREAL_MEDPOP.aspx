<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOREAL_MEDPOP.aspx.vb" Inherits="SC.SCCOREAL_MEDPOP" %>
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetHIGHCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHCUSTCODE.value,.txtCUSTNAME.value, "B")
