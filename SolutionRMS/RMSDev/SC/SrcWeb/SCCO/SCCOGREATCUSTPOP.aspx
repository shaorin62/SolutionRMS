<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOGREATCUSTPOP.aspx.vb" Inherits="SC.SCCOGREATCUSTPOP" %>
...
sub InitPage()
	...
	with frmThis
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "HIGHCUSTCODE | CUSTNAME | GREATNAME"
			mobjSCGLSpr.SetHeader .sprSht, "코드|광고주|사용광고처"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", "5 | 14 |20"
			...
			mobjSCGLSpr.SetCellAlign2 .sprSht, "HIGHCUSTCODE",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME|GREATNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetGREATCUSTCODE(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtHIGHCUSTCODE.value,.txtCUSTNAME.value)
										...
										<TABLE class="SEARCHDATA" id="tblKey" style="WIDTH: 392px" cellSpacing="0" cellPadding="0" width="392"
											...
											<TBODY>
												<TR>
													...
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtHIGHCUSTCODE,txtCUSTNAME)">광고처 
														명&nbsp;</TD>
