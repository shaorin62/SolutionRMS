<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOCUSTSEQPOP.aspx.vb" Inherits="SC.SCCOCUSTSEQPOP" %>
...
sub InitPage()
	...
	with frmThis
		...
		mobjSCGLSpr.SpreadLayout .sprSht, 11, 0, 0, 0, 2
		mobjSCGLSpr.SpreadDataField .sprSht, " SEQNO | SEQNAME | CUSTCODE | CUSTNAME | TIMCODE | TIMNAME | CLIENTSUBCODE | CLIENTSUBNAME | DEPT_CD | DEPT_NAME|GROUPGBN"
		mobjSCGLSpr.SetHeader .sprSht,	  "브랜드코드|브랜드명|광고주코드|광고주명|팀코드|팀명|사업부코드|사업부|부서코드|부서명|그룹구분"
		mobjSCGLSpr.SetColWidth .sprSht, "-1", "    0|      10|         0|      15|     0|  10|         0|    10|       0|    10|0"
		...
		mobjSCGLSpr.ColHidden .sprSht, "SEQNO | CUSTCODE | TIMCODE | CLIENTSUBCODE | DEPT_CD ", true
		mobjSCGLSpr.SetCellAlign2 .sprSht, "SEQNAME | CUSTNAME | TIMNAME | CLIENTSUBNAME | DEPT_NAME" ,-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.Get_BrandInfo(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtSUBSEQ.value,.txtSUBSEQNAME.value,.txtCUSTCODE.value,.txtCUSTNAME.value)
				...
				<TD>
					<FORM id="frmThis">
						...
						<TABLE id="tblBody" cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD class="DATA" vAlign="middle" height="21" style="WIDTH: 500px"><FONT face="굴림">
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="0" cellPadding="0" width="500" align="right" border="0">
												<TR>
							...
							<TR>
								<TD class="BODYSPLIT" style="WIDTH: 500px"><FONT face="굴림"></FONT></TD>
							</TR>
							<TR>
								<TD align="center" style="WIDTH: 500px"><FONT face="굴림">
										<OBJECT id="sprSht" style="WIDTH: 500px; HEIGHT: 274px" classid="clsid:41F841C1-AE16-11D5-8817-0050DA6EF5E5"
											VIEWASTEXT>
							...
							<TR>
								<TD class="BOTTOMSPLIT" id="lblStatus" style="WIDTH: 500px"><FONT face="굴림"></FONT></TD>
							</TR>
						</TABLE>
						<FONT face="굴림"></FONT>
				</TD>
