<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCOTIMPOP.aspx.vb" Inherits="SC.SCCOTIMPOP" %>
	...
	with frmThis
		...
		for i = 0 to intNo
			select case i
				...
				case 2 : .txtTIMCODE.value = vntInParam(i)	
				case 3 : .txtTIMNAME.value = vntInParam(i)
        ...
        With frmThis
			...
			mobjSCGLSpr.SpreadDataField .sprSht, "CUSTCODE | CUSTNAME | CLIENTSUBCODE | CLIENTSUBNAME | HIGHCUSTCODE | COMPANYNAME|GROUPGBN"
			mobjSCGLSpr.SetHeader .sprSht,		 "코드|팀명|사업부코드|사업부명|광고주코드|광고주명|그룹"
			mobjSCGLSpr.SetColWidth .sprSht, "-1", " 5|  12|         0|      10|         0|     15 |0"
			...
			mobjSCGLSpr.SetCellTypeStatic2 .sprSht, "GROUPGBN"
			mobjSCGLSpr.ColHidden .sprSht, "CLIENTSUBCODE | HIGHCUSTCODE",true
			mobjSCGLSpr.SetScrollBar .sprSht,2,False,0,-1
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTCODE",-1,-1,2,2,false
			mobjSCGLSpr.SetCellAlign2 .sprSht, "CUSTNAME | CLIENTSUBNAME | COMPANYNAME",-1,-1,0,2,false
...
sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOGET.GetTIMCODE(gstrConfigXml,mlngRowCnt,mlngColCnt, .txtCLIENTCODE.value, .txtCLIENTNAME.value,.txtTIMCODE.value,.txtTIMNAME.value)
											...
											<TBODY>
												...
												<TR>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMCODE,txtTIMNAME)">
														코드</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTIMCODE" type="text" size="9" name="txtTIMCODE"
															style="WIDTH: 90px; HEIGHT: 22px">&nbsp;</TD>
													<TD class="SEARCHLABEL" style="WIDTH: 70px; CURSOR: hand" onclick="vbscript:Call gCleanField(txtTIMNAME,txtTIMCODE)">
														팀&nbsp;명&nbsp;</TD>
													<TD class="SEARCHDATA"><INPUT class="INPUT" id="txtTIMNAME" style="WIDTH: 140px; HEIGHT: 22px" type="text"
															size="18" name="txtTIMNAME" tabIndex="1"></TD>
												</TR>
											</TBODY>
										</TABLE>
									</FONT>
