<%@ Page Language="vb" AutoEventWireup="false" Codebehind="leftmenu_reportmeddtl.aspx.vb" Inherits="SC.leftmenu_reportmeddtl" %>
...
<!--	
	...
	function defaultauth(strTT,strMENU) {
		...
		{
			parent.mainFrame.location.href="http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMBRANDAGENCYLIST.aspx"
				...
				<tr>
					<td background="../../images/newleftmenu/left_m_bg.gif" height="34" valign="top">
						<table width="184" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td class="left_menu" style="PADDING-RIGHT: 0px; PADDING-LEFT: 15px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px">매체별 집행내역</td>
							</tr>
							<tr>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu00">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="REME1_V">
									<a id="b1" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMBRANDAGENCYLIST.aspx',this.id);"
									class="left_menu3">AOR 공중파 광고정산</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="REME2_V">
									<a id="b2" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMCLIENTSUBSEQMEDLIST.aspx',this.id);"
									class="left_menu3">부문별 실집행 광고비</a><br>
							</tr>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu01">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="REME3_V">
									<a id="b3" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMCLIENTSUBCATVLIST.aspx',this.id);"
									class="left_menu3">부문별 실집행 광고비</a><br>
							</tr>
						</table>
						<table width="184" border="0" cellpadding="0" cellspacing="0">
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu02">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="REME4_V">
									<a id="b4" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMCLIENTSUBPRINTLIST.aspx',this.id);"
									class="left_menu3">부문별 실집행 광고비</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="REME5_V">
									<a id="b5" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMPRINTMEDAMTLIST.aspx',this.id);"
									class="left_menu3">매체별 집행내역</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="REME6_V">
									<a id="b6" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMPUBYEARMONAMTLIST.aspx',this.id);" 
									class="left_menu3">세부 집행내역</a><br>
							</tr>	
						</table>
						<table width="184" border="0" cellpadding="0" cellspacing="0">
							<tr>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu03">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="REME7_V">
									<a id="b7" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMINTERNETQSHEETLIST.aspx',this.id);"
									class="left_menu3">광고주/부문별 큐시트</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="REME8_V">
									<a id="b8" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMCLIENTSUBINTERNETLIST.aspx',this.id);"
									class="left_menu3">인터넷 매체별광고비</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="REME9_V">
									<a id="b9" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDSC/MDCMCICAMTLIST.aspx',this.id);" 
									class="left_menu3">광고주별 매체비</a><br>
							</tr>
						</table>
					</td>
				</tr>
