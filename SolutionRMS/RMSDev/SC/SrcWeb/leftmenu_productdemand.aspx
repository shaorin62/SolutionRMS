<%@ Page Language="vb" AutoEventWireup="false" Codebehind="leftmenu_productdemand.aspx.vb" Inherits="SC.leftmenu_productdemand" %>
				...
				<tr>
					<td background="../../images/newleftmenu/left_m_bg.gif" height="34" valign="top">
						<table width="184" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td class="left_menu" style="PADDING-RIGHT: 0px; PADDING-LEFT: 15px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px">제작 
									의뢰</td>
							</tr>
							<tr>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td class="left_menu2" style="PADDING-RIGHT: 0px; PADDING-LEFT: 20px; PADDING-BOTTOM: 0px; PADDING-TOP: 0px">
									<a href="javascript:menuclick(smenu00);" class="left_menu2" onclick="blur()">제작 관리</a></td>
							</tr>
							<TR>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu00">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px"
									id="PDCM1_V">
									<a id="b1" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/PD/SrcWeb/PDCO/PDCMPROJECTJOBLIST.aspx',this.id);"
										class="left_menu3">JOB등록/조회</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px"
									...
									<a id="b2" style="CURSOR:hand" onclick="javascript:detailclick('blank.htm',this.id);"
										class="left_menu3">예산합의 요청</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px"
									id="PDCM3_V">
									<a id="b3" style="CURSOR:hand" onclick="javascript:detailclick('blank.htm',this.id);"
										class="left_menu3">예산합의 승인</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px"
									id="PDCM4_V">
							...
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px"
									id="PDCM5_V">
									<a id="b5" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/PD/SrcWeb/PDCO/PDCMJOBSTATUS.aspx',this.id);"
										class="left_menu3">JOB진행현황 조회</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px"
									id="PDCM6_V">
									<a id="b6" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/PD/SrcWeb/PDCO/PDCMDEMANDCONFIRM.aspx',this.id);"
