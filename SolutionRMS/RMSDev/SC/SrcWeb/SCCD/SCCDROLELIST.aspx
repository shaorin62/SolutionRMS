<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SCCDROLELIST.aspx.vb" Inherits="SC.SCCDROLELIST" %>
...
Sub imgAuthCopy_onclick
	...
	with frmThis
		...
		vntRet = gShowModalWindow("../SCCO/SCCOEMPAUTHPOP.aspx","" , 413,435)
		...
		if isArray(vntRet) then
     	...
     	If strCOPYUSERID <> "" And strCOPYUSERNAME <> "" Then
			...
			intRtn = mobjSCCOROLEMST.ProcessRtn_Copy(gstrConfigXml,strUSERID,strCOPYUSERID)
...
Sub imgAuthbatchCopy_onclick
	...
	with frmThis
		If .txtEMPNO.value = "" or .sprSht.MaxRows = 0 Then
			gErrorMsgBox "복사할 사원을 우선 조회하십시오.","권한복사 안내"
			Exit Sub
		Else 
			strUSERNAME = trim(.txtEMPNAME.value)
			strUSERID = trim(.txtEMPNO.value)
		End If
		
		
		vntInParams = array(strUSERID ,strUSERNAME) '<< 받아오는경우
		
		vntRet = gShowModalWindow("../SCCO/SCCOEMPAUTHBATCHPOP.aspx",vntInParams , 520,455) 
...
Sub SelectRtn ()
	...
	with frmThis
		...
		vntData = mobjSCCOROLEMST.SelectRtn(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value,.txtEMPNAME.value,.cmbGUBN.value )
...
Sub ProcessRtn()
	...
	with frmThis
		...
		'처리 업무객체 호출
		intRtn = mobjSCCOROLEMST.ProcessRtn(gstrConfigXml,vntData,strUSERID)
...
Sub EMP_POP
	...
	with frmThis
		...
		vntRet = gShowModalWindow("../SCCO/SCCOEMPPOP.aspx",vntInParams , 413,435)
		if isArray(vntRet) then
...
Sub txtEMPNAME_onkeydown
	if window.event.keyCode = meEnter then
		...
		with frmThis
			...
			mlngRowCnt=clng(0)
			mlngColCnt=clng(0)
			vntData = mobjSCCOGET.GetSCEMP(gstrConfigXml,mlngRowCnt,mlngColCnt,.txtEMPNO.value, .txtEMPNAME.value,"A","","")
										...
										<TABLE class="SEARCHDATA" id="tblKey" cellSpacing="1" cellPadding="0" width="100%" border="0">
											<TR>
												...
												<TD class="SEARCHLABEL" style="CURSOR: hand" onclick="vbscript:Call gCleanField(txtEMPNO, txtEMPNAME)"
													width="90">사용자</TD>
												<TD class="SEARCHDATA"><INPUT class="INPUT_L" id="txtEMPNAME" title="사원조회" style="HEIGHT: 22px" type="text" maxLength="255"
														...
														align="absMiddle" border="0" name="ImgEMPNO"> <INPUT class="INPUT" id="txtEMPNO" title="사번조회" style="WIDTH: 88px; HEIGHT: 22px" type="text"
														maxLength="8" align="left" size="9" name="txtEMPNO"></TD>
											...
											<TR>
												...
												<TD vAlign="middle" align="right" height="20">
													...
													<TABLE style="HEIGHT: 20px" cellSpacing="0" cellPadding="2" border="0">
														<TR>
															<TD><IMG id="imgAuthCopy" onmouseover="JavaScript:this.src='../../../images/imgAuthCopyOn.gIF'" style="CURSOR: hand"
																	onmouseout="JavaScript:this.src='../../../images/imgAuthCopy.gIF'" height="20" alt="기존사용자 권한을 선택 하여 현재 조회 되어있는 사용자 에게 적용합니다."
																	src="../../../images/imgAuthCopy.gIF" border="0" name="imgAuthCopy" align="absMiddle">
															</TD>
															<TD><IMG id="imgAuthbatchCopy" onmouseover="JavaScript:this.src='../../../images/imgAuthCopybatchOn.gIF'" style="CURSOR: hand"
																	onmouseout="JavaScript:this.src='../../../images/imgAuthbatchCopy.gIF'" height="20" alt="현재 사용자의 권한을 다른 사용자들에게 일괄 적용 합니다.."
																	src="../../../images/imgAuthbatchCopy.gIF" border="0" name="imgAuthbatchCopy" align="absMiddle">
															</TD>
