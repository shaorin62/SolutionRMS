...
'Response.Write ("DSN:" & DSN & " Module:" & Module & " RptName:" & RptName & " Params:" & Params & " Opt:" & Opt)
...
basePath = Right(Path, 29)  '--->> 10 버젼일 경우에는 29를 사용할 것
...
'strDB = vntDBParam(2) : strUID = vntDBParam(0) : strPWD = vntDBParam(1)
	'UID=devadmin;PWD=password;DSN=MCDEV_NEW
	strDB = "MCDEV_NEW" : strUID = "advsa" : strPWD = "advsa1234"
'=========================================================================
...
If Err.Number <> 0 Then
  Response.Write strDB & "<BR>"
  Response.Write strUID & "<BR>"
  Response.Write strPWD & "<BR>"
  Response.Write "두번째<BR>"
  Response.Write strtt & "<BR>"
  Response.Write strta & "<BR>"
...
<HTML>
	<HEAD>
		...
		<!--
			...
			Sub EndPage()
				...
				window.open "SCRTCLEAN.asp","","left=10000"
			End Sub
	...
	<BODY leftmargin="0" topmargin="0">
		<TABLE border="0" width="100%" height="100%"  cellpadding="0" cellspacing="0" ID="Table1">
			...
			<A id="CRBug" href="#"><FONT size="2" face="돋움" color="#0000FF">▶ 크리스탈 레포트 프로그램 안내</FONT></A></TD></TR>
			-->
