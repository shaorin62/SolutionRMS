...
Public Class SimplePreviewReport
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SimplePreviewReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSimplePreviewReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SimplePreviewReport = New SimplePreviewReport
        rpt.Site = Me.Site
        Return rpt
    End Function
