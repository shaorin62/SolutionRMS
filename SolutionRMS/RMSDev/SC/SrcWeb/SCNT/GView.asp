...
<body leftmargin="10" topmargin="0" marginwidth="0" marginheight="0">
  ...
  <tr> 
    ...
    <td width="700" height="25" align="left">&nbsp;
      ...
      이전글이 없습니다. 
      <% else %>
      <a href="Gview.asp?num=<%=rs("board_num")%>&b_num=<%=rs("b_num")%>&part=<%=part%>&tail_part=<%=tail_part%>"><%=rs("title")%></a> 
  ...
  <tr align="right"> 
    <td height="30" colspan="3"><table width="170" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr align="right"> 
          <td>&nbsp;</td>
          <td >&nbsp;</td>
          <td ><a href="GList.asp?part=<%=part%>&tail_part=<%=tail_part%>"><img src="Image/list_icon.gif"  border="0"></a></td>
        </tr>
      </table></td>
  </tr>
  <tr align="right"> 
