        ...
        '************************ 이전 10 개구문 시작 ***************************
                ...
                Else
                %>
                <a href="Glist.asp?page=<%=blockPage-cdivide%>"> <img src="image/i_pp.gif" align=absmiddle  border="0"></a> 
                <%
                End If
        '************************ 이전 10 개 구문 끝***************************
        ...
        '---이전으로 가기-------------------------------------------------------
              ...
              %>
                ...
                <a href="Glist.asp?page=<%=page-1%>"> <img src="image/i_pre.gif" align=absmiddle  border="0"></a> 
                <% else %>
                <a href="Glist.asp?page=<%=page-1%>"> <img src="image/i_pre.gif" align=absmiddle  border="0"></a> 
                <% end if
       '---이전으로 가기 끝---------------------------------------------------
             ...
             %>
                ...
                <%Else%>
                <a href="Glist.asp?page=<%=blockPage%>"><%=blockPage%></a> 
                <%
    End If
...
if page=1 and int(page)<>int(totalpage) then
%>
                <a href="Glist.asp?page=<%=page+1%>"><img src="image/i_next.gif" align=absmiddle  border="0"></a> 
                <%elseif page=1 and int(page)=int(totalpage) then%>
...
Else
%>
                <a href="Glist.asp?page=<%=blockPage%>"> <img src="image/i_ff.gif" align=absmiddle   border="0"></a> 
                <%
End If
'************************ 다음 10 개 구문 끝***************************         
%>
