<%@ Page Language="vb" AutoEventWireup="false" Codebehind="leftmenu_outdoor.aspx.vb" Inherits="SC.leftmenu_outdoor" %>
...
<!--
	...
	function defaultauth(strTT,strMENU) {
		...
		{
			parent.mainFrame.location.href="http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORLIST.aspx"
				...
				<tr>
					<td background="../../images/newleftmenu/left_m_bg.gif" height="34" valign="top">
						<table width="184" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								<td class="left_menu" style="PADDING-RIGHT: 0px; PADDING-LEFT: 15px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px">옥외</td>
							</tr>
							<tr>
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu00">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="MDOU13_V">
									<a id="b13" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORDEPT.aspx',this.id);"
									class="left_menu3">옥외 담당부서 등록</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU1_V">
									<a id="b1" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORLIST.aspx',this.id);"
									class="left_menu3">청약확정</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU11_V">
									<a id="b11" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOOR_MEDIUM.aspx',this.id);"
									class="left_menu3">청약등록</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU2_V">
									<a id="b2" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORCOMMIAL.aspx',this.id);"
									class="left_menu3">거래명세서</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU3_V">
									<a id="b3" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORCONFLIST.aspx',this.id);"
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu01">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="MDOU4_V">
									<a id="b4" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORTAX.aspx',this.id);"
									class="left_menu3">세금계산서</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU10_V">
									<a id="b10" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMMERGEOUTDOORLIST.aspx',this.id);"
									class="left_menu3">통합청구 이동</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU5_V">
									<a id="b5" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORVOCH.aspx',this.id);"
						...
						<table width="184" border="0" cellpadding="0" cellspacing="0" id="smenu02">
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="MDOU12_V">
									<a id="b12" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOOR_REPORT.aspx',this.id);"
									class="left_menu3">옥외 보고서 확정 리스트</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 10px" 
									id="MDOU6_V">
									<a id="b6" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORMULTILIST.aspx',this.id);"
									class="left_menu3">광고주/매체사별</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU7_V">
									<a id="b7" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORREALMEDLIST.aspx',this.id);"
									class="left_menu3">년간 매체사별 실적</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU8_V">
									<a id="b8" style="CURSOR:hand"  onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORMONOUTALLLIST.aspx',this.id);"
									class="left_menu3">외주비 내역</a><br>
							</tr>
							<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU9_V">
									<a id="b9" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORMONREALLIST.aspx',this.id);"
									class="left_menu3">월간 매체사별 집행현황</a><br>
							</tr>
							<!--<tr>
								<td style="PADDING-RIGHT: 0px; PADDING-LEFT: 26px; PADDING-BOTTOM: 0px; PADDING-TOP: 2px" 
									id="MDOU10_V">
									<a id="b10" style="CURSOR:hand" onclick="javascript:detailclick('http://10.110.10.89:8080/MD/SrcWeb/MDOT/MDCMOUTDOORMONREALAMTLIST.aspx',this.id);"
									class="left_menu3">월간 매체사비/수수료집계</a><br>
							</tr>
							-->
						</table>
					</td>
